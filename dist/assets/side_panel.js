import{n as e,r as t}from"./constants-MgsnqggU.js";import{A as n,D as r,E as i,O as a,S as o,a as s,b as c,c as l,f as u,g as d,h as f,k as p,l as m,m as h,n as g,o as _,p as v,r as y,s as b,t as x,u as S,x as C,y as w}from"./token-store-D6sbpX_G.js";var T=new Set,E=[],ee=`deepseek-v4-pro`,D=null,te=[],ne=!0,O=!0,re=!1,ie=null,ae=``,oe=``,se=[],ce=-1,le=-1,k=null,ue=``,de=[],fe=-1,pe=null,me=null,he=[],ge={platformName:`Unknown`,platform:`unknown`,arch:`unknown`,shell:`/bin/sh`,homeDir:`/home/user`,workdir:``,connected:!1},_e={maxInputHistory:20,maxHistoryMessages:50,maxMessageLength:1e5,maxMemoryMessages:20,enableExecutionLog:!1,contextWindow:0},ve=.2,ye=1,be=0,xe=`all`,Se=``,Ce=[],we={},Te=new Map,A=null,Ee=new Map,De=new Set,Oe=new Map,ke=null,Ae=null,je=null,j=null,Me=null,Ne=18e4,Pe=null,Fe=!1,Ie=null,Le=``,Re=null,ze=0,Be=0,Ve=-1,He=!1,Ue=``,We=``,Ge=``,Ke=[],qe=!1,Je=new Map,M={get isGenerating(){return T.has(D)},set isGenerating(e){e?T.add(D):T.delete(D),document.dispatchEvent(new CustomEvent(`generating-state-changed`))},get generatingSessionIds(){return T},get messageHistory(){return E},set messageHistory(e){E=e},get currentModel(){return ee},set currentModel(e){ee=e},get activeSessionId(){return D},set activeSessionId(e){D=e},get sessions(){return te},set sessions(e){te=e},get useTools(){return ne},set useTools(e){ne=e},get isolateChat(){return O},set isolateChat(e){O=e},get enableSelectionQuery(){return re},set enableSelectionQuery(e){re=e},get currentTabId(){return ie},set currentTabId(e){ie=e},get selectedContextText(){return ae},set selectedContextText(e){ae=e},get quotedContextText(){return oe},set quotedContextText(e){oe=e},get customPrompts(){return se},set customPrompts(e){se=e},get selectedPromptIndex(){return ce},set selectedPromptIndex(e){ce=e},get selectedAgentAtIndex(){return le},set selectedAgentAtIndex(e){le=e},get draggedItemIndex(){return k},set draggedItemIndex(e){k=e},get systemPrompt(){return ue},set systemPrompt(e){ue=e},get activeAgentId(){return pe},set activeAgentId(e){pe=e},get activeAgentToolIds(){return me},set activeAgentToolIds(e){me=e},get customAgents(){return he},set customAgents(e){he=e},get agentPlatform(){return ge},set agentPlatform(e){Object.assign(ge,e)},get inputHistory(){return de},set inputHistory(e){de=e},get inputHistoryIndex(){return fe},set inputHistoryIndex(e){fe=e},get chatConfig(){return _e},set chatConfig(e){_e=e},get temperature(){return ve},set temperature(e){ve=e},get topP(){return ye},set topP(e){ye=e},get selectedTempIndex(){return be},set selectedTempIndex(e){be=e},get currentCategory(){return xe},set currentCategory(e){xe=e},get currentSearch(){return Se},set currentSearch(e){Se=e},get enabledTools(){return Ce},set enabledTools(e){Ce=e},get collapsedCategories(){return we},get sessionExecutionStatus(){return Te},set sessionExecutionStatus(e){Te=e},get currentExecutionStatus(){return Te.get(D)||null},set currentExecutionStatus(e){e===null?Te.delete(D):Te.set(D,e)},get executionLogListener(){return A},set executionLogListener(e){A=e},get pendingCancelApi(){return Ee.get(D)||null},set pendingCancelApi(e){e===null?Ee.delete(D):Ee.set(D,e)},get pendingCancelApiMap(){return Ee},get pendingCallApiSessionIds(){return De},set pendingCallApiSessionIds(e){De=e},get substituteLoadingIds(){return Oe},set substituteLoadingIds(e){Oe=e},get currentClarifyToolCallId(){return ke},set currentClarifyToolCallId(e){ke=e},get currentClarifySessionId(){return Ae},set currentClarifySessionId(e){Ae=e},get currentConfirmToolCallId(){return je},set currentConfirmToolCallId(e){je=e},get currentConfirmSessionId(){return j},set currentConfirmSessionId(e){j=e},get clarifyTimerInterval(){return Me},set clarifyTimerInterval(e){Me=e},get clarifyTimeoutValue(){return Ne},set clarifyTimeoutValue(e){Ne=e},get messageTocContainer(){return Pe},set messageTocContainer(e){Pe=e},get isMouseOverToc(){return Fe},set isMouseOverToc(e){Fe=e},get tocHideTimer(){return Ie},set tocHideTimer(e){Ie=e},get lastSelectedText(){return Le},set lastSelectedText(e){Le=e},get currentSelectionRange(){return Re},set currentSelectionRange(e){Re=e},get lastMouseX(){return ze},set lastMouseX(e){ze=e},get lastMouseY(){return Be},set lastMouseY(e){Be=e},get pendingDeleteIndex(){return Ve},set pendingDeleteIndex(e){Ve=e},get enableImageInput(){return He},set enableImageInput(e){He=e},get imageModelName(){return Ue},set imageModelName(e){Ue=e},get imageApiBase(){return We},set imageApiBase(e){We=e},get imageApiKey(){return Ge},set imageApiKey(e){Ge=e},get attachedImages(){return Ke},set attachedImages(e){Ke=e},get isScrolling(){return qe},set isScrolling(e){qe=e},get customModelMap(){return Je},set customModelMap(e){Je=e}},Ye=t,N=[{label:`精准编码`,temp:.2,topP:1,tip:`较低随机性，适合业务开发、调试、纠错`},{label:`均衡开发`,temp:.45,topP:.9,tip:`兼顾稳定性，用于封装工具类、常规脚本`},{label:`架构探索`,temp:.65,topP:.9,tip:`提供多种实现思路，用于组件重构、方案对比`},{label:`创意发散`,temp:.9,topP:.9,tip:`随机性较高，仅用于原型探索，不建议生产代码`}],Xe={page_interaction:`🖱️ 页面交互`,form_operation:`📝 表单操作`,content_extraction:`📄 内容提取`,tab_management:`📑 标签页管理`,bookmark_history:`🔖 书签历史`,storage_management:`💾 存储管理`,network_request:`🌐 网络请求`,media_output:`📷 媒体与输出`,debug_dev:`🔧 调试开发`,ai_collaboration:`🤖 AI协作`,local_agent:`🖥️ 本地代理`},Ze=[{id:`default`,name:`默认助手`,description:`全能 AI 助手，拥有所有工具能力`,icon:`🤖`,systemPrompt:null,toolIds:null,isBuiltin:!0,allowSubDispatch:!1,model:null,temperature:null,topP:null}],Qe=[{name:`代码审查专家`,icon:`🔍`,description:`专注于代码审查与质量保证`,systemPrompt:`你是一个资深的代码审查专家(Code Review Expert)。你的职责是：
1. 审查代码的逻辑正确性、性能和安全性
2. 检查代码风格、命名规范和最佳实践
...
- 示例优先：关键概念必须配代码或配置示例
- 面向读者：根据目标读者调整技术深度
- 保持简洁：避免冗余，每段话都要有信息量`,toolIds:[`get_page_text`,`page_to_markdown`,`copy_to_clipboard`,`search_bookmarks`,`search_history`,`search_conversation_memory`],allowSubDispatch:!1}];function $e(){return`agent_`+Date.now().toString(36)+`_`+Math.random().toString(36).substring(2,6)}var P=`customAgents`,et=`activeAgentId`;async function tt(){let e=(await chrome.storage.local.get([P]))[P]||[];return[...Ze,...e]}async function nt(){return(await chrome.storage.local.get([P]))[P]||[]}async function rt(e){return e&&(await tt()).find(t=>t.id===e)||null}async function it(e){let t=await nt(),n={id:$e(),name:e.name||`未命名Agent`,description:e.description||``,icon:e.icon||`🤖`,systemPrompt:e.systemPrompt||``,toolIds:e.toolIds||null,isBuiltin:!1,allowSubDispatch:e.allowSubDispatch===void 0?!1:e.allowSubDispatch,model:e.model||null,temperature:e.temperature===void 0?null:e.temperature,topP:e.topP===void 0?null:e.topP,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};return t.push(n),await chrome.storage.local.set({[P]:t}),n}async function at(e,t){let n=await nt(),r=n.findIndex(t=>t.id===e);return r===-1?null:(n[r]={...n[r],...t,id:e,isBuiltin:!1,updatedAt:new Date().toISOString()},await chrome.storage.local.set({[P]:n}),n[r])}async function ot(e){let t=await nt(),n=t.findIndex(t=>t.id===e);return n===-1?!1:(t.splice(n,1),await chrome.storage.local.set({[P]:t}),(await chrome.storage.local.get([et]))[et]===e&&await chrome.storage.local.remove(et),!0)}async function st(){return(await chrome.storage.local.get([et]))[et]||null}async function ct(e){e?await chrome.storage.local.set({[et]:e}):await chrome.storage.local.remove(et)}function F(e,t=`info`,n=3e3){let r=document.getElementById(`toastContainer`);if(!r)return;let i=document.createElement(`div`);i.className=`toast ${t}`,i.textContent=e,r.appendChild(i),requestAnimationFrame(()=>{i.classList.add(`toast-show`)}),setTimeout(()=>{i.classList.remove(`toast-show`),setTimeout(()=>{i.parentNode&&i.parentNode.removeChild(i)},300)},n)}function lt(){let e=document.getElementById(`userInput`);e&&(e.style.height=`auto`,e.style.height=Math.min(e.scrollHeight,100)+`px`)}function I(e){if(!e)return``;let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function ut(e){return!e||e<0?`0ms`:e<1e3?`${Math.round(e)}ms`:e<6e4?`${(e/1e3).toFixed(1)}s`:`${Math.floor(e/6e4)}分${(e%6e4/1e3).toFixed(1)}秒`}function dt(e,t){navigator.clipboard.writeText(e).then(()=>{let e=t.innerHTML;t.innerHTML=`<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
      <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
        ...
        <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
      </svg>`,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{F(`复制失败`,`error`)}document.body.removeChild(r)})}async function ft(e=null){let t=new Date().toLocaleString(`zh-CN`),n=``;if(M.agentPlatform&&M.agentPlatform.connected){let e=M.agentPlatform;n=`\n- 本地 Agent：${e.platformName} (${e.arch})，默认 shell: ${e.shell}，工作目录: ${e.workdir||`未设置`}`}let r=``;e&&e.allowSubDispatch&&(r=`
...
- 操作系统：Windows 10.0
- 当前时间：${t}${n}
`}function pt(){return new Promise(e=>{chrome.storage.local.get([`temperature`,`topP`],t=>{e({temperature:t.temperature===void 0?parseFloat(M.temperature.toFixed(2)):parseFloat(t.temperature.toFixed(2)),top_p:t.topP===void 0?parseFloat(M.topP.toFixed(2)):parseFloat(t.topP.toFixed(2))})})})}function mt(){return new Promise(e=>{chrome.runtime.sendMessage({type:`GET_CHAT_CONFIG`},t=>{t&&(M.chatConfig=t,console.log(`[SidePanel] 对话配置已加载:`,M.chatConfig)),e(t)})})}async function ht(){return new Promise(e=>{chrome.runtime.sendMessage({type:`GET_CHAT_CONFIG`},t=>{t&&(M.chatConfig=t,console.log(`[SidePanel] 同步加载对话配置:`,M.chatConfig)),e()})})}async function gt(){return new Promise(e=>{chrome.tabs.query({active:!0,currentWindow:!0},t=>{t&&t.length>0&&t[0].id?(M.currentTabId=t[0].id,console.log(`[SidePanel] 获取当前 Tab ID:`,M.currentTabId,`URL:`,t[0].url),e(M.currentTabId)):(console.warn(`[SidePanel] 未获取到有效的 Tab ID`),e(null))})})}function _t(){return new Promise(e=>{chrome.storage.local.get([`reactMaxIterations`,`reactApiTimeout`,`reactLoopTimeout`,`reactToolTimeout`,`reactClarifyTimeout`],t=>{e({maxIterations:t.reactMaxIterations||30,apiTimeout:t.reactApiTimeout||6e4,loopTimeout:t.reactLoopTimeout||3e5,toolTimeout:t.reactToolTimeout||3e4,clarifyTimeout:t.reactClarifyTimeout||18e4})})})}function vt(e){if(!e||!e.trim()||e.trim()==`/`)return;let t=e.trim(),n=M.inputHistory.indexOf(t);n!==-1&&M.inputHistory.splice(n,1),M.inputHistory.push(t),M.inputHistory.length>M.chatConfig.maxInputHistory&&M.inputHistory.shift(),yt()}function yt(){try{chrome.storage.local.set({inputHistory:M.inputHistory}),console.log(`[SidePanel] 输入历史已保存，数量:`,M.inputHistory.length)}catch(e){console.error(`[SidePanel] 保存输入历史失败:`,e)}}function bt(){document.addEventListener(`mouseover`,xt,!0),document.addEventListener(`mouseout`,St,!0),console.log(`[SidePanel] 消息目录功能已初始化`)}function xt(e){if(!(e.target instanceof Element))return;if(e.target.closest(`.message-toc-container`)){M.isMouseOverToc=!0;return}let t=e.target.closest(`.message.assistant`);if(!t)return;let n=t.querySelectorAll(`.markdown-body h1, .markdown-body h2, .markdown-body h3, .markdown-body h4, .markdown-body h5, .markdown-body h6`);if(n.length===0){wt();return}Ct(t,n)}function St(e){if(!(e.target instanceof Element))return;if(e.target.closest(`.message-toc-container`)){M.isMouseOverToc=!1,M.tocHideTimer&&=(clearTimeout(M.tocHideTimer),null);return}if(!e.target.closest(`.message.assistant`))return;let t=e.relatedTarget;t&&(t.closest(`.message-toc-container`)||t.closest(`.message.assistant`))||M.isMouseOverToc||(M.tocHideTimer&&clearTimeout(M.tocHideTimer),M.tocHideTimer=setTimeout(()=>{M.isMouseOverToc||wt(),M.tocHideTimer=null},800))}function Ct(e,t){let n=Array.from(t);M.messageTocContainer&&wt(),n.forEach((e,t)=>{e.id||=`toc-heading-${Date.now()}-${t}`});let r=document.createElement(`div`);r.className=`message-toc-container`,r.dataset.headingsCount=n.length;let i=0,a=n.map(e=>{let t=parseInt(e.tagName.charAt(1)),n=e.textContent.trim(),r=n.length>30?n.substring(0,30)+`...`:n,a=`H${t}`;return i++,`
...
`});let o=new Blob([a],{type:`text/csv;charset=utf-8;`}),s=document.createElement(`a`),c=URL.createObjectURL(o);s.setAttribute(`href`,c),s.setAttribute(`download`,`table-${Date.now()}.csv`),s.style.visibility=`hidden`,document.body.appendChild(s),s.click(),document.body.removeChild(s),console.log(`[SidePanel] Excel 下载成功`)}catch(e){console.error(`[SidePanel] 下载 Excel 失败:`,e),F(`下载失败: `+e.message,`error`)}}async function vn(){if(typeof mermaid>`u`){console.warn(`[SidePanel] Mermaid 库未加载`);return}console.log(`[SidePanel] ===== renderMermaidCharts 开始 =====`);let e=document.querySelectorAll(`.mermaid`);if(console.log(`[SidePanel] 找到 mermaid 元素数量:`,e.length),e.length!==0){for(let t=0;t<e.length;t++){let n=e[t];try{await mermaid.run({nodes:[n]}),console.log(`[SidePanel] 第`,t+1,`个 mermaid 图表渲染成功`),bn(n)}catch(e){console.error(`[SidePanel] 第`,t+1,`个 mermaid 图表渲染失败:`,e),!n.querySelector(`svg`)&&!n.querySelector(`.mermaid-controls`)&&(n.innerHTML=`<div style="color: #856404; background: #fff3cd; padding: 10px; border-radius: 4px; margin: 10px 0;">图表渲染失败: ${e.message}</div>`)}}console.log(`[SidePanel] ===== renderMermaidCharts 完成 =====`)}}function yn(e){return e?`<div class="markdown-body">${mn(e)}</div>`:``}function bn(e){if(e.querySelector(`.mermaid-controls`)){console.log(`[SidePanel] 工具栏已存在，跳过`);return}let t=e.querySelector(`svg`);if(!t){console.warn(`[SidePanel] SVG 元素未找到，当前内容:`,e.innerHTML.substring(0,100));return}console.log(`[SidePanel] 找到 SVG 元素，开始添加工具栏`),console.log(`[SidePanel] container 类名:`,e.className),console.log(`[SidePanel] container HTML:`,e.innerHTML.substring(0,200)),e.style.position=`relative`,e.style.cursor=`grab`,e.style.userSelect=`none`,e.style.webkitUserSelect=`none`;let n=e.querySelector(`.mermaid-svg-wrapper`);if(!n){n=document.createElement(`div`),n.className=`mermaid-svg-wrapper`,n.style.transformOrigin=`center center`,n.style.transition=`transform 0.2s ease`,n.style.display=`inline-block`,n.style.width=`100%`,t.style.maxWidth=`100%`,t.style.height=`auto`,t.style.userSelect=`none`,t.style.webkitUserSelect=`none`,n.appendChild(t),e.insertBefore(n,e.firstChild);let r=[];Array.from(e.childNodes).forEach(e=>{e.nodeType===Node.TEXT_NODE&&e.textContent.trim()&&r.push(e)}),r.forEach(e=>e.remove())}let r=document.createElement(`div`);r.className=`mermaid-controls`,r.innerHTML=`
  ...
  `,e.appendChild(r),console.log(`[SidePanel] 工具栏 HTML 已添加`),console.log(`[SidePanel] container 子元素:`,Array.from(e.children).map(e=>e.className).join(`, `));let i=1,a=.3,o=.15,s=e.dataset.rawCode||``;if(!s){let e=t.querySelector(`title`);e&&e.textContent&&(s=e.textContent.trim())}if(!s){let e=t.querySelector(`script[type="text/plain"]`);e&&(s=e.textContent.trim())}s&&!e.dataset.rawMermaidCode&&(e.dataset.rawMermaidCode=s),r.querySelector(`.view-source`).addEventListener(`click`,r=>{r.stopPropagation();let s=e.getAttribute(`data-raw-code`);Cn(e,s?decodeURIComponent(s):e.dataset.rawMermaidCode||``,n,t,i,{MIN_SCALE:a,MAX_SCALE:10,SCALE_STEP:o})}),r.querySelector(`.copy-to-clipboard`).addEventListener(`click`,e=>{e.stopPropagation(),xn(t,n,i)}),r.querySelector(`.download-png`).addEventListener(`click`,e=>{e.stopPropagation(),Sn(t,i)}),e.addEventListener(`wheel`,e=>{!e.ctrlKey&&!e.metaKey||(e.preventDefault(),e.stopPropagation(),i=e.deltaY<0?Math.min(10,i+o):Math.max(a,i-o),p())},{passive:!1});let c=!1,l,u,d=0,f=0;function p(){n.style.transform=`translate(${d}px, ${f}px) scale(${i})`}r.querySelector(`.zoom-in`).addEventListener(`click`,e=>{e.stopPropagation(),i=Math.min(10,i+o),p()}),r.querySelector(`.zoom-out`).addEventListener(`click`,e=>{e.stopPropagation(),i=Math.max(a,i-o),p()}),r.querySelector(`.reset-zoom`).addEventListener(`click`,e=>{e.stopPropagation(),i=1,d=0,f=0,p()}),e.addEventListener(`mousedown`,t=>{t.target.tagName!==`BUTTON`&&(c=!0,l=t.clientX-d,u=t.clientY-f,e.style.cursor=`grabbing`)}),document.addEventListener(`mousemove`,e=>{c&&(d=e.clientX-l,f=e.clientY-u,p())}),document.addEventListener(`mouseup`,()=>{c&&(c=!1,e.style.cursor=`grab`)})}async function xn(e,t,n){try{console.log(`[SidePanel] 开始复制到剪贴板`);let t=e.width.baseVal?.value||e.getAttribute(`width`)?.replace(`px`,``)||800,n=e.height.baseVal?.value||e.getAttribute(`height`)?.replace(`px`,``)||600,r=e.getAttribute(`viewBox`);if(r){let e=r.split(` `).map(parseFloat);t=e[2],n=e[3]}console.log(`[SidePanel] SVG 原始尺寸:`,t,`x`,n);let i=new XMLSerializer().serializeToString(e),a=`data:image/svg+xml;base64,${btoa(unescape(encodeURIComponent(i)))}`,o=new Image;o.onload=function(){let e=t+40,r=n+40,i=document.createElement(`canvas`);i.width=e*2,i.height=r*2;let a=i.getContext(`2d`);a.fillStyle=`#ffffff`,a.fillRect(0,0,i.width,i.height),a.drawImage(o,40,40,t*2,n*2),i.toBlob(function(e){if(e)if(navigator.clipboard&&typeof ClipboardItem<`u`)navigator.clipboard.write([new ClipboardItem({"image/png":e})]).then(()=>{console.log(`[SidePanel] 图片复制到剪贴板成功`),F(`Mermaid 图表已复制到剪贴板！`,`success`)}).catch(e=>{console.error(`[SidePanel] 复制到剪贴板失败:`,e),F(`复制失败，您的浏览器可能不支持此功能。请尝试使用下载按钮保存图表。`,`error`)});else{console.warn(`[SidePanel] Clipboard API 不可用，降级为下载`),F(`当前浏览器不支持图片复制功能，已自动转为下载。`,`warning`);let t=document.createElement(`a`);t.href=URL.createObjectURL(e),t.download=`mermaid-diagram-`+Date.now()+`.png`,document.body.appendChild(t),t.click(),document.body.removeChild(t)}},`image/png`)},o.onerror=function(e){console.error(`[SidePanel] 图片转换失败:`,e),F(`图片转换失败，请重试`,`error`)},o.src=a}catch(e){console.error(`[SidePanel] 复制到剪贴板失败:`,e),F(`复制失败: `+e.message,`error`)}}function Sn(e,t){try{console.log(`[SidePanel] 开始下载 PNG`);let t=e.width.baseVal?.value||e.getAttribute(`width`)?.replace(`px`,``)||800,n=e.height.baseVal?.value||e.getAttribute(`height`)?.replace(`px`,``)||600,r=e.getAttribute(`viewBox`);if(r){let e=r.split(` `).map(parseFloat);t=e[2],n=e[3]}console.log(`[SidePanel] SVG 原始尺寸:`,t,`x`,n);let i=new XMLSerializer().serializeToString(e),a=`data:image/svg+xml;base64,${btoa(unescape(encodeURIComponent(i)))}`,o=new Image;o.onload=function(){console.log(`[SidePanel] SVG 图片加载成功`);let e=t+40,r=n+40,i=document.createElement(`canvas`);i.width=e*2,i.height=r*2;let a=i.getContext(`2d`);a.fillStyle=`#ffffff`,a.fillRect(0,0,i.width,i.height),a.drawImage(o,40,40,t*2,n*2),i.toBlob(function(e){let t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`mermaid-diagram-`+Date.now()+`.png`,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(t),console.log(`[SidePanel] PNG 下载成功`)},`image/png`)},o.onerror=function(e){console.error(`[SidePanel] PNG 转换失败:`,e),F(`PNG 转换失败，请重试`,`error`)},o.src=a}catch(e){console.error(`[SidePanel] 下载 PNG 失败:`,e),F(`下载失败: `+e.message,`error`)}}function Cn(e,t,n,r,i,a){let o=e.querySelector(`.mermaid-source-view`),s=e.querySelector(`.mermaid-controls`);if(o)o.parentElement&&o.parentElement.remove(),n&&(n.style.display=`inline-block`),bn(e);else{n&&(n.style.display=`none`),s&&s.remove();let o=document.createElement(`div`);o.className=`mermaid-container-wrapper`,o.style.position=`relative`;let c=document.createElement(`pre`);c.className=`mermaid-source-view`,c.style.position=`relative`,c.textContent=t;let l=document.createElement(`button`);l.className=`source-copy-btn`,l.title=`复制源代码`,l.innerHTML=`
    ...
    `,u.addEventListener(`click`,()=>{rr(i)}),l.appendChild(u);let f=document.createElement(`div`);f.className=`popup-tool-items ${d?`collapsed`:``}`,a.forEach(e=>{let t=M.enabledTools.includes(e.id),n=document.createElement(`div`);n.className=`popup-tool-item`,n.dataset.category=i,n.innerHTML=`
      ...
      `;let r=n.querySelector(`input[type="checkbox"]`);r&&r.addEventListener(`change`,t=>{if(t.stopPropagation(),t.target.checked)M.enabledTools.includes(e.id)||M.enabledTools.push(e.id);else{let t=M.enabledTools.indexOf(e.id);t>-1&&M.enabledTools.splice(t,1)}ir(i),sr(),B()}),f.appendChild(n)}),l.appendChild(f),e.appendChild(l)}),e.children.length===0){let t=document.createElement(`div`);t.className=`popup-tool-empty`,t.textContent=`没有找到匹配的工具`,e.appendChild(t)}}function rr(e){M.collapsedCategories[e]=!M.collapsedCategories[e];let t=document.querySelector(`.popup-tool-category-group[data-category="${e}"]`);if(!t)return;let n=t.querySelector(`.popup-tool-category`).querySelector(`.category-expand-icon`),r=t.querySelector(`.popup-tool-items`);M.collapsedCategories[e]?(n.textContent=`▶`,r.classList.add(`collapsed`)):(n.textContent=`▼`,r.classList.remove(`collapsed`))}function ir(t){let n=document.querySelector(`.popup-tool-category[data-category="${t}"]`);if(!n)return;let r=n.querySelector(`.category-count`);if(!r)return;let i=e.filter(e=>e.category===t),a=i.length,o=0;i.forEach(e=>{let t=document.getElementById(`tool_`+e.id);t&&t.checked&&o++}),r.textContent=`${o}/${a}`}function ar(){return $n().filter(e=>{if(M.currentCategory!==`all`&&e.category!==M.currentCategory)return!1;if(M.currentSearch){let t=e.name.toLowerCase().includes(M.currentSearch.toLowerCase()),n=e.description.toLowerCase().includes(M.currentSearch.toLowerCase());if(!t&&!n)return!1}return!0})}function or(){Ye.forEach(e=>{ir(e)})}function sr(){let e=[`all`,...Ye],t=$n(),n=new Set(t.map(e=>e.id)),r=M.enabledTools.filter(e=>n.has(e)).length;e.forEach(e=>{let n=document.getElementById(`badge-`+e);if(!n)return;let i=0,a=0;if(e===`all`)i=t.length,a=r;else{let n=t.filter(t=>t.category===e);i=n.length,a=n.filter(e=>M.enabledTools.includes(e.id)).length}n.textContent=`${a}/${i}`,e!==`all`&&n.parentElement&&(n.parentElement.style.display=i===0?`none`:``)})}function B(){let e=document.getElementById(`toolsEnabledCount`);if(!e)return;let t=$n(),n=t.length,r=new Set(t.map(e=>e.id));e.textContent=`(已启用 ${M.enabledTools.filter(e=>r.has(e)).length}/${n})`}function cr(){let t=[];new Set(e.map(e=>e.id)),e.forEach(e=>{let n=document.getElementById(`tool_`+e.id);n?n.checked&&t.push(e.id):M.enabledTools.includes(e.id)&&t.push(e.id)}),M.enabledTools=t,M.useTools=M.enabledTools.length>0,chrome.storage.local.set({enabledTools:M.enabledTools},()=>{console.log(`[SidePanel] 工具配置已保存:`,M.enabledTools)}),Wn().catch(()=>{});let n=document.getElementById(`toolsPreselectToggle`);n&&chrome.storage.local.set({enableToolPreselect:n.checked},()=>{console.log(`[SidePanel] 工具预筛选开关已保存:`,n.checked)}),lr();let r=$n(),i=new Set(r.map(e=>e.id)),a=M.enabledTools.filter(e=>i.has(e)).length;F(M.useTools?`已启用 ${a} 个工具`:`工具已全部禁用`,`success`)}function lr(){let e=document.getElementById(`toolsToggleBtn`),t=document.getElementById(`toolsBadge`),n=$n(),r=new Set(n.map(e=>e.id)),i=M.enabledTools.filter(e=>r.has(e)).length;e&&(M.useTools&&i>0?(e.classList.add(`active`),e.title=`工具 (${i}个启用)`):(e.classList.remove(`active`),e.title=`工具 (未启用)`)),t&&(i>0?(t.textContent=i,t.style.display=`inline`):t.style.display=`none`)}async function ur(){await dr(),await V(),mr(),gr(),console.log(`[AgentMgr] Agent 管理器初始化完成, activeAgentId:`,M.activeAgentId)}async function dr(){let[e,t]=await Promise.all([st(),tt()]);M.activeAgentId=e,M.customAgents=t.filter(e=>!e.isBuiltin),console.log(`[AgentMgr] Agent 状态已加载, activeAgentId:`,e,`total:`,t.length)}async function V(){let e=document.getElementById(`agentListItems`),t=document.getElementById(`agentDropdownFooter`);if(!e)return;let n=await tt(),r=M.activeAgentId,i=``;for(let e of n){let t=e.id===r||!r&&e.id==="default",n=e.toolIds?e.toolIds.length:`全部`;i+=`
...
`).trim()}}async function Ti(){let t=await z();if(t.activeSessionId&&t.list.length>0){M.activeSessionId=t.activeSessionId,M.sessions=t.list;let n=t.list.find(e=>e.id===t.activeSessionId);if(n){if(M.messageHistory=n.messageHistory||[],M.currentModel=n.model||M.currentModel,M.useTools=n.useTools===void 0?M.useTools:n.useTools,n.enabledTools&&n.enabledTools.length>0){let t=new Set(e.map(e=>e.id)),r=n.enabledTools.filter(e=>t.has(e)),i=new Set(n.enabledTools),a=e.filter(e=>e.enabled&&!i.has(e.id)).map(e=>e.id);M.enabledTools=[...r,...a]}else M.enabledTools=n.enabledTools||M.enabledTools;M.temperature=n.temperature===void 0?M.temperature:n.temperature,M.topP=n.topP===void 0?M.topP:n.topP}M.messageHistory.forEach(e=>{let t=e.wasRevised;if(!t&&e.executionLog)try{t=(typeof e.executionLog==`string`?JSON.parse(e.executionLog):e.executionLog).some(e=>e.nodeType===`reflection`&&e.reflectionType===`post`&&e.action?.decision===`revised`)}catch{}e.htmlContent?Oa(e.htmlContent):Y(e.role,e.content,!1,e.executionLog||[],e.reflectionScore,t)});let r=document.querySelector(`.welcome-message`);r&&M.messageHistory.length>0&&r.remove(),vn();let i=`scrollPosition_`+(M.activeSessionId||`default`);chrome.storage.local.get([i],e=>{e[i]!==void 0&&setTimeout(()=>{let t=document.getElementById(`chatContainer`);t.scrollTop=e[i]},100)}),G()}else{await Gn();let e=await z();e.activeSessionId&&(M.activeSessionId=e.activeSessionId,M.sessions=e.list),G()}}function K(){try{Wn().catch(e=>{console.error(`[SidePanel] 保存当前会话失败:`,e)})}catch(e){console.error(`[SidePanel] 保存对话历史异常:`,e)}}function Ei(){M.messageHistory&&M.messageHistory.length>0&&Xn().then(()=>{M.messageHistory=[];let e=document.getElementById(`chatContainer`);if(e){e.innerHTML=``;let t=document.createElement(`div`);t.className=`welcome-message`,t.innerHTML=`
        ...
        </div>`}).join(``),t.querySelectorAll(`.export-session-item`).forEach(e=>{let t=e.querySelector(`.export-session-checkbox`);e.addEventListener(`click`,e=>{e.target!==t&&(t.checked=!t.checked),Oi()})});let i=document.getElementById(`exportSelectAllBtn`),a=document.getElementById(`exportDeselectAllBtn`),o=document.getElementById(`exportSelectCurrentBtn`);i&&(i.onclick=()=>{t.querySelectorAll(`.export-session-checkbox`).forEach(e=>{e.checked=!0}),Oi()}),a&&(a.onclick=()=>{t.querySelectorAll(`.export-session-checkbox`).forEach(e=>{e.checked=!1}),Oi()}),o&&(o.onclick=()=>{t.querySelectorAll(`.export-session-checkbox`).forEach(e=>{e.checked=e.dataset.sessionId===r}),Oi()}),Oi()}}catch(e){console.error(`[SidePanel] 加载会话列表失败:`,e),t.innerHTML=`<div class="export-sessions-empty">加载失败</div>`}e.classList.add(`show`)}}function Oi(){document.querySelectorAll(`#exportSessionsList .export-session-checkbox`);let e=document.querySelectorAll(`#exportSessionsList .export-session-checkbox:checked`),t=document.getElementById(`exportSelectedCount`);t&&(t.textContent=`已选 ${e.length} 个`);let n=document.getElementById(`exportSessionsOkBtn`);n&&(n.textContent=`导出选中 (${e.length})`,n.disabled=e.length===0,n.style.opacity=e.length===0?`0.5`:`1`)}function ki(){let e=document.getElementById(`exportSessionsModal`);e&&e.classList.remove(`show`)}async function Ai(){let e=document.querySelectorAll(`#exportSessionsList .export-session-checkbox:checked`),t=Array.from(e).map(e=>e.dataset.sessionId);if(t.length===0){F(`请至少选择一个会话`,`warning`);return}try{let{list:e}=await z(),n=e.filter(e=>t.includes(e.id)),r={version:1,exportedAt:new Date().toISOString(),sessions:n.map(e=>({title:e.title||`未命名会话`,model:e.model,useTools:e.useTools,enabledTools:e.enabledTools,temperature:e.temperature,topP:e.topP,createdAt:e.createdAt,messageHistory:(e.messageHistory||[]).map(e=>({role:e.role,content:e.content||``,executionLog:e.executionLog||[],htmlContent:e.htmlContent||``,reflectionScore:e.reflectionScore,wasRevised:e.wasRevised||!1}))}))},i=new Date,a=i.getFullYear()+String(i.getMonth()+1).padStart(2,`0`)+String(i.getDate()).padStart(2,`0`)+`-`+String(i.getHours()).padStart(2,`0`)+String(i.getMinutes()).padStart(2,`0`)+String(i.getSeconds()).padStart(2,`0`),o=n.length,s=o===1?`ai-helper-${n[0].title.replace(/[^a-zA-Z0-9\u4e00-\u9fa5_-]/g,`_`)}-${a}.aihelper.json`:`ai-helper-${o}sessions-${a}.aihelper.json`,c=JSON.stringify(r,null,2),l=new Blob([c],{type:`application/json;charset=utf-8;`}),u=URL.createObjectURL(l),d=document.createElement(`a`);d.href=u,d.download=s,document.body.appendChild(d),d.click(),document.body.removeChild(d),URL.revokeObjectURL(u),ki(),console.log(`[SidePanel] 会话已导出:`,s,`共`,o,`个会话`),F(`已导出 ${o} 个会话`,`success`)}catch(e){console.error(`[SidePanel] 导出失败:`,e),F(`导出失败: `+e.message,`error`)}}function ji(){let e=document.getElementById(`exportSessionsCloseBtn`),t=document.getElementById(`exportSessionsCancelBtn`),n=document.getElementById(`exportSessionsOkBtn`),r=document.getElementById(`exportSessionsModal`);e&&e.addEventListener(`click`,ki),t&&t.addEventListener(`click`,ki),n&&n.addEventListener(`click`,Ai),r&&r.addEventListener(`click`,e=>{e.target===r&&ki()})}function Mi(){let e=document.getElementById(`importSessionsFile`);e&&(e.value=``,e.click())}async function Ni(e){try{let t=await e.text(),n=JSON.parse(t),r=[];if(n.version&&n.sessions&&Array.isArray(n.sessions))r=n.sessions;else if(Array.isArray(n))r=n.length>0&&n[0].role?[{title:`导入的对话`,messageHistory:n.map(e=>({role:e.role||`user`,content:e.content||``}))}]:(n.length>0&&n[0].title,n);else throw Error(`无法识别的文件格式`);if(r.length===0){F(`文件中没有可导入的会话数据`,`warning`);return}let i=await Zn(r);await G(),console.log(`[SidePanel] 导入完成:`,i.length,`个会话`),F(`成功导入 ${i.length} 个会话`,`success`)}catch(e){console.error(`[SidePanel] 导入失败:`,e),F(`导入失败: `+e.message,`error`)}}function Pi(){document.getElementById(`confirmModal`).classList.add(`show`)}function Fi(){document.getElementById(`confirmModal`).classList.remove(`show`)}var q=1,Ii=0,Li=0,Ri=!1,zi=0,Bi=0,Vi=0,Hi=0,J=[],Ui=0;function Wi(){let e=document.getElementById(`imagePreviewLarge`);e&&(e.style.transform=`translate(${Ii}px, ${Li}px) scale(${q})`,q>1?(e.classList.add(`zoomable`),Ri?e.classList.add(`dragging`):e.classList.remove(`dragging`)):e.classList.remove(`zoomable`,`dragging`))}function Gi(){q=1,Ii=0,Li=0,Ri=!1,Wi()}function Ki(e,t){let n=document.getElementById(`imagePreviewOverlay`),r=document.getElementById(`imagePreviewLarge`);!n||!r||(qi(e,t),Ji(),Xi(e),n.classList.add(`show`))}function qi(e,t){J=[],t&&(t.closest(`.image-preview-bar`)||t.classList.contains(`image-preview-thumb`)?document.querySelectorAll(`.image-preview-thumb`).forEach(e=>{e.src&&J.push(e.src)}):t.closest(`.user-message-images`)&&t.closest(`.user-message-images`).querySelectorAll(`.user-message-image`).forEach(e=>{e.src&&J.push(e.src)})),J.length===0&&document.querySelectorAll(`.image-preview-thumb, .user-message-image`).forEach(e=>{e.src&&J.push(e.src)}),Ui=J.indexOf(e),Ui===-1&&(J.push(e),Ui=J.length-1)}function Ji(){let e=document.getElementById(`imagePreviewPrev`),t=document.getElementById(`imagePreviewNext`),n=document.getElementById(`imagePreviewCounter`);J.length<=1?(e&&(e.style.display=`none`),t&&(t.style.display=`none`),n&&(n.style.display=`none`)):(e&&(e.style.display=``),t&&(t.style.display=``),n&&(n.style.display=``),Yi())}function Yi(){let e=document.getElementById(`imagePreviewPrev`),t=document.getElementById(`imagePreviewNext`),n=document.getElementById(`imagePreviewCounter`);e&&(e.disabled=!1),t&&(t.disabled=!1),n&&(n.textContent=`${Ui+1} / ${J.length}`)}function Xi(e){let t=document.getElementById(`imagePreviewLarge`);t&&(Gi(),t.src=e)}function Zi(e){let t=J.length;t!==0&&(Ui=(Ui+e+t)%t,Xi(J[Ui]),Yi())}function Qi(){let e=document.getElementById(`imagePreviewOverlay`);if(!e||e.dataset.initialized)return;e.dataset.initialized=`true`;let t=document.getElementById(`imagePreviewLarge`),n=()=>{e.classList.remove(`show`),Gi()};e.addEventListener(`click`,t=>{t.target===e&&n()});let r=e.querySelector(`.image-preview-close`);r&&r.addEventListener(`click`,n);let i=document.getElementById(`imagePreviewPrev`),a=document.getElementById(`imagePreviewNext`);i&&i.addEventListener(`click`,e=>{e.stopPropagation(),Zi(-1)}),a&&a.addEventListener(`click`,e=>{e.stopPropagation(),Zi(1)}),document.addEventListener(`keydown`,t=>{e.classList.contains(`show`)&&(t.key===`Escape`?n():t.key===`ArrowLeft`?Zi(-1):t.key===`ArrowRight`&&Zi(1))}),e.addEventListener(`wheel`,n=>{if(!e.classList.contains(`show`))return;n.preventDefault();let r=t.getBoundingClientRect(),i=n.clientX-r.left-r.width/2,a=n.clientY-r.top-r.height/2,o=n.deltaY>0?-.15:.15,s=q,c=Math.max(.3,Math.min(5,q+o)),l=c/s;q=c,Ii=i-l*(i-Ii),Li=a-l*(a-Li),Wi()},{passive:!1}),t.addEventListener(`mousedown`,t=>{!e.classList.contains(`show`)||q<=1||(t.preventDefault(),Ri=!0,zi=t.clientX,Bi=t.clientY,Vi=Ii,Hi=Li,Wi())}),document.addEventListener(`mousemove`,e=>{Ri&&(Ii=Vi+(e.clientX-zi),Li=Hi+(e.clientY-Bi),Wi())}),document.addEventListener(`mouseup`,()=>{Ri&&(Ri=!1,Wi())}),t.addEventListener(`dblclick`,()=>{e.classList.contains(`show`)&&(q>1?Gi():(q=2,Ii=0,Li=0,Wi()))})}function $i(e){let t=new Image,n=URL.createObjectURL(e);t.onload=()=>{URL.revokeObjectURL(n);let{width:e,height:r}=t,i=1024;(e>i||r>i)&&(e>r?(r=Math.round(i/e*r),e=i):(e=Math.round(i/r*e),r=i));let a=document.createElement(`canvas`);a.width=e,a.height=r,a.getContext(`2d`).drawImage(t,0,0,e,r);let o=a.toDataURL(`image/jpeg`,.65);M.attachedImages.push({dataUrl:o});let s=document.getElementById(`imagePreviewBar`),c=document.getElementById(`userInput`);s&&(s.style.display=``),ea(),c&&c.focus()},t.onerror=()=>{URL.revokeObjectURL(n),console.error(`[ChatManager] 图片加载失败`)},t.src=n}function ea(){let e=document.getElementById(`imagePreviewBar`);if(e){if(e.innerHTML=``,M.attachedImages.length===0){e.style.display=`none`;return}e.style.display=``,M.attachedImages.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`image-preview-item`;let i=document.createElement(`img`);i.src=t.dataUrl,i.className=`image-preview-thumb`,i.title=`点击查看大图`,i.style.cursor=`zoom-in`,i.addEventListener(`click`,()=>{Ki(t.dataUrl,i)});let a=document.createElement(`button`);a.className=`image-preview-remove`,a.innerHTML=`×`,a.title=`移除图片`,a.addEventListener(`click`,e=>{e.stopPropagation(),M.attachedImages.splice(n,1),ea()}),r.appendChild(i),r.appendChild(a),e.appendChild(r)})}}function ta(e){if(!M.enableImageInput||M.attachedImages.length===0)return e;let t=[{type:`text`,text:e}];for(let e of M.attachedImages)t.push({type:`image_url`,image_url:{url:e.dataUrl}});return t}function na(e){if(typeof e==`string`)return e;if(Array.isArray(e)){let t=e.filter(e=>e.type===`text`);return t.length===1?t[0].text:t}return e}async function ra(){let e=document.getElementById(`userInput`),t=document.getElementById(`chatContainer`),s=e.value.trim();if(!s||M.isGenerating)return;let l=t.querySelector(`.welcome-message`);l&&l.remove();let u=s,d=M.enableSelectionQuery&&M.selectedContextText&&M.selectedContextText.trim(),f=M.quotedContextText&&M.quotedContextText.trim();if(f){let{compressed:e,wasCompressed:t}=C(M.quotedContextText.trim());u=`[引用内容${t?`摘要`:``}]\n${e}\n\n[用户问题]\n${s}`,M.quotedContextText=``}else if(d){let{compressed:e,wasCompressed:t}=C(M.selectedContextText.trim());u=`[选中内容${t?`摘要`:``}]\n${e}\n\n[用户问题]\n${s}`,M.selectedContextText=``}let p=ta(u);Y(`user`,p),M.messageHistory.push({role:`user`,content:p}),K(),vt(s),M.inputHistoryIndex=-1,e.value=``,e.style.height=`auto`,(d||f)&&wi(),M.isGenerating=!0;let m=M.activeSessionId,h=Ea(),g=M.enableImageInput&&M.attachedImages.length>0&&M.imageModelName||M.currentModel;if(M.attachedImages.length>0){let e=document.getElementById(`imagePreviewBar`);e&&(e.innerHTML=``,e.style.display=`none`)}try{await ht();let e=await Ar(),t=jr(e);M.activeAgentToolIds=t,console.log(`[SidePanel] 发送消息调试信息:`),console.log(`  - agent:`,e?e.name:`默认助手`),console.log(`  - agentToolIds:`,t),console.log(`  - isolateChat:`,M.isolateChat),console.log(`  - chatConfig:`,M.chatConfig),console.log(`  - messageHistory.length:`,M.messageHistory.length);let s=[{role:`system`,content:await ft(e)}];if(M.isolateChat){let e=M.messageHistory,t=M.chatConfig.contextWindow||0,n=a(g,M.enabledTools.length,t,M.customModelMap),r=Math.floor(n*.7),c=M.messageHistory.slice(0,-1),l=M.messageHistory[M.messageHistory.length-1],u=[],d=o([l]);for(let e=c.length-1;e>=0;e--){let t=c[e],n=o([t]);if(d+n<=r)u.unshift(t),d+=n;else break}if(u.length<c.length){let e=c.length-u.length,t=i(c.slice(0,e));t&&(s[0]={...s[0],content:s[0].content+`

`+t}),console.log(`[SidePanel] Token 预算裁剪: 保留 ${u.length} 条历史消息, 裁剪 ${e} 条 (预算: ${r} tokens)`)}else console.log(`[SidePanel] Token 预算内: ${u.length} 条历史消息 (预算: ${r} tokens)`);e=[...u,l],s=[...s,...e];for(let e=0;e<s.length-1;e++)s[e]={...s[e],content:na(s[e].content)}}else{let e=ta(u);s.push({role:`user`,content:e})}let l=await pt();l._loadingId=h;let d=M.chatConfig.contextWindow||0,f=o(s),p=c(f,r(g,d,M.customModelMap));if(console.log(`[SidePanel] 发送上下文: ${f} tokens (消息: ${s.length} 条), 压力: ${p.level}(${Math.round(p.ratio*100)}%)`),p.level===`critical`){console.warn(`[SidePanel] 上下文压力过高，主动裁剪...`);let e=a(g,M.enabledTools.length,d,M.customModelMap),t=n(s,e,{generateSummary:!1});s=t.messages,console.warn(`[SidePanel] 已主动裁剪: ${f} → ${o(s)} tokens (${t.trimmedCount} 条)`)}let _,v,y,b=!1,x=!1,S=null,C=!0;try{let e=await Ia(s,g,M.useTools,l);_=e.content,v=e.executionLog||[],y=e.reflectionScore,b=e.wasRevised||!1,x=e.wasStreamed||!1,S=e.streamingHtml||null,C=e.streamingConnected===void 0?!0:e.streamingConnected}catch(e){if(M.activeSessionId!==m){e.message===`任务已被用户停止`?Qn(m,{role:`assistant`,content:`任务已取消`,executionLog:e.executionLog||[]}):Qn(m,{role:`assistant`,content:`❌ 请求失败：`+(e.message||`未知错误`),executionLog:e.executionLog||[]}),Z(h),M.substituteLoadingIds.delete(m);return}if(e.message===`任务已被用户停止`){Z(h),M.substituteLoadingIds.delete(m),Y(`assistant`,`任务已取消`,!1,e.executionLog||[]),M.messageHistory.push({role:`assistant`,content:`任务已取消`,executionLog:e.executionLog||[]}),K();return}throw Z(h),M.substituteLoadingIds.delete(m),_=`❌ 请求失败：`+(e.message||`未知错误`),v=e.executionLog||[],Y(`assistant`,_,!0,v,y),M.messageHistory.push({role:`assistant`,content:_,executionLog:v,reflectionScore:y}),e}if(M.activeSessionId!==m){let e={role:`assistant`,content:_,executionLog:v,reflectionScore:y,wasRevised:b};x&&S&&(e.htmlContent=S),Qn(m,e),Z(h),M.substituteLoadingIds.delete(m);return}x?M.substituteLoadingIds.has(m)&&(Z(M.substituteLoadingIds.get(m)),M.substituteLoadingIds.delete(m)):(Z(h),M.substituteLoadingIds.has(m)&&(Z(M.substituteLoadingIds.get(m)),M.substituteLoadingIds.delete(m)),await wn(Y(`assistant`,_,!0,v,y,b)));let w={role:`assistant`,content:_,executionLog:v,reflectionScore:y,wasRevised:b};if(x&&S&&(w.htmlContent=S,!C)){Oa(S);let e=document.getElementById(`chatContainer`);e&&(e.scrollTop=e.scrollHeight)}M.messageHistory.push(w)}catch(e){console.error(`[SidePanel] sendMessage 异常:`,e?.message||e)}finally{K(),M.generatingSessionIds.delete(m),document.dispatchEvent(new CustomEvent(`generating-state-changed`)),e.focus(),M.attachedImages=[];let t=document.getElementById(`imagePreviewBar`);t&&(t.style.display=`none`)}}function ia(e,t){let n=document.getElementById(`userInput`);if(!t||M.isGenerating){console.log(`[SidePanel] triggerSelectionSearch 跳过:`,{hasText:!!t,isGenerating:M.isGenerating});return}let r=M.enableSelectionQuery;M.enableSelectionQuery=!0,M.selectedContextText=t,M.quotedContextText=``,n.value=`搜索一下`,n.dispatchEvent(new Event(`input`)),ra(),M.enableSelectionQuery=!1,setTimeout(()=>{M.enableSelectionQuery=r},1500)}function aa(e){let t=document.getElementById(`userInput`);!t||!e||(t.value=e,t.dispatchEvent(new Event(`input`)),t.focus())}function oa(e,t=``){let n=document.getElementById(`userInput`);!n||!e||M.isGenerating||(t&&(M.enableSelectionQuery=!0,M.selectedContextText=t,M.quotedContextText=``),n.value=e,n.dispatchEvent(new Event(`input`)),n.focus(),ra(),t&&(M.enableSelectionQuery=!1,setTimeout(()=>{M.enableSelectionQuery=!0},1500)))}function sa(e,t,n=!0){let r=document.getElementById(`chatContainer`),i=document.createElement(`div`);i.className=`user-context-bubble`,i.dataset.role=`context`,i.innerHTML=`
  ...
  `,document.body.appendChild(r),r.querySelector(`.ri-close`).addEventListener(`click`,()=>r.remove()),r.addEventListener(`click`,e=>{e.target===r&&r.remove()});let S=t.getBoundingClientRect(),C=r.querySelector(`.reflection-info-panel`),w=Math.min(window.innerHeight-40,560),T=S.right-380;T<10&&(T=10),T+380>window.innerWidth-10&&(T=window.innerWidth-380-10);let E=S.bottom+6;E+w>window.innerHeight-10&&(E=S.top-w-6),E<10&&(E=10),C.style.left=T+`px`,C.style.top=E+`px`,C.style.maxHeight=w+`px`}function ga(e){let t=[...e].sort((e,t)=>new Date(e.timestamp)-new Date(t.timestamp)),n=t.length,r=``,i=null;return t.forEach((e,t)=>{let a=e.nodeType===`subtask`,o=e.nodeType===`tool_exec`,s=e.nodeType===`api_call`,c=e.nodeType===`preselect`,l=e.nodeType===`reflection`,u=o&&e.action?.name===`plan_task`;a&&(i=e.subtaskIndex);let d=``,f=``;l?f=`🎯`:c?f=`🔍`:u?(d=`plan-task-level`,f=`📋`):a?(d=`subtask-level`,f=`🔀`):o&&i!==null?(d=`tool-level`,f=`🔧`):s&&i!==null?(d=`api-level`,f=`📡`):o?f=`⚡`:s&&(f=`📡`);let p=`○`,m=e.status||`processing`;e.status===`success`?p=`✓`:e.status===`failed`&&(p=`✗`),l&&(m=`reflection ${m}`);let h=I(e.nodeName||`未知节点`);if(e.subtaskIndex!==null&&e.subtaskIndex>=0&&(h=`<span class="subtask-badge">${e.subtaskIndex+1}</span> ${h}`),e.subtaskCount&&(h+=` <span class="plan-badge">(${e.subtaskCount}个子任务, ${e.strategy===`sequential`?`顺序执行`:`并行执行`})</span>`),(s||c||l)&&e.apiRequest){let t=[];e.apiRequest.messageCount!==void 0&&e.apiRequest.messageCount!==null&&t.push(`💬<span title="本次模型API调用携带的消息数">${e.apiRequest.messageCount}条</span>`),!c&&e.apiRequest.toolCount!==void 0&&e.apiRequest.toolCount!==null&&t.push(`🔧<span title="本次模型API调用携带的工具定义数">${e.apiRequest.toolCount}个</span>`),t.length>0&&(h+=` <span class="api-info-badge">（${t.join(` `)}）</span>`)}r+=`
    ...
    `}),r}function _a(e){let t=[...e].sort((e,t)=>new Date(e.timestamp)-new Date(t.timestamp));if(!t.some(e=>e.taskGroup))return xa(t);let n=new Map,r=[];t.forEach(e=>{e.taskGroup?(n.has(e.taskGroup)||n.set(e.taskGroup,{groupId:e.taskGroup,groupIndex:e.taskGroupIndex,groupName:e.taskGroupName,entries:[],status:e.status}),n.get(e.taskGroup).entries.push(e),e.status&&(n.get(e.taskGroup).status=e.status)):r.push(e)});let i=va(r,t.length);return n.forEach((e,n)=>{let r=e.status||`processing`;i+=`
      <div class="task-group-container" data-group-id="${n}">
        ...
        <div class="task-group-timeline">
          ${ya(e.entries,t.length)}
        </div>
      </div>
    `}),i}function va(e,t){if(e.length===0)return``;let n=``;return n+=`
...
... (点击展开查看完整输出)`:o,c=o,l=document.createElement(`div`);if(l.className=`tool-call-result`,l.innerHTML=`
  ...
  `,t.querySelector(`.tool-call-header`).addEventListener(`click`,()=>{t.classList.toggle(`expanded`)}),t}function Na(e,t,n=[],r=null,i=null){if(!e)return;e.querySelectorAll(`.thinking-indicator`).forEach(e=>e.classList.add(`hidden`));let a=e.querySelector(`.stream-status`);a&&a.remove(),e.classList.remove(`streaming`);let o=e.querySelector(`.message-content`),s=e.querySelector(`.stream-content`);if(o&&o.querySelector(`.tool-call-item`)||s&&s.querySelector(`.tool-call-item`)){let e=da>0?((Date.now()-da)/1e3).toFixed(1)+`s`:``,r=document.createElement(`div`);r.className=`thinking-process collapsed`;let i=document.createElement(`div`);i.className=`thinking-process-header`,i.innerHTML=`
    ...
    `;let a=document.createElement(`div`);a.className=`thinking-process-body`;let c=document.createElement(`div`);if(c.className=`thinking-process-content`,a.appendChild(c),s)for(;s.firstChild;)c.appendChild(s.firstChild);o.querySelectorAll(`.tool-call-item`).forEach(e=>c.appendChild(e)),c.querySelectorAll(`.preselect-card`).forEach(e=>e.remove());let l=(n||[]).filter(e=>e.nodeType===`preselect`);console.log(`[finalizeStreamingMessage] executionLog length:`,(n||[]).length,`preselectEntries:`,l.length),l.forEach(e=>{console.log(`[finalizeStreamingMessage] creating preselect card for entry:`,e);let t=Ma(e);c.insertBefore(t,c.firstChild)});let u=c.querySelectorAll(`.thinking-badge`),d=c.querySelectorAll(`.thinking-content`);u.length>0&&u[u.length-1].remove(),d.length>0&&d[d.length-1].remove(),r.appendChild(i),r.appendChild(a);let f=document.createElement(`div`);f.className=`final-answer`;let p=Si(t);p&&p.trim()&&(f.innerHTML=yn(p));let m=o.querySelector(`.thinking-indicator`);m&&m.remove(),o.appendChild(r),o.appendChild(f),i.addEventListener(`click`,()=>{r.classList.toggle(`collapsed`)})}else if(s){let e=Si(t);!s.querySelector(`.thinking-content`)&&e&&e.trim()&&(s.innerHTML=yn(e))}e.classList.add(`assistant`,`message`),e.dataset.rawContent=typeof t==`string`?t:JSON.stringify(t),e.dataset.textContent_=Si(t),e.dataset.executionLog=JSON.stringify(n);let c=document.createElement(`div`);c.className=`message-footer`;let l=document.createElement(`button`);l.className=`copy-btn`,l.innerHTML=[`<svg viewBox="0 0 16 16" fill="currentColor">`,`<path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25zM5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25z"/>`,`</svg>`,`<span>复制</span>`].join(``),l.addEventListener(`click`,t=>{t.stopPropagation(),Ba(e,l)}),c.appendChild(l);let u=document.createElement(`button`);u.className=`quote-btn`,u.innerHTML=[`<svg t="1781246498458" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="9645" width="14" height="14"><path d="M156.09136 606.57001a457.596822 457.596822 0 0 1 221.680239-392.516385 50.844091 50.844091 0 1 1 50.844091 86.943396 355.90864 355.90864 0 0 0-138.804369 152.532274h16.77855a152.532274 152.532274 0 1 1-152.532274 152.532274z m406.752731 0a457.596822 457.596822 0 0 1 221.680239-392.007944 50.844091 50.844091 0 1 1 50.844091 86.943396 355.90864 355.90864 0 0 0-138.804369 152.532274h16.77855a152.532274 152.532274 0 1 1-152.532274 152.532274z" fill="#8a8a8a" p-id="9646"></path></svg>`,`<span>引用</span>`].join(``),u.addEventListener(`click`,t=>{t.stopPropagation(),Ua(e)}),c.appendChild(u);let d=document.createElement(`div`);d.className=`export-menu-container`;let f=document.createElement(`button`);f.className=`export-trigger-btn`,f.innerHTML=`<svg t="1781245244396" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5115" width="14" height="14"><path d="M496.213333 739.84c2.133333 2.133333 4.693333 3.84 7.68 5.12 0.853333 0.426667 2.133333 0.426667 2.986667 0.853333 1.706667 0.426667 2.986667 0.853333 4.693333 0.853334 5.546667 0 11.093333-2.133333 14.933334-6.4l256-256c8.533333-8.533333 8.533333-21.76 0-30.293334s-21.76-8.533333-30.293334 0L533.333333 674.133333V128c0-11.946667-9.386667-21.333333-21.333333-21.333333s-21.333333 9.386667-21.333333 21.333333v545.706667l-219.306667-219.306667c-8.533333-8.533333-21.76-8.533333-30.293333 0s-8.533333 21.76 0 30.293333l255.146666 255.146667zM768 874.666667H256c-11.946667 0-21.333333 9.386667-21.333333 21.333333s9.386667 21.333333 21.333333 21.333333h512c11.946667 0 21.333333-9.386667 21.333333-21.333333s-9.386667-21.333333-21.333333-21.333333z" fill="#8a8a8a" p-id="5116"></path></svg><span>导出</span><svg class="dropdown-arrow" width="8" height="6" viewBox="0 0 8 6" fill="currentColor"><path d="M0 0l4 6 4-6z"/></svg>`;let p=document.createElement(`div`);p.className=`export-dropdown`,p.innerHTML=[`<div class="export-dropdown-item export-docx-item">`,`<svg t="1781245550030" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6544" width="32" height="32"><path d="M747.936 901.171H276.819c-72.2 0-130.953-55.224-130.953-123.078V244.721c0-67.854 58.752-123.078 130.953-123.078h383.525c6.597 0 12.937 2.505 17.795 6.954l192.363 178.046c5.317 4.96 8.386 11.914 8.386 19.227v452.223c0 67.854-58.752 123.078-130.952 123.078zM276.819 174.004c-43.31 0-78.592 31.703-78.592 70.717v533.372c0 39.015 35.282 70.718 78.592 70.718h471.117c43.31 0 78.592-31.703 78.592-70.718V337.324l-176.461-163.32H276.819z" fill="#8a8a8a" p-id="6545"></path><path d="M830.567 331.546H669.446c-14.471 0-26.18-11.71-26.18-26.181V156.209c0-14.471 11.709-26.18 26.18-26.18s26.181 11.709 26.181 26.18v122.976h134.94c14.471 0 26.181 11.709 26.181 26.18s-11.711 26.181-26.181 26.181z" fill="#8a8a8a" p-id="6546"></path><path d="M730.214 428.749l-92.04 343.616h-53.179L511.363 498.29l-75.677 274.074h-53.179l-92.04-343.616h49.088l69.542 255.667 69.541-255.667h63.406l69.541 255.667 69.541-255.667h49.088z" fill="#8a8a8a" p-id="6547"></path></svg>`,`<span>导出 Word</span>`,`</div>`,`<div class="export-dropdown-item export-pdf-item">`,`<svg t="1781245863206" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8152" width="32" height="32"><path d="M582.4 864H170.666667c-6.4 0-10.666667-4.266667-10.666667-10.666667V170.666667c0-6.4 4.266667-10.666667 10.666667-10.666667h309.333333V320c0 40.533333 34.133333 74.666667 74.666667 74.666667h160v38.4c0 17.066667 14.933333 32 32 32s32-14.933333 32-32V298.666667c0-8.533333-4.266667-17.066667-8.533334-23.466667l-170.666666-170.666667c-6.4-6.4-14.933333-8.533333-23.466667-8.533333H170.666667C130.133333 96 96 130.133333 96 170.666667v682.666666c0 40.533333 34.133333 74.666667 74.666667 74.666667h411.733333c17.066667 0 32-14.933333 32-32s-14.933333-32-32-32z m132.266667-550.4v17.066667H554.666667c-6.4 0-10.666667-4.266667-10.666667-10.666667V160h19.2l151.466667 153.6z" fill="#8a8a8a" p-id="8153"></path><path d="M332.8 533.333333c-12.8 0-19.2 2.133333-25.6 6.4-6.4 4.266667-8.533333 12.8-8.533333 23.466667v206.933333c0 6.4 2.133333 12.8 6.4 19.2 4.266667 4.266667 10.666667 8.533333 21.333333 8.533334s17.066667-4.266667 21.333333-8.533334c4.266667-4.266667 6.4-10.666667 6.4-19.2v-64h32c57.6 0 89.6-29.866667 89.6-87.466666 0-27.733333-8.533333-51.2-23.466666-64-14.933333-14.933333-36.266667-21.333333-66.133334-21.333334h-53.333333z m87.466667 85.333334c0 12.8-2.133333 23.466667-8.533334 27.733333-4.266667 4.266667-14.933333 8.533333-27.733333 8.533333h-32v-70.4H384c12.8 0 21.333333 2.133333 27.733333 8.533334 6.4 4.266667 8.533333 12.8 8.533334 25.6zM667.733333 571.733333c-8.533333-12.8-21.333333-21.333333-34.133333-29.866666-14.933333-4.266667-32-8.533333-51.2-8.533334h-61.866667c-8.533333 0-17.066667 0-23.466666 8.533334-2.133333 4.266667-4.266667 10.666667-4.266667 19.2V768c0 8.533333 2.133333 14.933333 4.266667 19.2 6.4 8.533333 14.933333 8.533333 23.466666 8.533333h64c19.2 0 34.133333-4.266667 49.066667-10.666666 12.8-6.4 25.6-17.066667 34.133333-29.866667 8.533333-12.8 14.933333-25.6 19.2-42.666667 4.266667-14.933333 6.4-32 6.4-49.066666 0-17.066667-2.133333-34.133333-6.4-49.066667-4.266667-14.933333-10.666667-29.866667-19.2-42.666667z m-42.666666 153.6c-8.533333 12.8-21.333333 19.2-38.4 19.2h-38.4v-160H576c21.333333 0 38.4 6.4 46.933333 19.2 10.666667 12.8 14.933333 34.133333 14.933334 59.733334 2.133333 27.733333-4.266667 46.933333-12.8 61.866666zM851.2 533.333333h-106.666667c-8.533333 0-17.066667 2.133333-21.333333 6.4-6.4 4.266667-8.533333 12.8-8.533333 21.333334v209.066666c0 6.4 2.133333 12.8 6.4 17.066667 4.266667 6.4 10.666667 8.533333 21.333333 8.533333 8.533333 0 17.066667-2.133333 21.333333-8.533333 2.133333-4.266667 6.4-8.533333 6.4-19.2v-85.333333h72.533334c12.8 0 23.466667-6.4 25.6-17.066667 2.133333-8.533333 2.133333-14.933333 0-17.066667-2.133333-4.266667-6.4-17.066667-25.6-17.066666H768v-49.066667h81.066667c8.533333 0 14.933333-2.133333 19.2-4.266667 4.266667-2.133333 8.533333-8.533333 8.533333-21.333333 2.133333-12.8-8.533333-23.466667-25.6-23.466667z" fill="#8a8a8a" p-id="8154"></path></svg>`,`<span>导出 PDF</span>`,`</div>`].join(``),p.querySelector(`.export-docx-item`).addEventListener(`click`,t=>{t.stopPropagation(),Va(e,f),p.classList.remove(`show`)}),p.querySelector(`.export-pdf-item`).addEventListener(`click`,t=>{t.stopPropagation(),Ha(e,f),p.classList.remove(`show`)}),f.addEventListener(`click`,e=>{e.stopPropagation(),document.querySelectorAll(`.export-dropdown.show`).forEach(e=>{e!==p&&e.classList.remove(`show`)}),p.classList.toggle(`show`)});let m=null;if(d.addEventListener(`mouseenter`,()=>{m=setTimeout(()=>{document.querySelectorAll(`.export-dropdown.show`).forEach(e=>{e!==p&&e.classList.remove(`show`)}),p.classList.add(`show`)},300)}),d.addEventListener(`mouseleave`,()=>{m&&=(clearTimeout(m),null),setTimeout(()=>{!d.matches(`:hover`)&&!p.matches(`:hover`)&&p.classList.remove(`show`)},100)}),d.appendChild(f),d.appendChild(p),c.appendChild(d),n&&n.length>0&&M.chatConfig?.enableExecutionLog){let e=document.createElement(`button`);e.className=`execution-log-btn`,e.type=`button`,e.title=`执行日志`,e.innerHTML=[`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">`,`<circle cx="12" cy="12" r="10"></circle>`,`<polyline points="12 6 12 12 16 14"></polyline>`,`</svg>`].join(``),c.appendChild(e)}let h=r!=null,g=n?n.filter(e=>e.nodeType===`reflection`&&e.reflectionType===`post`&&e.status===`success`).length:0,_=n?.find(e=>e.nodeType===`reflection`&&e.reflectionType===`post`);if(h&&M.chatConfig?.enableExecutionLog){let e=r>=8?`score-high`:r>=5?`score-mid`:`score-low`,t=r>=8?`✅`:r>=5?`🔍`:`⚠️`,n=g>1?` (${g}轮)`:``,i=document.createElement(`button`);i.className=`reflection-score-btn`,i.type=`button`,i.title=`AI 质量评估: ${r}/10${n}\n点击查看评估详情`,i.innerHTML=`<span class="reflection-badge ${e}">${t} ${r}/10</span>`,i.dataset.reflectionData=JSON.stringify({overallScore:_?.overallScore??r,dimensions:_?.dimensions||null,issues:_?.issues||null,suggestions:_?.suggestions||null,decision:_?.action?.decision||null,useful:_?.useful??null,reasoning:_?.reasoning||null,suggestion:_?.suggestion||null,rounds:g,wasRevised:!1}),c.appendChild(i)}else if(!h&&_&&_.status===`failed`&&M.chatConfig?.enableExecutionLog){let e=document.createElement(`button`);e.className=`reflection-score-btn`,e.type=`button`,e.title=`反思评估失败（点击查看执行日志）`,e.innerHTML=`<span class="reflection-badge score-low">⚠️ 反思失败</span>`,c.appendChild(e)}e.querySelector(`.message-content`).appendChild(c),fa(),ma(),Dn(),wn(e),e.dataset.htmlContent=e.outerHTML}function Pa(e){if(!e||e.disabled)return;e.disabled=!0,e.style.opacity=`0.4`,e.style.cursor=`not-allowed`;let t=document.querySelector(`.loading-message .stop-task-btn`);if(t){t.disabled=!0,t.style.opacity=`0.6`,t.style.cursor=`not-allowed`;let e=document.querySelector(`.loading-message .loading-text`);e&&(e.textContent=`停止中...`)}chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:null,sessionId:M.activeSessionId}),M.pendingCancelApi&&M.pendingCancelApi({message:`任务已被用户停止`,executionLog:M.currentExecutionStatus?.executionLog||[]})}function Fa(e){if(!e)return;e.querySelectorAll(`.thinking-indicator`).forEach(e=>e.classList.add(`hidden`));let t=e.querySelector(`.stream-status`);t&&(t.textContent=`已取消`),e.classList.remove(`streaming`),e.classList.add(`stream-cancelled`)}async function Ia(e,t,n=!1,r={}){let i=(await _t()).loopTimeout,a=M.activeSessionId,o=e=>e===void 0?la.get(a)||null:(la.set(a,e),e),s=chrome.runtime.connect({name:`keepalive-`+a});console.log(`[SidePanel] keepalive 端口已连接, sessionId:`,a);let c={restarted:!1,rejectFn:null,cleanup:null};s.onMessage.addListener(e=>{e.type===`SW_RESTARTED`&&e.sessionId===a&&(console.warn(`[SidePanel] ⚠️ 收到 SW_RESTARTED 通知，后台已重启，API 调用已丢失`),c.restarted=!0,c.rejectFn&&c.cleanup&&(c.cleanup(),c.rejectFn({message:`后台服务异常重启，API 调用已中断，请重试`,executionLog:[]})))});let l={timeoutId:null,removeListener:()=>{}},u=()=>{try{s.disconnect()}catch{}l.timeoutId&&=(clearTimeout(l.timeoutId),null),l.removeListener(),M.pendingCancelApiMap.delete(a),M.pendingCallApiSessionIds.delete(a),la.delete(a),bi()};return new Promise((s,d)=>{if(c.cleanup=u,c.rejectFn=d,c.restarted){u(),d({message:`后台服务异常重启，API 调用已中断，请重试`,executionLog:[]});return}let f=[],p=Math.round(i/1e3);o(null),X=null,da=0;let m=``,h={},g=e=>{o()&&Fa(o()),u(),(!e.executionLog||e.executionLog.length===0||f.length>0)&&(e.executionLog=f),d(e)};M.pendingCancelApi=g,M.pendingCallApiSessionIds.add(a),bi(),console.log(`[SidePanel] callApi: 添加 pendingCallApiSessionIds, mySessionId =`,a,`, set:`,[...M.pendingCallApiSessionIds]),l.timeoutId=setTimeout(()=>{g({message:`请求超时（${p}秒）`,executionLog:f}),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:M.currentTabId,sessionId:M.activeSessionId}).catch(e=>{console.log(`[SidePanel] 发送取消请求失败:`,e.message)})},i);let _=Date.now(),v=0,y=null,b=()=>{y===null&&l.timeoutId!==null&&(y=Date.now(),clearTimeout(l.timeoutId),l.timeoutId=null,console.log(`[SidePanel] 前端超时已暂停（澄清工具执行中）`))},x=()=>{if(y!==null){let e=Date.now()-y;v+=e,y=null;let t=Date.now()-_,n=i+v-t;if(n<=0){g({message:`请求超时（${p}秒）`,executionLog:f});return}l.timeoutId=setTimeout(()=>{g({message:`请求超时（${p}秒）`,executionLog:f}),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:M.currentTabId,sessionId:a}).catch(e=>{console.log(`[SidePanel] 发送取消请求失败:`,e.message)})},n),console.log(`[SidePanel] 前端超时已恢复，暂停时长:`,Math.round(e/1e3),`s，剩余时间:`,Math.round(n/1e3),`s`)}},S=e=>{if(console.log(`[SidePanel] 收到消息:`,e),e.sessionId&&e.sessionId!==a)return!1;if(e.type===`EXECUTION_STATUS_UPDATE`)return f=e.executionLog||[],!1;if(e.type===`CLARIFY_START`)return b(),!1;if(e.type===`CLARIFY_END`)return x(),!1;if(e.type===`STREAM_PRESELECT`){if(console.log(`[SidePanel] 收到预筛选日志，条数:`,e.preselectLog?.length),X=e.preselectLog||null,o()&&X&&X.length>0){let e=o().querySelector(`.message-content`);e&&(X.forEach(t=>{let n=Ma(t);e.insertBefore(n,e.firstChild)}),X=null,console.log(`[SidePanel] 预筛选卡片已追加到已有流式元素`))}return!1}if(e.type===`STREAM_START`){console.log(`[SidePanel] 流式输出开始`);let e=r._loadingId,t=e?document.getElementById(e):document.querySelector(`.loading-message`);if(t&&t.remove(),M.executionLogListener&&=(chrome.runtime.onMessage.removeListener(M.executionLogListener),null),M.currentExecutionStatus=null,o()){let e=o().querySelector(`.stream-content`);if(e){let t=document.createElement(`div`);t.className=`thinking-indicator`,t.innerHTML=`
            ...
            `;let n=t.querySelector(`.streaming-stop-btn`);n&&n.addEventListener(`click`,e=>{e.stopPropagation(),Pa(n)}),e.appendChild(t)}}else if(o(Da()),da=Date.now(),X&&X.length>0){let e=o().querySelector(`.message-content`);X.forEach(t=>{let n=Ma(t);e.insertBefore(n,e.firstChild)}),X=null}return m=``,ua=Date.now(),!1}if(e.type===`STREAM_CHUNK`)return o()&&(m+=e.delta,ka(o(),m)),!1;if(e.type===`STREAM_TOOL_CALL`)return o()&&e.toolCalls?.length>0&&Aa(o(),e.toolCalls),!1;if(e.type===`STREAM_TOOL_RESULT`)return o()&&e.result&&ja(e.result,o()),!1;if(e.type===`AGENT_STREAM`){if(o()&&e.execId){let t=h[e.execId];if(!t){let n=document.createElement(`div`);n.className=`agent-stream-output`,n.innerHTML=`
...
`+t.stderr:``),n.parentElement.scrollTop=n.parentElement.scrollHeight)}return!1}if(e.type===`AGENT_STREAM_DONE`){if(e.execId){let t=h[e.execId];if(t){let n=t.element.querySelector(`.agent-stream-label`);n&&(n.textContent=`命令输出 - ${e.exitCode===0?`完成`:`退出 (code: ${e.exitCode})`}`),e.exitCode!==0&&t.element.classList.add(`agent-stream-error`)}}return!1}if(e.type===`STREAM_DONE`){if(o()){let e=o().querySelector(`.stream-status`);e&&(e.textContent=`质量评估中...`)}return!1}if(e.type===`API_COMPLETE`){o()&&e.content&&Na(o(),e.content,e.executionLog||[],e.reflectionScore,e.reasoningContent);let t=o(),n=!!t,r=t?t.dataset.htmlContent||t.outerHTML:null,i=t?t.isConnected:!1;return u(),s({content:e.content,executionLog:e.executionLog||f,reflectionScore:e.reflectionScore,wasStreamed:n,wasRevised:e.wasRevised,streamingHtml:r,streamingConnected:i}),!1}else if(e.type===`API_ERROR`)return u(),d({message:e.error,executionLog:e.executionLog||f}),!1;return!1};chrome.runtime.onMessage.addListener(S),l.removeListener=()=>{chrome.runtime.onMessage.removeListener(S)},console.log(`[SidePanel] 发送 CALL_API 消息，useTools:`,n,`tabId:`,M.currentTabId,`sessionId:`,M.activeSessionId,`apiParams:`,r,`timeout:`,i),chrome.runtime.sendMessage({type:`CALL_API`,sessionId:M.activeSessionId,messages:e,model:t,useTools:n,tabId:M.currentTabId,apiParams:r,agentId:M.activeAgentId,agentToolIds:M.activeAgentToolIds,imageApiBase:M.enableImageInput&&M.attachedImages.length>0&&M.imageApiBase||``,imageApiKey:M.enableImageInput&&M.attachedImages.length>0&&M.imageApiKey||``})})}function La(e){let t=document.querySelector(`.execution-log-panel`);t&&t.remove();let n=document.createElement(`div`);n.className=`execution-log-panel`;let r=e.reduce((e,t)=>e+(t.duration||0),0),i=e.filter(e=>e.status===`success`).length,a=e.filter(e=>e.status===`failed`).length,o=e.filter(e=>e.nodeType===`subtask`).length,s=e.filter(e=>e.nodeType===`subtask`&&e.status===`success`).length,c=e.filter(e=>e.nodeType===`tool_exec`&&e.action?.name===`plan_task`&&e.status===`success`).length,l=e.filter(e=>e.nodeType===`reflection`).find(e=>e.reflectionType===`post`);n.innerHTML=`
  ...
  `,document.body.appendChild(n),n.addEventListener(`click`,e=>{e.target===n&&n.remove()}),n.querySelector(`.log-close`).addEventListener(`click`,()=>{n.remove()});let u=n.querySelector(`.toggle-expand-btn`),d=n.querySelectorAll(`.timeline-content`),f=!1;u.addEventListener(`click`,()=>{f=!f,d.forEach(e=>{f?e.classList.add(`expanded`):e.classList.remove(`expanded`)});let e=u.querySelector(`svg`);f?(e.innerHTML=`<polyline points="17 11 12 6 7 11"></polyline><polyline points="17 18 12 13 7 18"></polyline>`,u.setAttribute(`title`,`收起全部节点`)):(e.innerHTML=`<polyline points="7 13 12 18 17 13"></polyline><polyline points="7 6 12 11 17 6"></polyline>`,u.setAttribute(`title`,`展开全部节点`))}),n.querySelectorAll(`.timeline-header`).forEach(e=>{e.addEventListener(`click`,()=>{e.parentElement.classList.toggle(`expanded`)})});let p=n.querySelectorAll(`.combo-stat`),m=n.querySelectorAll(`.timeline-item`);p.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.status,n=e.classList.contains(`active`);p.forEach(e=>e.classList.remove(`active`)),n?m.forEach(e=>{e.style.display=``}):(e.classList.add(`active`),m.forEach(e=>{if(t===`subtask`)e.classList.contains(`subtask-level`)?e.style.display=``:e.style.display=`none`;else{let n=e.querySelector(`.timeline-dot`);n&&n.classList.contains(t)?e.style.display=``:e.style.display=`none`}}))})})}function Ra(e,t){try{let n=e.dataset.textContent_||e.dataset.rawContent||``;navigator.clipboard.writeText(n).then(()=>{let e=t.innerHTML;t.innerHTML=`
      ...
      `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}).catch(e=>{console.error(`[SidePanel] 复制失败:`,e);let r=document.createElement(`textarea`);r.value=n,r.style.position=`fixed`,r.style.left=`-999999px`,document.body.appendChild(r),r.select();try{document.execCommand(`copy`);let e=t.innerHTML;t.innerHTML=`
        ...
        `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{F(`复制失败`,`error`)}document.body.removeChild(r)})}catch(e){console.error(`[SidePanel] 复制失败:`,e),F(`复制失败`,`error`)}}function za(e){try{let t=e.dataset.rawContent||``,n=e.dataset.textContent_||``;if(!n&&!t){F(`无法获取消息内容`,`error`);return}if(M.attachedImages=[],t.startsWith(`[`))try{let e=JSON.parse(t);if(Array.isArray(e)){let t=e.filter(e=>e.type===`image_url`);for(let e of t)M.attachedImages.push({dataUrl:e.image_url.url})}}catch{}ea(),M.quotedContextText=``,M.selectedContextText=``;let r=n.match(/^\[引用内容\]\n([\s\S]+?)\n\n\[用户问题\]\n([\s\S]*)$/),i=n.match(/^\[选中内容\]\n([\s\S]+?)\n\n\[用户问题\]\n([\s\S]*)$/),a=r||i,o=n;if(a){let e=r?`quoted`:`selected`,t=a[1].trim(),n=a[2].trim(),i=document.getElementById(`selectionIndicator`),s=document.getElementById(`selectionText`);if(i&&s){let n;n=t.length>100?t.substring(0,100)+`...`:t.length>50?t.substring(0,50)+`...`:t,e===`quoted`?(M.quotedContextText=t,s.textContent=`💬 已引用: ${n}`):(M.selectedContextText=t,s.textContent=`📌 已选中: ${n}`),i.classList.add(`show`)}o=n}let s=document.getElementById(`userInput`);s.value=o,lt(),s.focus(),s.selectionStart=s.selectionEnd=s.value.length,console.log(`[SidePanel] 已加载消息内容到输入框，等待用户编辑后发送`)}catch(e){console.error(`[SidePanel] 编辑消息失败:`,e),F(`编辑失败: `+e.message,`error`)}}function Ba(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=M.messageHistory.find(e=>e.role===`assistant`);if(t)n=t.content;else{let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}}navigator.clipboard.writeText(n).then(()=>{let e=t.innerHTML;t.innerHTML=`
        <svg viewBox="0 0 16 16" fill="currentColor">
          <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
        </svg>
        <span>已复制</span>
      `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}).catch(e=>{let r=document.createElement(`textarea`);r.value=n,r.style.position=`fixed`,r.style.left=`-999999px`,document.body.appendChild(r),r.select();try{document.execCommand(`copy`);let e=t.innerHTML;t.innerHTML=`
          ...
          <span>已复制</span>
        `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{F(`复制失败，请手动选择内容复制`,`error`)}document.body.removeChild(r)})}catch(e){console.error(`[SidePanel] 复制失败:`,e),F(`复制失败`,`error`)}}function Va(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}let r=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
    ...
    `,i=new Blob([`﻿`,r],{type:`application/msword`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=`word-${new Date().getTime()}.doc`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a);let s=t.innerHTML;t.innerHTML=`
      ...
      <span>已导出</span>
    `,setTimeout(()=>{t.innerHTML=s},2e3),console.log(`[SidePanel] Word 文档导出成功`)}catch(e){console.error(`[SidePanel] 导出 Word 失败:`,e),F(`导出失败: `+e.message,`error`)}}function Ha(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}let r=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
...
`),t.dispatchEvent(new Event(`input`)),console.log(`[SidePanel] 已移除输入框中的选中内容前缀`))}M.lastSelectedText=``,M.currentSelectionRange=null}function Ga(){let e=document.getElementById(`promptManageList`).querySelectorAll(`.prompt-manage-item`);e.forEach(t=>{t.addEventListener(`dragstart`,e=>{M.draggedItemIndex=parseInt(t.dataset.index),t.classList.add(`dragging`),e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`text/plain`,M.draggedItemIndex)}),t.addEventListener(`dragend`,()=>{t.classList.remove(`dragging`),e.forEach(e=>e.classList.remove(`drag-over`)),M.draggedItemIndex=null}),t.addEventListener(`dragover`,e=>{e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`drag-over`)}),t.addEventListener(`dragleave`,()=>{t.classList.remove(`drag-over`)}),t.addEventListener(`drop`,e=>{e.stopPropagation(),e.preventDefault();let n=parseInt(t.dataset.index);if(M.draggedItemIndex!==null&&M.draggedItemIndex!==n){let e=M.customPrompts[M.draggedItemIndex];M.customPrompts.splice(M.draggedItemIndex,1),M.customPrompts.splice(n,0,e),chrome.storage.local.set({customPrompts:M.customPrompts}),$()}t.classList.remove(`drag-over`)})})}function Ka(){let e=document.querySelector(`.input-toolbar-right`);if(!e)return;let t=document.createElement(`button`);t.className=`prompt-manage-btn`,t.title=`提示词管理`,t.innerHTML=`<svg t="1781177976746" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5076" width="16" height="16"><path d="M674.56 231.552l101.568 56.96-56.896-101.632 56.96-101.568-101.632 56.896-101.632-56.896 56.96 101.568-56.896 101.632 101.568-56.96zM186.944 629.76l-101.504-56.896 56.832 101.632-56.832 101.568 101.504-56.96 101.632 56.96-56.896-101.568 56.896-101.568-101.568 56.832zM85.44 85.312l56.832 101.568-56.832 101.632 101.504-56.96 101.632 56.96L231.68 186.88l56.896-101.568-101.568 56.896-101.568-56.896z m351.872 438.016l-99.2-99.136L424.32 337.984l99.072 99.264-86.08 86.144m-41.856-223.04L300.352 395.392a40.448 40.448 0 0 0 0 57.28l474.24 474.112a40.448 40.448 0 0 0 57.344 0l94.912-95.04a40.448 40.448 0 0 0 0-57.344L452.736 300.288a40.448 40.448 0 0 0-57.28 0z" p-id="5077" fill="#777"></path></svg>`,t.addEventListener(`click`,()=>{eo()}),e.appendChild(t)}function qa(e=``){let t=document.getElementById(`promptSelector`),n=document.getElementById(`promptDropdown`);t.style.display=`block`,n.classList.add(`show`),Xa(e)}function Q(){let e=document.getElementById(`promptSelector`),t=document.getElementById(`promptDropdown`);e.style.display=`none`,t.classList.remove(`show`),M.selectedPromptIndex=-1}function Ja(){let e=document.getElementById(`promptSelector`),t=document.getElementById(`promptDropdown`),n=document.getElementById(`userInput`);e.style.display!==`none`&&t.classList.contains(`show`)?Q():(qa(),n.focus())}function Ya(e=``){Xa(e)}function Xa(e=``){let t=document.getElementById(`promptList`),n=e.toLowerCase(),r=M.customPrompts.filter(t=>e?t.code.toLowerCase().includes(n)||t.content.toLowerCase().includes(n):!0);if(r.length===0){t.innerHTML=`<div class="prompt-empty">暂无匹配的提示词</div>`,M.selectedPromptIndex=-1;return}M.selectedPromptIndex=0,t.innerHTML=r.map((e,t)=>`
  ...
  `).join(``),t.querySelectorAll(`.prompt-item`).forEach(e=>{e.addEventListener(`click`,t=>{let n=e.dataset.code;t.ctrlKey||t.metaKey?Qa(n):$a(n)})})}function Za(e){e.forEach((e,t)=>{t===M.selectedPromptIndex?e.classList.add(`selected`):e.classList.remove(`selected`)})}function Qa(e){let t=M.customPrompts.find(t=>t.code===e);if(!t)return;let n=document.getElementById(`userInput`),r=n.value,i=r.lastIndexOf(`/`),a=r;if(i!==-1){let e=-1;for(let t=i-1;t>=0;t--)if(r[t]===`
`){e=t;break}a=e===-1?r.substring(0,i).trimEnd():r.substring(0,e+1).trimEnd()}n.value=a+(a&&!a.endsWith(`
`)?`

`:``)+t.content,n.focus(),n.selectionStart=n.selectionEnd=n.value.length,Q(),lt(),console.log(`[SidePanel] 已追加提示词到输入框:`,t.code,t.content)}async function $a(e){let t=M.customPrompts.find(t=>t.code===e);if(!t)return;if(M.isGenerating){console.log(`[SidePanel] 正在生成中，请稍候...`);return}Q();let n=document.getElementById(`chatContainer`).querySelector(`.welcome-message`);n&&n.remove();let r=t.content,s=M.enableSelectionQuery&&M.selectedContextText&&M.selectedContextText.trim(),c=M.quotedContextText&&M.quotedContextText.trim();if(c){let e=M.quotedContextText.trim(),{compressed:n,wasCompressed:i}=C(e);r=`[引用内容${i?`摘要`:``}]\n${n}\n\n[用户问题]\n${t.content}`,sa(`quoted`,e,!1),M.quotedContextText=``}else if(s){let e=M.selectedContextText.trim(),{compressed:n,wasCompressed:i}=C(e);r=`[选中内容${i?`摘要`:``}]\n${n}\n\n[用户问题]\n${t.content}`,sa(`selected`,e,!1),M.selectedContextText=``}(s||c)&&Wa();let l=ta(r);Y(`user`,ta(t.content)),M.messageHistory.push({role:`user`,content:l}),K(),vt(t.content);let u=document.getElementById(`userInput`);u.value=``,u.style.height=`auto`,M.isGenerating=!0;let d=Ea(),f=M.activeSessionId,p=M.enableImageInput&&M.attachedImages.length>0&&M.imageModelName||M.currentModel;if(M.attachedImages.length>0){let e=document.getElementById(`imagePreviewBar`);e&&(e.innerHTML=``)}try{await ht(),console.log(`[SidePanel] 发送消息调试信息:`),console.log(`  - isolateChat:`,M.isolateChat),console.log(`  - chatConfig:`,M.chatConfig),console.log(`  - messageHistory.length:`,M.messageHistory.length);let e=[{role:`system`,content:await ft()}];if(M.isolateChat){let t=M.messageHistory,n=M.chatConfig.contextWindow||0,r=a(p,M.enabledTools.length||50,n,M.customModelMap),s=Math.floor(r*.7),c=M.messageHistory.slice(0,-1),l=M.messageHistory[M.messageHistory.length-1],u=[],d=o([l]);for(let e=c.length-1;e>=0;e--){let t=c[e],n=o([t]);if(d+n<=s)u.unshift(t),d+=n;else break}if(u.length<c.length){let t=c.length-u.length,n=i(c.slice(0,t));n&&(e[0]={...e[0],content:e[0].content+`

`+n})}t=[...u,l],e=[...e,...t];for(let t=0;t<e.length-1;t++)e[t]={...e[t],content:na(e[t].content)}}else e.push({role:`user`,content:l});let t=await pt(),n,r;try{let i=await Ia(e,p,M.useTools,t);n=i.content,r=i.executionLog||[]}catch(e){throw Z(d),n=`❌ 请求失败：`+(e.message||`未知错误`),r=e.executionLog||[],Y(`assistant`,n,!0,r),M.messageHistory.push({role:`assistant`,content:n,executionLog:r}),K(),e}Z(d),await wn(Y(`assistant`,n,!0,r)),M.messageHistory.push({role:`assistant`,content:n,executionLog:r}),K()}catch{}finally{M.generatingSessionIds.delete(f),document.dispatchEvent(new CustomEvent(`generating-state-changed`)),u.focus(),M.attachedImages=[]}}function eo(){document.getElementById(`promptManageModal`).classList.add(`show`),$()}function to(){document.getElementById(`promptManageModal`).classList.remove(`show`);let e=document.getElementById(`editPromptIndex`),t=document.getElementById(`newPromptCode`),n=document.getElementById(`newPromptContent`),r=document.getElementById(`promptManageAddBtn`);e&&(e.value=``),t&&(t.value=``),n&&(n.value=``),r&&(r.textContent=`添加提示词`,r.style.background=`#667eea`)}function $(){let e=document.getElementById(`promptManageList`);if(M.customPrompts.length===0){e.innerHTML=`<div class="prompt-empty">暂无提示词，请添加</div>`;return}e.innerHTML=M.customPrompts.map((e,t)=>`
  ...
  `).join(``),e.querySelectorAll(`.move-up-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.dataset.index);if(n>0){let e=M.customPrompts[n];M.customPrompts[n]=M.customPrompts[n-1],M.customPrompts[n-1]=e,chrome.storage.local.set({customPrompts:M.customPrompts}),$()}})}),e.querySelectorAll(`.move-down-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.dataset.index);if(n<M.customPrompts.length-1){let e=M.customPrompts[n];M.customPrompts[n]=M.customPrompts[n+1],M.customPrompts[n+1]=e,chrome.storage.local.set({customPrompts:M.customPrompts}),$()}})}),e.querySelectorAll(`.menu-toggle-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.dataset.index);M.customPrompts[n].enabledInMenu=!M.customPrompts[n].enabledInMenu,chrome.storage.local.set({customPrompts:M.customPrompts}),$()})}),e.querySelectorAll(`.edit-btn`).forEach(e=>{e.addEventListener(`click`,()=>{ao(parseInt(e.dataset.index))})}),e.querySelectorAll(`.delete-btn`).forEach(e=>{e.addEventListener(`click`,()=>{oo(parseInt(e.dataset.index))})}),Ga()}function no(e){let t=document.getElementById(`promptErrorModal`),n=document.getElementById(`promptErrorMessage`);n.textContent=e,t.classList.add(`show`)}function ro(){document.getElementById(`promptErrorModal`).classList.remove(`show`)}function io(){let e=document.getElementById(`editPromptIndex`),t=document.getElementById(`newPromptCode`),n=document.getElementById(`newPromptContent`),r=t.value.trim(),i=n.value.trim();if(!r||!i){no(`请填写编码和内容`);return}let a=e?parseInt(e.value):-1,o=M.customPrompts.findIndex(e=>e.code===r);if(o!==-1&&o!==a){no(`编码已存在`);return}a>=0&&a<M.customPrompts.length?M.customPrompts[a]={...M.customPrompts[a],code:r,content:i}:M.customPrompts.push({code:r,content:i,enabledInMenu:!1}),chrome.storage.local.set({customPrompts:M.customPrompts}),t.value=``,n.value=``,e&&(e.value=``);let s=document.getElementById(`promptManageAddBtn`);s.textContent=`添加提示词`,s.style.background=`#667eea`,$()}function ao(e){let t=M.customPrompts[e];if(!t)return;let n=document.getElementById(`editPromptIndex`),r=document.getElementById(`newPromptCode`),i=document.getElementById(`newPromptContent`),a=document.getElementById(`promptManageAddBtn`);n&&(n.value=e),r.value=t.code,i.value=t.content,a.textContent=`保存修改`,a.style.background=`#ffa502`,r.scrollIntoView({behavior:`smooth`})}function oo(e){let t=M.customPrompts[e];if(!t)return;M.pendingDeleteIndex=e;let n=document.getElementById(`deleteConfirmModal`),r=document.getElementById(`deleteConfirmMessage`);r.textContent=`确定要删除提示词 "/${t.code}" 吗？`,n.classList.add(`show`)}function so(){document.getElementById(`deleteConfirmModal`).classList.remove(`show`),M.pendingDeleteIndex=-1}function co(e){M.customPrompts.splice(e,1),chrome.storage.local.set({customPrompts:M.customPrompts}),$()}function lo(){let e=document.getElementById(`promptManageCancelBtn`),t=document.getElementById(`promptManageAddBtn`),n=document.getElementById(`promptModalCloseBtn`);e&&e.addEventListener(`click`,to),t&&t.addEventListener(`click`,io),n&&n.addEventListener(`click`,to);let r=document.getElementById(`deleteCancelBtn`),i=document.getElementById(`deleteConfirmBtn`);r&&r.addEventListener(`click`,so),i&&i.addEventListener(`click`,()=>{M.pendingDeleteIndex>=0&&co(M.pendingDeleteIndex),so()});let a=document.getElementById(`deleteConfirmModal`);a&&a.addEventListener(`click`,e=>{e.target===a&&so()});let o=document.getElementById(`promptErrorConfirmBtn`);o&&o.addEventListener(`click`,ro);let s=document.getElementById(`promptErrorModal`);s&&s.addEventListener(`click`,e=>{e.target===s&&ro()})}async function uo(e=``){let t=document.getElementById(`agentAtSelector`),n=document.getElementById(`agentAtDropdown`);t.style.display=`block`,n.classList.add(`show`),await po(e)}function fo(){let e=document.getElementById(`agentAtSelector`),t=document.getElementById(`agentAtDropdown`);e.style.display=`none`,t.classList.remove(`show`),M.selectedAgentAtIndex=-1}async function po(e=``){let t=document.getElementById(`agentAtList`),n=await tt(),r=e.toLowerCase(),i=n.filter(t=>e?t.name.toLowerCase().includes(r)||t.description&&t.description.toLowerCase().includes(r):!0);if(i.length===0){t.innerHTML=`<div class="prompt-empty">暂无匹配的 Agent</div>`,M.selectedAgentAtIndex=-1;return}M.selectedAgentAtIndex=0,t.innerHTML=i.map((e,t)=>{let n=e.id===M.activeAgentId||!M.activeAgentId&&e.id==="default",r=e.toolIds?e.toolIds.length:e.toolIds===null?`全局`:0,i=typeof r==`number`?`${r} 个工具`:`继承全局工具`;return`
    ...
    `}).join(``),t.querySelectorAll(`.prompt-item`).forEach(e=>{e.addEventListener(`click`,async t=>{let n=e.dataset.agentId;await ho(n)})})}function mo(e){e.forEach((e,t)=>{t===M.selectedAgentAtIndex?e.classList.add(`selected`):e.classList.remove(`selected`)})}async function ho(e){let t=document.getElementById(`userInput`),n=t.value,r=n.lastIndexOf(`@`);if(r!==-1){let e=n.substring(0,r);t.value=e,t.focus(),t.selectionStart=t.selectionEnd=e.length}fo(),await hr(e),lt()}function go(e,t){let n=document.getElementById(`tokenStatsOverlay`),r=document.getElementById(`tokenStatsClose`),i=document.getElementById(`tokenStatsRefreshBtn`),a=document.getElementById(`tokenStatsClearBtn`);if(!n)return;function o(){n.style.display=`flex`,c()}function s(){n.style.display=`none`}window.openTokenStats=o,r&&r.addEventListener(`click`,s),n&&n.addEventListener(`click`,e=>{e.target===n&&s()}),i&&i.addEventListener(`click`,c),a&&a.addEventListener(`click`,async()=>{await t(`确定要清空所有 Token 使用统计吗？此操作不可撤销。`,`清空统计`)&&(await x(),c())});async function c(){let t=e(),n=document.getElementById(`tokenStatsLoading`),r=document.getElementById(`tokenStatsEmpty`),i=document.getElementById(`tokenStatsContent`);n&&(n.style.display=``),r&&(r.style.display=`none`),i&&(i.style.display=`none`);try{let[e,a]=await Promise.all([y(t),g()]);if(n&&(n.style.display=`none`),!(a&&a.totalApiCalls>0)){r&&(r.style.display=``);return}i&&(i.style.display=``),l(e),u(a),d(e.records||[])}catch(e){console.error(`[TokenStats] 加载统计失败:`,e),n&&(n.style.display=`none`),r&&(r.textContent=`加载失败`,r.style.display=``)}}function l(e){let t=document.getElementById(`tokenSessionStats`);if(!t)return;if(!e||e.apiCallCount===0){t.innerHTML=`<div style="text-align:center;color:#999;padding:20px;">当前会话暂无数据</div>`;return}let n=e.totalTokens>0?(e.totalPromptTokens/e.totalTokens*100).toFixed(1):0,r=e.totalTokens>0?(e.totalCompletionTokens/e.totalTokens*100).toFixed(1):0;t.innerHTML=`
      ...
      </div>`}).join(``)}function f(e){return e>=1e6?(e/1e6).toFixed(1)+`M`:e>=1e3?(e/1e3).toFixed(1)+`K`:String(e)}}chrome.storage.onChanged.addListener((e,t)=>{t===`local`&&e.chatMaxMemoryMessages&&(M.chatConfig.maxMemoryMessages=e.chatMaxMemoryMessages.newValue,_o(),console.log(`[SidePanel] 记忆限制配置已更新:`,M.chatConfig.maxMemoryMessages)),t===`local`&&e.chatContextWindow&&(M.chatConfig.contextWindow=e.chatContextWindow.newValue||0,console.log(`[SidePanel] 上下文窗口配置已更新:`,M.chatConfig.contextWindow))});function _o(){let e=document.getElementById(`memoryLimitLabel`);e&&(M.chatConfig.maxMemoryMessages!==null&&M.chatConfig.maxMemoryMessages!==void 0&&M.chatConfig.maxMemoryMessages>0?e.textContent=`(最近${M.chatConfig.maxMemoryMessages}条)`:e.textContent=`(全)`,e.style.display=`inline`,e.style.cursor=`pointer`,e.title=`点击设置记忆历史限制条数`)}function vo(e){e.preventDefault(),e.stopPropagation();let t=document.getElementById(`memoryLimitDropdown`);if(t.classList.toggle(`show`),t.classList.contains(`show`)){let e=M.chatConfig.maxMemoryMessages;t.querySelectorAll(`.memory-limit-option`).forEach(t=>{t.classList.remove(`selected`);let n=parseInt(t.dataset.value);(e===null&&n===0||e!==null&&e>0&&n===e)&&t.classList.add(`selected`)});let n=t.querySelector(`#memoryLimitInput`);e!==null&&e>0?n.value=e:n.value=``}}function yo(){let e=document.getElementById(`memoryLimitDropdown`),t=document.getElementById(`memoryLimitLabel`),n=e?.querySelector(`#memoryLimitInput`);if(!e||!t)return;_o(),t.addEventListener(`click`,vo);let r=e.querySelectorAll(`.memory-limit-option`);r.forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let i=parseInt(e.dataset.value),a=i===0?null:i;r.forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`),n&&(n.value=i===0?``:i),chrome.storage.local.set({chatMaxMemoryMessages:a},()=>{M.chatConfig.maxMemoryMessages=a,_o(),F(`✅ 配置已更新`,`success`)})})}),n&&(n.addEventListener(`click`,e=>e.stopPropagation()),n.addEventListener(`mousedown`,e=>e.stopPropagation()),n.addEventListener(`change`,e=>{e.stopPropagation();let t=e.target.value.trim(),n=t&&parseInt(t)>0?parseInt(t):null;r.forEach(e=>e.classList.remove(`selected`)),chrome.storage.local.set({chatMaxMemoryMessages:n},()=>{M.chatConfig.maxMemoryMessages=n,_o(),F(`✅ 配置已更新`,`success`)})})),document.addEventListener(`click`,n=>{!e.contains(n.target)&&n.target!==t&&e.classList.remove(`show`)})}function bo(e){document.querySelectorAll(`.model-option`).forEach(t=>{t.dataset.value===e?(t.classList.add(`selected`),t.querySelector(`.model-option-check`).textContent=`✓`):(t.classList.remove(`selected`),t.querySelector(`.model-option-check`).textContent=``)})}function xo(e,t){let n=document.getElementById(`tempDropdown`);if(!n){typeof t==`function`&&t();return}chrome.storage.local.get([`deletedPresetModels`],r=>{if((r.deletedPresetModels||[]).forEach(e=>{let t=n.querySelector(`.model-option[data-value="${e}"]`);t&&t.remove()}),!e||e.length===0){typeof t==`function`&&t();return}let i=[`deepseek-v4-pro`,`deepseek-v4-flash`],a=!1;if(e.forEach(e=>{let t,r=0;if(typeof e==`string`)t=e,a=!0;else if(e&&typeof e==`object`&&e.name)t=e.name,r=e.contextWindow||0;else return;if(i.includes(t)){if(r&&r>0){let e=n.querySelector(`.model-option[data-value="${t}"]`);if(e){let t=e.querySelector(`.model-option-left`);t||(t=document.createElement(`span`),t.className=`model-option-left`,t.textContent=e.textContent,e.textContent=``,e.insertBefore(t,e.firstChild));let n=t.querySelector(`.model-ctx-badge`);if(n)n.textContent=r>=1e3?Math.round(r/1e3)+`K`:String(r);else{let e=document.createElement(`span`);e.className=`model-ctx-badge`,e.textContent=r>=1e3?Math.round(r/1e3)+`K`:String(r),t.appendChild(e)}}}return}if(n.querySelector(`.model-option[data-value="${t}"]`))return;let o=document.createElement(`div`);if(o.className=`model-option`,o.dataset.value=t,o.innerHTML=`<span class="model-option-check"></span><span class="model-option-left">${t}</span>`,r&&r>0){let e=o.querySelector(`.model-option-left`);if(e){let t=document.createElement(`span`);t.className=`model-ctx-badge`,t.textContent=r>=1e3?Math.round(r/1e3)+`K`:String(r),e.appendChild(t)}}o.addEventListener(`click`,e=>{e.stopPropagation(),M.currentModel=t,bo(t),chrome.storage.local.set({modelName:t})}),n.querySelector(`.model-section`).appendChild(o)}),a){let t=e.map(e=>typeof e==`string`?{name:e,contextWindow:0}:e);chrome.storage.local.set({customModels:t})}M.customModelMap=p(e),typeof t==`function`&&t()})}function So(e,t=`📌 已选中`){if(!M.enableSelectionQuery)return;M.quotedContextText=``,M.selectedContextText=e;let n=document.getElementById(`selectionIndicator`),r=document.getElementById(`selectionText`),i=document.getElementById(`userInput`);if(n&&r&&i){let i;i=e.length>100?e.substring(0,100)+`...`:e.length>50?e.substring(0,50)+`...`:e,r.textContent=`${t}: ${i}`,n.classList.add(`show`)}}function Co(e,t,n=0,r=0){if(!M.enableSelectionQuery)return;let i=document.getElementById(`selectionFloatingMenu`),a=document.getElementById(`selectionMenuItems`);if(!i||!a)return;let o=M.customPrompts.filter(e=>e.enabledInMenu===!0);if(o.length===0)return;a.innerHTML=``,o.forEach(e=>{let n=e.content.length>10?e.content.substring(0,10)+`...`:e.content,r=document.createElement(`div`);r.className=`menu-item`,r.innerHTML=`
      <span>${n}</span>
      <span class="menu-item-code">/${e.code}</span>
    `,r.addEventListener(`click`,n=>{n.stopPropagation(),wo(e,t)}),a.appendChild(r)});let s=document.body.getBoundingClientRect(),c=40+o.length*36,l=r-s.top-c-30,u=n-s.left-20;l<s.top+10&&(l=r-s.top+30),u<s.left+10&&(u=n-s.left+20),u+180>s.right-10&&(u=n-s.left-180-30,u<s.left+10&&(u=n-s.left+20)),l+c>s.bottom-10&&(l=r-s.top-c-30,l<s.top+10&&(l=r-s.top+30)),i.style.top=l+`px`,i.style.left=u+`px`,i.style.maxHeight=s.bottom-l-20+`px`,i.classList.add(`show`)}window.hideFloatingMenu=function(){let e=document.getElementById(`selectionFloatingMenu`);e&&e.classList.remove(`show`),M.lastSelectedText=``,M.currentSelectionRange=null};async function wo(e,t){if(!M.enableSelectionQuery)return;if(window.hideFloatingMenu(),M.isGenerating){console.log(`[SidePanel] 正在生成中，请稍候...`);return}M.selectedContextText=t,wi();let n=document.getElementById(`chatContainer`).querySelector(`.welcome-message`);n&&n.remove(),sa(`selected`,t,!1);let{compressed:r,wasCompressed:s}=C(t),c=`[选中内容${s?`摘要`:``}]\n${r}\n\n[用户问题]\n${e.content}`;Y(`user`,e.content),M.messageHistory.push({role:`user`,content:c}),K(),vt(e.content),M.isGenerating=!0;let l=Ea(),u=M.activeSessionId,d=M.currentModel;try{await ht(),console.log(`[SidePanel] 发送消息调试信息:`),console.log(`  - isolateChat:`,M.isolateChat),console.log(`  - chatConfig:`,M.chatConfig),console.log(`  - messageHistory.length:`,M.messageHistory.length);let e=[{role:`system`,content:await ft()}];if(M.isolateChat){let t=M.messageHistory,n=M.chatConfig.contextWindow||0,r=a(d,M.enabledTools.length||50,n,M.customModelMap),s=Math.floor(r*.7),c=M.messageHistory.slice(0,-1),l=M.messageHistory[M.messageHistory.length-1],u=[],f=o([l]);for(let e=c.length-1;e>=0;e--){let t=c[e],n=o([t]);if(f+n<=s)u.unshift(t),f+=n;else break}if(u.length<c.length){let t=c.length-u.length,n=i(c.slice(0,t));n&&(e[0]={...e[0],content:e[0].content+`

`+n})}t=[...u,l],e=[...e,...t]}else e.push({role:`user`,content:c});let t=await pt(),n,r;try{let i=await Ia(e,d,M.useTools,t);n=i.content,r=i.executionLog||[]}catch(e){throw Z(l),n=`❌ 请求失败：`+(e.message||`未知错误`),r=e.executionLog||[],Y(`assistant`,n,!0,r),M.messageHistory.push({role:`assistant`,content:n,executionLog:r}),K(),e}Z(l),await wn(Y(`assistant`,n,!0,r)),M.messageHistory.push({role:`assistant`,content:n,executionLog:r}),K()}catch{}finally{M.generatingSessionIds.delete(u),document.dispatchEvent(new CustomEvent(`generating-state-changed`)),document.getElementById(`userInput`).focus()}}function To(e){let t=document.getElementById(`headerAgentDot`),n=document.getElementById(`headerAgentIndicator`);if(!(!t||!n))if(!e||!e.connected)t.className=`header-agent-dot disconnected`,n.title=`Agent 未连接 - 点击前往设置`;else{t.className=`header-agent-dot connected`;let r=[`Agent 已连接`];e.platformName&&r.push(e.platformName),e.arch&&r.push(e.arch),n.title=r.join(` | `)+` - 点击前往设置`}}document.addEventListener(`DOMContentLoaded`,async()=>{window.__tableBlocks=[],await gt(),await xi(),chrome.runtime.onMessage.addListener(e=>{e.type===`SELECTION_AI_SEARCH`&&e.prompt&&(console.log(`[SidePanel] 收到选中文本 AI 搜索:`,e.selectedText?.substring(0,50)),ia(e.prompt,e.selectedText),chrome.storage.session.remove(`pendingSelectionSearch`).catch(()=>{})),e.type===`FILL_SIDEPANEL_INPUT`&&e.text&&(console.log(`[SidePanel] 收到追问填充:`,e.text?.substring(0,50)),aa(e.text),chrome.storage.session.remove(`pendingFillInput`).catch(()=>{})),e.type===`DIRECT_SEND`&&e.text&&(console.log(`[SidePanel] 收到直接发送:`,e.text?.substring(0,50)),oa(e.text,e.selectedText||``),chrome.storage.session.remove(`pendingDirectSend`).catch(()=>{})),e.type===`AGENT_STATUS_CHANGE`&&(console.log(`[SidePanel] 收到 Agent 状态变化:`,e.connected,e.status),chrome.storage.local.get(`agentPlatform`,e=>{M.agentPlatform=e.agentPlatform||{connected:!1},To(M.agentPlatform)})),e.type===`AGENT_CONNECTION_CHANGED`&&(console.log(`[SidePanel] 收到 Agent 连接状态变更:`,e.connected),M.agentPlatform={...M.agentPlatform,connected:e.connected},To(M.agentPlatform))});let t=await chrome.storage.session.get(`pendingSelectionSearch`);if(t.pendingSelectionSearch&&t.pendingSelectionSearch.selectedText){let{prompt:e,selectedText:n}=t.pendingSelectionSearch;console.log(`[SidePanel] 有待处理的选中文本搜索:`,n?.substring(0,50)),setTimeout(()=>{ia(e,n)},500),await chrome.storage.session.remove(`pendingSelectionSearch`)}let n=await chrome.storage.session.get(`pendingFillInput`);if(n.pendingFillInput&&n.pendingFillInput.text){let{text:e}=n.pendingFillInput;console.log(`[SidePanel] 有待填充的追问文本:`,e?.substring(0,50)),setTimeout(()=>{aa(e)},500),await chrome.storage.session.remove(`pendingFillInput`)}let r=await chrome.storage.session.get(`pendingDirectSend`);if(r.pendingDirectSend&&r.pendingDirectSend.text){let{text:e,selectedText:t}=r.pendingDirectSend;console.log(`[SidePanel] 有待直接发送的文本:`,e?.substring(0,50)),setTimeout(()=>{oa(e,t||``)},500),await chrome.storage.session.remove(`pendingDirectSend`)}chrome.tabs.onActivated.addListener(async e=>{console.log(`[SidePanel] Tab 切换, 新 Tab ID:`,e.tabId),M.currentTabId=e.tabId}),chrome.tabs.onUpdated.addListener(async(e,t)=>{t.status===`complete`&&M.currentTabId===e&&console.log(`[SidePanel] 当前 Tab 页面更新:`,t)}),typeof marked<`u`&&(marked.setOptions({breaks:!0,gfm:!0}),console.log(`[SidePanel] Marked 库已加载`)),typeof mermaid<`u`&&(mermaid.initialize({startOnLoad:!1,theme:`default`,securityLevel:`loose`,fontFamily:`-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif`}),console.log(`[SidePanel] Mermaid 库已加载`));let i=document.getElementById(`userInput`),a=document.getElementById(`sendBtn`),o=document.getElementById(`clearChatBtn`),s=document.getElementById(`exportChatBtn`),c=document.getElementById(`chatContainer`),l=document.getElementById(`tempDisplay`),u=document.getElementById(`tempDropdown`),d=document.getElementById(`tempPresetList`),f=document.getElementById(`tempSlider`),p=document.getElementById(`tempNumberInput`);function m(){if(!i||M.isScrolling)return;i.style.height=`auto`;let e=i.scrollHeight;e<=50?i.style.height=``:i.style.height=Math.min(e,100)+`px`}chrome.storage.local.get([`temperature`,`topP`,`selectedTempIndex`],e=>{e.temperature!==void 0&&(M.temperature=e.temperature),e.topP!==void 0&&(M.topP=e.topP),e.selectedTempIndex!==void 0&&(M.selectedTempIndex=e.selectedTempIndex),h()});function h(){f&&(f.value=M.temperature),p&&(p.value=M.temperature.toFixed(2));let e=document.getElementById(`tempIconValue`);e&&(e.textContent=M.temperature.toFixed(2)),g()}function g(){d.innerHTML=N.map((e,t)=>`
...
`||t[o-1]===` `),s&&c)if(o>a)s=!1,Q(),uo(t.substring(o+1));else{c=!1,fo();let e=t.substring(a+1);n.style.display!==`none`&&r.classList.contains(`show`)?Ya(e):qa(e)}else if(s){fo();let e=t.substring(a+1);n.style.display!==`none`&&r.classList.contains(`show`)?Ya(e):qa(e)}else c?(Q(),uo(t.substring(o+1))):(Q(),fo());m()}),c.addEventListener(`scroll`,()=>{let e=`scrollPosition_`+(M.activeSessionId||`default`);chrome.storage.local.set({[e]:c.scrollTop})});let ne=document.getElementById(`headerMoreBtn`),O=document.getElementById(`headerMoreDropdown`);ne&&O&&(ne.addEventListener(`click`,e=>{e.stopPropagation(),O.classList.toggle(`show`)}),document.addEventListener(`click`,e=>{!O.contains(e.target)&&e.target!==ne&&O.classList.remove(`show`)})),o.addEventListener(`click`,e=>{e.stopPropagation(),O.classList.remove(`show`),Pi()}),s&&s.addEventListener(`click`,e=>{e.stopPropagation(),O.classList.remove(`show`),Di()});let re=document.getElementById(`importChatBtn`);re&&re.addEventListener(`click`,e=>{e.stopPropagation(),O.classList.remove(`show`),Mi()});let ie=document.getElementById(`importSessionsFile`);ie&&ie.addEventListener(`change`,e=>{let t=e.target.files[0];t&&Ni(t)});let ae=document.getElementById(`settingsBtn`);ae&&ae.addEventListener(`click`,()=>{chrome.runtime.openOptionsPage()});let oe=document.getElementById(`headerAgentIndicator`);oe&&oe.addEventListener(`click`,async()=>{let e=chrome.runtime.getURL(`options.html#agent`),t=await chrome.tabs.query({url:chrome.runtime.getURL(`options.html`)});t.length>0?await chrome.tabs.update(t[0].id,{active:!0,url:e}):await chrome.tabs.create({url:e})});let se=document.getElementById(`prototypeLibraryBtn`);se&&se.addEventListener(`click`,e=>{e.stopPropagation(),O.classList.remove(`show`),Xt()});let ce=document.getElementById(`tokenStatsHeaderBtn`);ce&&ce.addEventListener(`click`,e=>{e.stopPropagation(),O.classList.remove(`show`),window.openTokenStats&&window.openTokenStats()}),go(()=>M.activeSessionId,Te);let le=document.getElementById(`isolateChatBtn`),k=document.getElementById(`enableToolsBtn`),ue=document.getElementById(`toolsConfigBtn`);chrome.storage.local.get([`isolateChat`,`enableSelectionQuery`,`enableTools`,`enabledTools`],t=>{t.isolateChat!==void 0&&(M.isolateChat=t.isolateChat),le.checked=M.isolateChat,t.enableSelectionQuery!==void 0&&(M.enableSelectionQuery=t.enableSelectionQuery);let n=document.getElementById(`enableSelectionQueryBtn`);if(n&&(n.checked=M.enableSelectionQuery),t.enableTools!==void 0&&(M.useTools=t.enableTools),t.enabledTools&&t.enabledTools.length>0){let n=new Set(e.map(e=>e.id)),r=t.enabledTools.filter(e=>n.has(e)),i=e.filter(e=>e.enabled&&!r.includes(e.id)).map(e=>e.id);M.enabledTools=[...r,...i],i.length>0&&chrome.storage.local.set({enabledTools:M.enabledTools})}else M.enabledTools=e.filter(e=>e.enabled).map(e=>e.id);M.enabledTools.length===0&&(M.useTools=!1),k&&(k.checked=M.useTools),x()}),le.addEventListener(`change`,()=>{M.isolateChat=le.checked,chrome.storage.local.set({isolateChat:M.isolateChat}),console.log(`[SidePanel] 记忆对话:`,M.isolateChat?`已启用`:`已禁用`)});let de=document.getElementById(`enableSelectionQueryBtn`);de&&de.addEventListener(`change`,()=>{M.enableSelectionQuery=de.checked,chrome.storage.local.set({enableSelectionQuery:M.enableSelectionQuery}),console.log(`[SidePanel] 划词问答:`,M.enableSelectionQuery?`已启用`:`已禁用`),!M.enableSelectionQuery&&M.selectedContextText&&wi()}),k&&k.addEventListener(`change`,()=>{M.useTools=k.checked,chrome.storage.local.set({enableTools:M.useTools}),M.useTools&&M.enabledTools.length===0&&(M.enabledTools=e.filter(e=>e.enabled).map(e=>e.id),chrome.storage.local.set({enabledTools:M.enabledTools})),console.log(`[SidePanel] 工具总开关:`,M.useTools?`已启用`:`已禁用`)}),ue&&ue.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),er()});let fe=document.getElementById(`toolsPopupOverlay`),pe=document.getElementById(`toolsPopupClose`),me=fe?fe.querySelector(`.modal-container`):null;pe&&pe.addEventListener(`click`,tr),me&&me.addEventListener(`click`,e=>{e.stopPropagation()});let he=document.getElementById(`toolsSearchInput`);he&&he.addEventListener(`input`,e=>{M.currentSearch=e.target.value.toLowerCase(),nr()});let ge=document.querySelectorAll(`.category-btn`);ge.forEach(e=>{e.addEventListener(`click`,()=>{ge.forEach(e=>{e.classList.remove(`active`),e.classList.contains(`category-all`)?(e.style.background=`#f5f3ff`,e.style.color=`#667eea`,e.style.borderColor=`#d4cfff`):(e.style.background=`white`,e.style.color=`#555`,e.style.borderColor=`#ececec`)}),e.classList.add(`active`),e.style.background=`linear-gradient(135deg, #667eea 0%, #764ba2 100%)`,e.style.color=`white`,e.style.borderColor=`transparent`,M.currentCategory=e.dataset.category,nr()})});let _e=document.getElementById(`toolsCategories`);_e&&_e.addEventListener(`wheel`,e=>{e.preventDefault(),_e.scrollLeft+=e.deltaY*2},{passive:!1});let ve=document.getElementById(`toolsSelectAll`),ye=document.getElementById(`toolsSelectNone`);ve&&ve.addEventListener(`click`,()=>{ar().forEach(e=>{let t=document.getElementById(`tool_`+e.id);t&&(t.checked=!0),M.enabledTools.includes(e.id)||M.enabledTools.push(e.id)}),or(),sr(),B()}),ye&&ye.addEventListener(`click`,()=>{ar().forEach(e=>{let t=document.getElementById(`tool_`+e.id);t&&(t.checked=!1);let n=M.enabledTools.indexOf(e.id);n>-1&&M.enabledTools.splice(n,1)}),or(),sr(),B()});let be=document.getElementById(`toolsPopupSave`);be&&be.addEventListener(`click`,()=>{cr(),B()});let xe=document.getElementById(`toolsPreselectToggle`);xe&&xe.addEventListener(`change`,()=>{chrome.storage.local.set({enableToolPreselect:xe.checked},()=>{console.log(`[SidePanel] 工具预筛选开关已更新:`,xe.checked)})});let Se=document.getElementById(`toolsPopupCancel`);Se&&Se.addEventListener(`click`,()=>{tr()});let Ce=document.getElementById(`modalCancelBtn`),we=document.getElementById(`modalConfirmBtn`);function Te(e,t=`确认操作`){return new Promise(n=>{let r=document.getElementById(`customConfirmOverlay`),i=document.getElementById(`customConfirmTitle`),a=document.getElementById(`customConfirmMessage`),o=document.getElementById(`customConfirmCancelBtn`),s=document.getElementById(`customConfirmOkBtn`);if(!r||!i||!a||!o||!s){n(confirm(e));return}let c=()=>{r.style.display=`none`,s.removeEventListener(`click`,l),o.removeEventListener(`click`,u),r.removeEventListener(`click`,d)},l=()=>{c(),n(!0)},u=()=>{c(),n(!1)},d=e=>{e.target===r&&(c(),n(!1))};i.textContent=t,a.textContent=e,r.style.display=`flex`,s.addEventListener(`click`,l),o.addEventListener(`click`,u),r.addEventListener(`click`,d)})}let A=document.getElementById(`toolStatsOverlay`),Ee=document.getElementById(`toolStatsClose`),De=document.getElementById(`toolStatsBtn`);function Oe(){A&&(A.style.display=`flex`,Me())}function ke(){A&&(A.style.display=`none`)}De&&De.addEventListener(`click`,e=>{e.stopPropagation(),Oe()}),Ee&&Ee.addEventListener(`click`,ke),A&&A.addEventListener(`click`,e=>{e.target===A&&ke()});let Ae=document.getElementById(`toolStatsRefreshBtn`);Ae&&Ae.addEventListener(`click`,Me);let je=document.getElementById(`toolStatsClearBtn`);je&&je.addEventListener(`click`,async()=>{await Te(`确定要清空所有工具使用统计吗？此操作不可撤销。`,`清空统计`)&&(await chrome.storage.local.remove([`toolUsageStats`]),Me())});let j={column:`callCount`,asc:!1};async function Me(){let t=document.getElementById(`toolStatsTable`),n=document.getElementById(`toolStatsTableBody`),r=document.getElementById(`toolStatsLoading`),i=document.getElementById(`toolStatsEmpty`),a=document.getElementById(`toolStatsSummary`),o=document.getElementById(`toolStatsUnusedSection`),s=document.getElementById(`toolStatsUnusedList`);if(!(!t||!n||!r||!i)){t.style.display=`none`,i.style.display=`none`,o&&(o.style.display=`none`),a&&(a.textContent=``),r.style.display=``;try{let n=(await chrome.storage.local.get([`toolUsageStats`])).toolUsageStats||{},c=Object.entries(n);if(c.length===0){r.style.display=`none`,i.style.display=``;return}let l={};e.forEach(e=>{l[e.id]=e.name?`${e.name}：${e.description||``}`:e.description||e.id}),Ne(c,l);let u=e.map(e=>e.id),d=new Set(c.map(([e])=>e)),f=u.filter(e=>!d.has(e)),p=c.length,m=f.length;a&&(a.textContent=`已使用 ${p} 个，未使用 ${m} 个`),o&&s&&m>0&&(s.innerHTML=f.sort((e,t)=>e.toLowerCase().localeCompare(t.toLowerCase())).map(e=>`<code title="${I(l[e]||e)}" style="padding: 3px 10px; background: #f5f5f5; color: #aaa; border: 1px solid #eee; border-radius: 4px; font-size: 11px;">${e}</code>`).join(``),o.style.display=``),r.style.display=`none`,t.style.display=``}catch(e){console.error(`[SidePanel] 加载统计失败:`,e),r.style.display=`none`,i.textContent=`加载失败`,i.style.display=``}}}function Ne(e,t){let n=document.getElementById(`toolStatsTableBody`);if(!n)return;let{column:r,asc:i}=j;n.innerHTML=[...e].sort((e,t)=>{let[n,a]=e,[o,s]=t,c=a.callCount>0?a.successCount/a.callCount*100:0,l=s.callCount>0?s.successCount/s.callCount*100:0,u=a.callCount>0?a.totalDuration/a.callCount:0,d=s.callCount>0?s.totalDuration/s.callCount:0,f=0;switch(r){case`name`:f=n.toLowerCase().localeCompare(o.toLowerCase());break;case`callCount`:f=a.callCount-s.callCount;break;case`successCount`:f=a.successCount-s.successCount;break;case`successRate`:f=c-l;break;case`duration`:f=u-d;break}return i?f:-f}).map(([e,n])=>{let r=n.callCount>0?n.successCount/n.callCount*100:0,i=n.callCount>0?n.totalDuration/n.callCount:0,a=t[e]||e,o=`#38a169`;r<60?o=`#e53e3e`:r<85&&(o=`#d69e2e`);let s=i<1e3?`${Math.round(i)}ms`:`${(i/1e3).toFixed(1)}s`;return`<tr>
      ...
      </tr>`}).join(``),Pe()}function Pe(){let{column:e,asc:t}=j,n=[`name`,`callCount`,`successCount`,`successRate`,`duration`],r={name:`sortByName`,callCount:`sortByCallCount`,successCount:`sortBySuccessCount`,successRate:`sortBySuccessRate`,duration:`sortByDuration`};n.forEach(n=>{let i=document.getElementById(r[n]);if(!i)return;let a=i.querySelector(`.sort-indicator`);a&&(n===e?(a.textContent=t?`▲`:`▼`,a.style.color=`#667eea`):(a.textContent=``,a.style.color=``))})}document.querySelectorAll(`#toolStatsTable th[data-sort]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.sort;j.column===t?j.asc=!j.asc:(j.column=t,j.asc=!1),Me()})}),Ce.addEventListener(`click`,()=>{Fi()}),we.addEventListener(`click`,()=>{Fi(),Ei()});let Fe=document.getElementById(`confirmModal`);Fe.addEventListener(`click`,e=>{e.target===Fe&&Fi()});let Ie=document.getElementById(`selectionClose`);Ie&&Ie.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),console.log(`[SidePanel] 用户点击关闭选中内容按钮`),wi(),window.hideFloatingMenu(),M.lastSelectedText=``,M.currentSelectionRange=null}),i.addEventListener(`input`,()=>{})}),mt().then(()=>_o()),document.addEventListener(`DOMContentLoaded`,()=>{yo()}),document.addEventListener(`DOMContentLoaded`,bt),document.addEventListener(`DOMContentLoaded`,lo),document.addEventListener(`DOMContentLoaded`,Ft),document.addEventListener(`DOMContentLoaded`,zt),document.addEventListener(`DOMContentLoaded`,pn),document.addEventListener(`DOMContentLoaded`,ji),document.addEventListener(`DOMContentLoaded`,()=>ur());function Eo(){let e=document.getElementById(`imagePreviewBar`),t=document.getElementById(`screenshotBtn`);e&&(e.style.display=M.attachedImages.length>0?``:`none`),t&&(M.enableImageInput?t.style.removeProperty(`display`):t.style.display=`none`),userInput&&(M.enableImageInput?userInput.style.paddingRight=`84px`:userInput.style.paddingRight=``),M.enableImageInput||(M.attachedImages=[]),Do()}function Do(){let e=document.getElementById(`imagePreviewBar`);if(e){if(e.innerHTML=``,M.attachedImages.length===0){e.style.display=`none`;return}e.style.display=``,M.attachedImages.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`image-preview-item`;let i=document.createElement(`img`);i.src=t.dataUrl,i.className=`image-preview-thumb`,i.title=`点击查看大图`,i.style.cursor=`zoom-in`,i.addEventListener(`click`,()=>{Ki(t.dataUrl,i)});let a=document.createElement(`button`);a.className=`image-preview-remove`,a.innerHTML=`×`,a.title=`移除图片`,a.addEventListener(`click`,e=>{e.stopPropagation(),M.attachedImages.splice(n,1),Do()}),r.appendChild(i),r.appendChild(a),e.appendChild(r)})}}async function Oo(){if(!M.enableImageInput){F(`请先开启图片输入功能`);return}try{let e=await chrome.runtime.sendMessage({type:`CAPTURE_TAB`});e?.dataUrl&&($i(await(await fetch(e.dataUrl)).blob()),F(`截图成功`))}catch(e){console.error(`[SidePanel] 全页面截图失败:`,e),F(`截图失败，请重试`)}}async function ko(){let e=await gt();if(!e){F(`无法获取当前标签页`);return}try{let t=await chrome.tabs.sendMessage(e,{type:`START_REGION_SELECTION`});if(!t)return;console.log(`[SidePanel] 区域选择结果:`,t);let n=await chrome.runtime.sendMessage({type:`CAPTURE_TAB`});if(!n?.dataUrl){F(`截图失败，请重试`);return}let r=await Ao(n.dataUrl,t);if(!r){F(`裁剪失败，请重试`);return}$i(await(await fetch(r)).blob())}catch(e){console.error(`[SidePanel] 区域截图失败:`,e),F(`区域截图失败，请确保页面已加载且未被浏览器限制`)}}function Ao(e,t){return new Promise((n,r)=>{let i=new Image;i.onload=()=>{let e=document.createElement(`canvas`),r=window.devicePixelRatio||1,a=t.x*r,o=t.y*r,s=t.width*r,c=t.height*r;e.width=s,e.height=c,e.getContext(`2d`).drawImage(i,a,o,s,c,0,0,s,c),n(e.toDataURL(`image/jpeg`,.85))},i.onerror=()=>r(Error(`图片加载失败`)),i.src=e})}
//# sourceMappingURL=side_panel-lVLXSk2P.js.map