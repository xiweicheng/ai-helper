import{n as e}from"./constants-BB5x2B5S.js";import{_ as t,c as n,d as r,f as i,g as a,h as o,i as s,l as c,m as l,n as u,s as d,t as f,u as p,v as m,x as h}from"./token-counter-C6QcPNvr.js";var g=new Set,_=[],v=`deepseek-v4-pro`,y=null,ee=[],b=!0,x=!0,S=!1,C=null,te=``,ne=``,w=[],T=-1,re=null,E=``,ie=[],ae=-1,oe={maxInputHistory:20,maxHistoryMessages:50,maxMessageLength:1e5,maxMemoryMessages:20},se=.2,ce=1,D=0,O=`all`,le=``,ue=[],k={},A=new Map,de=null,j=new Map,M=new Set,N=new Map,fe=null,pe=null,me=null,he=18e4,ge=null,_e=!1,ve=null,ye=``,be=null,xe=0,Se=0,Ce=-1,we=!1,P={get isGenerating(){return g.has(y)},set isGenerating(e){e?g.add(y):g.delete(y)},get generatingSessionIds(){return g},get messageHistory(){return _},set messageHistory(e){_=e},get currentModel(){return v},set currentModel(e){v=e},get activeSessionId(){return y},set activeSessionId(e){y=e},get sessions(){return ee},set sessions(e){ee=e},get useTools(){return b},set useTools(e){b=e},get isolateChat(){return x},set isolateChat(e){x=e},get enableSelectionQuery(){return S},set enableSelectionQuery(e){S=e},get currentTabId(){return C},set currentTabId(e){C=e},get selectedContextText(){return te},set selectedContextText(e){te=e},get quotedContextText(){return ne},set quotedContextText(e){ne=e},get customPrompts(){return w},set customPrompts(e){w=e},get selectedPromptIndex(){return T},set selectedPromptIndex(e){T=e},get draggedItemIndex(){return re},set draggedItemIndex(e){re=e},get systemPrompt(){return E},set systemPrompt(e){E=e},get inputHistory(){return ie},set inputHistory(e){ie=e},get inputHistoryIndex(){return ae},set inputHistoryIndex(e){ae=e},get chatConfig(){return oe},set chatConfig(e){oe=e},get temperature(){return se},set temperature(e){se=e},get topP(){return ce},set topP(e){ce=e},get selectedTempIndex(){return D},set selectedTempIndex(e){D=e},get currentCategory(){return O},set currentCategory(e){O=e},get currentSearch(){return le},set currentSearch(e){le=e},get enabledTools(){return ue},set enabledTools(e){ue=e},get collapsedCategories(){return k},get sessionExecutionStatus(){return A},set sessionExecutionStatus(e){A=e},get currentExecutionStatus(){return A.get(y)||null},set currentExecutionStatus(e){e===null?A.delete(y):A.set(y,e)},get executionLogListener(){return de},set executionLogListener(e){de=e},get pendingCancelApi(){return j.get(y)||null},set pendingCancelApi(e){e===null?j.delete(y):j.set(y,e)},get pendingCancelApiMap(){return j},get pendingCallApiSessionIds(){return M},set pendingCallApiSessionIds(e){M=e},get substituteLoadingIds(){return N},set substituteLoadingIds(e){N=e},get currentClarifyToolCallId(){return fe},set currentClarifyToolCallId(e){fe=e},get currentClarifySessionId(){return pe},set currentClarifySessionId(e){pe=e},get clarifyTimerInterval(){return me},set clarifyTimerInterval(e){me=e},get clarifyTimeoutValue(){return he},set clarifyTimeoutValue(e){he=e},get messageTocContainer(){return ge},set messageTocContainer(e){ge=e},get isMouseOverToc(){return _e},set isMouseOverToc(e){_e=e},get tocHideTimer(){return ve},set tocHideTimer(e){ve=e},get lastSelectedText(){return ye},set lastSelectedText(e){ye=e},get currentSelectionRange(){return be},set currentSelectionRange(e){be=e},get lastMouseX(){return xe},set lastMouseX(e){xe=e},get lastMouseY(){return Se},set lastMouseY(e){Se=e},get pendingDeleteIndex(){return Ce},set pendingDeleteIndex(e){Ce=e},get isScrolling(){return we},set isScrolling(e){we=e}},F=[{label:`精准编码`,temp:.2,topP:1,tip:`较低随机性，适合业务开发、调试、纠错`},{label:`均衡开发`,temp:.45,topP:.9,tip:`兼顾稳定性，用于封装工具类、常规脚本`},{label:`架构探索`,temp:.65,topP:.9,tip:`提供多种实现思路，用于组件重构、方案对比`},{label:`创意发散`,temp:.9,topP:.9,tip:`随机性较高，仅用于原型探索，不建议生产代码`}],Te={page_interaction:`🖱️ 页面交互`,form_operation:`📝 表单操作`,info_extract:`📄 信息提取`,page_analysis:`🔍 页面分析`,tab_management:`📑 标签页管理`,bookmark_history:`🔖 书签历史`,storage_management:`💾 存储管理`,network_request:`🌐 网络请求`,media_process:`📷 媒体处理`,debug_dev:`🔧 调试开发`,ai_collaboration:`🤖 AI协作`,system_integration:`⚙️ 系统集成`,memory:`🧠 记忆检索`},Ee=[`page_interaction`,`form_operation`,`info_extract`,`page_analysis`,`tab_management`,`bookmark_history`,`storage_management`,`network_request`,`media_process`,`debug_dev`,`ai_collaboration`,`system_integration`,`memory`];function I(e,t=`info`,n=3e3){let r=document.getElementById(`toastContainer`);if(!r)return;let i=document.createElement(`div`);i.className=`toast ${t}`,i.textContent=e,r.appendChild(i),requestAnimationFrame(()=>{i.classList.add(`toast-show`)}),setTimeout(()=>{i.classList.remove(`toast-show`),setTimeout(()=>{i.parentNode&&i.parentNode.removeChild(i)},300)},n)}function De(){let e=document.getElementById(`userInput`);e&&(e.style.height=`auto`,e.style.height=Math.min(e.scrollHeight,100)+`px`)}function L(e){if(!e)return``;let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function R(e){return!e||e<0?`0ms`:e<1e3?`${Math.round(e)}ms`:e<6e4?`${(e/1e3).toFixed(1)}s`:`${Math.floor(e/6e4)}分${(e%6e4/1e3).toFixed(1)}秒`}function Oe(e,t){navigator.clipboard.writeText(e).then(()=>{let e=t.innerHTML;t.innerHTML=`<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
      <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
        ...
        <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
      </svg>`,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{I(`复制失败`,`error`)}document.body.removeChild(r)})}function ke(){let e=new Date().toLocaleString(`zh-CN`),t=`
...
`}function Ae(){return new Promise(e=>{chrome.storage.local.get([`temperature`,`topP`],t=>{e({temperature:t.temperature===void 0?parseFloat(P.temperature.toFixed(2)):parseFloat(t.temperature.toFixed(2)),top_p:t.topP===void 0?parseFloat(P.topP.toFixed(2)):parseFloat(t.topP.toFixed(2))})})})}function je(){return new Promise(e=>{chrome.runtime.sendMessage({type:`GET_CHAT_CONFIG`},t=>{t&&(P.chatConfig=t,console.log(`[SidePanel] 对话配置已加载:`,P.chatConfig)),e(t)})})}async function Me(){return new Promise(e=>{chrome.runtime.sendMessage({type:`GET_CHAT_CONFIG`},t=>{t&&(P.chatConfig=t,console.log(`[SidePanel] 同步加载对话配置:`,P.chatConfig)),e()})})}async function Ne(){return new Promise(e=>{chrome.tabs.query({active:!0,currentWindow:!0},t=>{t&&t.length>0&&t[0].id?(P.currentTabId=t[0].id,console.log(`[SidePanel] 获取当前 Tab ID:`,P.currentTabId,`URL:`,t[0].url),e(P.currentTabId)):(console.warn(`[SidePanel] 未获取到有效的 Tab ID`),e(null))})})}function Pe(){return new Promise(e=>{chrome.storage.local.get([`reactMaxIterations`,`reactApiTimeout`,`reactLoopTimeout`,`reactToolTimeout`,`reactClarifyTimeout`],t=>{e({maxIterations:t.reactMaxIterations||30,apiTimeout:t.reactApiTimeout||6e4,loopTimeout:t.reactLoopTimeout||3e5,toolTimeout:t.reactToolTimeout||3e4,clarifyTimeout:t.reactClarifyTimeout||18e4})})})}function Fe(e){if(!e||!e.trim()||e.trim()==`/`)return;let t=e.trim(),n=P.inputHistory.indexOf(t);n!==-1&&P.inputHistory.splice(n,1),P.inputHistory.push(t),P.inputHistory.length>P.chatConfig.maxInputHistory&&P.inputHistory.shift(),Ie()}function Ie(){try{chrome.storage.local.set({inputHistory:P.inputHistory}),console.log(`[SidePanel] 输入历史已保存，数量:`,P.inputHistory.length)}catch(e){console.error(`[SidePanel] 保存输入历史失败:`,e)}}function Le(){document.addEventListener(`mouseover`,Re,!0),document.addEventListener(`mouseout`,ze,!0),console.log(`[SidePanel] 消息目录功能已初始化`)}function Re(e){if(!(e.target instanceof Element))return;if(e.target.closest(`.message-toc-container`)){P.isMouseOverToc=!0;return}let t=e.target.closest(`.message.assistant`);if(!t)return;let n=t.querySelectorAll(`.markdown-body h1, .markdown-body h2, .markdown-body h3, .markdown-body h4, .markdown-body h5, .markdown-body h6`);if(n.length===0){Ve();return}Be(t,n)}function ze(e){if(!(e.target instanceof Element))return;if(e.target.closest(`.message-toc-container`)){P.isMouseOverToc=!1,P.tocHideTimer&&=(clearTimeout(P.tocHideTimer),null);return}if(!e.target.closest(`.message.assistant`))return;let t=e.relatedTarget;t&&(t.closest(`.message-toc-container`)||t.closest(`.message.assistant`))||P.isMouseOverToc||(P.tocHideTimer&&clearTimeout(P.tocHideTimer),P.tocHideTimer=setTimeout(()=>{P.isMouseOverToc||Ve(),P.tocHideTimer=null},800))}function Be(e,t){let n=Array.from(t);P.messageTocContainer&&Ve(),n.forEach((e,t)=>{e.id||=`toc-heading-${Date.now()}-${t}`});let r=document.createElement(`div`);r.className=`message-toc-container`,r.dataset.headingsCount=n.length;let i=0,a=n.map(e=>{let t=parseInt(e.tagName.charAt(1)),n=e.textContent.trim(),r=n.length>30?n.substring(0,30)+`...`:n,a=`H${t}`;return i++,`
  ...
  `,document.body.appendChild(r),P.messageTocContainer=r;let o=e.getBoundingClientRect(),s=window.innerWidth-280;o.right<s&&(r.style.left=o.right+`px`,r.style.right=`0`,r.style.width=`auto`);let c=r.querySelector(`.message-toc-toggle`),l=r.querySelector(`.message-toc-panel`);c.addEventListener(`mouseenter`,()=>{l.classList.add(`expanded`)}),c.addEventListener(`click`,()=>{l.classList.toggle(`expanded`)}),l.addEventListener(`mouseenter`,()=>{l.classList.add(`expanded`)}),r.querySelectorAll(`.message-toc-item`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.target,n=document.getElementById(t);n&&(n.scrollIntoView({behavior:`smooth`,block:`start`}),n.classList.add(`toc-highlight`),setTimeout(()=>{n.classList.remove(`toc-highlight`)},1500))})})}function Ve(){P.tocHideTimer&&=(clearTimeout(P.tocHideTimer),null),P.messageTocContainer&&=(P.messageTocContainer.remove(),null)}function He(e){return`${Math.floor(e/60)}:${(e%60).toString().padStart(2,`0`)}`}function Ue(e=`default`){try{let t=new(window.AudioContext||window.webkitAudioContext),n=t.createOscillator(),r=t.createGain();n.connect(r),r.connect(t.destination);let i={default:{frequency:800,duration:.3},success:{frequency:523,duration:.2},warning:{frequency:440,duration:.4},error:{frequency:220,duration:.5}},a=i[e]||i.default;n.frequency.value=a.frequency,n.type=`sine`,r.gain.setValueAtTime(.3,t.currentTime),r.gain.exponentialRampToValueAtTime(.01,t.currentTime+a.duration),n.start(t.currentTime),n.stop(t.currentTime+a.duration),console.log(`[SidePanel] 提示音已播放:`,e)}catch(e){console.error(`[SidePanel] 播放提示音失败:`,e.message)}}function We(e,t){let n=document.getElementById(`clarifyTimer`),r=document.getElementById(`clarifyTimerText`);if(!n||!r)return;r.textContent=`剩余时间: ${He(e)}`;let i=e/t*100;n.classList.remove(`warning`,`critical`),e<=10?(n.classList.add(`critical`),r.textContent=`即将超时: ${He(e)}`):(e<=30||i<=15)&&n.classList.add(`warning`),e===30&&Ue(`warning`)}function Ge(e){Ke(),P.clarifyTimeoutValue=e;let t=Math.ceil(e/1e3),n=t;We(n,t),P.clarifyTimerInterval=setInterval(()=>{n--,n<=0?Ke():We(n,t)},1e3)}function Ke(){P.clarifyTimerInterval&&=(clearInterval(P.clarifyTimerInterval),null)}function qe(e){console.log(`[SidePanel] 显示澄清对话框:`,e);let{question:t,options:n,recommendedOption:r,allowCustomInput:i=!0,allowAdditionalInfo:a=!0,toolCallId:o,timeout:s=18e4,sessionId:c}=e;P.currentClarifyToolCallId=o,P.currentClarifySessionId=c||null;let l=document.getElementById(`clarifySessionName`);if(l)if(c&&P.sessions){let e=P.sessions.find(e=>e.id===c);e?(l.textContent=`会话: ${e.title}`,l.style.display=`block`):(l.textContent=`会话: ${c.substring(0,8)}...`,l.style.display=`block`)}else l.textContent=``,l.style.display=`none`;let u=r!==void 0&&r>=0?r:0,d=[u],f=u,p=document.getElementById(`clarifyQuestion`);p&&(p.textContent=t);let m=document.getElementById(`clarifyOptionsList`);if(m&&(document.querySelectorAll(`.clarify-option-item`).forEach(e=>{e.remove()}),n.forEach((e,t)=>{let n=d.includes(t),r=document.createElement(`div`);r.className=`clarify-option-item ${f===t?`selected`:``} ${n?`recommended`:``}`,r.dataset.index=t,r.innerHTML=`
      ...
      `,e.addEventListener(`click`,()=>Ye(-1)),m.appendChild(e);let t=document.getElementById(`clarifyCustomInput`);t&&m.appendChild(t)}let h=document.getElementById(`clarifyCustomInput`);h&&h.classList.remove(`show`);let g=document.getElementById(`clarifyAdditionalInfo`);g&&g.classList.toggle(`show`,a);let _=document.getElementById(`clarifyCustomTextarea`);_&&(_.value=``);let v=document.getElementById(`clarifyAdditionalTextarea`);v&&(v.value=``);let y=document.getElementById(`clarifyOverlay`);y&&y.classList.add(`show`),Ge(s),console.log(`[SidePanel] 澄清对话框已显示`)}function Je(){let e=document.getElementById(`clarifyOverlay`);e&&e.classList.remove(`show`),P.currentClarifyToolCallId=null,P.currentClarifySessionId=null,Ke(),console.log(`[SidePanel] 澄清对话框已隐藏`)}function Ye(e){document.querySelectorAll(`.clarify-option-item`).forEach(e=>{e.classList.remove(`selected`)});let t=document.querySelector(`.clarify-option-item[data-index="${e}"]`);t&&t.classList.add(`selected`);let n=document.getElementById(`clarifyCustomInput`);if(n)if(e===-1){n.classList.add(`show`);let e=document.getElementById(`clarifyCustomTextarea`);e&&e.focus()}else n.classList.remove(`show`);console.log(`[SidePanel] 选择澄清选项:`,e)}function Xe(){if(!P.currentClarifyToolCallId){console.error(`[SidePanel] 没有当前工具调用ID`);return}let e=-1;document.querySelectorAll(`.clarify-option-item`).forEach((t,n)=>{t.classList.contains(`selected`)&&(e=parseInt(t.dataset.index))});let t=document.getElementById(`clarifyCustomTextarea`),n=t?t.value.trim():``,r=document.getElementById(`clarifyAdditionalTextarea`),i=r?r.value.trim():``,a={type:`CLARIFY_RESPONSE`,toolCallId:P.currentClarifyToolCallId,selectedOption:e,customInput:n,additionalInfo:i};console.log(`[SidePanel] 发送澄清响应:`,a),chrome.runtime.sendMessage(a),Je()}function Ze(){if(P.currentClarifyToolCallId){let e={type:`CLARIFY_RESPONSE`,toolCallId:P.currentClarifyToolCallId,selectedOption:-1,customInput:``,additionalInfo:``};chrome.runtime.sendMessage(e)}Je()}function Qe(){let e=document.getElementById(`clarifyConfirmBtn`);e&&e.addEventListener(`click`,Xe);let t=document.getElementById(`clarifyCancelBtn`);t&&t.addEventListener(`click`,Ze),chrome.runtime.onMessage.addListener((e,t,n)=>{if(e.type===`SHOW_CLARIFY_DIALOG`)console.log(`[SidePanel] 收到澄清请求:`,e,`当前激活会话:`,P.activeSessionId),qe(e.data),n({success:!0});else if(e.type===`PLAY_NOTIFICATION_SOUND`)console.log(`[SidePanel] 收到播放提示音请求:`,e),Ue(e.soundType),n({success:!0});else if(e.type===`CLARIFY_TIMEOUT`){if(console.log(`[SidePanel] 收到澄清超时通知:`,e),e.sessionId&&P.currentClarifySessionId&&e.sessionId!==P.currentClarifySessionId){console.log(`[SidePanel] 澄清超时来自其他会话，忽略`);return}let t=document.getElementById(`clarifyTimer`),n=document.getElementById(`clarifyTimerText`);t&&n&&(t.classList.remove(`warning`),t.classList.add(`critical`),n.textContent=`已超时`),Ue(`error`)}}),console.log(`[SidePanel] 澄清对话框事件已初始化`)}var z=null,B=1,$e=.25,et=2,tt=.1;function nt(e){let t=e.trim();return/^\s*<!DOCTYPE\s/i.test(t)||/^\s*<html[\s>]/i.test(t)?/<\/head>/i.test(t)?t.replace(/<\/head>/i,`<style>html,body{overflow:auto!important;height:auto!important;}</style></head>`):/<body[\s>]/i.test(t)?t.replace(/<body([\s>])/i,`<body$1<style>html,body{overflow:auto!important;height:auto!important;}</style>`):t:`<!DOCTYPE html>
<html>
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head>
<body style="margin:0;padding:0;overflow:auto;">${t}</body>
</html>`}function rt(e){console.log(`[SidePanel] 显示 UI 原型预览:`,e),z=e,vt();let t=document.getElementById(`prototypeTitle`),n=document.getElementById(`prototypeDescription`),r=document.getElementById(`prototypeIframe`);t&&(t.textContent=e.title||`UI 原型预览`),n&&(n.textContent=e.description||``,n.style.display=e.description?`block`:`none`),r&&e.html&&(r.srcdoc=nt(e.html));let i=document.getElementById(`prototypeOverlay`);i&&i.classList.add(`show`),console.log(`[SidePanel] UI 原型预览弹窗已显示`)}function it(){let e=document.getElementById(`prototypeOverlay`);e&&e.classList.remove(`show`);let t=document.getElementById(`prototypeIframe`);t&&(t.srcdoc=``),z=null,console.log(`[SidePanel] UI 原型预览弹窗已隐藏`)}function at(){if(!z)return;let e=z.id,t=z.title||`原型`;it();let n=document.getElementById(`userInput`);n&&(n.value=`请帮我优化这个UI原型界面 ${e}（${t}），`,n.focus(),n.style.height=`auto`,n.style.height=n.scrollHeight+`px`),console.log(`[SidePanel] 继续优化原型:`,e)}function ot(){if(!z||!z.html){console.error(`[SidePanel] 没有可下载的原型`);return}let e=nt(z.html),t=new Blob([e],{type:`text/html`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=(z.title||`prototype`).replace(/[^a-zA-Z0-9\u4e00-\u9fa5_-]/g,`_`)+`.html`,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(n),console.log(`[SidePanel] 原型已下载:`,r.download)}function st(){if(!z||!z.html){console.error(`[SidePanel] 没有可打开的原型`);return}let e=nt(z.html),t=new Blob([e],{type:`text/html`}),n=URL.createObjectURL(t);chrome.tabs.create({url:n,active:!0}),console.log(`[SidePanel] 原型已在新标签页打开`)}async function ct(e){try{let t=await o(e);if(!t){console.error(`[SidePanel] 未找到原型:`,e);return}rt(t)}catch(e){console.error(`[SidePanel] 加载原型失败:`,e)}}async function lt(){let e=document.getElementById(`prototypeLibraryList`),t=document.getElementById(`prototypeLibraryModal`);if(!(!e||!t)){e.innerHTML=`<div class="prototype-library-empty">加载中...</div>`;try{let t=await a();t.length===0?e.innerHTML=`<div class="prototype-library-empty">暂无原型</div>`:(e.innerHTML=t.map(e=>{let t=e.id.replace(`proto_`,``).slice(-6);return`
...
`});let o=new Blob([a],{type:`text/csv;charset=utf-8;`}),s=document.createElement(`a`),c=URL.createObjectURL(o);s.setAttribute(`href`,c),s.setAttribute(`download`,`table-${Date.now()}.csv`),s.style.visibility=`hidden`,document.body.appendChild(s),s.click(),document.body.removeChild(s),console.log(`[SidePanel] Excel 下载成功`)}catch(e){console.error(`[SidePanel] 下载 Excel 失败:`,e),I(`下载失败: `+e.message,`error`)}}async function Dt(){if(typeof mermaid>`u`){console.warn(`[SidePanel] Mermaid 库未加载`);return}console.log(`[SidePanel] ===== renderMermaidCharts 开始 =====`);let e=document.querySelectorAll(`.mermaid`);if(console.log(`[SidePanel] 找到 mermaid 元素数量:`,e.length),e.length!==0){for(let t=0;t<e.length;t++){let n=e[t];try{await mermaid.run({nodes:[n]}),console.log(`[SidePanel] 第`,t+1,`个 mermaid 图表渲染成功`),kt(n)}catch(e){console.error(`[SidePanel] 第`,t+1,`个 mermaid 图表渲染失败:`,e),!n.querySelector(`svg`)&&!n.querySelector(`.mermaid-controls`)&&(n.innerHTML=`<div style="color: #856404; background: #fff3cd; padding: 10px; border-radius: 4px; margin: 10px 0;">图表渲染失败: ${e.message}</div>`)}}console.log(`[SidePanel] ===== renderMermaidCharts 完成 =====`)}}function Ot(e){return e?`<div class="markdown-body">${Ct(e)}</div>`:``}function kt(e){if(e.querySelector(`.mermaid-controls`)){console.log(`[SidePanel] 工具栏已存在，跳过`);return}let t=e.querySelector(`svg`);if(!t){console.warn(`[SidePanel] SVG 元素未找到，当前内容:`,e.innerHTML.substring(0,100));return}console.log(`[SidePanel] 找到 SVG 元素，开始添加工具栏`),console.log(`[SidePanel] container 类名:`,e.className),console.log(`[SidePanel] container HTML:`,e.innerHTML.substring(0,200)),e.style.position=`relative`,e.style.cursor=`grab`,e.style.userSelect=`none`,e.style.webkitUserSelect=`none`;let n=e.querySelector(`.mermaid-svg-wrapper`);if(!n){n=document.createElement(`div`),n.className=`mermaid-svg-wrapper`,n.style.transformOrigin=`center center`,n.style.transition=`transform 0.2s ease`,n.style.display=`inline-block`,n.style.width=`100%`,t.style.maxWidth=`100%`,t.style.height=`auto`,t.style.userSelect=`none`,t.style.webkitUserSelect=`none`,n.appendChild(t),e.insertBefore(n,e.firstChild);let r=[];Array.from(e.childNodes).forEach(e=>{e.nodeType===Node.TEXT_NODE&&e.textContent.trim()&&r.push(e)}),r.forEach(e=>e.remove())}let r=document.createElement(`div`);r.className=`mermaid-controls`,r.innerHTML=`
...
`).trim()}}async function pn(){let e=await H();if(e.activeSessionId&&e.list.length>0){P.activeSessionId=e.activeSessionId,P.sessions=e.list;let t=e.list.find(t=>t.id===e.activeSessionId);t&&(P.messageHistory=t.messageHistory||[],P.currentModel=t.model||P.currentModel,P.useTools=t.useTools===void 0?P.useTools:t.useTools,P.enabledTools=t.enabledTools||P.enabledTools,P.temperature=t.temperature===void 0?P.temperature:t.temperature,P.topP=t.topP===void 0?P.topP:t.topP),P.messageHistory.forEach(e=>{let t=e.wasRevised;if(!t&&e.executionLog)try{t=(typeof e.executionLog==`string`?JSON.parse(e.executionLog):e.executionLog).some(e=>e.nodeType===`reflection`&&e.reflectionType===`post`&&e.action?.decision===`revised`)}catch{}q(e.role,e.content,!1,e.executionLog||[],e.reflectionScore,t)});let n=document.querySelector(`.welcome-message`);n&&P.messageHistory.length>0&&n.remove(),Dt();let r=`scrollPosition_`+(P.activeSessionId||`default`);chrome.storage.local.get([r],e=>{e[r]!==void 0&&setTimeout(()=>{let t=document.getElementById(`chatContainer`);t.scrollTop=e[r]},100)}),U()}else{await Jt();let e=await H();e.activeSessionId&&(P.activeSessionId=e.activeSessionId,P.sessions=e.list),U()}}function G(){try{qt().catch(e=>{console.error(`[SidePanel] 保存当前会话失败:`,e)})}catch(e){console.error(`[SidePanel] 保存对话历史异常:`,e)}}function mn(){P.messageHistory&&P.messageHistory.length>0&&Qt().then(()=>{P.messageHistory=[];let e=document.getElementById(`chatContainer`);if(e){e.innerHTML=``;let t=document.createElement(`div`);t.className=`welcome-message`,t.innerHTML=`
  ...
  `,e.appendChild(n),e.scrollTop=e.scrollHeight;let r=n.querySelector(`.stop-task-btn`),i=n.querySelector(`.loading-text`);r&&r.addEventListener(`click`,e=>{e.stopPropagation(),r.disabled=!0,r.style.opacity=`0.6`,r.style.cursor=`not-allowed`,i&&(i.textContent=`停止中...`),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:null,sessionId:P.activeSessionId}),P.pendingCancelApi&&P.pendingCancelApi({message:`任务已被用户停止`,executionLog:P.currentExecutionStatus?.executionLog||[]})});let a=P.activeSessionId;P.executionLogListener=(e,n,r)=>e.sessionId&&e.sessionId!==a?!1:e.type===`EXECUTION_STATUS_UPDATE`?(console.log(`[SidePanel] 收到执行状态更新:`,e.nodeName,e.status,`日志数量:`,e.executionLog?.length),Nn(t,e.nodeName,e.status,e.executionLog),!1):!1,chrome.runtime.onMessage.addListener(P.executionLogListener),chrome.storage.local.get(`enableExecutionLog`,e=>{if(e.enableExecutionLog){let e=n.querySelector(`.execution-status-container`);e&&(e.style.display=`flex`)}});let o=n.querySelector(`.execution-log-toggle-btn`);return o&&o.addEventListener(`click`,e=>{e.stopPropagation(),Mn(t)}),t}function J(e){let t=document.getElementById(e);if(t){let e=t.querySelector(`.loading-text`);e&&(e.textContent=`思考中...`),t.remove()}P.executionLogListener&&=(chrome.runtime.onMessage.removeListener(P.executionLogListener),null),P.currentExecutionStatus=null;let n=document.querySelector(`.execution-log-panel.realtime-mode`);n&&n.remove()}async function Fn(e,t,n=!1,r={}){let i=(await Pe()).loopTimeout,a=P.activeSessionId;return new Promise((o,s)=>{let c=[],l=Math.round(i/1e3),u=e=>{d&&clearTimeout(d),v(),P.pendingCancelApiMap.delete(a),P.pendingCallApiSessionIds.delete(a),ln(),(!e.executionLog||e.executionLog.length===0||c.length>0)&&(e.executionLog=c),s(e)};P.pendingCancelApi=u,P.pendingCallApiSessionIds.add(a),ln(),console.log(`[SidePanel] callApi: 添加 pendingCallApiSessionIds, mySessionId =`,a,`, set:`,[...P.pendingCallApiSessionIds]);let d=setTimeout(()=>{u({message:`请求超时（${l}秒）`,executionLog:c}),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:P.currentTabId,sessionId:P.activeSessionId}).catch(e=>{console.log(`[SidePanel] 发送取消请求失败:`,e.message)})},i),f=Date.now(),p=0,m=null,h=()=>{m===null&&d!==null&&(m=Date.now(),clearTimeout(d),d=null,console.log(`[SidePanel] 前端超时已暂停（澄清工具执行中）`))},g=()=>{if(m!==null){let e=Date.now()-m;p+=e,m=null;let t=Date.now()-f,n=i+p-t;if(n<=0){u({message:`请求超时（${l}秒）`,executionLog:c});return}d=setTimeout(()=>{u({message:`请求超时（${l}秒）`,executionLog:c}),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:P.currentTabId,sessionId:a}).catch(e=>{console.log(`[SidePanel] 发送取消请求失败:`,e.message)})},n),console.log(`[SidePanel] 前端超时已恢复，暂停时长:`,Math.round(e/1e3),`s，剩余时间:`,Math.round(n/1e3),`s`)}},_=e=>(console.log(`[SidePanel] 收到消息:`,e),e.sessionId&&e.sessionId!==a?!1:e.type===`EXECUTION_STATUS_UPDATE`?(c=e.executionLog||[],!1):e.type===`CLARIFY_START`?(h(),!1):e.type===`CLARIFY_END`?(g(),!1):e.type===`API_COMPLETE`?(d&&clearTimeout(d),P.pendingCancelApiMap.delete(a),P.pendingCallApiSessionIds.delete(a),ln(),chrome.runtime.onMessage.removeListener(_),o({content:e.content,executionLog:e.executionLog||c,reflectionScore:e.reflectionScore}),!1):e.type===`API_ERROR`?(d&&clearTimeout(d),P.pendingCancelApiMap.delete(a),P.pendingCallApiSessionIds.delete(a),ln(),chrome.runtime.onMessage.removeListener(_),s({message:e.error,executionLog:e.executionLog||c}),!1):!1);chrome.runtime.onMessage.addListener(_);let v=()=>{chrome.runtime.onMessage.removeListener(_)};console.log(`[SidePanel] 发送 CALL_API 消息，useTools:`,n,`tabId:`,P.currentTabId,`sessionId:`,P.activeSessionId,`apiParams:`,r,`timeout:`,i),chrome.runtime.sendMessage({type:`CALL_API`,sessionId:P.activeSessionId,messages:e,model:t,useTools:n,tabId:P.currentTabId,apiParams:r})})}function In(e){let t=document.querySelector(`.execution-log-panel`);t&&t.remove();let n=document.createElement(`div`);n.className=`execution-log-panel`;let r=e.reduce((e,t)=>e+(t.duration||0),0),i=e.filter(e=>e.status===`success`).length,a=e.filter(e=>e.status===`failed`).length,o=e.filter(e=>e.nodeType===`subtask`).length,s=e.filter(e=>e.nodeType===`subtask`&&e.status===`success`).length,c=e.filter(e=>e.nodeType===`tool_exec`&&e.action?.name===`plan_task`&&e.status===`success`).length,l=e.filter(e=>e.nodeType===`reflection`).find(e=>e.reflectionType===`post`);n.innerHTML=`
    <div class="log-container">
      <div class="log-header">
        <div class="log-title">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  `,document.body.appendChild(n),n.addEventListener(`click`,e=>{e.target===n&&n.remove()}),n.querySelector(`.log-close`).addEventListener(`click`,()=>{n.remove()});let u=n.querySelector(`.toggle-expand-btn`),d=n.querySelectorAll(`.timeline-content`),f=!1;u.addEventListener(`click`,()=>{f=!f,d.forEach(e=>{f?e.classList.add(`expanded`):e.classList.remove(`expanded`)});let e=u.querySelector(`svg`);f?(e.innerHTML=`<polyline points="17 11 12 6 7 11"></polyline><polyline points="17 18 12 13 7 18"></polyline>`,u.setAttribute(`title`,`收起全部节点`)):(e.innerHTML=`<polyline points="7 13 12 18 17 13"></polyline><polyline points="7 6 12 11 17 6"></polyline>`,u.setAttribute(`title`,`展开全部节点`))}),n.querySelectorAll(`.timeline-header`).forEach(e=>{e.addEventListener(`click`,()=>{e.parentElement.classList.toggle(`expanded`)})});let p=n.querySelectorAll(`.combo-stat`),m=n.querySelectorAll(`.timeline-item`);p.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.status,n=e.classList.contains(`active`);p.forEach(e=>e.classList.remove(`active`)),n?m.forEach(e=>{e.style.display=``}):(e.classList.add(`active`),m.forEach(e=>{if(t===`subtask`)e.classList.contains(`subtask-level`)?e.style.display=``:e.style.display=`none`;else{let n=e.querySelector(`.timeline-dot`);n&&n.classList.contains(t)?e.style.display=``:e.style.display=`none`}}))})})}function Ln(e,t){try{let n=e.dataset.rawContent||``;navigator.clipboard.writeText(n).then(()=>{let e=t.innerHTML;t.innerHTML=`
      ...
      `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}).catch(e=>{let r=document.createElement(`textarea`);r.value=n,r.style.position=`fixed`,r.style.left=`-999999px`,document.body.appendChild(r),r.select();try{document.execCommand(`copy`);let e=t.innerHTML;t.innerHTML=`
          ...
          <span>已复制</span>
        `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{I(`复制失败，请手动选择内容复制`,`error`)}document.body.removeChild(r)})}catch(e){console.error(`[SidePanel] 复制失败:`,e),I(`复制失败`,`error`)}}function Bn(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}let r=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
    ...
    `,i=new Blob([`﻿`,r],{type:`application/msword`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=`word-${new Date().getTime()}.doc`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a);let s=t.innerHTML;t.innerHTML=`
      ...
      <span>已导出</span>
    `,setTimeout(()=>{t.innerHTML=s},2e3),console.log(`[SidePanel] Word 文档导出成功`)}catch(e){console.error(`[SidePanel] 导出 Word 失败:`,e),I(`导出失败: `+e.message,`error`)}}function Vn(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}let r=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
    ...
    `,i=window.open(``,`_blank`,`width=800,height=600`);if(!i){I(`请允许弹出窗口以使用 PDF 导出功能`,`warning`);return}i.document.write(r),i.document.close(),i.onload=function(){setTimeout(()=>{i.focus(),i.print()},500)};let a=t.innerHTML;t.innerHTML=`
      ...
      <span>已触发</span>
    `,setTimeout(()=>{t.innerHTML=a},2e3),console.log(`[SidePanel] PDF 导出已触发`)}catch(e){console.error(`[SidePanel] 导出 PDF 失败:`,e),I(`导出失败: `+e.message,`error`)}}function Hn(e){try{let t=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!t){console.warn(`[SidePanel] 无法获取消息内容`);return}let n=document.getElementById(`userInput`);if(!n){console.warn(`[SidePanel] 找不到输入框`);return}let r=e.querySelector(`.quote-btn`),i=r?r.innerHTML:``;dn(t),r&&(r.innerHTML=`
        <svg viewBox="0 0 16 16" fill="currentColor">
          <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
        </svg>
        <span>已引用</span>
      `,r.classList.add(`quoted`),setTimeout(()=>{r.innerHTML=i,r.classList.remove(`quoted`)},2e3)),n.focus(),console.log(`[SidePanel] 已引用消息内容到提示条，输入框已获取焦点`)}catch(e){console.error(`[SidePanel] 引用提问失败:`,e),I(`引用失败: `+e.message,`error`)}}function Un(){console.log(`[SidePanel] 清除选中内容上下文`),P.selectedContextText=``,P.quotedContextText=``;let e=document.getElementById(`selectionIndicator`),t=document.getElementById(`userInput`);if(e&&(e.classList.remove(`show`),console.log(`[SidePanel] 已隐藏选中内容提示条`)),typeof window.hideFloatingMenu==`function`&&window.hideFloatingMenu(),t&&t.value.startsWith(`[选中内容]`)){let e=t.value.split(`
