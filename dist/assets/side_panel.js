import{n as e}from"./constants-BMbKeydk.js";var t=!1,n=[],r=`deepseek-v4-pro`,i=!0,a=!0,o=!1,s=null,c=``,l=``,u=[],d=-1,f=null,p=``,m=[],h=-1,g={maxInputHistory:20,maxHistoryMessages:50,maxMessageLength:5e3,maxMemoryMessages:null},_=.2,v=1,y=0,b=`all`,x=``,S=[],ee={},C=null,w=null,T=null,E=null,D=18e4,O=null,k=!1,A=null,j=``,M=null,N=null,te=0,ne=0,P=-1,F=!1,I={get isGenerating(){return t},set isGenerating(e){t=e},get messageHistory(){return n},set messageHistory(e){n=e},get currentModel(){return r},set currentModel(e){r=e},get useTools(){return i},set useTools(e){i=e},get isolateChat(){return a},set isolateChat(e){a=e},get enableSelectionQuery(){return o},set enableSelectionQuery(e){o=e},get currentTabId(){return s},set currentTabId(e){s=e},get selectedContextText(){return c},set selectedContextText(e){c=e},get quotedContextText(){return l},set quotedContextText(e){l=e},get customPrompts(){return u},set customPrompts(e){u=e},get selectedPromptIndex(){return d},set selectedPromptIndex(e){d=e},get draggedItemIndex(){return f},set draggedItemIndex(e){f=e},get systemPrompt(){return p},set systemPrompt(e){p=e},get inputHistory(){return m},set inputHistory(e){m=e},get inputHistoryIndex(){return h},set inputHistoryIndex(e){h=e},get chatConfig(){return g},set chatConfig(e){g=e},get temperature(){return _},set temperature(e){_=e},get topP(){return v},set topP(e){v=e},get selectedTempIndex(){return y},set selectedTempIndex(e){y=e},get currentCategory(){return b},set currentCategory(e){b=e},get currentSearch(){return x},set currentSearch(e){x=e},get enabledTools(){return S},set enabledTools(e){S=e},get collapsedCategories(){return ee},get currentExecutionStatus(){return C},set currentExecutionStatus(e){C=e},get executionLogListener(){return w},set executionLogListener(e){w=e},get currentClarifyToolCallId(){return T},set currentClarifyToolCallId(e){T=e},get clarifyTimerInterval(){return E},set clarifyTimerInterval(e){E=e},get clarifyTimeoutValue(){return D},set clarifyTimeoutValue(e){D=e},get messageTocContainer(){return O},set messageTocContainer(e){O=e},get isMouseOverToc(){return k},set isMouseOverToc(e){k=e},get tocHideTimer(){return A},set tocHideTimer(e){A=e},get lastSelectedText(){return j},set lastSelectedText(e){j=e},get currentSelectionRange(){return M},set currentSelectionRange(e){M=e},get selectedHighlightElement(){return N},set selectedHighlightElement(e){N=e},get lastMouseX(){return te},set lastMouseX(e){te=e},get lastMouseY(){return ne},set lastMouseY(e){ne=e},get pendingDeleteIndex(){return P},set pendingDeleteIndex(e){P=e},get isScrolling(){return F},set isScrolling(e){F=e}},L=[{label:`精准编码`,temp:.2,topP:1,tip:`较低随机性，适合业务开发、调试、纠错`},{label:`均衡开发`,temp:.45,topP:.9,tip:`兼顾稳定性，用于封装工具类、常规脚本`},{label:`架构探索`,temp:.65,topP:.9,tip:`提供多种实现思路，用于组件重构、方案对比`},{label:`创意发散`,temp:.9,topP:.9,tip:`随机性较高，仅用于原型探索，不建议生产代码`}];function R(e,t=`info`,n=3e3){let r=document.getElementById(`toastContainer`);if(!r)return;let i=document.createElement(`div`);i.className=`toast ${t}`,i.textContent=e,r.appendChild(i),requestAnimationFrame(()=>{i.classList.add(`toast-show`)}),setTimeout(()=>{i.classList.remove(`toast-show`),setTimeout(()=>{i.parentNode&&i.parentNode.removeChild(i)},300)},n)}function re(){let e=document.getElementById(`userInput`);e&&(e.style.height=`auto`,e.style.height=Math.min(e.scrollHeight,100)+`px`)}function z(e){if(!e)return``;let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function B(e){return!e||e<0?`0ms`:e<1e3?`${Math.round(e)}ms`:e<6e4?`${(e/1e3).toFixed(1)}s`:`${Math.floor(e/6e4)}分${(e%6e4/1e3).toFixed(1)}秒`}function ie(e,t){navigator.clipboard.writeText(e).then(()=>{let e=t.innerHTML;t.innerHTML=`<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
      <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
        ...
        <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
      </svg>`,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{R(`复制失败`,`error`)}document.body.removeChild(r)})}function ae(){let e=new Date().toLocaleString(`zh-CN`),t=`
...
- 操作系统：Windows 10.0
- 当前时间：${e}
`}function oe(){return new Promise(e=>{chrome.storage.local.get([`temperature`,`topP`],t=>{e({temperature:t.temperature===void 0?parseFloat(I.temperature.toFixed(2)):parseFloat(t.temperature.toFixed(2)),top_p:t.topP===void 0?parseFloat(I.topP.toFixed(2)):parseFloat(t.topP.toFixed(2))})})})}function se(){return new Promise(e=>{chrome.runtime.sendMessage({type:`GET_CHAT_CONFIG`},t=>{t&&(I.chatConfig=t,console.log(`[SidePanel] 对话配置已加载:`,I.chatConfig)),e(t)})})}async function ce(){return new Promise(e=>{chrome.runtime.sendMessage({type:`GET_CHAT_CONFIG`},t=>{t&&(I.chatConfig=t,console.log(`[SidePanel] 同步加载对话配置:`,I.chatConfig)),e()})})}async function le(){return new Promise(e=>{chrome.tabs.query({active:!0,currentWindow:!0},t=>{t&&t.length>0&&t[0].id?(I.currentTabId=t[0].id,console.log(`[SidePanel] 获取当前 Tab ID:`,I.currentTabId,`URL:`,t[0].url),e(I.currentTabId)):(console.warn(`[SidePanel] 未获取到有效的 Tab ID`),e(null))})})}function ue(){return new Promise(e=>{chrome.storage.local.get([`reactMaxIterations`,`reactApiTimeout`,`reactLoopTimeout`,`reactToolTimeout`,`reactClarifyTimeout`],t=>{e({maxIterations:t.reactMaxIterations||30,apiTimeout:t.reactApiTimeout||6e4,loopTimeout:t.reactLoopTimeout||3e5,toolTimeout:t.reactToolTimeout||3e4,clarifyTimeout:t.reactClarifyTimeout||18e4})})})}function de(e){if(!e||!e.trim()||e.trim()==`/`)return;let t=e.trim(),n=I.inputHistory.indexOf(t);n!==-1&&I.inputHistory.splice(n,1),I.inputHistory.push(t),I.inputHistory.length>I.chatConfig.maxInputHistory&&I.inputHistory.shift(),fe()}function fe(){try{chrome.storage.local.set({inputHistory:I.inputHistory}),console.log(`[SidePanel] 输入历史已保存，数量:`,I.inputHistory.length)}catch(e){console.error(`[SidePanel] 保存输入历史失败:`,e)}}function pe(){document.addEventListener(`mouseover`,me,!0),document.addEventListener(`mouseout`,he,!0),console.log(`[SidePanel] 消息目录功能已初始化`)}function me(e){if(!(e.target instanceof Element))return;if(e.target.closest(`.message-toc-container`)){I.isMouseOverToc=!0;return}let t=e.target.closest(`.message.assistant`);if(!t)return;let n=t.querySelectorAll(`.markdown-body h1, .markdown-body h2, .markdown-body h3, .markdown-body h4, .markdown-body h5, .markdown-body h6`);if(n.length===0){_e();return}ge(t,n)}function he(e){if(!(e.target instanceof Element))return;if(e.target.closest(`.message-toc-container`)){I.isMouseOverToc=!1,I.tocHideTimer&&=(clearTimeout(I.tocHideTimer),null);return}if(!e.target.closest(`.message.assistant`))return;let t=e.relatedTarget;t&&(t.closest(`.message-toc-container`)||t.closest(`.message.assistant`))||I.isMouseOverToc||(I.tocHideTimer&&clearTimeout(I.tocHideTimer),I.tocHideTimer=setTimeout(()=>{I.isMouseOverToc||_e(),I.tocHideTimer=null},800))}function ge(e,t){let n=Array.from(t);I.messageTocContainer&&_e(),n.forEach((e,t)=>{e.id||=`toc-heading-${Date.now()}-${t}`});let r=document.createElement(`div`);r.className=`message-toc-container`,r.dataset.headingsCount=n.length;let i=0,a=n.map(e=>{let t=parseInt(e.tagName.charAt(1)),n=e.textContent.trim(),r=n.length>30?n.substring(0,30)+`...`:n,a=`H${t}`;return i++,`
  ...
  `,document.body.appendChild(r),I.messageTocContainer=r;let o=e.getBoundingClientRect(),s=window.innerWidth-280;o.right<s&&(r.style.left=o.right+`px`,r.style.right=`0`,r.style.width=`auto`);let c=r.querySelector(`.message-toc-toggle`),l=r.querySelector(`.message-toc-panel`);c.addEventListener(`mouseenter`,()=>{l.classList.add(`expanded`)}),c.addEventListener(`click`,()=>{l.classList.toggle(`expanded`)}),l.addEventListener(`mouseenter`,()=>{l.classList.add(`expanded`)}),r.querySelectorAll(`.message-toc-item`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.target,n=document.getElementById(t);n&&(n.scrollIntoView({behavior:`smooth`,block:`start`}),n.classList.add(`toc-highlight`),setTimeout(()=>{n.classList.remove(`toc-highlight`)},1500))})})}function _e(){I.tocHideTimer&&=(clearTimeout(I.tocHideTimer),null),I.messageTocContainer&&=(I.messageTocContainer.remove(),null)}function ve(e){return`${Math.floor(e/60)}:${(e%60).toString().padStart(2,`0`)}`}function ye(e=`default`){try{let t=new(window.AudioContext||window.webkitAudioContext),n=t.createOscillator(),r=t.createGain();n.connect(r),r.connect(t.destination);let i={default:{frequency:800,duration:.3},success:{frequency:523,duration:.2},warning:{frequency:440,duration:.4},error:{frequency:220,duration:.5}},a=i[e]||i.default;n.frequency.value=a.frequency,n.type=`sine`,r.gain.setValueAtTime(.3,t.currentTime),r.gain.exponentialRampToValueAtTime(.01,t.currentTime+a.duration),n.start(t.currentTime),n.stop(t.currentTime+a.duration),console.log(`[SidePanel] 提示音已播放:`,e)}catch(e){console.error(`[SidePanel] 播放提示音失败:`,e.message)}}function be(e,t){let n=document.getElementById(`clarifyTimer`),r=document.getElementById(`clarifyTimerText`);if(!n||!r)return;r.textContent=`剩余时间: ${ve(e)}`;let i=e/t*100;n.classList.remove(`warning`,`critical`),e<=10?(n.classList.add(`critical`),r.textContent=`即将超时: ${ve(e)}`):(e<=30||i<=15)&&n.classList.add(`warning`),e===30&&ye(`warning`)}function xe(e){Se(),I.clarifyTimeoutValue=e;let t=Math.ceil(e/1e3),n=t;be(n,t),I.clarifyTimerInterval=setInterval(()=>{n--,n<=0?Se():be(n,t)},1e3)}function Se(){I.clarifyTimerInterval&&=(clearInterval(I.clarifyTimerInterval),null)}function Ce(e){console.log(`[SidePanel] 显示澄清对话框:`,e);let{question:t,options:n,recommendedOption:r,allowCustomInput:i=!0,allowAdditionalInfo:a=!0,toolCallId:o,timeout:s=18e4}=e;I.currentClarifyToolCallId=o;let c=r!==void 0&&r>=0?r:0,l=[c],u=c,d=document.getElementById(`clarifyQuestion`);d&&(d.textContent=t);let f=document.getElementById(`clarifyOptionsList`);if(f&&(document.querySelectorAll(`.clarify-option-item`).forEach(e=>{e.remove()}),n.forEach((e,t)=>{let n=l.includes(t),r=document.createElement(`div`);r.className=`clarify-option-item ${u===t?`selected`:``} ${n?`recommended`:``}`,r.dataset.index=t,r.innerHTML=`
      ...
      </div>`)}),r.forEach((e,t)=>{i=i.replace(`%%TABLE_BLOCK_${t}%%`,je(e))}),i}function Ae(e){if(!e)return``;let t=e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`);return t=t.replace(/`([^`]+)`/g,`<code>$1</code>`),t=t.replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`),t=t.replace(/\*([^*]+)\*/g,`<em>$1</em>`),t=t.replace(/~~([^~]+)~~/g,`<del>$1</del>`),t}function je(e){let{header:t,body:n,full:r}=e,i=window.__tableBlocks?window.__tableBlocks.length:0;window.__tableBlocks&&(window.__tableBlocks[i]={full:r,header:t,body:n});let a=t.split(`|`).filter(e=>e.trim()).map(e=>Ae(e.trim())),o=n.trim().split(`
`).filter(e=>e.trim()).map(e=>e.split(`|`).filter(e=>e.trim()).map(e=>Ae(e.trim()))),s=`<div class="table-container-wrapper"><table>`;return s+=`<thead><tr>`,a.forEach((e,t)=>{t===a.length-1?s+=`<th class="table-header-cell-wrapper">
        ${e}
      ...
      </th>`:s+=`<th>${e}</th>`}),s+=`</tr></thead>`,s+=`<tbody>`,o.forEach(e=>{s+=`<tr>`,e.forEach(e=>{s+=`<td>${e}</td>`}),s+=`</tr>`}),s+=`</tbody>`,s+=`</table></div>`,s}function Me(e){try{let{header:t,body:n}=e,r=t.split(`|`).filter(e=>e.trim()).map(e=>e.trim()),i=n.trim().split(`
...
`});let o=new Blob([a],{type:`text/csv;charset=utf-8;`}),s=document.createElement(`a`),c=URL.createObjectURL(o);s.setAttribute(`href`,c),s.setAttribute(`download`,`table-${Date.now()}.csv`),s.style.visibility=`hidden`,document.body.appendChild(s),s.click(),document.body.removeChild(s),console.log(`[SidePanel] Excel 下载成功`)}catch(e){console.error(`[SidePanel] 下载 Excel 失败:`,e),R(`下载失败: `+e.message,`error`)}}async function Ne(){if(typeof mermaid>`u`){console.warn(`[SidePanel] Mermaid 库未加载`);return}console.log(`[SidePanel] ===== renderMermaidCharts 开始 =====`);let e=document.querySelectorAll(`.mermaid`);if(console.log(`[SidePanel] 找到 mermaid 元素数量:`,e.length),e.length!==0){for(let t=0;t<e.length;t++){let n=e[t];try{await mermaid.run({nodes:[n]}),console.log(`[SidePanel] 第`,t+1,`个 mermaid 图表渲染成功`),Fe(n)}catch(e){console.error(`[SidePanel] 第`,t+1,`个 mermaid 图表渲染失败:`,e),!n.querySelector(`svg`)&&!n.querySelector(`.mermaid-controls`)&&(n.innerHTML=`<div style="color: #856404; background: #fff3cd; padding: 10px; border-radius: 4px; margin: 10px 0;">图表渲染失败: ${e.message}</div>`)}}console.log(`[SidePanel] ===== renderMermaidCharts 完成 =====`)}}function Pe(e){return e?`<div class="markdown-body">${ke(e)}</div>`:``}function Fe(e){if(e.querySelector(`.mermaid-controls`)){console.log(`[SidePanel] 工具栏已存在，跳过`);return}let t=e.querySelector(`svg`);if(!t){console.warn(`[SidePanel] SVG 元素未找到，当前内容:`,e.innerHTML.substring(0,100));return}console.log(`[SidePanel] 找到 SVG 元素，开始添加工具栏`),console.log(`[SidePanel] container 类名:`,e.className),console.log(`[SidePanel] container HTML:`,e.innerHTML.substring(0,200)),e.style.position=`relative`,e.style.cursor=`grab`,e.style.userSelect=`none`,e.style.webkitUserSelect=`none`;let n=e.querySelector(`.mermaid-svg-wrapper`);if(!n){n=document.createElement(`div`),n.className=`mermaid-svg-wrapper`,n.style.transformOrigin=`center center`,n.style.transition=`transform 0.2s ease`,n.style.display=`inline-block`,n.style.width=`100%`,t.style.maxWidth=`100%`,t.style.height=`auto`,t.style.userSelect=`none`,t.style.webkitUserSelect=`none`,n.appendChild(t),e.insertBefore(n,e.firstChild);let r=[];Array.from(e.childNodes).forEach(e=>{e.nodeType===Node.TEXT_NODE&&e.textContent.trim()&&r.push(e)}),r.forEach(e=>e.remove())}let r=document.createElement(`div`);r.className=`mermaid-controls`,r.innerHTML=`
  ...
  `,e.appendChild(r),console.log(`[SidePanel] 工具栏 HTML 已添加`),console.log(`[SidePanel] container 子元素:`,Array.from(e.children).map(e=>e.className).join(`, `));let i=1,a=.3,o=.15,s=e.dataset.rawCode||``;if(!s){let e=t.querySelector(`title`);e&&e.textContent&&(s=e.textContent.trim())}if(!s){let e=t.querySelector(`script[type="text/plain"]`);e&&(s=e.textContent.trim())}s&&!e.dataset.rawMermaidCode&&(e.dataset.rawMermaidCode=s),r.querySelector(`.view-source`).addEventListener(`click`,r=>{r.stopPropagation();let s=e.getAttribute(`data-raw-code`);Re(e,s?decodeURIComponent(s):e.dataset.rawMermaidCode||``,n,t,i,{MIN_SCALE:a,MAX_SCALE:3,SCALE_STEP:o})}),r.querySelector(`.copy-to-clipboard`).addEventListener(`click`,e=>{e.stopPropagation(),Ie(t,n,i)}),r.querySelector(`.download-png`).addEventListener(`click`,e=>{e.stopPropagation(),Le(t,i)}),e.addEventListener(`wheel`,e=>{!e.ctrlKey&&!e.metaKey||(e.preventDefault(),e.stopPropagation(),i=e.deltaY<0?Math.min(3,i+o):Math.max(a,i-o),p())},{passive:!1});let c=!1,l,u,d=0,f=0;function p(){n.style.transform=`translate(${d}px, ${f}px) scale(${i})`}r.querySelector(`.zoom-in`).addEventListener(`click`,e=>{e.stopPropagation(),i=Math.min(3,i+o),p()}),r.querySelector(`.zoom-out`).addEventListener(`click`,e=>{e.stopPropagation(),i=Math.max(a,i-o),p()}),r.querySelector(`.reset-zoom`).addEventListener(`click`,e=>{e.stopPropagation(),i=1,d=0,f=0,p()}),e.addEventListener(`mousedown`,t=>{t.target.tagName!==`BUTTON`&&(c=!0,l=t.clientX-d,u=t.clientY-f,e.style.cursor=`grabbing`)}),document.addEventListener(`mousemove`,e=>{c&&(d=e.clientX-l,f=e.clientY-u,p())}),document.addEventListener(`mouseup`,()=>{c&&(c=!1,e.style.cursor=`grab`)})}async function Ie(e,t,n){try{console.log(`[SidePanel] 开始复制到剪贴板`);let t=e.width.baseVal?.value||e.getAttribute(`width`)?.replace(`px`,``)||800,n=e.height.baseVal?.value||e.getAttribute(`height`)?.replace(`px`,``)||600,r=e.getAttribute(`viewBox`);if(r){let e=r.split(` `).map(parseFloat);t=e[2],n=e[3]}console.log(`[SidePanel] SVG 原始尺寸:`,t,`x`,n);let i=new XMLSerializer().serializeToString(e),a=`data:image/svg+xml;base64,${btoa(unescape(encodeURIComponent(i)))}`,o=new Image;o.onload=function(){let e=t+40,r=n+40,i=document.createElement(`canvas`);i.width=e*2,i.height=r*2;let a=i.getContext(`2d`);a.fillStyle=`#ffffff`,a.fillRect(0,0,i.width,i.height),a.drawImage(o,40,40,t*2,n*2),i.toBlob(function(e){if(e)if(navigator.clipboard&&typeof ClipboardItem<`u`)navigator.clipboard.write([new ClipboardItem({"image/png":e})]).then(()=>{console.log(`[SidePanel] 图片复制到剪贴板成功`),R(`Mermaid 图表已复制到剪贴板！`,`success`)}).catch(e=>{console.error(`[SidePanel] 复制到剪贴板失败:`,e),R(`复制失败，您的浏览器可能不支持此功能。请尝试使用下载按钮保存图表。`,`error`)});else{console.warn(`[SidePanel] Clipboard API 不可用，降级为下载`),R(`当前浏览器不支持图片复制功能，已自动转为下载。`,`warning`);let t=document.createElement(`a`);t.href=URL.createObjectURL(e),t.download=`mermaid-diagram-`+Date.now()+`.png`,document.body.appendChild(t),t.click(),document.body.removeChild(t)}},`image/png`)},o.onerror=function(e){console.error(`[SidePanel] 图片转换失败:`,e),R(`图片转换失败，请重试`,`error`)},o.src=a}catch(e){console.error(`[SidePanel] 复制到剪贴板失败:`,e),R(`复制失败: `+e.message,`error`)}}function Le(e,t){try{console.log(`[SidePanel] 开始下载 PNG`);let t=e.width.baseVal?.value||e.getAttribute(`width`)?.replace(`px`,``)||800,n=e.height.baseVal?.value||e.getAttribute(`height`)?.replace(`px`,``)||600,r=e.getAttribute(`viewBox`);if(r){let e=r.split(` `).map(parseFloat);t=e[2],n=e[3]}console.log(`[SidePanel] SVG 原始尺寸:`,t,`x`,n);let i=new XMLSerializer().serializeToString(e),a=`data:image/svg+xml;base64,${btoa(unescape(encodeURIComponent(i)))}`,o=new Image;o.onload=function(){console.log(`[SidePanel] SVG 图片加载成功`);let e=t+40,r=n+40,i=document.createElement(`canvas`);i.width=e*2,i.height=r*2;let a=i.getContext(`2d`);a.fillStyle=`#ffffff`,a.fillRect(0,0,i.width,i.height),a.drawImage(o,40,40,t*2,n*2),i.toBlob(function(e){let t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`mermaid-diagram-`+Date.now()+`.png`,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(t),console.log(`[SidePanel] PNG 下载成功`)},`image/png`)},o.onerror=function(e){console.error(`[SidePanel] PNG 转换失败:`,e),R(`PNG 转换失败，请重试`,`error`)},o.src=a}catch(e){console.error(`[SidePanel] 下载 PNG 失败:`,e),R(`下载失败: `+e.message,`error`)}}function Re(e,t,n,r,i,a){let o=e.querySelector(`.mermaid-source-view`),s=e.querySelector(`.mermaid-controls`);if(o)o.parentElement&&o.parentElement.remove(),n&&(n.style.display=`inline-block`),Fe(e);else{n&&(n.style.display=`none`),s&&s.remove();let o=document.createElement(`div`);o.className=`mermaid-container-wrapper`,o.style.position=`relative`;let c=document.createElement(`pre`);c.className=`mermaid-source-view`,c.style.position=`relative`,c.textContent=t;let l=document.createElement(`button`);l.className=`source-copy-btn`,l.title=`复制源代码`,l.innerHTML=`
    ...
    `,u.addEventListener(`click`,o=>{o.stopPropagation(),Re(e,t,n,r,i,a)}),c.appendChild(l),c.appendChild(u),o.appendChild(c),e.appendChild(o)}}async function ze(e){if(console.log(`[SidePanel] ===== renderMessageMermaid 开始 =====`),typeof mermaid>`u`){console.warn(`[SidePanel] Mermaid 库未加载`);return}await new Promise(e=>setTimeout(e,300));let t=e.querySelectorAll(`.mermaid`);if(console.log(`[SidePanel] 找到 mermaid 元素数量:`,t.length),t.length===0){console.log(`[SidePanel] 未找到 mermaid 元素`);return}try{await mermaid.run({nodes:Array.from(t)}),console.log(`[SidePanel] Mermaid.run 完成`),await new Promise(e=>setTimeout(e,300)),t.forEach((e,t)=>{console.log(`[SidePanel] 开始为第`,t+1,`个图表添加工具栏`),Fe(e)}),await new Promise(e=>setTimeout(e,100));let n=e.querySelectorAll(`.mermaid-controls`);console.log(`[SidePanel] 工具栏添加结果:`,n.length,`个成功`)}catch(e){console.error(`[SidePanel] Mermaid 渲染失败:`,e),t.forEach(t=>{!t.querySelector(`svg`)&&!t.querySelector(`.mermaid-controls`)&&(t.innerHTML=`<div style="color: #856404; background: #fff3cd; padding: 10px; border-radius: 4px;">图表渲染失败: ${e.message}</div>`)})}Be()}function Be(){let e=document.querySelectorAll(`.code-copy-btn`);console.log(`[SidePanel] 找到代码复制按钮数量:`,e.length),e.forEach((e,t)=>{if(e.dataset.bound){console.log(`[SidePanel] 按钮`,t,`已绑定，跳过`);return}e.dataset.bound=`true`,e.addEventListener(`click`,t=>{console.log(`[SidePanel] 代码复制按钮被点击`),t.stopPropagation();let n=e.closest(`.code-block-container`);if(console.log(`[SidePanel] 找到容器:`,!!n),n){let t=n.querySelector(`pre code`);if(console.log(`[SidePanel] 找到代码元素:`,!!t),t){let n=t.textContent;console.log(`[SidePanel] 代码长度:`,n.length),ie(n,e)}}}),console.log(`[SidePanel] 已绑定按钮`,t)}),Ve()}function Ve(){document.querySelectorAll(`.copy-md-btn`).forEach((e,t)=>{e.dataset.bound||(e.dataset.bound=`true`,e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.dataset.tableIndex,r=window.__tableBlocks?.[parseInt(n)];r&&ie(r.full,e)}))}),document.querySelectorAll(`.download-excel-btn`).forEach((e,t)=>{e.dataset.bound||(e.dataset.bound=`true`,e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.dataset.tableIndex,r=window.__tableBlocks?.[parseInt(n)];r&&Me(r)}))})}function He(e){I.quotedContextText=e;let t=document.getElementById(`selectionIndicator`),n=document.getElementById(`selectionText`),r=document.getElementById(`userInput`);if(t&&n&&r){let r;r=e.length>100?e.substring(0,100)+`...`:e.length>50?e.substring(0,50)+`...`:e,n.textContent=`💬 已引用: ${r}`,t.classList.add(`show`)}}function V(){console.log(`[SidePanel] 清除选中内容上下文`),I.selectedContextText=``,I.quotedContextText=``;let e=document.getElementById(`selectionIndicator`),t=document.getElementById(`userInput`);if(e&&(e.classList.remove(`show`),console.log(`[SidePanel] 已隐藏选中内容提示条`)),typeof window.hideFloatingMenu==`function`&&window.hideFloatingMenu(),t&&t.value.startsWith(`[选中内容]`)){let e=t.value.split(`
`),n=e.findIndex(e=>e.startsWith(`[用户问题]`));n===-1?t.value=``:t.value=e.slice(n+1).join(`
`).trim()}}async function Ue(){chrome.storage.local.get([`chatHistory`,`scrollPosition`],e=>{if(e.chatHistory&&e.chatHistory.length>0){I.messageHistory=e.chatHistory,I.messageHistory.forEach(e=>{K(e.role,e.content,!1,e.executionLog||[])});let t=document.querySelector(`.welcome-message`);t&&t.remove(),Ne(),e.scrollPosition!==void 0&&setTimeout(()=>{let t=document.getElementById(`chatContainer`);t.scrollTop=e.scrollPosition},100)}})}function H(){let e=I.messageHistory.slice(-I.chatConfig.maxHistoryMessages).map(e=>({role:e.role,content:e.content.substring(0,I.chatConfig.maxMessageLength),executionLog:e.executionLog||[]}));try{chrome.storage.local.set({chatHistory:e},t=>{if(chrome.runtime.lastError){if(console.error(`[SidePanel] 保存对话历史失败:`,chrome.runtime.lastError.message),I.messageHistory.length>5){I.messageHistory=I.messageHistory.slice(-5);let e=I.messageHistory.map(e=>({role:e.role,content:e.content.substring(0,2e3),executionLog:e.executionLog||[]}));chrome.storage.local.set({chatHistory:e},()=>{chrome.runtime.lastError?console.error(`[SidePanel] 再次保存失败:`,chrome.runtime.lastError.message):console.log(`[SidePanel] 截断后保存成功，消息数:`,e.length)})}}else console.log(`[SidePanel] 对话历史已保存，消息数:`,e.length)})}catch(e){console.error(`[SidePanel] 保存对话历史异常:`,e)}}function We(){I.messageHistory=[],chrome.storage.local.remove([`chatHistory`,`scrollPosition`],()=>{let e=document.getElementById(`chatContainer`);e.innerHTML=`
      <div class="welcome-message">
        <div class="icon">💬</div>
        <h2>开始对话</h2>
        <p>输入您的问题，AI 助手将为您解答</p>
      </div>
    `,console.log(`[SidePanel] 对话历史已清除`)})}function Ge(){if(!I.messageHistory||I.messageHistory.length===0){R(`当前没有对话历史可导出`,`warning`);return}let e=I.messageHistory.map((e,t)=>{let n=document.querySelectorAll(`.message`)[t],r=null;return r=n&&n.dataset.timestamp?n.dataset.timestamp:new Date().toISOString(),{role:e.role===`user`?`user`:`assistant`,content:e.content||``,timestamp:r,displayName:e.role===`user`?`我`:`AI助手`}}),t=new Date,n=`ai-helper-${t.getFullYear()+String(t.getMonth()+1).padStart(2,`0`)+String(t.getDate()).padStart(2,`0`)+`-`+String(t.getHours()).padStart(2,`0`)+String(t.getMinutes()).padStart(2,`0`)+String(t.getSeconds()).padStart(2,`0`)}.json`,r=JSON.stringify(e,null,2),i=new Blob([r],{type:`application/json;charset=utf-8;`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=n,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a),console.log(`[SidePanel] 对话历史已导出:`,n,`共`,e.length,`条消息`),R(`对话历史已导出 (${e.length} 条消息)`,`success`)}function Ke(){document.getElementById(`confirmModal`).classList.add(`show`)}function U(){document.getElementById(`confirmModal`).classList.remove(`show`)}async function W(){let e=document.getElementById(`userInput`),t=document.getElementById(`sendBtn`),n=document.getElementById(`chatContainer`),r=e.value.trim();if(!r||I.isGenerating)return;let i=n.querySelector(`.welcome-message`);i&&i.remove();let a=r,o=I.enableSelectionQuery&&I.selectedContextText&&I.selectedContextText.trim(),s=I.quotedContextText&&I.quotedContextText.trim();if(s){let e=I.quotedContextText.trim();a=`[引用内容]\n${e}\n\n[用户问题]\n${r}`,G(`quoted`,e,!1),I.quotedContextText=``}else if(o){let e=I.selectedContextText.trim();a=`[选中内容]\n${e}\n\n[用户问题]\n${r}`,G(`selected`,e,!1),I.selectedContextText=``}K(`user`,r),I.messageHistory.push({role:`user`,content:a}),H(),de(r),e.value=``,e.style.height=`auto`,(o||s)&&V(),I.isGenerating=!0,t.disabled=!0;let c=nt(),l=I.currentModel;try{await ce(),console.log(`[SidePanel] 发送消息调试信息:`),console.log(`  - isolateChat:`,I.isolateChat),console.log(`  - chatConfig:`,I.chatConfig),console.log(`  - messageHistory.length:`,I.messageHistory.length);let e=[{role:`system`,content:ae()}];if(I.isolateChat){let t=I.messageHistory;I.chatConfig.maxMemoryMessages!==null&&I.chatConfig.maxMemoryMessages!==void 0&&I.chatConfig.maxMemoryMessages>0?(t=[...I.messageHistory.slice(0,-1).slice(-I.chatConfig.maxMemoryMessages),I.messageHistory[I.messageHistory.length-1]],console.log(`[SidePanel] 记忆历史限制生效:`,I.chatConfig.maxMemoryMessages,`条（不含当前消息），实际发送:`,t.length,`条`)):console.log(`[SidePanel] 记忆历史限制未生效:`,I.chatConfig.maxMemoryMessages),e=[...e,...t]}else e.push({role:`user`,content:a});let t=await oe(),n,r;try{let i=await rt(e,l,I.useTools,t);n=i.content,r=i.executionLog||[]}catch(e){throw q(c),n=`❌ 请求失败：`+(e.message||`未知错误`),r=e.executionLog||[],K(`assistant`,n,!0,r),I.messageHistory.push({role:`assistant`,content:n,executionLog:r}),H(),e}q(c),await ze(K(`assistant`,n,!0,r)),I.messageHistory.push({role:`assistant`,content:n,executionLog:r}),H()}catch{}finally{I.isGenerating=!1,t.disabled=!1,e.focus()}}function qe(e,t){let n=document.getElementById(`userInput`);if(!t||I.isGenerating){console.log(`[SidePanel] triggerSelectionSearch 跳过:`,{hasText:!!t,isGenerating:I.isGenerating});return}let r=I.enableSelectionQuery;I.enableSelectionQuery=!0,I.selectedContextText=t,I.quotedContextText=``,n.value=`搜索一下`,n.dispatchEvent(new Event(`input`)),W(),I.enableSelectionQuery=!1,setTimeout(()=>{I.enableSelectionQuery=r},1500)}function Je(e){let t=document.getElementById(`userInput`);!t||!e||(t.value=e,t.dispatchEvent(new Event(`input`)),t.focus())}function Ye(e,t=``){let n=document.getElementById(`userInput`);!n||!e||I.isGenerating||(t&&(I.enableSelectionQuery=!0,I.selectedContextText=t,I.quotedContextText=``),n.value=e,n.dispatchEvent(new Event(`input`)),n.focus(),W(),t&&(I.enableSelectionQuery=!1,setTimeout(()=>{I.enableSelectionQuery=!0},1500)))}function G(e,t,n=!0){let r=document.getElementById(`chatContainer`),i=document.createElement(`div`);i.className=`user-context-bubble`,i.dataset.role=`context`,i.innerHTML=`
  ...
  `,e.appendChild(n),e.scrollTop=e.scrollHeight;let r=n.querySelector(`.stop-task-btn`),i=n.querySelector(`.loading-text`);r&&r.addEventListener(`click`,e=>{e.stopPropagation(),r.disabled=!0,r.style.opacity=`0.6`,r.style.cursor=`not-allowed`,i&&(i.textContent=`停止中...`),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:null})}),I.executionLogListener=(e,n,r)=>e.type===`EXECUTION_STATUS_UPDATE`?(console.log(`[SidePanel] 收到执行状态更新:`,e.nodeName,e.status,`日志数量:`,e.executionLog?.length),tt(t,e.nodeName,e.status,e.executionLog),!1):!1,chrome.runtime.onMessage.addListener(I.executionLogListener),chrome.storage.local.get(`enableExecutionLog`,e=>{if(e.enableExecutionLog){let e=n.querySelector(`.execution-status-container`);e&&(e.style.display=`flex`)}});let a=n.querySelector(`.execution-log-toggle-btn`);return a&&a.addEventListener(`click`,e=>{e.stopPropagation(),et(t)}),t}function q(e){let t=document.getElementById(e);if(t){let e=t.querySelector(`.loading-text`);e&&(e.textContent=`思考中...`),t.remove()}I.executionLogListener&&=(chrome.runtime.onMessage.removeListener(I.executionLogListener),null),I.currentExecutionStatus=null;let n=document.querySelector(`.realtime-execution-log-panel`);n&&n.remove()}async function rt(e,t,n=!1,r={}){let i=(await ue()).loopTimeout;return new Promise((a,o)=>{let s=[],c=Math.round(i/1e3),l=setTimeout(()=>{g(),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:I.currentTabId}).catch(e=>{console.log(`[SidePanel] 发送取消请求失败:`,e.message)}),o({message:`请求超时（${c}秒）`,executionLog:s})},i),u=Date.now(),d=0,f=null,p=()=>{f===null&&l!==null&&(f=Date.now(),clearTimeout(l),l=null,console.log(`[SidePanel] 前端超时已暂停（澄清工具执行中）`))},m=()=>{if(f!==null){let e=Date.now()-f;d+=e,f=null;let t=Date.now()-u,n=i+d-t;if(n<=0){g(),o({message:`请求超时（${c}秒）`,executionLog:s});return}l=setTimeout(()=>{g(),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:I.currentTabId}).catch(e=>{console.log(`[SidePanel] 发送取消请求失败:`,e.message)}),o({message:`请求超时（${c}秒）`,executionLog:s})},n),console.log(`[SidePanel] 前端超时已恢复，暂停时长:`,Math.round(e/1e3),`s，剩余时间:`,Math.round(n/1e3),`s`)}},h=e=>(console.log(`[SidePanel] 收到消息:`,e),e.type===`EXECUTION_STATUS_UPDATE`?(s=e.executionLog||[],!1):e.type===`CLARIFY_START`?(p(),!1):e.type===`CLARIFY_END`?(m(),!1):e.type===`API_COMPLETE`?(l&&clearTimeout(l),chrome.runtime.onMessage.removeListener(h),a({content:e.content,executionLog:e.executionLog||s}),!1):e.type===`API_ERROR`?(l&&clearTimeout(l),chrome.runtime.onMessage.removeListener(h),o({message:e.error,executionLog:e.executionLog||s}),!1):!1);chrome.runtime.onMessage.addListener(h);let g=()=>{chrome.runtime.onMessage.removeListener(h)};console.log(`[SidePanel] 发送 CALL_API 消息，useTools:`,n,`tabId:`,I.currentTabId,`apiParams:`,r,`timeout:`,i),chrome.runtime.sendMessage({type:`CALL_API`,messages:e,model:t,useTools:n,tabId:I.currentTabId,apiParams:r})})}function it(e){let t=document.querySelector(`.execution-log-panel`);t&&t.remove();let n=document.createElement(`div`);n.className=`execution-log-panel`;let r=e.reduce((e,t)=>e+(t.duration||0),0),i=e.filter(e=>e.status===`success`).length,a=e.filter(e=>e.status===`failed`).length,o=e.filter(e=>e.nodeType===`subtask`).length,s=e.filter(e=>e.nodeType===`subtask`&&e.status===`success`).length;n.innerHTML=`
  ...
  `,document.body.appendChild(n),n.addEventListener(`click`,e=>{e.target===n&&n.remove()}),n.querySelector(`.log-close`).addEventListener(`click`,()=>{n.remove()});let c=n.querySelector(`.toggle-expand-btn`),l=n.querySelectorAll(`.timeline-content`),u=!1;c.addEventListener(`click`,()=>{u=!u,l.forEach(e=>{u?e.classList.add(`expanded`):e.classList.remove(`expanded`)});let e=c.querySelector(`svg`);u?(e.innerHTML=`<polyline points="17 11 12 6 7 11"></polyline><polyline points="17 18 12 13 7 18"></polyline>`,c.setAttribute(`title`,`收起全部节点`)):(e.innerHTML=`<polyline points="7 13 12 18 17 13"></polyline><polyline points="7 6 12 11 17 6"></polyline>`,c.setAttribute(`title`,`展开全部节点`))}),n.querySelectorAll(`.timeline-header`).forEach(e=>{e.addEventListener(`click`,()=>{e.parentElement.classList.toggle(`expanded`)})});let d=n.querySelectorAll(`.combo-stat`),f=n.querySelectorAll(`.timeline-item`);d.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.status,n=e.classList.contains(`active`);d.forEach(e=>e.classList.remove(`active`)),n?f.forEach(e=>{e.style.display=``}):(e.classList.add(`active`),f.forEach(e=>{if(t===`subtask`)e.classList.contains(`subtask-level`)?e.style.display=``:e.style.display=`none`;else{let n=e.querySelector(`.timeline-dot`);n&&n.classList.contains(t)?e.style.display=``:e.style.display=`none`}}))})})}function at(e,t){try{let n=e.dataset.rawContent||``;navigator.clipboard.writeText(n).then(()=>{let e=t.innerHTML;t.innerHTML=`
      ...
      `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}).catch(e=>{console.error(`[SidePanel] 复制失败:`,e);let r=document.createElement(`textarea`);r.value=n,r.style.position=`fixed`,r.style.left=`-999999px`,document.body.appendChild(r),r.select();try{document.execCommand(`copy`);let e=t.innerHTML;t.innerHTML=`
        ...
        `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{R(`复制失败`,`error`)}document.body.removeChild(r)})}catch(e){console.error(`[SidePanel] 复制失败:`,e),R(`复制失败`,`error`)}}function ot(e){try{let t=e.dataset.rawContent||``;if(!t){R(`无法获取消息内容`,`error`);return}let n=document.getElementById(`userInput`);n.value=t,re(),n.focus(),n.selectionStart=n.selectionEnd=n.value.length,console.log(`[SidePanel] 已加载消息内容到输入框，等待用户编辑后发送`)}catch(e){console.error(`[SidePanel] 编辑消息失败:`,e),R(`编辑失败: `+e.message,`error`)}}function st(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=I.messageHistory.find(e=>e.role===`assistant`);if(t)n=t.content;else{let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}}navigator.clipboard.writeText(n).then(()=>{let e=t.innerHTML;t.innerHTML=`
        <svg viewBox="0 0 16 16" fill="currentColor">
          <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
        </svg>
        <span>已复制</span>
      `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}).catch(e=>{let r=document.createElement(`textarea`);r.value=n,r.style.position=`fixed`,r.style.left=`-999999px`,document.body.appendChild(r),r.select();try{document.execCommand(`copy`);let e=t.innerHTML;t.innerHTML=`
          ...
          <span>已复制</span>
        `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{R(`复制失败，请手动选择内容复制`,`error`)}document.body.removeChild(r)})}catch(e){console.error(`[SidePanel] 复制失败:`,e),R(`复制失败`,`error`)}}function ct(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}let r=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
    ...
    `,i=new Blob([`﻿`,r],{type:`application/msword`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=`word-${new Date().getTime()}.doc`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a);let s=t.innerHTML;t.innerHTML=`
      ...
      <span>已导出</span>
    `,setTimeout(()=>{t.innerHTML=s},2e3),console.log(`[SidePanel] Word 文档导出成功`)}catch(e){console.error(`[SidePanel] 导出 Word 失败:`,e),R(`导出失败: `+e.message,`error`)}}function lt(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}let r=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
...
`),t.dispatchEvent(new Event(`input`)),console.log(`[SidePanel] 已移除输入框中的选中内容前缀`))}I.lastSelectedText=``,I.currentSelectionRange=null}function ft(){let e=document.getElementById(`promptManageList`).querySelectorAll(`.prompt-manage-item`);e.forEach(t=>{t.addEventListener(`dragstart`,e=>{I.draggedItemIndex=parseInt(t.dataset.index),t.classList.add(`dragging`),e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`text/plain`,I.draggedItemIndex)}),t.addEventListener(`dragend`,()=>{t.classList.remove(`dragging`),e.forEach(e=>e.classList.remove(`drag-over`)),I.draggedItemIndex=null}),t.addEventListener(`dragover`,e=>{e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`drag-over`)}),t.addEventListener(`dragleave`,()=>{t.classList.remove(`drag-over`)}),t.addEventListener(`drop`,e=>{e.stopPropagation(),e.preventDefault();let n=parseInt(t.dataset.index);if(I.draggedItemIndex!==null&&I.draggedItemIndex!==n){let e=I.customPrompts[I.draggedItemIndex];I.customPrompts.splice(I.draggedItemIndex,1),I.customPrompts.splice(n,0,e),chrome.storage.local.set({customPrompts:I.customPrompts}),Y()}t.classList.remove(`drag-over`)})})}function pt(){let e=document.querySelector(`.input-toolbar-right`);if(!e)return;let t=document.createElement(`button`);t.className=`prompt-manage-btn`,t.title=`提示词管理`,t.innerHTML=`<svg t="1781177976746" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5076" width="16" height="16"><path d="M674.56 231.552l101.568 56.96-56.896-101.632 56.96-101.568-101.632 56.896-101.632-56.896 56.96 101.568-56.896 101.632 101.568-56.96zM186.944 629.76l-101.504-56.896 56.832 101.632-56.832 101.568 101.504-56.96 101.632 56.96-56.896-101.568 56.896-101.568-101.568 56.832zM85.44 85.312l56.832 101.568-56.832 101.632 101.504-56.96 101.632 56.96L231.68 186.88l56.896-101.568-101.568 56.896-101.568-56.896z m351.872 438.016l-99.2-99.136L424.32 337.984l99.072 99.264-86.08 86.144m-41.856-223.04L300.352 395.392a40.448 40.448 0 0 0 0 57.28l474.24 474.112a40.448 40.448 0 0 0 57.344 0l94.912-95.04a40.448 40.448 0 0 0 0-57.344L452.736 300.288a40.448 40.448 0 0 0-57.28 0z" p-id="5077" fill="#777"></path></svg>`,t.addEventListener(`click`,()=>{xt()}),e.appendChild(t)}function mt(e=``){let t=document.getElementById(`promptSelector`),n=document.getElementById(`promptDropdown`);t.style.display=`block`,n.classList.add(`show`),_t(e)}function J(){let e=document.getElementById(`promptSelector`),t=document.getElementById(`promptDropdown`);e.style.display=`none`,t.classList.remove(`show`),I.selectedPromptIndex=-1}function ht(){let e=document.getElementById(`promptSelector`),t=document.getElementById(`promptDropdown`),n=document.getElementById(`userInput`);e.style.display!==`none`&&t.classList.contains(`show`)?J():(mt(),n.focus())}function gt(e=``){_t(e)}function _t(e=``){let t=document.getElementById(`promptList`),n=e.toLowerCase(),r=I.customPrompts.filter(t=>e?t.code.toLowerCase().includes(n)||t.content.toLowerCase().includes(n):!0);if(r.length===0){t.innerHTML=`<div class="prompt-empty">暂无匹配的提示词</div>`,I.selectedPromptIndex=-1;return}I.selectedPromptIndex=0,t.innerHTML=r.map((e,t)=>`
  ...
  `).join(``),t.querySelectorAll(`.prompt-item`).forEach(e=>{e.addEventListener(`click`,t=>{let n=e.dataset.code;t.ctrlKey||t.metaKey?yt(n):bt(n)})})}function vt(e){e.forEach((e,t)=>{t===I.selectedPromptIndex?e.classList.add(`selected`):e.classList.remove(`selected`)})}function yt(e){let t=I.customPrompts.find(t=>t.code===e);if(!t)return;let n=document.getElementById(`userInput`),r=n.value,i=r.lastIndexOf(`/`),a=r;if(i!==-1){let e=-1;for(let t=i-1;t>=0;t--)if(r[t]===`
`){e=t;break}a=e===-1?r.substring(0,i).trimEnd():r.substring(0,e+1).trimEnd()}n.value=a+(a&&!a.endsWith(`
`)?`

`:``)+t.content,n.focus(),n.selectionStart=n.selectionEnd=n.value.length,J(),re(),console.log(`[SidePanel] 已追加提示词到输入框:`,t.code,t.content)}async function bt(e){let t=I.customPrompts.find(t=>t.code===e);if(!t)return;if(I.isGenerating){console.log(`[SidePanel] 正在生成中，请稍候...`);return}J();let n=document.getElementById(`chatContainer`).querySelector(`.welcome-message`);n&&n.remove();let r=t.content,i=I.enableSelectionQuery&&I.selectedContextText&&I.selectedContextText.trim(),a=I.quotedContextText&&I.quotedContextText.trim();if(a){let e=I.quotedContextText.trim();r=`[引用内容]\n${e}\n\n[用户问题]\n${t.content}`,G(`quoted`,e,!1),I.quotedContextText=``}else if(i){let e=I.selectedContextText.trim();r=`[选中内容]\n${e}\n\n[用户问题]\n${t.content}`,G(`selected`,e,!1),I.selectedContextText=``}(i||a)&&dt(),K(`user`,t.content),I.messageHistory.push({role:`user`,content:r}),H(),de(t.content);let o=document.getElementById(`userInput`);o.value=``,o.style.height=`auto`,I.isGenerating=!0;let s=document.getElementById(`sendBtn`);s.disabled=!0;let c=nt(),l=I.currentModel;try{await ce(),console.log(`[SidePanel] 发送消息调试信息:`),console.log(`  - isolateChat:`,I.isolateChat),console.log(`  - chatConfig:`,I.chatConfig),console.log(`  - messageHistory.length:`,I.messageHistory.length);let e=[{role:`system`,content:ae()}];if(I.isolateChat){let t=I.messageHistory;I.chatConfig.maxMemoryMessages!==null&&I.chatConfig.maxMemoryMessages!==void 0&&I.chatConfig.maxMemoryMessages>0?(t=[...I.messageHistory.slice(0,-1).slice(-I.chatConfig.maxMemoryMessages),I.messageHistory[I.messageHistory.length-1]],console.log(`[SidePanel] 记忆历史限制生效:`,I.chatConfig.maxMemoryMessages,`条（不含当前消息），实际发送:`,t.length,`条`)):console.log(`[SidePanel] 记忆历史限制未生效:`,I.chatConfig.maxMemoryMessages),e=[...e,...t]}else e.push({role:`user`,content:r});let t=await oe(),n,i;try{let r=await rt(e,l,I.useTools,t);n=r.content,i=r.executionLog||[]}catch(e){throw q(c),n=`❌ 请求失败：`+(e.message||`未知错误`),i=e.executionLog||[],K(`assistant`,n,!0,i),I.messageHistory.push({role:`assistant`,content:n,executionLog:i}),H(),e}q(c),await ze(K(`assistant`,n,!0,i)),I.messageHistory.push({role:`assistant`,content:n,executionLog:i}),H()}catch{}finally{I.isGenerating=!1,s.disabled=!1,o.focus()}}function xt(){document.getElementById(`promptManageModal`).classList.add(`show`),Y()}function St(){document.getElementById(`promptManageModal`).classList.remove(`show`);let e=document.getElementById(`editPromptIndex`),t=document.getElementById(`newPromptCode`),n=document.getElementById(`newPromptContent`),r=document.getElementById(`promptManageAddBtn`);e&&(e.value=``),t&&(t.value=``),n&&(n.value=``),r&&(r.textContent=`添加提示词`,r.style.background=`#667eea`)}function Y(){let e=document.getElementById(`promptManageList`);if(I.customPrompts.length===0){e.innerHTML=`<div class="prompt-empty">暂无提示词，请添加</div>`;return}e.innerHTML=I.customPrompts.map((e,t)=>`
