import{n as e,r as t}from"./constants-7d0xjh5l.js";import{_ as n,c as r,d as i,f as a,g as o,h as s,i as c,l,m as u,n as d,s as f,t as p,u as m,v as h,x as g}from"./token-counter-048_GRqq.js";var _=new Set,v=[],y=`deepseek-v4-pro`,b=null,x=[],S=!0,C=!0,w=!1,ee=null,te=``,T=``,E=[],D=-1,O=null,ne=``,re=[],ie=-1,ae={platformName:`Unknown`,platform:`unknown`,arch:`unknown`,shell:`/bin/sh`,homeDir:`/home/user`,workdir:``,connected:!1},oe={maxInputHistory:20,maxHistoryMessages:50,maxMessageLength:1e5,maxMemoryMessages:20},k=.2,se=1,ce=0,le=`all`,A=``,ue=[],de={},j=new Map,fe=null,M=new Map,N=new Set,pe=new Map,me=null,he=null,ge=null,_e=null,P=null,ve=18e4,ye=null,be=!1,xe=null,Se=``,Ce=null,we=0,Te=0,Ee=-1,De=!1,F={get isGenerating(){return _.has(b)},set isGenerating(e){e?_.add(b):_.delete(b)},get generatingSessionIds(){return _},get messageHistory(){return v},set messageHistory(e){v=e},get currentModel(){return y},set currentModel(e){y=e},get activeSessionId(){return b},set activeSessionId(e){b=e},get sessions(){return x},set sessions(e){x=e},get useTools(){return S},set useTools(e){S=e},get isolateChat(){return C},set isolateChat(e){C=e},get enableSelectionQuery(){return w},set enableSelectionQuery(e){w=e},get currentTabId(){return ee},set currentTabId(e){ee=e},get selectedContextText(){return te},set selectedContextText(e){te=e},get quotedContextText(){return T},set quotedContextText(e){T=e},get customPrompts(){return E},set customPrompts(e){E=e},get selectedPromptIndex(){return D},set selectedPromptIndex(e){D=e},get draggedItemIndex(){return O},set draggedItemIndex(e){O=e},get systemPrompt(){return ne},set systemPrompt(e){ne=e},get agentPlatform(){return ae},set agentPlatform(e){Object.assign(ae,e)},get inputHistory(){return re},set inputHistory(e){re=e},get inputHistoryIndex(){return ie},set inputHistoryIndex(e){ie=e},get chatConfig(){return oe},set chatConfig(e){oe=e},get temperature(){return k},set temperature(e){k=e},get topP(){return se},set topP(e){se=e},get selectedTempIndex(){return ce},set selectedTempIndex(e){ce=e},get currentCategory(){return le},set currentCategory(e){le=e},get currentSearch(){return A},set currentSearch(e){A=e},get enabledTools(){return ue},set enabledTools(e){ue=e},get collapsedCategories(){return de},get sessionExecutionStatus(){return j},set sessionExecutionStatus(e){j=e},get currentExecutionStatus(){return j.get(b)||null},set currentExecutionStatus(e){e===null?j.delete(b):j.set(b,e)},get executionLogListener(){return fe},set executionLogListener(e){fe=e},get pendingCancelApi(){return M.get(b)||null},set pendingCancelApi(e){e===null?M.delete(b):M.set(b,e)},get pendingCancelApiMap(){return M},get pendingCallApiSessionIds(){return N},set pendingCallApiSessionIds(e){N=e},get substituteLoadingIds(){return pe},set substituteLoadingIds(e){pe=e},get currentClarifyToolCallId(){return me},set currentClarifyToolCallId(e){me=e},get currentClarifySessionId(){return he},set currentClarifySessionId(e){he=e},get currentConfirmToolCallId(){return ge},set currentConfirmToolCallId(e){ge=e},get currentConfirmSessionId(){return _e},set currentConfirmSessionId(e){_e=e},get clarifyTimerInterval(){return P},set clarifyTimerInterval(e){P=e},get clarifyTimeoutValue(){return ve},set clarifyTimeoutValue(e){ve=e},get messageTocContainer(){return ye},set messageTocContainer(e){ye=e},get isMouseOverToc(){return be},set isMouseOverToc(e){be=e},get tocHideTimer(){return xe},set tocHideTimer(e){xe=e},get lastSelectedText(){return Se},set lastSelectedText(e){Se=e},get currentSelectionRange(){return Ce},set currentSelectionRange(e){Ce=e},get lastMouseX(){return we},set lastMouseX(e){we=e},get lastMouseY(){return Te},set lastMouseY(e){Te=e},get pendingDeleteIndex(){return Ee},set pendingDeleteIndex(e){Ee=e},get isScrolling(){return De},set isScrolling(e){De=e}},Oe=t,I=[{label:`精准编码`,temp:.2,topP:1,tip:`较低随机性，适合业务开发、调试、纠错`},{label:`均衡开发`,temp:.45,topP:.9,tip:`兼顾稳定性，用于封装工具类、常规脚本`},{label:`架构探索`,temp:.65,topP:.9,tip:`提供多种实现思路，用于组件重构、方案对比`},{label:`创意发散`,temp:.9,topP:.9,tip:`随机性较高，仅用于原型探索，不建议生产代码`}],ke={page_interaction:`🖱️ 页面交互`,form_operation:`📝 表单操作`,info_extract:`📄 信息提取`,page_analysis:`🔍 页面分析`,tab_management:`📑 标签页管理`,bookmark_history:`🔖 书签历史`,storage_management:`💾 存储管理`,network_request:`🌐 网络请求`,media_process:`📷 媒体处理`,debug_dev:`🔧 调试开发`,ai_collaboration:`🤖 AI协作`,system_integration:`⚙️ 系统集成`,memory:`🧠 记忆检索`};function L(e,t=`info`,n=3e3){let r=document.getElementById(`toastContainer`);if(!r)return;let i=document.createElement(`div`);i.className=`toast ${t}`,i.textContent=e,r.appendChild(i),requestAnimationFrame(()=>{i.classList.add(`toast-show`)}),setTimeout(()=>{i.classList.remove(`toast-show`),setTimeout(()=>{i.parentNode&&i.parentNode.removeChild(i)},300)},n)}function Ae(){let e=document.getElementById(`userInput`);e&&(e.style.height=`auto`,e.style.height=Math.min(e.scrollHeight,100)+`px`)}function R(e){if(!e)return``;let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function z(e){return!e||e<0?`0ms`:e<1e3?`${Math.round(e)}ms`:e<6e4?`${(e/1e3).toFixed(1)}s`:`${Math.floor(e/6e4)}分${(e%6e4/1e3).toFixed(1)}秒`}function je(e,t){navigator.clipboard.writeText(e).then(()=>{let e=t.innerHTML;t.innerHTML=`<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
      <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
        ...
        <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
      </svg>`,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{L(`复制失败`,`error`)}document.body.removeChild(r)})}function Me(){let e=new Date().toLocaleString(`zh-CN`),t=``;if(F.agentPlatform&&F.agentPlatform.connected){let e=F.agentPlatform;t=`\n- 本地 Agent：${e.platformName} (${e.arch})，默认 shell: ${e.shell}，工作目录: ${e.workdir||`未设置`}`}let n=`
...
- 操作系统：Windows 10.0
- 当前时间：${e}${t}
`}function Ne(){return new Promise(e=>{chrome.storage.local.get([`temperature`,`topP`],t=>{e({temperature:t.temperature===void 0?parseFloat(F.temperature.toFixed(2)):parseFloat(t.temperature.toFixed(2)),top_p:t.topP===void 0?parseFloat(F.topP.toFixed(2)):parseFloat(t.topP.toFixed(2))})})})}function Pe(){return new Promise(e=>{chrome.runtime.sendMessage({type:`GET_CHAT_CONFIG`},t=>{t&&(F.chatConfig=t,console.log(`[SidePanel] 对话配置已加载:`,F.chatConfig)),e(t)})})}async function Fe(){return new Promise(e=>{chrome.runtime.sendMessage({type:`GET_CHAT_CONFIG`},t=>{t&&(F.chatConfig=t,console.log(`[SidePanel] 同步加载对话配置:`,F.chatConfig)),e()})})}async function Ie(){return new Promise(e=>{chrome.tabs.query({active:!0,currentWindow:!0},t=>{t&&t.length>0&&t[0].id?(F.currentTabId=t[0].id,console.log(`[SidePanel] 获取当前 Tab ID:`,F.currentTabId,`URL:`,t[0].url),e(F.currentTabId)):(console.warn(`[SidePanel] 未获取到有效的 Tab ID`),e(null))})})}function Le(){return new Promise(e=>{chrome.storage.local.get([`reactMaxIterations`,`reactApiTimeout`,`reactLoopTimeout`,`reactToolTimeout`,`reactClarifyTimeout`],t=>{e({maxIterations:t.reactMaxIterations||30,apiTimeout:t.reactApiTimeout||6e4,loopTimeout:t.reactLoopTimeout||3e5,toolTimeout:t.reactToolTimeout||3e4,clarifyTimeout:t.reactClarifyTimeout||18e4})})})}function Re(e){if(!e||!e.trim()||e.trim()==`/`)return;let t=e.trim(),n=F.inputHistory.indexOf(t);n!==-1&&F.inputHistory.splice(n,1),F.inputHistory.push(t),F.inputHistory.length>F.chatConfig.maxInputHistory&&F.inputHistory.shift(),ze()}function ze(){try{chrome.storage.local.set({inputHistory:F.inputHistory}),console.log(`[SidePanel] 输入历史已保存，数量:`,F.inputHistory.length)}catch(e){console.error(`[SidePanel] 保存输入历史失败:`,e)}}function Be(){document.addEventListener(`mouseover`,Ve,!0),document.addEventListener(`mouseout`,He,!0),console.log(`[SidePanel] 消息目录功能已初始化`)}function Ve(e){if(!(e.target instanceof Element))return;if(e.target.closest(`.message-toc-container`)){F.isMouseOverToc=!0;return}let t=e.target.closest(`.message.assistant`);if(!t)return;let n=t.querySelectorAll(`.markdown-body h1, .markdown-body h2, .markdown-body h3, .markdown-body h4, .markdown-body h5, .markdown-body h6`);if(n.length===0){We();return}Ue(t,n)}function He(e){if(!(e.target instanceof Element))return;if(e.target.closest(`.message-toc-container`)){F.isMouseOverToc=!1,F.tocHideTimer&&=(clearTimeout(F.tocHideTimer),null);return}if(!e.target.closest(`.message.assistant`))return;let t=e.relatedTarget;t&&(t.closest(`.message-toc-container`)||t.closest(`.message.assistant`))||F.isMouseOverToc||(F.tocHideTimer&&clearTimeout(F.tocHideTimer),F.tocHideTimer=setTimeout(()=>{F.isMouseOverToc||We(),F.tocHideTimer=null},800))}function Ue(e,t){let n=Array.from(t);F.messageTocContainer&&We(),n.forEach((e,t)=>{e.id||=`toc-heading-${Date.now()}-${t}`});let r=document.createElement(`div`);r.className=`message-toc-container`,r.dataset.headingsCount=n.length;let i=0,a=n.map(e=>{let t=parseInt(e.tagName.charAt(1)),n=e.textContent.trim(),r=n.length>30?n.substring(0,30)+`...`:n,a=`H${t}`;return i++,`
...
`).trim()}}async function bn(){let t=await U();if(t.activeSessionId&&t.list.length>0){F.activeSessionId=t.activeSessionId,F.sessions=t.list;let n=t.list.find(e=>e.id===t.activeSessionId);if(n){if(F.messageHistory=n.messageHistory||[],F.currentModel=n.model||F.currentModel,F.useTools=n.useTools===void 0?F.useTools:n.useTools,n.enabledTools&&n.enabledTools.length>0){let t=new Set(e.map(e=>e.id)),r=n.enabledTools.filter(e=>t.has(e)),i=e.filter(e=>e.enabled&&!r.includes(e.id)).map(e=>e.id);F.enabledTools=[...r,...i]}else F.enabledTools=n.enabledTools||F.enabledTools;F.temperature=n.temperature===void 0?F.temperature:n.temperature,F.topP=n.topP===void 0?F.topP:n.topP}F.messageHistory.forEach(e=>{let t=e.wasRevised;if(!t&&e.executionLog)try{t=(typeof e.executionLog==`string`?JSON.parse(e.executionLog):e.executionLog).some(e=>e.nodeType===`reflection`&&e.reflectionType===`post`&&e.action?.decision===`revised`)}catch{}J(e.role,e.content,!1,e.executionLog||[],e.reflectionScore,t)});let r=document.querySelector(`.welcome-message`);r&&F.messageHistory.length>0&&r.remove(),Pt();let i=`scrollPosition_`+(F.activeSessionId||`default`);chrome.storage.local.get([i],e=>{e[i]!==void 0&&setTimeout(()=>{let t=document.getElementById(`chatContainer`);t.scrollTop=e[i]},100)}),W()}else{await tn();let e=await U();e.activeSessionId&&(F.activeSessionId=e.activeSessionId,F.sessions=e.list),W()}}function K(){try{en().catch(e=>{console.error(`[SidePanel] 保存当前会话失败:`,e)})}catch(e){console.error(`[SidePanel] 保存对话历史异常:`,e)}}function xn(){F.messageHistory&&F.messageHistory.length>0&&on().then(()=>{F.messageHistory=[];let e=document.getElementById(`chatContainer`);if(e){e.innerHTML=``;let t=document.createElement(`div`);t.className=`welcome-message`,t.innerHTML=`
  ...
  `,e.appendChild(n),e.scrollTop=e.scrollHeight;let r=n.querySelector(`.stop-task-btn`),i=n.querySelector(`.loading-text`);r&&r.addEventListener(`click`,e=>{e.stopPropagation(),r.disabled=!0,r.style.opacity=`0.6`,r.style.cursor=`not-allowed`,i&&(i.textContent=`停止中...`),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:null,sessionId:F.activeSessionId}),F.pendingCancelApi&&F.pendingCancelApi({message:`任务已被用户停止`,executionLog:F.currentExecutionStatus?.executionLog||[]})});let a=F.activeSessionId;F.executionLogListener=(e,n,r)=>e.sessionId&&e.sessionId!==a?!1:e.type===`EXECUTION_STATUS_UPDATE`?(console.log(`[SidePanel] 收到执行状态更新:`,e.nodeName,e.status,`日志数量:`,e.executionLog?.length),Bn(t,e.nodeName,e.status,e.executionLog),!1):!1,chrome.runtime.onMessage.addListener(F.executionLogListener),chrome.storage.local.get(`enableExecutionLog`,e=>{if(e.enableExecutionLog){let e=n.querySelector(`.execution-status-container`);e&&(e.style.display=`flex`)}});let o=n.querySelector(`.execution-log-toggle-btn`);return o&&o.addEventListener(`click`,e=>{e.stopPropagation(),zn(t)}),t}function Y(e){let t=document.getElementById(e);if(t){let e=t.querySelector(`.loading-text`);e&&(e.textContent=`思考中...`),t.remove()}F.executionLogListener&&=(chrome.runtime.onMessage.removeListener(F.executionLogListener),null),F.currentExecutionStatus=null;let n=document.querySelector(`.execution-log-panel.realtime-mode`);n&&n.remove()}async function Hn(e,t,n=!1,r={}){let i=(await Le()).loopTimeout,a=F.activeSessionId,o=chrome.runtime.connect({name:`keepalive-`+a});console.log(`[SidePanel] keepalive 端口已连接, sessionId:`,a);let s={restarted:!1,rejectFn:null,cleanup:null};o.onMessage.addListener(e=>{e.type===`SW_RESTARTED`&&e.sessionId===a&&(console.warn(`[SidePanel] ⚠️ 收到 SW_RESTARTED 通知，后台已重启，API 调用已丢失`),s.restarted=!0,s.rejectFn&&s.cleanup&&(s.cleanup(),s.rejectFn({message:`后台服务异常重启，API 调用已中断，请重试`,executionLog:[]})))});let c={timeoutId:null,removeListener:()=>{}},l=()=>{try{o.disconnect()}catch{}c.timeoutId&&=(clearTimeout(c.timeoutId),null),c.removeListener(),F.pendingCancelApiMap.delete(a),F.pendingCallApiSessionIds.delete(a),gn()};return new Promise((o,u)=>{if(s.cleanup=l,s.rejectFn=u,s.restarted){l(),u({message:`后台服务异常重启，API 调用已中断，请重试`,executionLog:[]});return}let d=[],f=Math.round(i/1e3),p=e=>{l(),(!e.executionLog||e.executionLog.length===0||d.length>0)&&(e.executionLog=d),u(e)};F.pendingCancelApi=p,F.pendingCallApiSessionIds.add(a),gn(),console.log(`[SidePanel] callApi: 添加 pendingCallApiSessionIds, mySessionId =`,a,`, set:`,[...F.pendingCallApiSessionIds]),c.timeoutId=setTimeout(()=>{p({message:`请求超时（${f}秒）`,executionLog:d}),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:F.currentTabId,sessionId:F.activeSessionId}).catch(e=>{console.log(`[SidePanel] 发送取消请求失败:`,e.message)})},i);let m=Date.now(),h=0,g=null,_=()=>{g===null&&c.timeoutId!==null&&(g=Date.now(),clearTimeout(c.timeoutId),c.timeoutId=null,console.log(`[SidePanel] 前端超时已暂停（澄清工具执行中）`))},v=()=>{if(g!==null){let e=Date.now()-g;h+=e,g=null;let t=Date.now()-m,n=i+h-t;if(n<=0){p({message:`请求超时（${f}秒）`,executionLog:d});return}c.timeoutId=setTimeout(()=>{p({message:`请求超时（${f}秒）`,executionLog:d}),chrome.runtime.sendMessage({type:`CANCEL_REACT`,tabId:F.currentTabId,sessionId:a}).catch(e=>{console.log(`[SidePanel] 发送取消请求失败:`,e.message)})},n),console.log(`[SidePanel] 前端超时已恢复，暂停时长:`,Math.round(e/1e3),`s，剩余时间:`,Math.round(n/1e3),`s`)}},y=e=>(console.log(`[SidePanel] 收到消息:`,e),e.sessionId&&e.sessionId!==a?!1:e.type===`EXECUTION_STATUS_UPDATE`?(d=e.executionLog||[],!1):e.type===`CLARIFY_START`?(_(),!1):e.type===`CLARIFY_END`?(v(),!1):e.type===`API_COMPLETE`?(l(),o({content:e.content,executionLog:e.executionLog||d,reflectionScore:e.reflectionScore}),!1):e.type===`API_ERROR`?(l(),u({message:e.error,executionLog:e.executionLog||d}),!1):!1);chrome.runtime.onMessage.addListener(y),c.removeListener=()=>{chrome.runtime.onMessage.removeListener(y)},console.log(`[SidePanel] 发送 CALL_API 消息，useTools:`,n,`tabId:`,F.currentTabId,`sessionId:`,F.activeSessionId,`apiParams:`,r,`timeout:`,i),chrome.runtime.sendMessage({type:`CALL_API`,sessionId:F.activeSessionId,messages:e,model:t,useTools:n,tabId:F.currentTabId,apiParams:r})})}function Un(e){let t=document.querySelector(`.execution-log-panel`);t&&t.remove();let n=document.createElement(`div`);n.className=`execution-log-panel`;let r=e.reduce((e,t)=>e+(t.duration||0),0),i=e.filter(e=>e.status===`success`).length,a=e.filter(e=>e.status===`failed`).length,o=e.filter(e=>e.nodeType===`subtask`).length,s=e.filter(e=>e.nodeType===`subtask`&&e.status===`success`).length,c=e.filter(e=>e.nodeType===`tool_exec`&&e.action?.name===`plan_task`&&e.status===`success`).length,l=e.filter(e=>e.nodeType===`reflection`).find(e=>e.reflectionType===`post`);n.innerHTML=`
    <div class="log-container">
      <div class="log-header">
        <div class="log-title">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  `,document.body.appendChild(n),n.addEventListener(`click`,e=>{e.target===n&&n.remove()}),n.querySelector(`.log-close`).addEventListener(`click`,()=>{n.remove()});let u=n.querySelector(`.toggle-expand-btn`),d=n.querySelectorAll(`.timeline-content`),f=!1;u.addEventListener(`click`,()=>{f=!f,d.forEach(e=>{f?e.classList.add(`expanded`):e.classList.remove(`expanded`)});let e=u.querySelector(`svg`);f?(e.innerHTML=`<polyline points="17 11 12 6 7 11"></polyline><polyline points="17 18 12 13 7 18"></polyline>`,u.setAttribute(`title`,`收起全部节点`)):(e.innerHTML=`<polyline points="7 13 12 18 17 13"></polyline><polyline points="7 6 12 11 17 6"></polyline>`,u.setAttribute(`title`,`展开全部节点`))}),n.querySelectorAll(`.timeline-header`).forEach(e=>{e.addEventListener(`click`,()=>{e.parentElement.classList.toggle(`expanded`)})});let p=n.querySelectorAll(`.combo-stat`),m=n.querySelectorAll(`.timeline-item`);p.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.status,n=e.classList.contains(`active`);p.forEach(e=>e.classList.remove(`active`)),n?m.forEach(e=>{e.style.display=``}):(e.classList.add(`active`),m.forEach(e=>{if(t===`subtask`)e.classList.contains(`subtask-level`)?e.style.display=``:e.style.display=`none`;else{let n=e.querySelector(`.timeline-dot`);n&&n.classList.contains(t)?e.style.display=``:e.style.display=`none`}}))})})}function Wn(e,t){try{let n=e.dataset.rawContent||``;navigator.clipboard.writeText(n).then(()=>{let e=t.innerHTML;t.innerHTML=`
      ...
      `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}).catch(e=>{console.error(`[SidePanel] 复制失败:`,e);let r=document.createElement(`textarea`);r.value=n,r.style.position=`fixed`,r.style.left=`-999999px`,document.body.appendChild(r),r.select();try{document.execCommand(`copy`);let e=t.innerHTML;t.innerHTML=`
        ...
        `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{L(`复制失败`,`error`)}document.body.removeChild(r)})}catch(e){console.error(`[SidePanel] 复制失败:`,e),L(`复制失败`,`error`)}}function Gn(e){try{let t=e.dataset.rawContent||``;if(!t){L(`无法获取消息内容`,`error`);return}let n=document.getElementById(`userInput`);n.value=t,Ae(),n.focus(),n.selectionStart=n.selectionEnd=n.value.length,console.log(`[SidePanel] 已加载消息内容到输入框，等待用户编辑后发送`)}catch(e){console.error(`[SidePanel] 编辑消息失败:`,e),L(`编辑失败: `+e.message,`error`)}}function Kn(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=F.messageHistory.find(e=>e.role===`assistant`);if(t)n=t.content;else{let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}}navigator.clipboard.writeText(n).then(()=>{let e=t.innerHTML;t.innerHTML=`
        <svg viewBox="0 0 16 16" fill="currentColor">
          <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.75.75 0 0 1 1.06-1.06L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0z"/>
        </svg>
        <span>已复制</span>
      `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}).catch(e=>{let r=document.createElement(`textarea`);r.value=n,r.style.position=`fixed`,r.style.left=`-999999px`,document.body.appendChild(r),r.select();try{document.execCommand(`copy`);let e=t.innerHTML;t.innerHTML=`
          ...
          <span>已复制</span>
        `,t.classList.add(`copied`),setTimeout(()=>{t.innerHTML=e,t.classList.remove(`copied`)},2e3)}catch{L(`复制失败，请手动选择内容复制`,`error`)}document.body.removeChild(r)})}catch(e){console.error(`[SidePanel] 复制失败:`,e),L(`复制失败`,`error`)}}function qn(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}let r=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
    ...
    `,i=new Blob([`﻿`,r],{type:`application/msword`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=`word-${new Date().getTime()}.doc`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a);let s=t.innerHTML;t.innerHTML=`
      ...
      <span>已导出</span>
    `,setTimeout(()=>{t.innerHTML=s},2e3),console.log(`[SidePanel] Word 文档导出成功`)}catch(e){console.error(`[SidePanel] 导出 Word 失败:`,e),L(`导出失败: `+e.message,`error`)}}function Jn(e,t){try{let n=e.dataset.rawMarkdown||e.dataset.rawContent||``;if(!n){let t=e.querySelector(`.markdown-body`);n=t?t.innerText:e.innerText}let r=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
...
`),t.dispatchEvent(new Event(`input`)),console.log(`[SidePanel] 已移除输入框中的选中内容前缀`))}F.lastSelectedText=``,F.currentSelectionRange=null}function Zn(){let e=document.getElementById(`promptManageList`).querySelectorAll(`.prompt-manage-item`);e.forEach(t=>{t.addEventListener(`dragstart`,e=>{F.draggedItemIndex=parseInt(t.dataset.index),t.classList.add(`dragging`),e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`text/plain`,F.draggedItemIndex)}),t.addEventListener(`dragend`,()=>{t.classList.remove(`dragging`),e.forEach(e=>e.classList.remove(`drag-over`)),F.draggedItemIndex=null}),t.addEventListener(`dragover`,e=>{e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`drag-over`)}),t.addEventListener(`dragleave`,()=>{t.classList.remove(`drag-over`)}),t.addEventListener(`drop`,e=>{e.stopPropagation(),e.preventDefault();let n=parseInt(t.dataset.index);if(F.draggedItemIndex!==null&&F.draggedItemIndex!==n){let e=F.customPrompts[F.draggedItemIndex];F.customPrompts.splice(F.draggedItemIndex,1),F.customPrompts.splice(n,0,e),chrome.storage.local.set({customPrompts:F.customPrompts}),Z()}t.classList.remove(`drag-over`)})})}function Qn(){let e=document.querySelector(`.input-toolbar-right`);if(!e)return;let t=document.createElement(`button`);t.className=`prompt-manage-btn`,t.title=`提示词管理`,t.innerHTML=`<svg t="1781177976746" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5076" width="16" height="16"><path d="M674.56 231.552l101.568 56.96-56.896-101.632 56.96-101.568-101.632 56.896-101.632-56.896 56.96 101.568-56.896 101.632 101.568-56.96zM186.944 629.76l-101.504-56.896 56.832 101.632-56.832 101.568 101.504-56.96 101.632 56.96-56.896-101.568 56.896-101.568-101.568 56.832zM85.44 85.312l56.832 101.568-56.832 101.632 101.504-56.96 101.632 56.96L231.68 186.88l56.896-101.568-101.568 56.896-101.568-56.896z m351.872 438.016l-99.2-99.136L424.32 337.984l99.072 99.264-86.08 86.144m-41.856-223.04L300.352 395.392a40.448 40.448 0 0 0 0 57.28l474.24 474.112a40.448 40.448 0 0 0 57.344 0l94.912-95.04a40.448 40.448 0 0 0 0-57.344L452.736 300.288a40.448 40.448 0 0 0-57.28 0z" p-id="5077" fill="#777"></path></svg>`,t.addEventListener(`click`,()=>{or()}),e.appendChild(t)}function $n(e=``){let t=document.getElementById(`promptSelector`),n=document.getElementById(`promptDropdown`);t.style.display=`block`,n.classList.add(`show`),nr(e)}function X(){let e=document.getElementById(`promptSelector`),t=document.getElementById(`promptDropdown`);e.style.display=`none`,t.classList.remove(`show`),F.selectedPromptIndex=-1}function er(){let e=document.getElementById(`promptSelector`),t=document.getElementById(`promptDropdown`),n=document.getElementById(`userInput`);e.style.display!==`none`&&t.classList.contains(`show`)?X():($n(),n.focus())}function tr(e=``){nr(e)}function nr(e=``){let t=document.getElementById(`promptList`),n=e.toLowerCase(),r=F.customPrompts.filter(t=>e?t.code.toLowerCase().includes(n)||t.content.toLowerCase().includes(n):!0);if(r.length===0){t.innerHTML=`<div class="prompt-empty">暂无匹配的提示词</div>`,F.selectedPromptIndex=-1;return}F.selectedPromptIndex=0,t.innerHTML=r.map((e,t)=>`
  ...
  `).join(``),t.querySelectorAll(`.prompt-item`).forEach(e=>{e.addEventListener(`click`,t=>{let n=e.dataset.code;t.ctrlKey||t.metaKey?ir(n):ar(n)})})}function rr(e){e.forEach((e,t)=>{t===F.selectedPromptIndex?e.classList.add(`selected`):e.classList.remove(`selected`)})}function ir(e){let t=F.customPrompts.find(t=>t.code===e);if(!t)return;let n=document.getElementById(`userInput`),r=n.value,i=r.lastIndexOf(`/`),a=r;if(i!==-1){let e=-1;for(let t=i-1;t>=0;t--)if(r[t]===`
`){e=t;break}a=e===-1?r.substring(0,i).trimEnd():r.substring(0,e+1).trimEnd()}n.value=a+(a&&!a.endsWith(`
`)?`

`:``)+t.content,n.focus(),n.selectionStart=n.selectionEnd=n.value.length,X(),Ae(),console.log(`[SidePanel] 已追加提示词到输入框:`,t.code,t.content)}async function ar(e){let t=F.customPrompts.find(t=>t.code===e);if(!t)return;if(F.isGenerating){console.log(`[SidePanel] 正在生成中，请稍候...`);return}X();let n=document.getElementById(`chatContainer`).querySelector(`.welcome-message`);n&&n.remove();let r=t.content,i=F.enableSelectionQuery&&F.selectedContextText&&F.selectedContextText.trim(),a=F.quotedContextText&&F.quotedContextText.trim();if(a){let e=F.quotedContextText.trim();r=`[引用内容]\n${e}\n\n[用户问题]\n${t.content}`,q(`quoted`,e,!1),F.quotedContextText=``}else if(i){let e=F.selectedContextText.trim();r=`[选中内容]\n${e}\n\n[用户问题]\n${t.content}`,q(`selected`,e,!1),F.selectedContextText=``}(i||a)&&Xn(),J(`user`,t.content),F.messageHistory.push({role:`user`,content:r}),K(),Re(t.content);let o=document.getElementById(`userInput`);o.value=``,o.style.height=`auto`,F.isGenerating=!0;let s=document.getElementById(`sendBtn`);s.disabled=!0;let c=Vn(),l=F.activeSessionId,u=F.currentModel;try{await Fe(),console.log(`[SidePanel] 发送消息调试信息:`),console.log(`  - isolateChat:`,F.isolateChat),console.log(`  - chatConfig:`,F.chatConfig),console.log(`  - messageHistory.length:`,F.messageHistory.length);let e=[{role:`system`,content:Me()}];if(F.isolateChat){let t=F.messageHistory;F.chatConfig.maxMemoryMessages!==null&&F.chatConfig.maxMemoryMessages!==void 0&&F.chatConfig.maxMemoryMessages>0?(t=[...F.messageHistory.slice(0,-1).slice(-F.chatConfig.maxMemoryMessages),F.messageHistory[F.messageHistory.length-1]],console.log(`[SidePanel] 记忆历史限制生效:`,F.chatConfig.maxMemoryMessages,`条（不含当前消息），实际发送:`,t.length,`条`)):console.log(`[SidePanel] 记忆历史限制未生效:`,F.chatConfig.maxMemoryMessages),e=[...e,...t]}else e.push({role:`user`,content:r});let t=await Ne(),n,i;try{let r=await Hn(e,u,F.useTools,t);n=r.content,i=r.executionLog||[]}catch(e){throw Y(c),n=`❌ 请求失败：`+(e.message||`未知错误`),i=e.executionLog||[],J(`assistant`,n,!0,i),F.messageHistory.push({role:`assistant`,content:n,executionLog:i}),K(),e}Y(c),await Bt(J(`assistant`,n,!0,i)),F.messageHistory.push({role:`assistant`,content:n,executionLog:i}),K()}catch{}finally{F.generatingSessionIds.delete(l),s.disabled=!1,o.focus()}}function or(){document.getElementById(`promptManageModal`).classList.add(`show`),Z()}function sr(){document.getElementById(`promptManageModal`).classList.remove(`show`);let e=document.getElementById(`editPromptIndex`),t=document.getElementById(`newPromptCode`),n=document.getElementById(`newPromptContent`),r=document.getElementById(`promptManageAddBtn`);e&&(e.value=``),t&&(t.value=``),n&&(n.value=``),r&&(r.textContent=`添加提示词`,r.style.background=`#667eea`)}function Z(){let e=document.getElementById(`promptManageList`);if(F.customPrompts.length===0){e.innerHTML=`<div class="prompt-empty">暂无提示词，请添加</div>`;return}e.innerHTML=F.customPrompts.map((e,t)=>`
  ...
  `).join(``),e.querySelectorAll(`.move-up-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.dataset.index);if(n>0){let e=F.customPrompts[n];F.customPrompts[n]=F.customPrompts[n-1],F.customPrompts[n-1]=e,chrome.storage.local.set({customPrompts:F.customPrompts}),Z()}})}),e.querySelectorAll(`.move-down-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.dataset.index);if(n<F.customPrompts.length-1){let e=F.customPrompts[n];F.customPrompts[n]=F.customPrompts[n+1],F.customPrompts[n+1]=e,chrome.storage.local.set({customPrompts:F.customPrompts}),Z()}})}),e.querySelectorAll(`.menu-toggle-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.dataset.index);F.customPrompts[n].enabledInMenu=!F.customPrompts[n].enabledInMenu,chrome.storage.local.set({customPrompts:F.customPrompts}),Z()})}),e.querySelectorAll(`.edit-btn`).forEach(e=>{e.addEventListener(`click`,()=>{dr(parseInt(e.dataset.index))})}),e.querySelectorAll(`.delete-btn`).forEach(e=>{e.addEventListener(`click`,()=>{fr(parseInt(e.dataset.index))})}),Zn()}function cr(e){let t=document.getElementById(`promptErrorModal`),n=document.getElementById(`promptErrorMessage`);n.textContent=e,t.classList.add(`show`)}function lr(){document.getElementById(`promptErrorModal`).classList.remove(`show`)}function ur(){let e=document.getElementById(`editPromptIndex`),t=document.getElementById(`newPromptCode`),n=document.getElementById(`newPromptContent`),r=t.value.trim(),i=n.value.trim();if(!r||!i){cr(`请填写编码和内容`);return}let a=e?parseInt(e.value):-1,o=F.customPrompts.findIndex(e=>e.code===r);if(o!==-1&&o!==a){cr(`编码已存在`);return}a>=0&&a<F.customPrompts.length?F.customPrompts[a]={...F.customPrompts[a],code:r,content:i}:F.customPrompts.push({code:r,content:i,enabledInMenu:!1}),chrome.storage.local.set({customPrompts:F.customPrompts}),t.value=``,n.value=``,e&&(e.value=``);let s=document.getElementById(`promptManageAddBtn`);s.textContent=`添加提示词`,s.style.background=`#667eea`,Z()}function dr(e){let t=F.customPrompts[e];if(!t)return;let n=document.getElementById(`editPromptIndex`),r=document.getElementById(`newPromptCode`),i=document.getElementById(`newPromptContent`),a=document.getElementById(`promptManageAddBtn`);n&&(n.value=e),r.value=t.code,i.value=t.content,a.textContent=`保存修改`,a.style.background=`#ffa502`,r.scrollIntoView({behavior:`smooth`})}function fr(e){let t=F.customPrompts[e];if(!t)return;F.pendingDeleteIndex=e;let n=document.getElementById(`deleteConfirmModal`),r=document.getElementById(`deleteConfirmMessage`);r.textContent=`确定要删除提示词 "/${t.code}" 吗？`,n.classList.add(`show`)}function pr(){document.getElementById(`deleteConfirmModal`).classList.remove(`show`),F.pendingDeleteIndex=-1}function mr(e){F.customPrompts.splice(e,1),chrome.storage.local.set({customPrompts:F.customPrompts}),Z()}function hr(){let e=document.getElementById(`promptManageCancelBtn`),t=document.getElementById(`promptManageAddBtn`),n=document.getElementById(`promptModalCloseBtn`);e&&e.addEventListener(`click`,sr),t&&t.addEventListener(`click`,ur),n&&n.addEventListener(`click`,sr);let r=document.getElementById(`deleteCancelBtn`),i=document.getElementById(`deleteConfirmBtn`);r&&r.addEventListener(`click`,pr),i&&i.addEventListener(`click`,()=>{F.pendingDeleteIndex>=0&&mr(F.pendingDeleteIndex),pr()});let a=document.getElementById(`deleteConfirmModal`);a&&a.addEventListener(`click`,e=>{e.target===a&&pr()});let o=document.getElementById(`promptErrorConfirmBtn`);o&&o.addEventListener(`click`,lr);let s=document.getElementById(`promptErrorModal`);s&&s.addEventListener(`click`,e=>{e.target===s&&lr()})}function gr(){let e=document.getElementById(`toolsPopupOverlay`);if(!e)return;F.currentCategory=`all`,F.currentSearch=``;let t=document.getElementById(`toolsSearchInput`);t&&(t.value=``),Cr(),Q(),chrome.storage.local.get([`enableToolPreselect`],e=>{let t=document.getElementById(`toolsPreselectToggle`);t&&(t.checked=e.enableToolPreselect===void 0?!0:e.enableToolPreselect)}),document.querySelectorAll(`.category-btn`).forEach(e=>{e.classList.remove(`active`),e.classList.contains(`category-all`)?(e.classList.add(`active`),e.style.background=`linear-gradient(135deg, #667eea 0%, #764ba2 100%)`,e.style.color=`white`,e.style.borderColor=`transparent`):(e.style.background=`white`,e.style.color=`#555`,e.style.borderColor=`#ececec`)}),vr(),e.classList.add(`show`),console.log(`[SidePanel] 打开工具弹窗`)}function _r(){let e=document.getElementById(`toolsPopupOverlay`);e&&(document.querySelectorAll(`.category-btn`).forEach(e=>{e.classList.remove(`active`),e.style.background=``,e.style.color=``,e.style.borderColor=``}),e.classList.remove(`show`),console.log(`[SidePanel] 关闭工具弹窗`))}function vr(){let t=document.getElementById(`toolsPopupList`);if(!t)return;t.innerHTML=``;let n={};e.forEach(e=>{if(F.currentCategory!==`all`&&e.category!==F.currentCategory)return;if(F.currentSearch){let t=e.name.toLowerCase().includes(F.currentSearch),n=e.description.toLowerCase().includes(F.currentSearch);if(!t&&!n)return}let t=e.category||`other`;n[t]||(n[t]=[]),n[t].push(e)});let r=ke;if(Oe.forEach(i=>{let a=n[i];if(!a||a.length===0)return;let o=e.filter(e=>e.category===i),s=o.length,c=o.filter(e=>F.enabledTools.includes(e.id)).length,l=document.createElement(`div`);l.className=`popup-tool-category-group`,l.dataset.category=i;let u=document.createElement(`div`);u.className=`popup-tool-category`,u.dataset.category=i;let d=F.collapsedCategories[i]||!1;u.innerHTML=`
      <span class="category-expand-icon">${d?`▶`:`▼`}</span>
      <span class="category-name">${r[i]||i}</span>
      <span class="category-count">${c}/${s}</span>
    `,u.addEventListener(`click`,()=>{yr(i)}),l.appendChild(u);let f=document.createElement(`div`);f.className=`popup-tool-items ${d?`collapsed`:``}`,a.forEach(e=>{let t=F.enabledTools.includes(e.id),n=document.createElement(`div`);n.className=`popup-tool-item`,n.dataset.category=i,n.innerHTML=`
    ...
    `).join(``),d.querySelectorAll(`.temp-preset-item`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),_(parseInt(e.dataset.index))})})}function _(e){let t=I[e];t&&(F.selectedTempIndex=e,F.temperature=t.temp,h(),chrome.storage.local.set({temperature:F.temperature,topP:F.topP,selectedTempIndex:F.selectedTempIndex}))}f.addEventListener(`input`,e=>{e.stopPropagation();let t=parseFloat(e.target.value);isNaN(t)&&(t=0),t=Math.max(0,Math.min(1,t)),F.temperature=t,p.value=t.toFixed(2);let n=document.getElementById(`tempIconValue`);n&&(n.textContent=t.toFixed(2));let r=0,i=Math.abs(I[0].temp-t);for(let e=1;e<I.length;e++){let n=Math.abs(I[e].temp-t);n<i&&(i=n,r=e)}F.selectedTempIndex=r,g(),chrome.storage.local.set({temperature:F.temperature,topP:F.topP,selectedTempIndex:F.selectedTempIndex})}),p.addEventListener(`change`,e=>{e.stopPropagation();let t=parseFloat(e.target.value);isNaN(t)&&(t=0),t=Math.max(0,Math.min(1,t)),F.temperature=t,f.value=t,p.value=t.toFixed(2);let n=0,r=Math.abs(I[0].temp-t);for(let e=1;e<I.length;e++){let i=Math.abs(I[e].temp-t);i<r&&(r=i,n=e)}F.selectedTempIndex=n,g(),chrome.storage.local.set({temperature:F.temperature,topP:F.topP,selectedTempIndex:F.selectedTempIndex})}),l&&u&&(l.addEventListener(`click`,e=>{e.stopPropagation(),u.classList.toggle(`show`)}),document.addEventListener(`click`,e=>{let t=document.querySelector(`.temp-selector`);t&&!t.contains(e.target)&&u.classList.remove(`show`)})),c.addEventListener(`mousedown`,e=>{F.lastMouseX=e.clientX,F.lastMouseY=e.clientY}),c.addEventListener(`mouseup`,e=>{F.lastMouseX=e.clientX,F.lastMouseY=e.clientY,F.enableSelectionQuery&&setTimeout(()=>{let e=window.getSelection();if(e&&!e.isCollapsed&&e.toString().trim()){let t=e.toString().trim();c.contains(e.anchorNode)&&t!==F.lastSelectedText&&(F.lastSelectedText=t,F.currentSelectionRange=e.getRangeAt(0).cloneRange(),Ar(t),jr(e,t,F.lastMouseX,F.lastMouseY))}else c.contains(e.anchorNode)||(F.lastSelectedText=``,F.currentSelectionRange=null,window.hideFloatingMenu())},10)});let v=``,y=null;async function b(){try{let e=await new Promise(e=>{chrome.tabs.query({active:!0,currentWindow:!0},t=>e(t))});if(e&&e.length>0){let t=await new Promise(t=>{chrome.tabs.sendMessage(e[0].id,{action:`getSelectedText`},e=>{chrome.runtime.lastError?(console.debug(`[SidePanel] content script 未加载或无法通信:`,chrome.runtime.lastError.message),t(null)):t(e)})});if(!t)return;let n=t?.text||``;n&&n.trim()?n!==v&&(v=n,Ar(n.trim())):v=``}}catch{}}function x(){y&&=(clearInterval(y),null),F.enableSelectionQuery&&(y=setInterval(b,500))}x(),chrome.storage.onChanged.addListener((e,t)=>{t===`local`&&`enableSelectionQuery`in e&&(F.enableSelectionQuery=e.enableSelectionQuery.newValue,x())}),chrome.storage.local.get([`modelName`,`customModels`,`customPrompts`,`systemPrompt`,`inputHistory`,`agentPlatform`],e=>{let t=e.modelName;t&&(F.currentModel=t),F.customPrompts=e.customPrompts||[],F.systemPrompt=e.systemPrompt||``,F.inputHistory=e.inputHistory||[],e.agentPlatform&&(F.agentPlatform=e.agentPlatform),Qn(),kr(e.customModels,()=>{t&&Or(t)})}),chrome.storage.onChanged.addListener((e,t)=>{if(t===`local`){if(e.customModels){let t=e.customModels.newValue||[],n=u.querySelector(`.model-section`);n&&n.querySelectorAll(`.model-option`).forEach(e=>{let t=e.dataset.value;t!==`deepseek-v4-pro`&&t!==`deepseek-v4-flash`&&e.remove()}),kr(t)}if(e.modelName){let t=e.modelName.newValue;t&&(F.currentModel=t,Or(t))}}}),bn(),document.addEventListener(`session-switched`,()=>{let e=document.getElementById(`chatContainer`),t=document.getElementById(`sendBtn`),n=document.getElementById(`userInput`);if(!e)return;if(F.executionLogListener&&=(chrome.runtime.onMessage.removeListener(F.executionLogListener),null),t&&(t.disabled=F.isGenerating),n&&n.focus(),e.innerHTML=``,!F.messageHistory||F.messageHistory.length===0){let t=document.createElement(`div`);t.className=`welcome-message`,t.innerHTML=`
        <div class="icon-wrapper">
          <div class="icon">💬</div>
        </div>
        <h2>开始对话</h2>
        <p>输入您的问题，AI 助手将为您解答</p>
      `,e.appendChild(t)}else F.messageHistory.forEach(e=>{J(e.role,e.content,!1,e.executionLog||[])}),Pt();let r=F.pendingCallApiSessionIds.has(F.activeSessionId)&&!!F.pendingCancelApi;if(console.log(`[SidePanel] session-switched: pendingTask?`,r,`pendingSessionIds:`,[...F.pendingCallApiSessionIds],`activeSessionId:`,F.activeSessionId,`hasCancelApi:`,!!F.pendingCancelApi),r){console.log(`[SidePanel] 切回有后台任务的会话，显示加载状态`);let e=Vn();F.substituteLoadingIds.set(F.activeSessionId,e)}let i=`scrollPosition_`+(F.activeSessionId||`default`);chrome.storage.local.get([i],e=>{e[i]!==void 0&&setTimeout(()=>{let t=document.getElementById(`chatContainer`);t&&(t.scrollTop=e[i])},150)})}),document.querySelectorAll(`.model-option`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.dataset.value;F.currentModel=n,Or(n),chrome.storage.local.set({modelName:n})})}),document.addEventListener(`click`,e=>{let t=document.getElementById(`promptDropdown`),n=document.getElementById(`promptSelector`),r=document.getElementById(`selectionFloatingMenu`);if(n.contains(e.target)||(t.classList.remove(`show`),X()),r&&!r.contains(e.target)){let t=window.getSelection(),n=c.contains(e.target),r=t&&!t.isCollapsed&&c.contains(t.anchorNode);(!n||!r)&&window.hideFloatingMenu()}}),a.addEventListener(`click`,Tn);let S=document.getElementById(`promptTriggerBtn`);S&&S.addEventListener(`click`,e=>{e.stopPropagation(),S.blur(),er()}),document.addEventListener(`keydown`,e=>{if((e.ctrlKey||e.metaKey)&&e.key===`t`){e.preventDefault();let t=document.getElementById(`toolsPopup`);t&&t.style.display!==`none`?_r():gr()}}),i.addEventListener(`keydown`,e=>{let t=document.getElementById(`promptSelector`),n=document.getElementById(`promptDropdown`);if(t.style.display!==`none`&&n.classList.contains(`show`)){let t=n.querySelectorAll(`.prompt-item`),r=t.length;if(r!==0&&e.key===`ArrowDown`){e.preventDefault(),F.selectedPromptIndex<0?F.selectedPromptIndex=0:F.selectedPromptIndex=(F.selectedPromptIndex+1)%r,rr(t);return}if(e.key===`ArrowUp`){e.preventDefault(),F.selectedPromptIndex<0||F.selectedPromptIndex===0?F.selectedPromptIndex=r-1:--F.selectedPromptIndex,rr(t);return}if(e.key===`Enter`&&(e.ctrlKey||e.metaKey)&&F.selectedPromptIndex>=0){e.preventDefault();let n=t[F.selectedPromptIndex].dataset.code;ir(n);return}if(e.key===`Enter`&&F.selectedPromptIndex>=0){e.preventDefault();let n=t[F.selectedPromptIndex].dataset.code;ar(n);return}if(e.key===`Escape`){X();return}}if(e.key===`Escape`){F.inputHistoryIndex>=0&&(F.inputHistoryIndex=-1),i.value&&(i.value=``,i.style.height=`auto`,i.dispatchEvent(new Event(`input`))),e.preventDefault();return}if(!(t.style.display!==`none`&&n.classList.contains(`show`))&&!F.isGenerating){if(e.key===`ArrowUp`){e.preventDefault(),F.inputHistoryIndex===-1?F.inputHistoryIndex=F.inputHistory.length-1:F.inputHistoryIndex>0&&F.inputHistoryIndex--,F.inputHistoryIndex<0&&(F.inputHistoryIndex=0),F.inputHistoryIndex>=0&&F.inputHistory.length>0&&(i.value=F.inputHistory[F.inputHistoryIndex],i.dispatchEvent(new Event(`input`)));return}if(e.key===`ArrowDown`){e.preventDefault(),F.inputHistoryIndex>=0&&F.inputHistoryIndex<F.inputHistory.length-1?(F.inputHistoryIndex++,i.value=F.inputHistory[F.inputHistoryIndex],i.dispatchEvent(new Event(`input`))):(F.inputHistoryIndex=-1,i.value=``,i.dispatchEvent(new Event(`input`)));return}}e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),Tn())}),i.addEventListener(`wheel`,e=>{F.isScrolling=!0;let t=i.style.height||i.offsetHeight+`px`;i.style.height=t,i.scrollHeight<=i.clientHeight+10&&(e.preventDefault(),e.stopPropagation()),setTimeout(()=>{F.isScrolling=!1},100)},{passive:!1}),i.addEventListener(`input`,e=>{let t=i.value;document.getElementById(`promptSelector`),document.getElementById(`promptDropdown`);let n=t.lastIndexOf(`/`);if(n!==-1){let e=t.substring(n+1);n===0||t[n-1]===`
`||t[n-1]===` `?$n(e):tr(e)}else X();m()}),c.addEventListener(`scroll`,()=>{let e=`scrollPosition_`+(F.activeSessionId||`default`);chrome.storage.local.set({[e]:c.scrollTop})});let C=document.getElementById(`headerMoreBtn`),w=document.getElementById(`headerMoreDropdown`);C&&w&&(C.addEventListener(`click`,e=>{e.stopPropagation(),w.classList.toggle(`show`)}),document.addEventListener(`click`,e=>{!w.contains(e.target)&&e.target!==C&&w.classList.remove(`show`)})),o.addEventListener(`click`,e=>{e.stopPropagation(),w.classList.remove(`show`),Cn()}),s&&s.addEventListener(`click`,e=>{e.stopPropagation(),w.classList.remove(`show`),Sn()});let ee=document.getElementById(`settingsBtn`);ee&&ee.addEventListener(`click`,()=>{chrome.runtime.openOptionsPage()});let te=document.getElementById(`prototypeLibraryBtn`);te&&te.addEventListener(`click`,e=>{e.stopPropagation(),w.classList.remove(`show`),gt()});let T=document.getElementById(`isolateChatBtn`),E=document.getElementById(`enableToolsBtn`),D=document.getElementById(`toolsConfigBtn`);chrome.storage.local.get([`isolateChat`,`enableSelectionQuery`,`enableTools`,`enabledTools`],t=>{t.isolateChat!==void 0&&(F.isolateChat=t.isolateChat),T.checked=F.isolateChat,t.enableSelectionQuery!==void 0&&(F.enableSelectionQuery=t.enableSelectionQuery);let n=document.getElementById(`enableSelectionQueryBtn`);if(n&&(n.checked=F.enableSelectionQuery),t.enableTools!==void 0&&(F.useTools=t.enableTools),t.enabledTools&&t.enabledTools.length>0){let n=new Set(e.map(e=>e.id)),r=t.enabledTools.filter(e=>n.has(e)),i=e.filter(e=>e.enabled&&!r.includes(e.id)).map(e=>e.id);F.enabledTools=[...r,...i],i.length>0&&chrome.storage.local.set({enabledTools:F.enabledTools})}else F.enabledTools=e.filter(e=>e.enabled).map(e=>e.id);F.enabledTools.length===0&&(F.useTools=!1),E&&(E.checked=F.useTools),x()}),T.addEventListener(`change`,()=>{F.isolateChat=T.checked,chrome.storage.local.set({isolateChat:F.isolateChat}),console.log(`[SidePanel] 记忆对话:`,F.isolateChat?`已启用`:`已禁用`)});let O=document.getElementById(`enableSelectionQueryBtn`);O&&O.addEventListener(`change`,()=>{F.enableSelectionQuery=O.checked,chrome.storage.local.set({enableSelectionQuery:F.enableSelectionQuery}),console.log(`[SidePanel] 划词问答:`,F.enableSelectionQuery?`已启用`:`已禁用`),!F.enableSelectionQuery&&F.selectedContextText&&yn()}),E&&E.addEventListener(`change`,()=>{F.useTools=E.checked,chrome.storage.local.set({enableTools:F.useTools}),F.useTools&&F.enabledTools.length===0&&(F.enabledTools=e.filter(e=>e.enabled).map(e=>e.id),chrome.storage.local.set({enabledTools:F.enabledTools})),console.log(`[SidePanel] 工具总开关:`,F.useTools?`已启用`:`已禁用`)}),D&&D.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),gr()});let ne=document.getElementById(`toolsPopupOverlay`),re=document.getElementById(`toolsPopupClose`),ie=ne?ne.querySelector(`.modal-container`):null;re&&re.addEventListener(`click`,_r),ie&&ie.addEventListener(`click`,e=>{e.stopPropagation()});let ae=document.getElementById(`toolsSearchInput`);ae&&ae.addEventListener(`input`,e=>{F.currentSearch=e.target.value.toLowerCase(),vr()});let oe=document.querySelectorAll(`.category-btn`);oe.forEach(e=>{e.addEventListener(`click`,()=>{oe.forEach(e=>{e.classList.remove(`active`),e.classList.contains(`category-all`)?(e.style.background=`#f5f3ff`,e.style.color=`#667eea`,e.style.borderColor=`#d4cfff`):(e.style.background=`white`,e.style.color=`#555`,e.style.borderColor=`#ececec`)}),e.classList.add(`active`),e.style.background=`linear-gradient(135deg, #667eea 0%, #764ba2 100%)`,e.style.color=`white`,e.style.borderColor=`transparent`,F.currentCategory=e.dataset.category,vr()})});let k=document.getElementById(`toolsCategories`);k&&k.addEventListener(`wheel`,e=>{e.preventDefault(),k.scrollLeft+=e.deltaY*2},{passive:!1});let se=document.getElementById(`toolsSelectAll`),ce=document.getElementById(`toolsSelectNone`);se&&se.addEventListener(`click`,()=>{xr().forEach(e=>{let t=document.getElementById(`tool_`+e.id);t&&(t.checked=!0),F.enabledTools.includes(e.id)||F.enabledTools.push(e.id)}),Sr(),Cr(),Q()}),ce&&ce.addEventListener(`click`,()=>{xr().forEach(e=>{let t=document.getElementById(`tool_`+e.id);t&&(t.checked=!1);let n=F.enabledTools.indexOf(e.id);n>-1&&F.enabledTools.splice(n,1)}),Sr(),Cr(),Q()});let le=document.getElementById(`toolsPopupSave`);le&&le.addEventListener(`click`,()=>{wr(),Q()});let A=document.getElementById(`toolsPreselectToggle`);A&&A.addEventListener(`change`,()=>{chrome.storage.local.set({enableToolPreselect:A.checked},()=>{console.log(`[SidePanel] 工具预筛选开关已更新:`,A.checked)})});let ue=document.getElementById(`toolsPopupCancel`);ue&&ue.addEventListener(`click`,()=>{_r()});let de=document.getElementById(`modalCancelBtn`),j=document.getElementById(`modalConfirmBtn`);function fe(e,t=`确认操作`){return new Promise(n=>{let r=document.getElementById(`customConfirmOverlay`),i=document.getElementById(`customConfirmTitle`),a=document.getElementById(`customConfirmMessage`),o=document.getElementById(`customConfirmCancelBtn`),s=document.getElementById(`customConfirmOkBtn`);if(!r||!i||!a||!o||!s){n(confirm(e));return}let c=()=>{r.style.display=`none`,s.removeEventListener(`click`,l),o.removeEventListener(`click`,u),r.removeEventListener(`click`,d)},l=()=>{c(),n(!0)},u=()=>{c(),n(!1)},d=e=>{e.target===r&&(c(),n(!1))};i.textContent=t,a.textContent=e,r.style.display=`flex`,s.addEventListener(`click`,l),o.addEventListener(`click`,u),r.addEventListener(`click`,d)})}let M=document.getElementById(`toolStatsOverlay`),N=document.getElementById(`toolStatsClose`),pe=document.getElementById(`toolStatsBtn`);function me(){M&&(M.style.display=`flex`,P())}function he(){M&&(M.style.display=`none`)}pe&&pe.addEventListener(`click`,e=>{e.stopPropagation(),me()}),N&&N.addEventListener(`click`,he),M&&M.addEventListener(`click`,e=>{e.target===M&&he()});let ge=document.getElementById(`toolStatsRefreshBtn`);ge&&ge.addEventListener(`click`,P);let _e=document.getElementById(`toolStatsClearBtn`);_e&&_e.addEventListener(`click`,async()=>{await fe(`确定要清空所有工具使用统计吗？此操作不可撤销。`,`清空统计`)&&(await chrome.storage.local.remove([`toolUsageStats`]),P())});async function P(){let e=document.getElementById(`toolStatsTable`),t=document.getElementById(`toolStatsTableBody`),n=document.getElementById(`toolStatsLoading`),r=document.getElementById(`toolStatsEmpty`);if(!(!e||!t||!n||!r)){e.style.display=`none`,r.style.display=`none`,n.style.display=``;try{let i=(await chrome.storage.local.get([`toolUsageStats`])).toolUsageStats||{},a=Object.entries(i);if(a.length===0){n.style.display=`none`,r.style.display=``;return}a.sort((e,t)=>t[1].callCount-e[1].callCount),t.innerHTML=a.map(([e,t])=>{let n=t.callCount>0?t.successCount/t.callCount*100:0,r=t.callCount>0?t.totalDuration/t.callCount:0,i=`#38a169`;n<60?i=`#e53e3e`:n<85&&(i=`#d69e2e`);let a=r<1e3?`${Math.round(r)}ms`:`${(r/1e3).toFixed(1)}s`;return`<tr>
          <td style="padding: 6px 10px; border-bottom: 1px solid #eee; color: #333;"><code>${e}</code></td>
          <td style="padding: 6px 10px; text-align: right; border-bottom: 1px solid #eee; color: #666;">${t.callCount}</td>
          <td style="padding: 6px 10px; text-align: right; border-bottom: 1px solid #eee; color: #666;">${t.successCount}</td>
          <td style="padding: 6px 10px; border-bottom: 1px solid #eee;">
            <span style="display: inline-block; width: 50px; height: 5px; border-radius: 3px; background: #e0e0e0; vertical-align: middle; margin-right: 6px;">
              <span style="display: inline-block; width: ${n*.5}px; height: 5px; border-radius: 3px; background: ${i}; vertical-align: top;"></span>
            </span>
            <span style="font-size: 12px; color: ${i}; font-weight: 500;">${n.toFixed(0)}%</span>
          </td>
          <td style="padding: 6px 10px; text-align: right; border-bottom: 1px solid #eee; color: #888; font-size: 12px;">${a}</td>
        </tr>`}).join(``),n.style.display=`none`,e.style.display=``}catch(e){console.error(`[SidePanel] 加载统计失败:`,e),n.style.display=`none`,r.textContent=`加载失败`,r.style.display=``}}}de.addEventListener(`click`,()=>{wn()}),j.addEventListener(`click`,()=>{wn(),xn()});let ve=document.getElementById(`confirmModal`);ve.addEventListener(`click`,e=>{e.target===ve&&wn()});let ye=document.getElementById(`selectionClose`);ye&&ye.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),console.log(`[SidePanel] 用户点击关闭选中内容按钮`),yn(),window.hideFloatingMenu(),F.lastSelectedText=``,F.currentSelectionRange=null}),i.addEventListener(`input`,()=>{})}),Pe().then(()=>$()),document.addEventListener(`DOMContentLoaded`,()=>{Dr()}),document.addEventListener(`DOMContentLoaded`,Be),document.addEventListener(`DOMContentLoaded`,hr),document.addEventListener(`DOMContentLoaded`,tt),document.addEventListener(`DOMContentLoaded`,at),document.addEventListener(`DOMContentLoaded`,kt);
//# sourceMappingURL=side_panel-BCNeQ4a_.js.map