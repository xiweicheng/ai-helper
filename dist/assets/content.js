...
`).length}),p[0].length===0&&u.lastIndex++}if(s&&f.length>0){g();let e=document.createElement(`style`);e.id=`ai-helper-highlight-style`,e.textContent=`
      ...
      `,document.head.appendChild(e),document.body.innerHTML=document.body.innerHTML.replace(new RegExp(c.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),l),`<span class="ai-helper-search-highlight">$&</span>`)}return{success:!0,pattern:c,mode:`regex`,total:f.length,matches:f,highlighted:s}}catch(e){return{success:!1,error:e.message}}}function ue(e=null,t=!0,n=!0,r=5e4){try{let i=e?document.querySelector(e):document.body;if(!i)return{success:!1,error:`未找到目标元素`};let a=``,o=(e,r=0)=>{if(r>6)return``;let i=``,a=e.tagName.toLowerCase();switch(a){case`h1`:case`h2`:case`h3`:case`h4`:case`h5`:case`h6`:let s=parseInt(a[1]);i+=`
...
`).length,scrolls:n,startScrollY:l,endScrollY:window.scrollY})}catch(t){e({success:!1,error:t.message})}})}var v=null;function ge(e,n=500,r=3e3){try{if(!e)return{success:!1,error:`选择器不能为空`};let n=e.trim();for(let[e,t]of[[/^"([\s\S]*)"$/,`$1`],[/^'([\s\S]*)'$/,`$1`],[/^`([\s\S]*)`$/,`$1`],[/^"([\s\S]*)"$/,`$1`],[/^'([\s\S]*)'$/,`$1`],[/^「([\s\S]*)」$/,`$1`]])n=n.replace(e,t);let r=t(n);return r?(r.click(),{success:!0,message:`已成功点击元素: ${e}`}):{success:!1,error:`未找到匹配选择器的元素: ${e}`}}catch(e){return{success:!1,error:e.message}}}function _e(e){return e.isContentEditable||e.getAttribute(`contenteditable`)===`true`}function ve(e,t){try{return e.focus(),document.execCommand(`insertText`,!1,t)||(e.textContent=t),e.dispatchEvent(new Event(`input`,{bubbles:!0})),e.dispatchEvent(new Event(`change`,{bubbles:!0})),!0}catch{try{return e.textContent=t,e.dispatchEvent(new Event(`input`,{bubbles:!0})),!0}catch{return!1}}}function ye(e,n=500){try{let n=[];return e.forEach(e=>{let{selector:r,value:i,fieldType:a=`text`}=e,o=t(r);if(!o){n.push({selector:r,success:!1,error:`未找到元素`});return}try{if(a===`text`){if(_e(o)){let e=ve(o,i);n.push({selector:r,success:e,value:i});return}o.value=i,o.dispatchEvent(new Event(`input`,{bubbles:!0})),o.dispatchEvent(new Event(`change`,{bubbles:!0}))}else if(a===`contenteditable`){let e=ve(o,i);n.push({selector:r,success:e,value:i});return}else if(a===`select`){let e=o.querySelector(`option[value="${i}"]`)||Array.from(o.options).find(e=>e.textContent===i);if(e)o.value=e.value,o.dispatchEvent(new Event(`change`,{bubbles:!0}));else{n.push({selector:r,success:!1,error:`未找到匹配的选项`});return}}else if(a===`checkbox`)o.checked=i===`true`||i===!0,o.dispatchEvent(new Event(`change`,{bubbles:!0}));else if(a===`radio`){let e=document.querySelector(`${r}[value="${i}"]`);if(e)e.checked=!0,e.dispatchEvent(new Event(`change`,{bubbles:!0}));else{n.push({selector:r,success:!1,error:`未找到匹配的单选按钮`});return}}n.push({selector:r,success:!0,value:i})}catch(e){n.push({selector:r,success:!1,error:e.message})}}),{success:!0,message:`表单填充完成，成功 ${n.filter(e=>e.success).length}/${e.length} 个字段`,details:n}}catch(e){return{success:!1,error:e.message}}}function be(e){try{let{target:n=`selector`,selector:r,x:i=0,y:a=0,behavior:o=`smooth`,align:s=`center`}=e;if(n===`top`)window.scrollTo({top:0,left:0,behavior:o});else if(n===`bottom`)window.scrollTo({top:document.body.scrollHeight,left:0,behavior:o});else if(n===`coordinates`)window.scrollTo({top:a,left:i,behavior:o});else if(n===`selector`&&r){let e=t(r);if(!e)return{success:!1,error:`未找到元素: ${r}`};e.scrollIntoView({behavior:o,block:s})}else return{success:!1,error:`无效的滚动目标或缺少选择器`};return{success:!0,message:`滚动完成`}}catch(e){return{success:!1,error:e.message}}}function xe(e){if(!e)return!1;if(e.offsetParent===null&&e.tagName!==`BODY`){let t=window.getComputedStyle(e);if(t.display===`none`||t.visibility===`hidden`||t.position!==`fixed`)return!1}let t=window.getComputedStyle(e);if(t.display===`none`||t.visibility===`hidden`||parseFloat(t.opacity)<=0)return!1;let n=e.getBoundingClientRect();if(n.width<=0||n.height<=0)return!1;let r=window.innerHeight||document.documentElement.clientHeight,i=window.innerWidth||document.documentElement.clientWidth;return n.top<r&&n.bottom>0&&n.left<i&&n.right>0}function Se(e,n=`appeared`,r=1e4){return new Promise((i,a)=>{let o=Date.now(),s=()=>{let a=t(e);if(n===`appeared`&&a){i({success:!0,message:`元素 ${e} 已出现`,element:e});return}if(n===`disappeared`&&!a){i({success:!0,message:`元素 ${e} 已消失`});return}if(n===`visible`&&a&&xe(a)){i({success:!0,message:`元素 ${e} 已可见`,element:e});return}if(n===`hidden`&&(!a||!xe(a))){i({success:!0,message:`元素 ${e} 已隐藏`});return}if(Date.now()-o>r){i({success:!1,error:`等待超时（${r}ms），元素 ${e} 未达到 ${n} 状态`});return}setTimeout(s,100)};s()})}function Ce({key:e,text:t,ctrlKey:n=!1,shiftKey:r=!1,altKey:i=!1}){try{let a=document.activeElement;if(!a)return{success:!1,error:`没有聚焦的元素`};if(t){let e=a.tagName===`INPUT`||a.tagName===`TEXTAREA`,n=a.isContentEditable;if(e||n){if(a.focus(),n)try{document.execCommand(`selectAll`,!1,null),document.execCommand(`insertText`,!1,t)}catch{a.textContent+=t}else{let e=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,`value`)||Object.getOwnPropertyDescriptor(HTMLTextAreaElement.prototype,`value`);e&&e.set?e.set.call(a,a.value+t):a.value+=t}try{a.dispatchEvent(new InputEvent(`input`,{bubbles:!0,cancelable:!0,inputType:`insertText`,data:t}))}catch{a.dispatchEvent(new Event(`input`,{bubbles:!0}))}a.dispatchEvent(new Event(`change`,{bubbles:!0}))}}if(e){let t={key:e,code:e.length===1?`Key${e.toUpperCase()}`:e,keyCode:e.toUpperCase().charCodeAt(0),which:e.toUpperCase().charCodeAt(0),bubbles:!0,cancelable:!0,ctrlKey:n,shiftKey:r,altKey:i};document.activeElement.dispatchEvent(new KeyboardEvent(`keydown`,t)),document.activeElement.dispatchEvent(new KeyboardEvent(`keypress`,t)),document.activeElement.dispatchEvent(new KeyboardEvent(`keyup`,t))}return{success:!0,message:`键盘输入成功`}}catch(e){return{success:!1,error:e.message}}}function we(e,n){return new Promise((r,i)=>{try{let i=t(e),a=t(n);if(!i){r({success:!1,error:`未找到源元素: ${e}`});return}if(!a){r({success:!1,error:`未找到目标元素: ${n}`});return}let o=i.getBoundingClientRect(),s=a.getBoundingClientRect(),c=o.left+o.width/2,l=o.top+o.height/2,u=s.left+s.width/2,d=s.top+s.height/2,f=(e,t,n)=>{let r=new DragEvent(e,{bubbles:!0,cancelable:!0,clientX:t,clientY:n,screenX:t,screenY:n});Object.defineProperty(r,"dataTransfer",{value:{getData:()=>``,setData:()=>{},effectAllowed:`all`,dropEffect:`none`}}),document.elementFromPoint(t,n)?.dispatchEvent(r)};f(`dragstart`,c,l),f(`dragenter`,u,d),f(`dragover`,u,d),f(`drop`,u,d),f(`dragend`,c,l),r({success:!0,experimental:!0,message:`[实验性] 已尝试拖拽 ${e} → ${n}（拖拽模拟在浏览器中为部分支持，可能未生效）`})}catch(e){r({success:!1,error:e.message})}})}function Te(e,n,r,i=`application/octet-stream`){try{let a=t(e);if(!a)return{success:!1,error:`未找到文件上传控件: ${e}`};if(a.type!==`file`)return{success:!1,error:`选择的元素不是文件上传控件`};let o;try{let e=atob(r),t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);o=new Blob([t],{type:i})}catch{o=new Blob([r],{type:i})}let s=new File([o],n,{type:i}),c=new DataTransfer;return c.items.add(s),a.files=c.files,a.dispatchEvent(new Event(`change`,{bubbles:!0})),{success:!0,message:`已上传文件: ${n}`}}catch(e){return{success:!1,error:e.message}}}function Ee(e,t,n=null,r=5e3){return new Promise(async i=>{try{let a=document.querySelector(e);if(!a){i({success:!1,error:`未找到触发器: ${e}`});return}if(a.tagName===`SELECT`){let e=a.options;for(let n=0;n<e.length;n++){let r=e[n],o=(r.textContent||r.label||``).trim();if(o===t||o.includes(t)){a.value=r.value,a.dispatchEvent(new Event(`change`,{bubbles:!0})),a.dispatchEvent(new Event(`input`,{bubbles:!0})),i({success:!0,message:`已选择: ${o}`,triggerTag:`SELECT`});return}}i({success:!1,error:`在 <select> 中未找到匹配的选项: "${t}"`,availableOptions:Array.from(e).map(e=>e.textContent?.trim()).filter(Boolean)});return}a.click(),await new Promise(e=>setTimeout(e,300));let o=Date.now(),s=n?document.querySelector(n):document,c=null;for(;Date.now()-o<r;){let e=s.querySelectorAll(`li, [role="option"], [role="menuitem"], .option, .dropdown-item, .select-item, [data-value], div`);for(let n of e){let e=(n.textContent||``).trim();if(!(e.length<2)&&(e===t||e.includes(t)||e.replace(/\s+/g,``)===t.replace(/\s+/g,``))){c=n;break}}if(c)break;await new Promise(e=>setTimeout(e,100))}if(!c){i({success:!1,error:`在 ${r}ms 内未找到匹配选项: "${t}"`});return}c.click(),i({success:!0,message:`已选择: ${c.textContent?.trim()}`,triggerTag:a.tagName})}catch(e){i({success:!1,error:e.message})}})}function De({action:e,storage:t,key:n,value:r}){try{let i=t===`session`?sessionStorage:localStorage;switch(e){case`get`:if(!n){let e={};for(let t=0;t<i.length;t++){let n=i.key(t);e[n]=i.getItem(n)}return{success:!0,content:JSON.stringify(e),data:e}}let t=i.getItem(n);return{success:!0,content:JSON.stringify({key:n,value:t}),value:t};case`set`:return!n||r===void 0?{success:!1,error:`set操作需要提供key和value`}:(i.setItem(n,r),{success:!0,message:`已设置 ${n}`});case`remove`:return n?(i.removeItem(n),{success:!0,message:`已删除 ${n}`}):{success:!1,error:`remove操作需要提供key`};case`clear`:return i.clear(),{success:!0,message:`已清空存储`};default:return{success:!1,error:`未知操作: ${e}`}}}catch(e){return{success:!1,error:e.message}}}function Oe(){return new Promise((e,t)=>{if(!(`EyeDropper`in window)){e({success:!1,error:`您的浏览器不支持 EyeDropper API`});return}new EyeDropper().open().then(t=>{e({success:!0,color:t.sRGBHex,message:`已取色: ${t.sRGBHex}`})}).catch(t=>{t.name===`AbortError`?e({success:!1,error:`用户取消了取色`}):e({success:!1,error:t.message})})})}function ke(e,t=`zh-CN`,n=1,r=1){try{if(!(`speechSynthesis`in window))return{success:!1,error:`您的浏览器不支持语音合成`};v&&speechSynthesis.cancel();let i=new SpeechSynthesisUtterance(e);return i.lang=t,i.rate=n,i.pitch=r,v=i,new Promise(e=>{i.onend=()=>{v=null,e({success:!0,message:`朗读完成`})},i.onerror=t=>{v=null,e({success:!1,error:t.error})},speechSynthesis.speak(i),e({success:!0,message:`开始朗读...`})})}catch(e){return{success:!1,error:e.message}}}function Ae(e,t=null,n=null){try{let r=t?document.querySelector(t):document.querySelector(`video, audio`);if(!r)return{success:!1,error:`未找到视频/音频元素`};switch(e){case`play`:return r.play(),{success:!0,message:`已播放`};case`pause`:return r.pause(),{success:!0,message:`已暂停`};case`toggle`:return r.paused?(r.play(),{success:!0,message:`已播放`}):(r.pause(),{success:!0,message:`已暂停`});case`stop`:return r.pause(),r.currentTime=0,{success:!0,message:`已停止`};case`seek`:return n===null?{success:!1,error:`seek操作需要提供value参数`}:(r.currentTime=n,{success:!0,message:`已跳转到 ${n} 秒`});case`volume`:return n===null?{success:!1,error:`volume操作需要提供value参数`}:(r.volume=Math.max(0,Math.min(1,n)),{success:!0,message:`音量已设置为 ${Math.round(n*100)}%`});case`mute`:return r.muted=!r.muted,{success:!0,message:r.muted?`已静音`:`已取消静音`};case`speed`:return n===null?{success:!1,error:`speed操作需要提供value参数`}:(r.playbackRate=Math.max(.1,Math.min(10,n)),{success:!0,message:`播放速度已设置为 ${n}x`});case`fullscreen`:return r.requestFullscreen?r.requestFullscreen():r.webkitRequestFullscreen?r.webkitRequestFullscreen():r.mozRequestFullScreen&&r.mozRequestFullScreen(),{success:!0,message:`已进入全屏`};default:return{success:!1,error:`未知操作: ${e}`}}}catch(e){return{success:!1,error:e.message}}}function je(e,t){try{let n=document.createElement(`canvas`);n.width=t,n.height=t;let r=n.getContext(`2d`);r.fillStyle=`#FFFFFF`,r.fillRect(0,0,t,t);let i=[];for(let t=0;t<e.length;t++)i.push(e.charCodeAt(t));let a=Math.max(2,Math.floor(t/41)),o=Math.floor(t/a),s=Math.floor((t-o*a)/2);r.fillStyle=`#000000`;let c=(e,t)=>{let n=7*a;r.fillRect(e,t,n,n),r.fillStyle=`#FFFFFF`,r.fillRect(e+a,t+a,n-2*a,n-2*a),r.fillStyle=`#000000`,r.fillRect(e+2*a,t+2*a,n-4*a,n-4*a),r.fillStyle=`#000000`};c(s,s),c(s+(o-7)*a,s),c(s,s+(o-7)*a);let l=0;for(let t=0;t<e.length;t++)l=(l<<5)-l+e.charCodeAt(t),l|=0;let u=e=>{let t=e+1831565813;return t=Math.imul(t^t>>>15,t|1),t^=t+Math.imul(t^t>>>7,t|61),((t^t>>>14)>>>0)/4294967296};for(let e=0;e<o;e++)for(let t=0;t<o;t++){let n=e<8&&t<8,i=e<8&&t>=o-8,c=e>=o-8&&t<8;n||i||c||u(l+e*o+t)>.5&&r.fillRect(s+t*a,s+e*a,a,a)}return n.toDataURL(`image/png`)}catch{return null}}function Me(e=``,t=200,n=`M`,r=!0){return new Promise(i=>{try{let a=e||window.location.href,o=document.createElement(`div`);o.id=`ai-helper-qrcode`,o.style.cssText=`
  ...
  </div>`,B.innerHTML=t,B._clickHandler=e=>{if(e.target.closest(`.aih-dropdown-settings`)){e.stopPropagation(),B.style.display=`none`;try{chrome.runtime.sendMessage({type:`OPEN_OPTIONS_PAGE`,hash:`toolbar`}).catch(()=>{})}catch{}return}if(e.target.closest(`.aih-dropdown-block`)){e.stopPropagation(),e.preventDefault(),B.style.display=`none`,ht();return}if(e.target.closest(`.aih-dropdown-hide`)){e.stopPropagation(),e.preventDefault(),B.style.display=`none`,Le=!0,Q(),J(),M=``;return}let t=e.target.closest(`[data-action]`);t&&(e.stopPropagation(),B.style.display=`none`,ct(t.dataset.action,M))},B.addEventListener(`click`,B._clickHandler),B.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[role="button"]`);t&&(e.preventDefault(),t.click())}})}async function Ke(){if(b)return;await Ve();let e=[...R].sort((e,t)=>e.order-t.order),t=e.find(e=>e.id===`ai-search`),n=e.filter(e=>e.id!==`ai-search`&&e.id!==`copy`),r=n.slice(0,Re-1),i=n.slice(Re-1);b=document.createElement(`div`),b.id=`aih-selection-toolbar`;let a=`<span class="aih-tb-buttons">`;a+=`<span class="aih-tb-grip" title="拖拽移动">${y.grip}</span>`;let o=z;t&&(a+=`<div class="aih-tb-btn primary" role="button" tabindex="0" data-action="ai-search" title="AI 搜索">
  ...
  </span>`,b.innerHTML=a,b.addEventListener(`click`,e=>{if(e.target.closest(`.aih-tb-btn-overflow`)){e.stopPropagation();let t=e.target.closest(`.aih-tb-btn-overflow`).getBoundingClientRect();B&&(B.style.display=B.style.display===`block`?`none`:`block`,B.style.top=t.bottom+4+`px`,B.style.left=t.right-160+`px`);return}let t=e.target.closest(`[data-action]`);if(!t)return;e.stopPropagation();let n=t.dataset.action;ct(n,M)}),b.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[role="button"]`);t&&!t.classList.contains(`aih-tb-ask-send`)&&(e.preventDefault(),t.click())}}),W(b);let s=b.querySelector(`.aih-tb-ask-input`),c=b.querySelector(`.aih-tb-ask-send`);b.querySelector(`.aih-tb-buttons`);let l=()=>{let e=s.value.trim();if(e){let t=w;d(),s.value=``,et(e,t),Q()}},u=()=>{if(C)return;C=!0,w=M||``;let e=window.getSelection();e.rangeCount>0&&(T=e.getRangeAt(0).cloneRange());let t=b.getBoundingClientRect().right;E=b.style.left,b.classList.add(`aih-ask-mode`),b.style.width=`360px`;let n=Math.max(8,t-360);b.style.left=n+`px`,requestAnimationFrame(()=>{if(T){let e=window.getSelection();e.removeAllRanges(),e.addRange(T)}requestAnimationFrame(()=>{s.focus()})})},d=()=>{C&&(C=!1,w=``,T=null,b.classList.remove(`aih-ask-mode`),b.style.width=``,E&&=(b.style.left=E,``))};s.addEventListener(`focus`,()=>{C||u()}),s.addEventListener(`mousedown`,e=>{C||(e.preventDefault(),u())}),s.addEventListener(`blur`,()=>{setTimeout(()=>{C&&!b.contains(document.activeElement)&&(d(),Q())},150)}),s.addEventListener(`keydown`,e=>{e.key===`Escape`?(e.preventDefault(),e.stopPropagation(),d(),s.blur()):e.key===`Enter`&&(e.preventDefault(),e.stopPropagation(),l())}),c.addEventListener(`mousedown`,e=>{e.preventDefault(),e.stopPropagation(),l()}),Be(b,`.aih-tb-grip`)}function qe(){if(x)return;x=document.createElement(`div`),x.id=`aih-selection-result`,x.innerHTML=`
  ...
  `,x.querySelector(`.aih-result-close`).addEventListener(`click`,e=>{e.stopPropagation(),J()}),x.querySelector(`.aih-result-lock`).addEventListener(`click`,e=>{e.stopPropagation(),Qe()}),x.querySelector(`.aih-result-footer`).addEventListener(`click`,e=>{e.stopPropagation();let t=e.target.closest(`[data-action]`)?.dataset?.action;if(t===`regenerate-result`){if(!j||!A)return;$(j,A,Ie)}else t===`copy-result`&&ut()});let e=x.querySelector(`.aih-followup-input`);x.querySelector(`.aih-followup-send`).addEventListener(`click`,t=>{t.stopPropagation();let n=e.value.trim();n&&($e(n),e.value=``)}),e.addEventListener(`keydown`,t=>{if(t.key===`Enter`){t.preventDefault();let n=e.value.trim();n&&($e(n),e.value=``)}}),x.querySelector(`.aih-suggestions-list`).addEventListener(`click`,e=>{let t=e.target.closest(`.aih-suggestion-chip`);if(!t)return;e.stopPropagation();let n=t.dataset.question;n&&$e(n)}),x.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[role="button"]`);t&&(e.preventDefault(),t.click())}}),W(x),Be(x,`.aih-result-header`)}function Je(e,t,n,r=[]){if(!x)return;W(x);let i=window.innerWidth,a=window.innerHeight;x.style.display=`flex`,x.style.left=`-9999px`,x.style.top=`-9999px`;let o=x.querySelector(`.aih-result-body`);o.innerHTML=n;let s=x.querySelector(`.aih-result-suggestions`),c=x.querySelector(`.aih-suggestions-list`);r.length>0&&s&&c?(c.innerHTML=r.map(e=>`<div class="aih-suggestion-chip" role="button" tabindex="0" data-question="${X(e)}">${X(e)}</div>`).join(``),s.style.display=`block`):s&&(s.style.display=`none`),requestAnimationFrame(()=>{let n=x.getBoundingClientRect(),r=n.width||420,o=Math.min(n.height||200,520),s=e-r/2;s<8&&(s=8),s+r>i-8&&(s=i-r-8);let c=t-o-8;c<8&&(c=t+8),x.style.left=s+`px`,x.style.top=c+`px`,x.style.maxHeight=Math.min(520,a-c-16)+`px`,D=!0,W(x)})}function Ye(e,t){if(!x)return;I={x:e,y:t},O=!1,Y();let n=x.querySelector(`.aih-result-suggestions`);n&&(n.style.display=`none`);let r=x.querySelector(`.aih-followup-input`);r&&(r.value=``),W(x),x.style.display=`flex`;let i=x.querySelector(`.aih-result-body`);i.innerHTML=`<div class="aih-result-loading"><div class="aih-spinner"></div>AI 正在思考...</div>`,Ze(x,e,t),D=!0,Q()}function Xe(e,t,n){if(!x)return;O=!1,k=``,Y(),W(x),x.style.display=`flex`;let r=x.querySelector(`.aih-result-body`);r.innerHTML=`<div class="aih-result-error">请求失败: ${X(n)}</div>`,Ze(x,e,t),D=!0}function Ze(e,t,n){let r=window.innerWidth,i=window.innerHeight;e.style.left=`-9999px`,e.style.top=`-9999px`,requestAnimationFrame(()=>{let a=e.getBoundingClientRect(),o=a.width||420,s=Math.min(a.height||200,520),c=t-o/2;c<8&&(c=8),c+o>r-8&&(c=r-o-8);let l=n-s-8;l<8&&(l=n+8),e.style.left=c+`px`,e.style.top=l+`px`,e.style.maxHeight=Math.min(520,i-l-16)+`px`,W(e)})}function J(){x&&(x.style.display=`none`,D=!1,O=!1,k=``,Y())}function Qe(){O=!O,Y()}function Y(){if(!x)return;let e=x.querySelector(`.aih-result-lock`);e&&(O?(e.innerHTML=y.lock,e.classList.add(`locked`),e.title=`解除锁定`):(e.innerHTML=y.unlock,e.classList.remove(`locked`),e.title=`锁定窗口`))}function $e(t){if(!t||!K())return;let n=M||A||``;try{chrome.runtime.sendMessage({type:`DIRECT_SEND`,text:t,selectedText:n}).catch(t=>{e.error(`[SelectionToolbar] 发送追问到侧边栏失败:`,t)})}catch{}}function et(t,n){if(!(!t||!K()))try{chrome.runtime.sendMessage({type:`DIRECT_SEND`,text:t,selectedText:n||``}).catch(t=>{e.error(`[SelectionToolbar] 发送到侧边栏失败:`,t)})}catch{}}function X(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Z(e,t){if(!b||!M||D)return;W(b);let n=window.innerWidth,r=window.innerHeight;b.style.display=`flex`,lastToolbarShowTime=Date.now(),requestAnimationFrame(()=>{let i=b.getBoundingClientRect(),a=i.width||300,o=i.height||40,s=e-a/2;s<8&&(s=8),s+a>n-8&&(s=n-a-8);let c=t-o-10;c<8&&(c=t+10),c<8&&(c=8),c+o>r-8&&(c=r-o-8),b.style.left=s+`px`,b.style.top=c+`px`,S||=(b.classList.add(`show`),!0)})}function Q(){!b||!S||(C&&(C=!1,w=``,T=null,b.classList.remove(`aih-ask-mode`),b.style.width=``,E&&=(b.style.left=E,``)),b.classList.remove(`show`),b.style.display=`none`,S=!1)}function tt(){if(!b)return{x:0,y:0};let e=b.getBoundingClientRect();return{x:e.left+e.width/2,y:e.top}}function nt(e){let t=e.getBoundingClientRect();return{x:t.left+t.width/2,y:t.top}}function rt(){if(!K()||!N)return;if(!H){let t=r();if(e.debug(`[SelectionToolbar] iframe onSelectionChange text:`,t.text?.substring(0,30),`currentSelectedText:`,!!M,`pendingIframeSelection:`,!!U),t.text&&t.text.length>=2){let n=o(t.range);U={text:t.text,x:n.x,y:n.y},e.debug(`[SelectionToolbar] iframe pendingIframeSelection 已设置`)}else if(M){M=``,U=null;try{chrome.runtime.sendMessage({type:`IFRAME_SELECTION_CLEAR`}).catch(()=>{})}catch{}}return}if(P.length>0&&P.includes(window.location.hostname)||Le)return;let t=window.getSelection(),n=t?t.toString().trim():``,i=null;if(n&&n.length>=2&&t.rangeCount>0)i=t.getRangeAt(0);else{let e=r();e.text&&e.text.length>=2&&(n=e.text,i=e.range)}if(!n||n.length<2){C||Q(),M=``,L=null;return}let a=5e3,s=n.length>a?n.substring(0,a)+`...`:n;if(i){let e=i.commonAncestorContainer,t=e.nodeType===Node.TEXT_NODE?e.parentElement.closest(`[contenteditable], input, textarea`):e.closest&&e.closest(`[contenteditable], input, textarea`);if(t instanceof HTMLElement&&(t.tagName===`INPUT`||t.tagName===`TEXTAREA`)){Q(),M=``,L=null;return}}M=s,L=!0}function it(e){if(!(b&&b.contains(e.target))&&!(x&&x.contains(e.target))){if(F){F=!1;return}D&&!O&&J(),S&&!C&&Q(),chrome.runtime.sendMessage({type:`IFRAME_CLICK_DISMISS`}).catch(()=>{})}}function at(){if(e.debug(`[SelectionToolbar] onMouseUp isTopFrame:`,H,`pendingSelection:`,L,`pendingIframeSelection:`,!!U,`currentSelectedText:`,!!M,`isToolbarVisible:`,S,`toolbarEl:`,!!b),!H){if(U){F=!0,U.text,M=U.text;try{window.parent.postMessage({type:`IFRAME_SELECTION`,text:U.text,x:U.x,y:U.y},`*`)}catch{}try{chrome.runtime.sendMessage({type:`IFRAME_SELECTION`,text:U.text,x:U.x,y:U.y}).catch(()=>{})}catch{}U=null}return}if(!S&&L&&M){F=!0;let e=window.innerWidth/2,t=window.innerHeight/2,n=window.getSelection();if(n&&n.rangeCount>0){let r=n.getRangeAt(0).getBoundingClientRect();(r.width>0||r.height>0)&&(e=r.left+r.width/2,t=r.top)}if(e===window.innerWidth/2&&t===window.innerHeight/2){let n=r();if(n.text&&n.text.length>=2){let r=o(n.range);e=r.x,t=r.y}}chrome.runtime.sendMessage({type:`IFRAME_CLICK_DISMISS`}).catch(()=>{}),Z(e,t),L=null}}function ot(){if(C)return;if(!H&&M){let e=r();if(e.text){let t=o(e.range);try{window.parent.postMessage({type:`IFRAME_SELECTION`,text:e.text,x:t.x,y:t.y},`*`)}catch{}try{chrome.runtime.sendMessage({type:`IFRAME_SELECTION`,text:e.text,x:t.x,y:t.y}).catch(()=>{})}catch{}}return}if(!S)return;let e=window.getSelection();if(e&&e.rangeCount>0&&M){let t=e.getRangeAt(0).getBoundingClientRect();if(t.width>0||t.height>0){Z(t.left+t.width/2,t.top);return}}let t=r();if(t.text&&t.text.length>=2&&M){let e=o(t.range);Z(e.x,e.y);return}Q()}function st(){C||S&&Q()}function ct(e,t){if(!t)return;if(A=t,e===`copy`){lt(t),Q();return}if(j=e,Ie=``,[`ai-search`,`explain`,`translate`,`summary`].includes(e)){$(e,t);return}let n=R.find(t=>t.id===e);n&&(Ie=n.systemPrompt||``,$(e,t,n.systemPrompt))}function lt(t){dt(t).then(()=>{mt()}).catch(t=>{e.error(`[SelectionToolbar] 复制失败:`,t),pt()})}function ut(){let t=k;t&&dt(t).then(()=>{mt()}).catch(t=>{e.error(`[SelectionToolbar] 复制结果失败:`,t),pt()})}async function dt(e){if(!navigator.clipboard)return ft(e);try{await navigator.clipboard.writeText(e)}catch(t){if(t.name===`NotAllowedError`||t.name===`SecurityError`)return ft(e);throw t}}function ft(e){return new Promise((t,n)=>{let r=document.createElement(`textarea`);r.value=e,r.style.position=`fixed`,r.style.left=`-9999px`,r.style.opacity=`0`,W(r);try{r.select(),r.setSelectionRange(0,e.length),document.execCommand(`copy`)?t():n(Error(`execCommand copy failed`))}catch(e){n(e)}finally{r.remove()}})}function pt(){let e=document.getElementById(`aih-copy-toast`);e&&e.remove();let t=document.createElement(`div`);t.id=`aih-copy-toast`,t.textContent=`复制失败，请手动复制`,t.style.cssText=`
    position: fixed;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%);
  ...
  `,!document.getElementById(`aih-toast-anim`)){let e=document.createElement(`style`);e.id=`aih-toast-anim`,e.textContent=`
    ...
    `,document.head.appendChild(e)}W(t),t.style.zIndex=`2147483647`,setTimeout(()=>t.remove(),1300)}function $(t,n,r){if(!K()){e.warn(`[SelectionToolbar] 扩展上下文已失效，请刷新页面`);return}let i={"ai-search":`搜索并分析以下内容：\n\n${n}`,explain:`用1-3句话简洁解释以下内容，不需要展开说明。\n\n${n}\n\n---\n回答完毕后，请在最后另起一行，严格按以下格式提供3个用户可能追问的问题：\n---SUGGESTIONS---\n问题1\n问题2\n问题3`,translate:`翻译以下内容，只输出翻译结果：\n\n${n}`,summary:`用3-5个要点总结以下内容，每条要点一句话。\n\n${n}\n\n---\n回答完毕后，请在最后另起一行，严格按以下格式提供3个用户可能追问的问题：\n---SUGGESTIONS---\n问题1\n问题2\n问题3`},a=r?`请处理以下内容：\n\n${n}`:i[t]||n;if(t===`ai-search`){Q(),window.getSelection().removeAllRanges();try{chrome.runtime.sendMessage({type:`SELECTION_TOOLBAR_ACTION`,action:t,text:n,prompt:a}).catch(t=>{e.error(`[SelectionToolbar] 发送消息失败:`,t)})}catch{}return}qe();let o={"ai-search":`AI搜索`,explain:`解释`,translate:`翻译`,summary:`总结`}[t];if(!o&&R){let e=R.find(e=>e.id===t);o=e?e.name:`AI 回答`}let s=x.querySelector(`.aih-result-header span`);s&&(s.innerHTML=`${y.sparkle} ${o||`AI 回答`}`);let c=D&&x?nt(x):tt();Ye(c.x,c.y),chrome.runtime.sendMessage({type:`SELECTION_TOOLBAR_ACTION`,action:t,text:n,prompt:a,systemPrompt:r||``}).catch(t=>{e.error(`[SelectionToolbar] 发送消息失败:`,t),Xe(c.x,c.y,t.message)})}chrome.runtime.onMessage.addListener((t,n,r)=>{if(K()){if(t.type===`IFRAME_SELECTION`){if(!H)return;e.debug(`[SelectionToolbar] 收到 IFRAME_SELECTION text:`,t.text?.substring(0,30),`isToolbarVisible:`,S,`isResultVisible:`,D),M=t.text;let n=t.x,r=t.y;if(window.top!==window&&window.frameElement)try{let e=window.frameElement.getBoundingClientRect();n=t.x-e.left,r=t.y-e.top}catch{}if(S&&b&&M){requestAnimationFrame(()=>{let e=window.innerWidth,t=b.offsetWidth||300,i=b.offsetHeight||40,a=n-t/2;a<8&&(a=8),a+t>e-8&&(a=e-t-8);let o=r-i-8;o<8&&(o=r+8),b.style.left=a+`px`,b.style.top=o+`px`});return}L={x:n,y:r},M&&M.length>=2&&Z(n,r);return}if(t.type===`IFRAME_SELECTION_CLEAR`){if(!H)return;S&&!C&&(Q(),M=``);return}if(t.type===`IFRAME_CLICK_DISMISS`){S&&b&&Date.now()-lastToolbarShowTime>300&&(Q(),M=``),D&&!O&&J();return}if(H){if(t.type===`SELECTION_TOOLBAR_STREAM_START`){V=``;return}if(t.type===`SELECTION_TOOLBAR_STREAM_CHUNK`){if(V+=t.delta||``,x&&D){let e=x.querySelector(`.aih-result-body`);e&&(e.querySelector(`.aih-result-content-stream`)||(e.innerHTML=`<div class="aih-result-content-stream"></div>`),e.innerHTML=`<div class="aih-result-content-stream">`+X(V).replace(/\n/g,`<br>`)+`</div>`)}return}if(t.type===`SELECTION_TOOLBAR_STREAM_DONE`){t.finalContent&&(V=t.finalContent);let e=V||`无响应`;k=V;let n=e,r=[],i=e.indexOf(`---SUGGESTIONS---`);i!==-1&&(n=e.substring(0,i).trim(),k=n,r=e.substring(i+17).split(`
`).map(e=>e.replace(/^[\d]+[\.\、\s]+/,``).trim()).filter(e=>e.length>0).slice(0,3));let a=typeof marked<`u`?marked.parse(n):X(n).replace(/\n/g,`<br>`);Je(I.x,I.y,a,r),V=``;return}if(t.type===`SELECTION_TOOLBAR_RESULT`)if(t.error)k=``,Xe(I.x,I.y,t.error);else{let e=t.content||`无响应`,n=e;k=e;let r=[],i=e.indexOf(`---SUGGESTIONS---`);i!==-1&&(n=e.substring(0,i).trim(),k=n,r=e.substring(i+17).split(`
`).map(e=>e.replace(/^[\d]+[\.\、\s]+/,``).trim()).filter(e=>e.length>0).slice(0,3));let a=typeof marked<`u`?marked.parse(n):X(n).replace(/\n/g,`<br>`);Je(I.x,I.y,a,r)}}}});function ht(){if(!K())return;let e=window.location.hostname;try{chrome.storage.local.get([`blockedDomains`],t=>{try{let n=t.blockedDomains||[];n.includes(e)||(n.push(e),chrome.storage.local.set({blockedDomains:n},()=>{P=n,Q(),J(),M=``}))}catch{}})}catch{}}function gt(){K()&&chrome.storage.local.get([`enableSelectionToolbar`,`blockedDomains`],t=>{N=t.enableSelectionToolbar===void 0?!0:!!t.enableSelectionToolbar,P=t.blockedDomains||[],e.debug(`[SelectionToolbar] 开关状态:`,N?`已启用`:`已禁用`,`屏蔽域名:`,P.length)})}chrome.storage.onChanged.addListener((e,t)=>{K()&&(t===`local`&&e.enableSelectionToolbar&&(N=!!e.enableSelectionToolbar.newValue,N||(Q(),J(),M=``)),t===`local`&&e.blockedDomains&&(P=e.blockedDomains.newValue||[]),t===`local`&&e.toolbarTools&&He())});function _t(){Fe(),Ke(),qe(),gt(),document.addEventListener(`selectionchange`,rt),document.addEventListener(`click`,it,!0),document.addEventListener(`mouseup`,at,!0),window.addEventListener(`scroll`,ot,!0),window.addEventListener(`resize`,st),window.addEventListener(`message`,e=>{if(e.data?.type===`IFRAME_SELECTION`&&H){M=e.data.text;let t=e.data.x,n=e.data.y;if(window.top!==window&&window.frameElement)try{let r=window.frameElement.getBoundingClientRect();t=e.data.x-r.left,n=e.data.y-r.top}catch{}if(S&&b&&M){requestAnimationFrame(()=>{let e=window.innerWidth,r=b.offsetWidth||300,i=b.offsetHeight||40,a=t-r/2;a<8&&(a=8),a+r>e-8&&(a=e-r-8);let o=n-i-8;o<8&&(o=n+8),b.style.left=a+`px`,b.style.top=o+`px`});return}L={x:t,y:n},M&&M.length>=2&&Z(t,n);return}e.data?.type===`IFRAME_CLICK_DISMISS`&&H&&D&&!O&&J()}),H&&(ze=s(rt),new MutationObserver(()=>{c(ze),ze=s(rt)}).observe(document.body,{childList:!0,subtree:!0})),e.debug(`[SelectionToolbar] 初始化完成`,H?`(顶层frame)`:`(子frame)`)}e.debug(`[ContentScript] 内容脚本已加载 URL:`,window.location.href,`isTopFrame:`,window.top===window,`hasBody:`,!!document.body),document.addEventListener(`keydown`,e=>{(e.ctrlKey||e.metaKey)&&e.shiftKey&&e.key===`A`&&(e.preventDefault(),chrome.action.click()),e.altKey&&!e.shiftKey&&e.code===`KeyS`&&!e.ctrlKey&&!e.metaKey&&(e.preventDefault(),chrome.runtime.sendMessage({type:`CAPTURE_TAB_FROM_PAGE`})),e.altKey&&e.shiftKey&&e.code===`KeyS`&&!e.ctrlKey&&!e.metaKey&&(e.preventDefault(),chrome.runtime.sendMessage({type:`CAPTURE_REGION_FROM_PAGE`}))});var vt={GET_PAGE_TEXT:e=>l(e),GET_FULL_HTML:e=>u(e),QUERY_INTERACTIVE_ELEMENTS:e=>d(e),GET_SELECTED_CONTENT:e=>h(e.format),CLICK_ELEMENT:e=>ge(e.selector,e.waitTime,e.timeout),FILL_FORM:e=>ye(e.fields,e.waitTime),SCROLL_TO:e=>be(e),HOVER_ELEMENT:e=>re(e.selector),KEYBOARD_INPUT:e=>Ce(e),FILE_UPLOAD:e=>Te(e.selector,e.fileName,e.fileContent,e.fileType),EXTRACT_TABLE:e=>ee(e.selector,e.includeHeaders,e.format),EXTRACT_METADATA:()=>ie(),EXTRACT_LINKS:e=>oe(e.filterType,e.includeImages),EXTRACT_FORMS:e=>se(e.formSelector),EXTRACT_IMAGES:e=>ce(e),SEARCH_IN_PAGE:e=>le(e),PAGE_TO_MARKDOWN:e=>ue(e.selector,e.includeImages,e.includeLinks,e.maxLength),PAGE_TO_JSON:e=>de(e.selector,e.maxItems),FIND_SIMILAR_ELEMENTS:e=>fe(e.selector,e.maxResults),GET_IFRAME_CONTENT:e=>pe(e.selector,e.includeNested,e.maxLength),HIGHLIGHT_TEXT:e=>ae(e.text,e.color),REMOVE_HIGHLIGHTS:()=>g(),SHADOW_DOM_QUERY:e=>Ne(e.selector,e.deep,e.maxDepth,e.maxResults),MANAGE_STORAGE:e=>De(e),TEXT_TO_SPEECH:e=>ke(e.text,e.lang,e.rate,e.pitch),INJECT_CSS:e=>Pe(e.css,e.targetSelector,e.injectMode),VIDEO_CONTROL:e=>Ae(e.action,e.selector,e.value),COPY_TO_CLIPBOARD:e=>te(e.text),PASTE_FROM_CLIPBOARD:()=>ne(),WAIT_FOR_ELEMENT:e=>Se(e.selector,e.state,e.timeout),DRAG_AND_DROP:e=>we(e.sourceSelector,e.targetSelector),SELECT_DROPDOWN:e=>Ee(e.triggerSelector,e.optionText,e.optionSelector,e.timeout),COLOR_PICKER:()=>Oe(),GENERATE_QRCODE:e=>Me(e.content,e.size,e.errorCorrection,e.showImage),GET_ELEMENT_COUNT:e=>me(e.selector,e.includeHidden),SCROLL_AND_COLLECT:e=>he(e),CLEAR_PAGE_DATA:e=>{try{let t=[];return e.site?window.location.href.includes(new URL(e.site).hostname)&&(localStorage.clear(),sessionStorage.clear(),t.push(`localStorage`,`sessionStorage`)):(localStorage.clear(),sessionStorage.clear(),t.push(`localStorage`,`sessionStorage`)),{success:!0,cleared:t}}catch(e){return{success:!1,error:e.message}}},START_REGION_SELECTION:()=>xt()},yt=new Set([`COPY_TO_CLIPBOARD`,`PASTE_FROM_CLIPBOARD`,`WAIT_FOR_ELEMENT`,`DRAG_AND_DROP`,`SELECT_DROPDOWN`,`SCROLL_AND_COLLECT`,`WATCH_ELEMENT`,`COLOR_PICKER`,`GENERATE_QRCODE`,`SCREENSHOT_ELEMENT`,`PAGE_TO_PDF`,`START_REGION_SELECTION`]),bt=new Set([`GET_PAGE_TEXT`,`GET_FULL_HTML`,`PAGE_TO_MARKDOWN`,`PAGE_TO_JSON`,`EXTRACT_METADATA`,`EXTRACT_TABLE`,`GET_ELEMENT_COUNT`,`SCROLL_AND_COLLECT`,`GET_IFRAME_CONTENT`,`QUERY_INTERACTIVE_ELEMENTS`]);chrome.runtime.onMessage.addListener((e,t,n)=>{if(bt.has(e.type)&&window.top!==window)return;if(e.action===`getSelectedText`){let e=window.getSelection()?.toString()?.trim()||``;if(e&&document.hasFocus())return n({text:e}),!0;let t=r();return t.text&&t.text.trim()&&document.hasFocus()&&n({text:t.text.trim()}),!0}let i=vt[e.type];if(!i)return;let a=i(e);if(yt.has(e.type)||a instanceof Promise)return Promise.resolve(a).then(n),!0;n(a)}),_t();function xt(){return new Promise(e=>{let t=document.createElement(`div`);t.id=`__region_select_overlay__`,t.style.cssText=`
...
//# sourceMappingURL=content-C7eX5Ter.js.map