(()=>{var V={DEBUG:0,INFO:1,WARN:2,ERROR:3},W=V.DEBUG;function Xe(e){W=e}function Ye(){return W}function Ve(...e){W<=V.DEBUG&&console.debug("[AIH]",...e)}function Qe(...e){W<=V.INFO&&console.info("[AIH]",...e)}function Je(...e){W<=V.WARN&&console.warn("[AIH]",...e)}function Ze(...e){W<=V.ERROR&&console.error("[AIH]",...e)}var k={debug:Ve,info:Qe,warn:Je,error:Ze,setLogLevel:Xe,getLogLevel:Ye};function $(e,t=document,n=5,o=0){if(o>n)return null;try{if(t.querySelectorAll)for(let r of t.querySelectorAll("*")){if(r.shadowRoot){let i=$(e,r.shadowRoot,n,o+1);if(i)return i}if(r.tagName==="IFRAME"||r.tagName==="FRAME")try{let i=r.contentDocument||r.contentWindow?.document;if(i){let a=$(e,i,n,o+1);if(a)return a}}catch{}}let l=t.querySelector?.(e);if(l)return l}catch{}return null}function K(e,t=document,n=5,o=0,l=new Set){if(o>n)return[];try{t.querySelectorAll&&(t.querySelectorAll(e).forEach(r=>{l.add(r)}),t.querySelectorAll("*").forEach(r=>{if(r.shadowRoot&&K(e,r.shadowRoot,n,o+1,l),r.tagName==="IFRAME"||r.tagName==="FRAME")try{let i=r.contentDocument||r.contentWindow?.document;i&&K(e,i,n,o+1,l)}catch{}}))}catch{}return Array.from(l)}function j(e=document,t=5,n=0){if(n>t)return{text:"",range:null};try{let o=e.getSelection?.();if(o&&!o.isCollapsed&&o.rangeCount>0){let l=o.toString().trim();if(l)return{text:l,range:o.getRangeAt(0),depth:n,source:"shadow"}}if(e.querySelectorAll){for(let l of e.querySelectorAll("*"))if(l.shadowRoot){let r=j(l.shadowRoot,t,n+1);if(r.text)return r}}}catch{}return{text:"",range:null}}function ae(e=document,t=5,n=0,o=new Set){if(n>t||o.has(e))return"";o.add(e);let l="";try{e.body?l+=e.body.innerText||"":e instanceof ShadowRoot&&(l+=e.textContent||""),e.querySelectorAll&&e.querySelectorAll("*").forEach(r=>{if(r.shadowRoot&&(l+=`
...
`)}`}:{success:!0,content:JSON.stringify({data:r,rowCount:r.length,columnCount:r[0]?.length||0}),data:r}}catch(o){return{success:!1,error:o.message}}}async function bt(e){try{return await navigator.clipboard.writeText(e),{success:!0,message:"\u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F"}}catch{try{let t=document.createElement("textarea");return t.value=e,t.style.position="fixed",t.style.left="-9999px",document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),{success:!0,message:"\u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F\uFF08\u964D\u7EA7\u65B9\u6848\uFF09"}}catch(t){return{success:!1,error:t.message}}}}async function xt(){try{return{success:!0,content:await navigator.clipboard.readText()}}catch(e){return{success:!1,error:e.message}}}function wt(e){try{let t=$(e);if(!t)return{success:!1,error:`\u672A\u627E\u5230\u5143\u7D20: ${e}`};let n=new MouseEvent("mouseenter",{bubbles:!0,cancelable:!0,view:window});t.dispatchEvent(n);let o=new MouseEvent("mouseover",{bubbles:!0,cancelable:!0,view:window});return t.dispatchEvent(o),{success:!0,message:`\u5DF2\u5728\u5143\u7D20\u4E0A\u89E6\u53D1\u60AC\u505C\u6548\u679C: ${e}`}}catch(t){return{success:!1,error:t.message}}}function vt(e,t="yellow"){try{if(!e)return{success:!1,error:"\u672A\u63D0\u4F9B\u8981\u9AD8\u4EAE\u7684\u6587\u672C"};xe();let n=document.createElement("style");n.id="ai-helper-highlight-style",n.textContent=`
  ...
  </div>`,w.innerHTML=t,w._clickHandler=n=>{if(n.target.closest(".aih-dropdown-settings")){n.stopPropagation(),w.style.display="none";try{chrome.runtime.sendMessage({type:"OPEN_OPTIONS_PAGE",hash:"toolbar"}).catch(()=>{})}catch{}return}if(n.target.closest(".aih-dropdown-block")){n.stopPropagation(),n.preventDefault(),w.style.display="none",Jt();return}if(n.target.closest(".aih-dropdown-hide")){n.stopPropagation(),n.preventDefault(),w.style.display="none",Ie=!0,T(),U(),b="";return}let o=n.target.closest("[data-action]");o&&(n.stopPropagation(),w.style.display="none",Fe(o.dataset.action,b))},w.addEventListener("click",w._clickHandler),w.addEventListener("keydown",n=>{if(n.key==="Enter"||n.key===" "){let o=n.target.closest('[role="button"]');o&&(n.preventDefault(),o.click())}})}async function Ft(){if(m)return;await Oe();let e=[...M].sort((d,p)=>d.order-p.order),t=e.find(d=>d.id==="ai-search"),n=e.filter(d=>d.id!=="ai-search"&&d.id!=="copy"),o=n.slice(0,Me-1),l=n.slice(Me-1);m=document.createElement("div"),m.id="aih-selection-toolbar";let r='<span class="aih-tb-buttons">';r+=`<span class="aih-tb-grip" title="\u62D6\u62FD\u79FB\u52A8">${v.grip}</span>`;let i=Te;t&&(r+=`<div class="aih-tb-btn primary" role="button" tabindex="0" data-action="ai-search" title="AI \u641C\u7D22">
  ...
  `,g.querySelector(".aih-result-close").addEventListener("click",t=>{t.stopPropagation(),U()}),g.querySelector(".aih-result-lock").addEventListener("click",t=>{t.stopPropagation(),jt()}),g.querySelector(".aih-result-footer").addEventListener("click",t=>{t.stopPropagation();let n=t.target.closest("[data-action]")?.dataset?.action;if(n==="regenerate-result"){if(!we||!ue)return;Ee(we,ue,ve)}else n==="copy-result"&&Qt()});let e=g.querySelector(".aih-followup-input");g.querySelector(".aih-followup-send").addEventListener("click",t=>{t.stopPropagation();let n=e.value.trim();n&&(ge(n),e.value="")}),e.addEventListener("keydown",t=>{if(t.key==="Enter"){t.preventDefault();let n=e.value.trim();n&&(ge(n),e.value="")}}),g.querySelector(".aih-suggestions-list").addEventListener("click",t=>{let n=t.target.closest(".aih-suggestion-chip");if(!n)return;t.stopPropagation();let o=n.dataset.question;o&&ge(o)}),g.addEventListener("keydown",t=>{if(t.key==="Enter"||t.key===" "){let n=t.target.closest('[role="button"]');n&&(t.preventDefault(),n.click())}}),N(g),_e(g,".aih-result-header")}function Re(e,t,n,o=[]){if(!g)return;N(g);let l=window.innerWidth,r=window.innerHeight;g.style.display="flex",g.style.left="-9999px",g.style.top="-9999px";let i=g.querySelector(".aih-result-body");i.innerHTML=n;let a=g.querySelector(".aih-result-suggestions"),s=g.querySelector(".aih-suggestions-list");o.length>0&&a&&s?(s.innerHTML=o.map(c=>`<div class="aih-suggestion-chip" role="button" tabindex="0" data-question="${G(c)}">${G(c)}</div>`).join(""),a.style.display="block"):a&&(a.style.display="none"),requestAnimationFrame(()=>{let c=g.getBoundingClientRect(),h=c.width||420,u=Math.min(c.height||200,520),d=e-h/2;d<8&&(d=8),d+h>l-8&&(d=l-h-8);let p=t-u-8;p<8&&(p=t+8),g.style.left=d+"px",g.style.top=p+"px",g.style.maxHeight=Math.min(520,r-p-16)+"px",_=!0,N(g)})}function Ht(e,t){if(!g)return;H={x:e,y:t},q=!1,fe();let n=g.querySelector(".aih-result-suggestions");n&&(n.style.display="none");let o=g.querySelector(".aih-followup-input");o&&(o.value=""),N(g),g.style.display="flex";let l=g.querySelector(".aih-result-body");l.innerHTML='<div class="aih-result-loading"><div class="aih-spinner"></div>AI \u6B63\u5728\u601D\u8003...</div>',Be(g,e,t),_=!0,T()}function Pe(e,t,n){if(!g)return;q=!1,D="",fe(),N(g),g.style.display="flex";let o=g.querySelector(".aih-result-body");o.innerHTML=`<div class="aih-result-error">\u8BF7\u6C42\u5931\u8D25: ${G(n)}</div>`,Be(g,e,t),_=!0}function Be(e,t,n){let o=window.innerWidth,l=window.innerHeight;e.style.left="-9999px",e.style.top="-9999px",requestAnimationFrame(()=>{let r=e.getBoundingClientRect(),i=r.width||420,a=Math.min(r.height||200,520),s=t-i/2;s<8&&(s=8),s+i>o-8&&(s=o-i-8);let c=n-a-8;c<8&&(c=n+8),e.style.left=s+"px",e.style.top=c+"px",e.style.maxHeight=Math.min(520,l-c-16)+"px",N(e)})}function U(){g&&(g.style.display="none",_=!1,q=!1,D="",fe())}function jt(){q=!q,fe()}function fe(){if(!g)return;let e=g.querySelector(".aih-result-lock");e&&(q?(e.innerHTML=v.lock,e.classList.add("locked"),e.title="\u89E3\u9664\u9501\u5B9A"):(e.innerHTML=v.unlock,e.classList.remove("locked"),e.title="\u9501\u5B9A\u7A97\u53E3"))}function ge(e){if(!e||!I())return;let t=b||ue||"";try{chrome.runtime.sendMessage({type:"DIRECT_SEND",text:e,selectedText:t}).catch(n=>{k.error("[SelectionToolbar] \u53D1\u9001\u8FFD\u95EE\u5230\u4FA7\u8FB9\u680F\u5931\u8D25:",n)})}catch{}}function zt(e,t){if(!(!e||!I()))try{chrome.runtime.sendMessage({type:"DIRECT_SEND",text:e,selectedText:t||""}).catch(n=>{k.error("[SelectionToolbar] \u53D1\u9001\u5230\u4FA7\u8FB9\u680F\u5931\u8D25:",n)})}catch{}}function G(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}function te(e,t){if(!m||!b||_)return;N(m);let n=window.innerWidth,o=window.innerHeight;m.style.display="flex",lastToolbarShowTime=Date.now(),requestAnimationFrame(()=>{let l=m.getBoundingClientRect(),r=l.width||300,i=l.height||40,a=e-r/2;a<8&&(a=8),a+r>n-8&&(a=n-r-8);let s=t-i-10;s<8&&(s=t+10),s<8&&(s=8),s+i>o-8&&(s=o-i-8),m.style.left=a+"px",m.style.top=s+"px",R||=(m.classList.add("show"),!0)})}function T(){!m||!R||(A&&(A=!1,le="",Q=null,m.classList.remove("aih-ask-mode"),m.style.width="",Z&&=(m.style.left=Z,"")),m.classList.remove("show"),m.style.display="none",R=!1)}function Ut(){if(!m)return{x:0,y:0};let e=m.getBoundingClientRect();return{x:e.left+e.width/2,y:e.top}}function Wt(e){let t=e.getBoundingClientRect();return{x:t.left+t.width/2,y:t.top}}function ye(){if(!I()||!ee)return;if(!L){let r=j();if(k.debug("[SelectionToolbar] iframe onSelectionChange text:",r.text?.substring(0,30),"currentSelectedText:",!!b,"pendingIframeSelection:",!!C),r.text&&r.text.length>=2){let i=ce(r.range);C={text:r.text,x:i.x,y:i.y},k.debug("[SelectionToolbar] iframe pendingIframeSelection \u5DF2\u8BBE\u7F6E")}else if(b){b="",C=null;try{chrome.runtime.sendMessage({type:"IFRAME_SELECTION_CLEAR"}).catch(()=>{})}catch{}}return}if(X.length>0&&X.includes(window.location.hostname)||Ie)return;let e=window.getSelection(),t=e?e.toString().trim():"",n=null;if(t&&t.length>=2&&e.rangeCount>0)n=e.getRangeAt(0);else{let r=j();r.text&&r.text.length>=2&&(t=r.text,n=r.range)}if(!t||t.length<2){A||T(),b="",P=null;return}let o=5e3,l=t.length>o?t.substring(0,o)+"...":t;if(n){let r=n.commonAncestorContainer,i=r.nodeType===Node.TEXT_NODE?r.parentElement.closest("[contenteditable], input, textarea"):r.closest&&r.closest("[contenteditable], input, textarea");if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA")){T(),b="",P=null;return}}b=l,P=!0}function Gt(e){if(!(m&&m.contains(e.target))&&!(g&&g.contains(e.target))){if(he){he=!1;return}_&&!q&&U(),R&&!A&&T(),chrome.runtime.sendMessage({type:"IFRAME_CLICK_DISMISS"}).catch(()=>{})}}function Kt(){if(k.debug("[SelectionToolbar] onMouseUp isTopFrame:",L,"pendingSelection:",P,"pendingIframeSelection:",!!C,"currentSelectedText:",!!b,"isToolbarVisible:",R,"toolbarEl:",!!m),!L){if(C){he=!0,C.text,b=C.text;try{window.parent.postMessage({type:"IFRAME_SELECTION",text:C.text,x:C.x,y:C.y},"*")}catch{}try{chrome.runtime.sendMessage({type:"IFRAME_SELECTION",text:C.text,x:C.x,y:C.y}).catch(()=>{})}catch{}C=null}return}if(!R&&P&&b){he=!0;let e=window.innerWidth/2,t=window.innerHeight/2,n=window.getSelection();if(n&&n.rangeCount>0){let o=n.getRangeAt(0).getBoundingClientRect();(o.width>0||o.height>0)&&(e=o.left+o.width/2,t=o.top)}if(e===window.innerWidth/2&&t===window.innerHeight/2){let o=j();if(o.text&&o.text.length>=2){let l=ce(o.range);e=l.x,t=l.y}}chrome.runtime.sendMessage({type:"IFRAME_CLICK_DISMISS"}).catch(()=>{}),te(e,t),P=null}}function Xt(){if(A)return;if(!L&&b){let n=j();if(n.text){let o=ce(n.range);try{window.parent.postMessage({type:"IFRAME_SELECTION",text:n.text,x:o.x,y:o.y},"*")}catch{}try{chrome.runtime.sendMessage({type:"IFRAME_SELECTION",text:n.text,x:o.x,y:o.y}).catch(()=>{})}catch{}}return}if(!R)return;let e=window.getSelection();if(e&&e.rangeCount>0&&b){let n=e.getRangeAt(0).getBoundingClientRect();if(n.width>0||n.height>0){te(n.left+n.width/2,n.top);return}}let t=j();if(t.text&&t.text.length>=2&&b){let n=ce(t.range);te(n.x,n.y);return}T()}function Yt(){A||R&&T()}function Fe(e,t){if(!t)return;if(ue=t,e==="copy"){Vt(t),T();return}if(we=e,ve="",["ai-search","explain","translate","summary"].includes(e)){Ee(e,t);return}let n=M.find(o=>o.id===e);n&&(ve=n.systemPrompt||"",Ee(e,t,n.systemPrompt))}function Vt(e){He(e).then(()=>{ze()}).catch(t=>{k.error("[SelectionToolbar] \u590D\u5236\u5931\u8D25:",t),je()})}function Qt(){let e=D;e&&He(e).then(()=>{ze()}).catch(t=>{k.error("[SelectionToolbar] \u590D\u5236\u7ED3\u679C\u5931\u8D25:",t),je()})}async function He(e){if(!navigator.clipboard)return $e(e);try{await navigator.clipboard.writeText(e)}catch(t){if(t.name==="NotAllowedError"||t.name==="SecurityError")return $e(e);throw t}}function $e(e){return new Promise((t,n)=>{let o=document.createElement("textarea");o.value=e,o.style.position="fixed",o.style.left="-9999px",o.style.opacity="0",N(o);try{o.select(),o.setSelectionRange(0,e.length),document.execCommand("copy")?t():n(Error("execCommand copy failed"))}catch(l){n(l)}finally{o.remove()}})}function je(){let e=document.getElementById("aih-copy-toast");e&&e.remove();let t=document.createElement("div");t.id="aih-copy-toast",t.textContent="\u590D\u5236\u5931\u8D25\uFF0C\u8BF7\u624B\u52A8\u590D\u5236",t.style.cssText=`
    position: fixed;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%);
