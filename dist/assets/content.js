...
`).length}),p[0].length===0&&h.lastIndex++}if(a&&c.length>0){ge();let g=document.createElement("style");g.id="ai-helper-highlight-style",g.textContent=`
        .ai-helper-search-highlight {
          background-color: #ffff00;
          color: #000;
          padding: 1px 2px;
...
`)}`}:{success:!0,content:JSON.stringify({data:r,rowCount:r.length,columnCount:r[0]?.length||0}),data:r}}catch(o){return{success:!1,error:o.message}}}async function ht(e){try{return await navigator.clipboard.writeText(e),{success:!0,message:"\u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F"}}catch{try{let t=document.createElement("textarea");return t.value=e,t.style.position="fixed",t.style.left="-9999px",document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),{success:!0,message:"\u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F\uFF08\u964D\u7EA7\u65B9\u6848\uFF09"}}catch(t){return{success:!1,error:t.message}}}}async function pt(){try{return{success:!0,content:await navigator.clipboard.readText()}}catch(e){return{success:!1,error:e.message}}}function ft(e){try{let t=N(e);if(!t)return{success:!1,error:`\u672A\u627E\u5230\u5143\u7D20: ${e}`};let n=new MouseEvent("mouseenter",{bubbles:!0,cancelable:!0,view:window});t.dispatchEvent(n);let o=new MouseEvent("mouseover",{bubbles:!0,cancelable:!0,view:window});return t.dispatchEvent(o),{success:!0,message:`\u5DF2\u5728\u5143\u7D20\u4E0A\u89E6\u53D1\u60AC\u505C\u6548\u679C: ${e}`}}catch(t){return{success:!1,error:t.message}}}function mt(e,t="yellow"){try{if(!e)return{success:!1,error:"\u672A\u63D0\u4F9B\u8981\u9AD8\u4EAE\u7684\u6587\u672C"};ge();let n=document.createElement("style");n.id="ai-helper-highlight-style",n.textContent=`
      .ai-helper-highlight {
  ...
  </div>`,x.innerHTML=t,x._clickHandler=n=>{if(n.target.closest(".aih-dropdown-settings")){n.stopPropagation(),x.style.display="none";try{chrome.runtime.sendMessage({type:"OPEN_OPTIONS_PAGE",hash:"toolbar"}).catch(()=>{})}catch{}return}if(n.target.closest(".aih-dropdown-block")){n.stopPropagation(),n.preventDefault(),x.style.display="none",Wt();return}if(n.target.closest(".aih-dropdown-hide")){n.stopPropagation(),n.preventDefault(),x.style.display="none",Le=!0,S(),z(),b="";return}let o=n.target.closest("[data-action]");o&&(n.stopPropagation(),x.style.display="none",Oe(o.dataset.action,b))},x.addEventListener("click",x._clickHandler),x.addEventListener("keydown",n=>{if(n.key==="Enter"||n.key===" "){let o=n.target.closest('[role="button"]');o&&(n.preventDefault(),o.click())}})}async function $t(){if(f)return;await Me();let e=[...R].sort((c,p)=>c.order-p.order),t=e.find(c=>c.id==="ai-search"),n=e.filter(c=>c.id!=="ai-search"&&c.id!=="copy"),o=n.slice(0,Te-1),i=n.slice(Te-1);f=document.createElement("div"),f.id="aih-selection-toolbar";let r='<span class="aih-tb-buttons">';r+=`<span class="aih-tb-grip" title="\u62D6\u62FD\u79FB\u52A8">${v.grip}</span>`;let l=we;t&&(r+=`<div class="aih-tb-btn primary" role="button" tabindex="0" data-action="ai-search" title="AI \u641C\u7D22">
  ...
  `,!document.getElementById("aih-toast-anim")){let n=document.createElement("style");n.id="aih-toast-anim",n.textContent=`
    ...
    `,document.head.appendChild(n)}I(t),t.style.zIndex="2147483647",setTimeout(()=>t.remove(),1300)}function xe(e,t,n){if(!$()){k.warn("[SelectionToolbar] \u6269\u5C55\u4E0A\u4E0B\u6587\u5DF2\u5931\u6548\uFF0C\u8BF7\u5237\u65B0\u9875\u9762");return}let o={"ai-search":`\u641C\u7D22\u5E76\u5206\u6790\u4EE5\u4E0B\u5185\u5BB9\uFF1A
