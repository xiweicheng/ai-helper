(()=>{var X={DEBUG:0,INFO:1,WARN:2,ERROR:3},U=X.DEBUG;function We(e){U=e}function Ge(){return U}function Ke(...e){U<=X.DEBUG&&console.debug("[AIH]",...e)}function Xe(...e){U<=X.INFO&&console.info("[AIH]",...e)}function Ye(...e){U<=X.WARN&&console.warn("[AIH]",...e)}function Ve(...e){U<=X.ERROR&&console.error("[AIH]",...e)}var k={debug:Ke,info:Xe,warn:Ye,error:Ve,setLogLevel:We,getLogLevel:Ge};function N(e,t=document,n=5,o=0){if(o>n)return null;try{if(t.querySelectorAll)for(let r of t.querySelectorAll("*")){if(r.shadowRoot){let l=N(e,r.shadowRoot,n,o+1);if(l)return l}if(r.tagName==="IFRAME"||r.tagName==="FRAME")try{let l=r.contentDocument||r.contentWindow?.document;if(l){let a=N(e,l,n,o+1);if(a)return a}}catch{}}let i=t.querySelector?.(e);if(i)return i}catch{}return null}function J(e,t=document,n=5,o=0,i=new Set){if(o>n)return[];try{t.querySelectorAll&&(t.querySelectorAll(e).forEach(r=>{i.add(r)}),t.querySelectorAll("*").forEach(r=>{if(r.shadowRoot&&J(e,r.shadowRoot,n,o+1,i),r.tagName==="IFRAME"||r.tagName==="FRAME")try{let l=r.contentDocument||r.contentWindow?.document;l&&J(e,l,n,o+1,i)}catch{}}))}catch{}return Array.from(i)}function j(e=document,t=5,n=0){if(n>t)return{text:"",range:null};try{let o=e.getSelection?.();if(o&&!o.isCollapsed&&o.rangeCount>0){let i=o.toString().trim();if(i)return{text:i,range:o.getRangeAt(0),depth:n,source:"shadow"}}if(e.querySelectorAll){for(let i of e.querySelectorAll("*"))if(i.shadowRoot){let r=j(i.shadowRoot,t,n+1);if(r.text)return r}}}catch{}return{text:"",range:null}}function le(e=document,t=5,n=0,o=new Set){if(n>t||o.has(e))return"";o.add(e);let i="";try{e.body?i+=e.body.innerText||"":e instanceof ShadowRoot&&(i+=e.textContent||""),e.querySelectorAll&&e.querySelectorAll("*").forEach(r=>{if(r.shadowRoot&&(i+=`
`+le(r.shadowRoot,t,n+1,o)),r.tagName==="IFRAME"||r.tagName==="FRAME")try{let l=r.contentDocument||r.contentWindow?.document;l&&l.body&&(i+=`
`+le(l,t,n+1,o))}catch{}})}catch{}return i.trim().replace(/\n{3,}/g,`

`)}function ae(e=document,t=5,n=0,o=new Set){if(n>t||o.has(e))return"";o.add(e);let i="";try{e.documentElement?i=e.documentElement.outerHTML:e instanceof ShadowRoot&&(i=e.innerHTML||"");let r=[];e.querySelectorAll&&e.querySelectorAll("*").forEach(l=>{if(l.shadowRoot){let a=ae(l.shadowRoot,t,n+1,o);a&&r.push(`<!-- shadow-root of ${l.tagName} -->
${a}`)}if(l.tagName==="IFRAME"||l.tagName==="FRAME")try{let a=l.contentDocument||l.contentWindow?.document;if(a&&a.documentElement){let s=ae(a,t,n+1,o);s&&r.push(`<!-- iframe content -->
${s}`)}}catch{}}),r.length>0&&(i+=`
<!-- Shadow DOM and iframe content -->
`+r.join(`
`))}catch{}return i}function se(e){if(!e)return{x:window.innerWidth/2,y:window.innerHeight/2};let t;try{t=e.getBoundingClientRect()}catch{t={left:0,top:0,width:0,height:0}}if(!t||t.width===0&&t.height===0){let i=e.commonAncestorContainer;if(i){let r=i.nodeType===Node.TEXT_NODE?i.parentElement:i;r&&r.getBoundingClientRect&&(t=r.getBoundingClientRect())}}let n=t.left+t.width/2,o=t.top;if(window.top!==window){let i=e.startContainer.ownerDocument;for(;i&&i!==window.top.document;){let r=i.defaultView?.frameElement;if(!r)break;let l=r.getBoundingClientRect();n+=l.left,o+=l.top,i=r.ownerDocument}}return{x:n,y:o}}function ge(e,t=document,n=5,o=0,i=new Set){if(o>n||i.has(t))return i;try{let r=()=>e();t.addEventListener?.("selectionchange",r),i.add({root:t,listener:r}),t.querySelectorAll&&t.querySelectorAll("*").forEach(l=>{l.shadowRoot&&ge(e,l.shadowRoot,n,o+1,i)})}catch{}return i}function Qe(e){for(let{root:t,listener:n}of e)try{t.removeEventListener?.("selectionchange",n)}catch{}e.clear()}function ce(e){if(e.id)return`#${e.id}`;let t=[],n=e;for(;n&&n!==document.body&&n!==document.documentElement;){let o=n.tagName.toLowerCase();if(n.id){o=`#${n.id}`,t.unshift(o);break}if(n.className&&typeof n.className=="string"){let r=n.className.trim().split(/\s+/).filter(l=>l);r.length>0&&(o+="."+r[0])}let i=n.parentElement;if(i){let r=Array.from(i.children).filter(l=>l.tagName===n.tagName);if(r.length>1){let l=r.indexOf(n)+1;o+=`:nth-child(${l})`}}t.unshift(o),n=i}return t.join(" > ")}function Je(e){if(e.tagName==="INPUT"||e.tagName==="TEXTAREA")return e.value||e.placeholder||e.name||"";if(e.tagName==="SELECT"){let t=e.options[e.selectedIndex];return t?t.text:""}return e.textContent.trim()}function Ze(e){return e.tagName==="INPUT"?e.type==="checkbox"||e.type==="radio"?e.checked?"checked":"unchecked":e.value:e.tagName==="SELECT"?e.value:""}function V(e){if(e.id)return`#${e.id}`;let t=e.tagName.toLowerCase();if(e.className){let n=e.className.split(" ").filter(o=>o).slice(0,2);n.length&&(t+="."+n.join("."))}return t}function ye(){document.querySelectorAll(".ai-helper-highlight").forEach(t=>{let n=t.parentNode;if(n&&n.insertBefore&&n.removeChild){for(;t.firstChild;)n.insertBefore(t.firstChild,t);n.removeChild(t),typeof n.normalize=="function"&&n.normalize()}});let e=document.getElementById("ai-helper-highlight-style");e&&e.remove()}function et(){try{let e=i=>{let r=document.querySelector(`meta[name="${i}"]`)||document.querySelector(`meta[property="${i}"]`)||document.querySelector(`meta[property="og:${i}"]`);return r?r.content:null},t=i=>{let r=document.querySelectorAll(`meta[name="${i}"], meta[property="${i}"], meta[property="og:${i}"]`);return Array.from(r).map(l=>l.content).filter(Boolean)},n=[];document.querySelectorAll('script[type="application/ld+json"]').forEach(i=>{try{let r=JSON.parse(i.textContent);Array.isArray(r)?n.push(...r):r&&r["@graph"]&&Array.isArray(r["@graph"])?n.push(...r["@graph"]):r&&n.push(r)}catch{}});let o=[];return document.querySelectorAll("[itemscope]").forEach(i=>{let r=i.getAttribute("itemtype")||"";if(!r)return;let l={};i.querySelectorAll("[itemprop]").forEach(a=>{if(a.closest("[itemscope]")!==i)return;let s=a.getAttribute("itemprop")||"";if(!s)return;let d=a.getAttribute("content")||a.getAttribute("href")||a.getAttribute("src")||a.textContent?.trim();d&&(l[s]?l[s]=Array.isArray(l[s])?[...l[s],d]:[l[s],d]:l[s]=d)}),o.push({itemType:r,properties:l})}),{success:!0,data:{title:document.title,description:e("description"),keywords:e("keywords"),author:e("author"),ogTitle:e("og:title"),ogDescription:e("og:description"),ogImage:e("og:image"),ogUrl:e("og:url"),ogType:e("og:type"),ogSiteName:e("og:site_name"),ogLocale:e("og:locale"),articlePublishedTime:e("article:published_time"),articleModifiedTime:e("article:modified_time"),articleAuthor:e("article:author"),twitterCard:e("twitter:card"),twitterTitle:e("twitter:title"),twitterDescription:e("twitter:description"),twitterImage:e("twitter:image"),twitterSite:e("twitter:site"),twitterCreator:e("twitter:creator"),canonicalUrl:document.querySelector('link[rel="canonical"]')?.href,links:t("citation_author"),jsonLd:n.length>0?n:void 0,microdata:o.length>0?o:void 0}}}catch(e){return{success:!1,error:e.message}}}function tt(e="all",t=!1){try{let n=window.location.hostname,o=[];return document.querySelectorAll("a[href]").forEach(i=>{try{let r=i.href;if(!r||r.startsWith("javascript:")||r.startsWith("#"))return;let l=new URL(r),a=l.hostname!==n;if(e==="internal"&&a||e==="external"&&!a)return;o.push({href:r,text:i.textContent.trim(),title:i.title,domain:l.hostname,isExternal:a,target:i.target})}catch{}}),t&&document.querySelectorAll("img[src]").forEach(i=>{try{let r=i.src;if(!r)return;let l=new URL(r),a=l.hostname!==n;if(e==="internal"&&a||e==="external"&&!a)return;o.push({href:r,text:i.alt||"",title:i.title,domain:l.hostname,isExternal:a,type:"image"})}catch{}}),{success:!0,total:o.length,links:o}}catch(n){return{success:!1,error:n.message}}}function nt(e=null){try{let t=(e?[document.querySelector(e)].filter(Boolean):Array.from(document.querySelectorAll("form"))).map((n,o)=>{let i=[],r=n.id||`form-${o}`;return n.querySelectorAll("input").forEach(l=>{i.push({tag:"input",name:l.name,id:l.id,type:l.type,placeholder:l.placeholder,required:l.required,selector:V(l)})}),n.querySelectorAll("textarea").forEach(l=>{i.push({tag:"textarea",name:l.name,id:l.id,placeholder:l.placeholder,required:l.required,selector:V(l)})}),n.querySelectorAll("select").forEach(l=>{let a=Array.from(l.options).map(s=>({value:s.value,text:s.textContent.trim()}));i.push({tag:"select",name:l.name,id:l.id,required:l.required,options:a,selector:V(l)})}),{formId:r,action:n.action,method:n.method,fields:i}});return{success:!0,total:t.length,forms:t}}catch(t){return{success:!1,error:t.message}}}function rt(e={}){try{let{minWidth:t=0,minHeight:n=0,includeBackgroundImages:o=!1,download:i=!1,maxResults:r=100}=e,l=[],a=new Set;return document.querySelectorAll("img[src]").forEach(s=>{try{let d=s.src;if(!d||a.has(d))return;let h=s.naturalWidth||s.width||0,u=s.naturalHeight||s.height||0;h>=t&&u>=n&&(a.add(d),l.push({src:d,alt:s.alt||"",title:s.title||"",width:h,height:u,selector:V(s)}))}catch{}}),o&&document.querySelectorAll("*").forEach(s=>{try{let d=window.getComputedStyle(s).backgroundImage;if(!d||d==="none"||d.startsWith("gradient"))return;let h=d.match(/url\(['"]?([^'")]+)['"]?\)/);if(h&&h[1]){let u=h[1];a.has(u)||(a.add(u),l.push({src:u,alt:"",title:"",width:0,height:0,type:"background",selector:V(s)}))}}catch{}}),i&&l.length>0&&l.slice(0,Math.min(r,10)).forEach((s,d)=>{setTimeout(()=>{let h=document.createElement("a");h.href=s.src,h.download=`image_${d+1}.png`,document.body.appendChild(h),h.click(),document.body.removeChild(h)},d*500)}),{success:!0,total:l.length,images:l.slice(0,r),message:i?`\u5DF2\u5F00\u59CB\u4E0B\u8F7D ${Math.min(l.length,10)} \u5F20\u56FE\u7247`:""}}catch(t){return{success:!1,error:t.message}}}function ot(e="iframe",t=!1,n=1e4){try{let o=document.querySelectorAll(e),i=[],r=(l,a=1,s="")=>{try{let d=ce(l),h=s?`${s} > iframe`:d,u=l.src||"about:blank",c=!1,p="",g="",y=0;try{let v=l.contentDocument||l.contentWindow?.document;v&&(c=!0,p=v.title||"",g=le(v).substring(0,n),y=ae(v).length,t&&a<2&&v.querySelectorAll("iframe").forEach(E=>{r(E,a+1,h)}))}catch{c=!1}i.push({selector:h,url:u,accessible:c,title:p,textContent:g,htmlLength:y})}catch{}};return o.forEach(l=>r(l)),{success:!0,iframes:i,total:i.length,accessible:i.filter(l=>l.accessible).length}}catch(o){return{success:!1,error:o.message}}}function it(e={}){try{let{query:t,pattern:n,mode:o="plain",caseSensitive:i=!1,contextLength:r=50,maxResults:l=20,highlight:a=!1}=e,s=t||n;if(!s)return{success:!1,error:"\u9700\u8981\u63D0\u4F9B\u641C\u7D22\u5173\u952E\u8BCD"};if(o==="plain"){let g=window.find(s,i,!1,!0,!1,!0,!1),y=0,v=[];try{let E=window.getSelection(),O=E&&E.rangeCount>0?E.getRangeAt(0):null,P=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null,!1),te=i?"g":"gi",He=s.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),je=new RegExp(He,te),ne=document.body.innerText,Ee=0;for(;P.nextNode();){let ke=P.currentNode.textContent.match(je);if(ke)for(let re of ke){if(v.length>=l)break;let K=ne.indexOf(re,Ee),ze=Math.max(0,K-r),Ue=Math.min(ne.length,K+re.length+r);v.push({match:re,position:K,context:ne.substring(ze,Ue),lineNumber:ne.substring(0,K).split(`
`).length}),y++,Ee=K+re.length}if(v.length>=l)break}O&&(E.removeAllRanges(),E.addRange(O))}catch{y=+!!g}if(a&&y>0){ye();let E=document.createElement("style");E.id="ai-helper-highlight-style",E.textContent=`
        ...
        `,document.head.appendChild(E);let O=i?"g":"gi",P=s.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");document.body.innerHTML=document.body.innerHTML.replace(new RegExp(P,O),'<span class="ai-helper-search-highlight">$&</span>')}return{success:!0,query:s,mode:"plain",found:g,total:y,matches:v,highlighted:a}}let d=i?"g":"gi",h=new RegExp(s,d),u=document.body.innerText,c=[],p;for(;(p=h.exec(u))!==null&&c.length<l;){let g=Math.max(0,p.index-r),y=Math.min(u.length,p.index+p[0].length+r);c.push({match:p[0],position:p.index,context:u.substring(g,y),lineNumber:u.substring(0,p.index).split(`
`).length}),p[0].length===0&&h.lastIndex++}if(a&&c.length>0){ye();let g=document.createElement("style");g.id="ai-helper-highlight-style",g.textContent=`
        .ai-helper-search-highlight {
          background-color: #ffff00;
          color: #000;
          padding: 1px 2px;
      ...
      `,document.head.appendChild(g),document.body.innerHTML=document.body.innerHTML.replace(new RegExp(s.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),d),'<span class="ai-helper-search-highlight">$&</span>')}return{success:!0,pattern:s,mode:"regex",total:c.length,matches:c,highlighted:a}}catch(t){return{success:!1,error:t.message}}}function lt(e={}){let{filterByText:t,elementTypes:n,maxResults:o=100}=e,i=[],r=new Set,l={button:'button, [role="button"], input[type="submit"], input[type="button"], input[type="reset"]',input:'input:not([type="hidden"]):not([type="submit"]):not([type="button"]):not([type="reset"])',select:"select",textarea:"textarea",a:"a[href]",checkbox:'input[type="checkbox"]',radio:'input[type="radio"]',menuitem:'[role="menuitem"], [role="menu"], [role="menuitemcheckbox"], [role="menuitemradio"]'},a=[];return n&&n.length>0?n.forEach(s=>{l[s]&&a.push(l[s])}):a=Object.values(l),a.forEach(s=>{try{J(s).forEach(d=>{let h=ce(d);if(r.has(h))return;r.add(h);let u=d.tagName.toLowerCase(),c=Je(d),p=Ze(d);if(t&&!c.toLowerCase().includes(t.toLowerCase()))return;let g={tag:u,selector:h,text:c.substring(0,100)};u==="a"?g.href=d.href:(u==="input"||u==="select"||u==="textarea")&&(g.name=d.name,g.type=d.type||"text",g.value=p,g.placeholder=d.placeholder),d.id&&(g.id=d.id),d.className&&typeof d.className=="string"&&(g.className=d.className.split(" ").filter(y=>y).slice(0,3).join(" ")),i.push(g)})}catch{}}),{success:!0,count:Math.min(i.length,o),total:i.length,elements:i.slice(0,o)}}function at(e,t=50){try{if(!e)return{success:!1,error:"\u9009\u62E9\u5668\u4E0D\u80FD\u4E3A\u7A7A"};let n=N(e);if(!n)return{success:!1,error:`\u672A\u627E\u5230\u76EE\u6807\u5143\u7D20: ${e}`};let o=a=>{let s=a.tagName.toLowerCase(),d=a.classList?Array.from(a.classList).sort().join("."):"",h={};return Array.from(a.children).forEach(u=>{let c=u.tagName.toLowerCase();h[c]=(h[c]||0)+1}),`${s}|${d}|${Object.keys(h).sort().map(u=>`${u}:${h[u]}`).join(",")}`},i=o(n),r=[],l=document.querySelectorAll(n.tagName.toLowerCase());for(let a of l)if(a!==n){if(r.length>=t)break;o(a)===i&&r.push({tag:a.tagName.toLowerCase(),selector:ce(a),text:(a.textContent||"").trim().substring(0,200),id:a.id||"",className:typeof a.className=="string"?a.className:""})}return{success:!0,original:{tag:n.tagName.toLowerCase(),selector:ce(n),text:(n.textContent||"").trim().substring(0,200),signature:i},similar:r,count:r.length}}catch(n){return{success:!1,error:n.message}}}function st(e={}){let{scrollPixels:t=800,maxScrolls:n=20,pauseMs:o=500,selector:i}=e;return new Promise(async r=>{try{let l=i?document.querySelector(i):null,a=()=>{let g=l||document.body,y=document.createTreeWalker(g,NodeFilter.SHOW_TEXT),v="",E;for(;E=y.nextNode();){let O=E.parentElement;if(!O)continue;let P=O.getBoundingClientRect();if(P.bottom>-100&&P.top<window.innerHeight+100){let te=E.textContent.trim();te&&(v+=te+`
`)}}return v},s=l||document.scrollingElement||document.documentElement,d="",h=window.scrollY,u=0;for(let g=0;g<n;g++){let y=a();d+=y+`
`;let v=window.scrollY;if(s.scrollBy({top:t,behavior:"auto"}),u++,await new Promise(E=>setTimeout(E,o)),Math.abs(window.scrollY-v)<5&&(await new Promise(E=>setTimeout(E,o)),Math.abs(window.scrollY-v)<5))break}l&&s.scrollTo({top:h,behavior:"auto"});let c=d.split(`
`),p=[];for(let g of c){let y=g.trim();y&&y!==p[p.length-1]&&p.push(y)}r({success:!0,content:p.join(`
`),contentLength:p.join(`
`).length,scrolls:u,startScrollY:h,endScrollY:window.scrollY})}catch(l){r({success:!1,error:l.message})}})}function ct(e={}){let{maxLength:t=5e4,includeHeadings:n=!0,includeLinks:o=!0}=e,i=le(),r={title:document.title||"",url:window.location.href,content:i.substring(0,t),wordCount:i.split(/\s+/).length};return n&&(r.headings=Array.from(J("h1, h2, h3, h4, h5, h6")).map(l=>({level:l.tagName,text:l.textContent.trim()})).filter(l=>l.text.length>0).slice(0,30)),o&&(r.links=Array.from(J("a")).map(l=>({text:l.textContent.trim(),href:l.href})).filter(l=>l.text.length>0).slice(0,50)),{success:!0,data:r}}function dt(e={}){let{includeStyles:t=!1,maxLength:n=5e4}=e,o=ae();return t||(o=o.replace(/\s*style="[^"]*"/gi,"")),{success:!0,content:JSON.stringify({title:document.title,url:window.location.href,html:o.substring(0,n),fullLength:o.length})}}function ut(e="text"){try{let t=window.getSelection();if(!t||t.isCollapsed||t.rangeCount===0)return{success:!1,error:"\u5F53\u524D\u6CA1\u6709\u9009\u4E2D\u7684\u5185\u5BB9"};let n={success:!0,data:{selectedCount:t.rangeCount,text:""}};if(e==="html"){let o=[];for(let i=0;i<t.rangeCount;i++){let r=t.getRangeAt(i).cloneContents(),l=document.createElement("div");l.appendChild(r),o.push(l.innerHTML)}n.data.html=o.join(`
`),n.data.text=t.toString()}else n.data.text=t.toString();return n}catch(t){return{success:!1,error:t.message}}}function ht(e="table",t=!0,n="json"){try{let o=N(e);if(!o)return{success:!1,error:`\u672A\u627E\u5230\u5339\u914D\u9009\u62E9\u5668\u7684\u8868\u683C: ${e}`};let i=Array.from(o.querySelectorAll("tr")),r=[];return i.forEach((l,a)=>{let s=Array.from(l.querySelectorAll("td, th")).map(d=>d.textContent.trim());(t||a>0)&&r.push(s)}),n==="markdown"?r.length===0?{success:!0,content:"\u8868\u683C\u4E3A\u7A7A"}:{success:!0,content:`${`| ${r[0].join(" | ")} |`}
${`| ${r[0].map(()=>"---").join(" | ")} |`}
${r.slice(1).map(l=>`| ${l.join(" | ")} |`).join(`
`)}`}:{success:!0,content:JSON.stringify({data:r,rowCount:r.length,columnCount:r[0]?.length||0}),data:r}}catch(o){return{success:!1,error:o.message}}}async function pt(e){try{return await navigator.clipboard.writeText(e),{success:!0,message:"\u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F"}}catch{try{let t=document.createElement("textarea");return t.value=e,t.style.position="fixed",t.style.left="-9999px",document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),{success:!0,message:"\u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F\uFF08\u964D\u7EA7\u65B9\u6848\uFF09"}}catch(t){return{success:!1,error:t.message}}}}async function ft(){try{return{success:!0,content:await navigator.clipboard.readText()}}catch(e){return{success:!1,error:e.message}}}function mt(e){try{let t=N(e);if(!t)return{success:!1,error:`\u672A\u627E\u5230\u5143\u7D20: ${e}`};let n=new MouseEvent("mouseenter",{bubbles:!0,cancelable:!0,view:window});t.dispatchEvent(n);let o=new MouseEvent("mouseover",{bubbles:!0,cancelable:!0,view:window});return t.dispatchEvent(o),{success:!0,message:`\u5DF2\u5728\u5143\u7D20\u4E0A\u89E6\u53D1\u60AC\u505C\u6548\u679C: ${e}`}}catch(t){return{success:!1,error:t.message}}}function gt(e,t="yellow"){try{if(!e)return{success:!1,error:"\u672A\u63D0\u4F9B\u8981\u9AD8\u4EAE\u7684\u6587\u672C"};ye();let n=document.createElement("style");n.id="ai-helper-highlight-style",n.textContent=`
      .ai-helper-highlight {
        background-color: ${t} !important;
        padding: 2px 0;
      }
    `,document.head.appendChild(n);let o=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null,!1),i=[],r;for(;r=o.nextNode();)r.nodeValue.toLowerCase().includes(e.toLowerCase())&&i.push(r);let l=[];return i.forEach(a=>{let s=a.parentNode;if(!s||!s.replaceChild||!s.insertBefore)return;let d=a.nodeValue,h=d.toLowerCase(),u=d.toLowerCase(),c=h.indexOf(u);if(c!==-1){let p=document.createElement("span");p.className="ai-helper-highlight",p.textContent=d.substring(c,c+d.length);let g=document.createTextNode(d.substring(0,c)),y=document.createTextNode(d.substring(c+d.length));s.replaceChild(y,a),s.insertBefore(p,y),s.insertBefore(g,p),l.push(p)}}),l.length>0&&l[0].scrollIntoView({behavior:"smooth",block:"center"}),{success:!0,message:`\u5DF2\u9AD8\u4EAE ${l.length} \u5904\u6587\u672C`,count:l.length}}catch(n){return{success:!1,error:n.message}}}function yt(e,t=500,n=3e3){try{if(!e)return{success:!1,error:"\u9009\u62E9\u5668\u4E0D\u80FD\u4E3A\u7A7A"};let o=e.trim();for(let[r,l]of[[/^"([\s\S]*)"$/,"$1"],[/^'([\s\S]*)'$/,"$1"],[/^`([\s\S]*)`$/,"$1"],[/^"([\s\S]*)"$/,"$1"],[/^'([\s\S]*)'$/,"$1"],[/^「([\s\S]*)」$/,"$1"]])o=o.replace(r,l);let i=N(o);return i?(i.click(),{success:!0,message:`\u5DF2\u6210\u529F\u70B9\u51FB\u5143\u7D20: ${e}`}):{success:!1,error:`\u672A\u627E\u5230\u5339\u914D\u9009\u62E9\u5668\u7684\u5143\u7D20: ${e}`}}catch(o){return{success:!1,error:o.message}}}function bt(e){return e.isContentEditable||e.getAttribute("contenteditable")==="true"}function Re(e,t){let n=e.tagName==="TEXTAREA"?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,o=Object.getOwnPropertyDescriptor(n,"value");o&&o.set?o.set.call(e,t):e.value=t}function Se(e,t){try{return e.focus(),document.execCommand("insertText",!1,t)||(e.textContent=t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),!0}catch{try{return e.textContent=t,e.dispatchEvent(new Event("input",{bubbles:!0})),!0}catch{return!1}}}function xt(e,t=500){try{let n=[];return e.forEach(o=>{let{selector:i,value:r,fieldType:l="text"}=o,a=N(i);if(!a){n.push({selector:i,success:!1,error:"\u672A\u627E\u5230\u5143\u7D20"});return}try{if(l==="text"){if(bt(a)){let s=Se(a,r);n.push({selector:i,success:s,value:r});return}Re(a,r),a.dispatchEvent(new Event("input",{bubbles:!0})),a.dispatchEvent(new Event("change",{bubbles:!0}))}else if(l==="contenteditable"){let s=Se(a,r);n.push({selector:i,success:s,value:r});return}else if(l==="select"){let s=a.querySelector(`option[value="${r}"]`)||Array.from(a.options).find(d=>d.textContent===r);if(s)a.value=s.value,a.dispatchEvent(new Event("change",{bubbles:!0}));else{n.push({selector:i,success:!1,error:"\u672A\u627E\u5230\u5339\u914D\u7684\u9009\u9879"});return}}else if(l==="checkbox")a.checked=r==="true"||r===!0,a.dispatchEvent(new Event("change",{bubbles:!0}));else if(l==="radio"){let s=document.querySelector(`${i}[value="${r}"]`);if(s)s.checked=!0,s.dispatchEvent(new Event("change",{bubbles:!0}));else{n.push({selector:i,success:!1,error:"\u672A\u627E\u5230\u5339\u914D\u7684\u5355\u9009\u6309\u94AE"});return}}n.push({selector:i,success:!0,value:r})}catch(s){n.push({selector:i,success:!1,error:s.message})}}),{success:!0,message:`\u8868\u5355\u586B\u5145\u5B8C\u6210\uFF0C\u6210\u529F ${n.filter(o=>o.success).length}/${e.length} \u4E2A\u5B57\u6BB5`,details:n}}catch(n){return{success:!1,error:n.message}}}function wt(e){try{let{target:t="selector",selector:n,x:o=0,y:i=0,behavior:r="smooth",align:l="center"}=e;if(t==="top")window.scrollTo({top:0,left:0,behavior:r});else if(t==="bottom")window.scrollTo({top:document.body.scrollHeight,left:0,behavior:r});else if(t==="coordinates")window.scrollTo({top:i,left:o,behavior:r});else if(t==="selector"&&n){let a=N(n);if(!a)return{success:!1,error:`\u672A\u627E\u5230\u5143\u7D20: ${n}`};a.scrollIntoView({behavior:r,block:l})}else return{success:!1,error:"\u65E0\u6548\u7684\u6EDA\u52A8\u76EE\u6807\u6216\u7F3A\u5C11\u9009\u62E9\u5668"};return{success:!0,message:"\u6EDA\u52A8\u5B8C\u6210"}}catch(t){return{success:!1,error:t.message}}}function Te(e){if(!e)return!1;if(e.offsetParent===null&&e.tagName!=="BODY"){let r=window.getComputedStyle(e);if(r.display==="none"||r.visibility==="hidden"||r.position!=="fixed")return!1}let t=window.getComputedStyle(e);if(t.display==="none"||t.visibility==="hidden"||parseFloat(t.opacity)<=0)return!1;let n=e.getBoundingClientRect();if(n.width<=0||n.height<=0)return!1;let o=window.innerHeight||document.documentElement.clientHeight,i=window.innerWidth||document.documentElement.clientWidth;return n.top<o&&n.bottom>0&&n.left<i&&n.right>0}function vt(e,t="appeared",n=1e4){return new Promise((o,i)=>{let r=Date.now(),l=()=>{let a=N(e);if(t==="appeared"&&a){o({success:!0,message:`\u5143\u7D20 ${e} \u5DF2\u51FA\u73B0`,element:e});return}if(t==="disappeared"&&!a){o({success:!0,message:`\u5143\u7D20 ${e} \u5DF2\u6D88\u5931`});return}if(t==="visible"&&a&&Te(a)){o({success:!0,message:`\u5143\u7D20 ${e} \u5DF2\u53EF\u89C1`,element:e});return}if(t==="hidden"&&(!a||!Te(a))){o({success:!0,message:`\u5143\u7D20 ${e} \u5DF2\u9690\u85CF`});return}if(Date.now()-r>n){o({success:!1,error:`\u7B49\u5F85\u8D85\u65F6\uFF08${n}ms\uFF09\uFF0C\u5143\u7D20 ${e} \u672A\u8FBE\u5230 ${t} \u72B6\u6001`});return}setTimeout(l,100)};l()})}function Et({key:e,text:t,ctrlKey:n=!1,shiftKey:o=!1,altKey:i=!1}){try{let r=document.activeElement;if(!r)return{success:!1,error:"\u6CA1\u6709\u805A\u7126\u7684\u5143\u7D20"};if(t){let l=r.tagName==="INPUT"||r.tagName==="TEXTAREA",a=r.isContentEditable;if(l||a){if(r.focus(),a)try{document.execCommand("selectAll",!1,null),document.execCommand("insertText",!1,t)}catch{r.textContent+=t}else Re(r,r.value+t);try{r.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,inputType:"insertText",data:t}))}catch{r.dispatchEvent(new Event("input",{bubbles:!0}))}r.dispatchEvent(new Event("change",{bubbles:!0}))}}if(e){let l={key:e,code:e.length===1?`Key${e.toUpperCase()}`:e,keyCode:e.toUpperCase().charCodeAt(0),which:e.toUpperCase().charCodeAt(0),bubbles:!0,cancelable:!0,ctrlKey:n,shiftKey:o,altKey:i};document.activeElement.dispatchEvent(new KeyboardEvent("keydown",l)),document.activeElement.dispatchEvent(new KeyboardEvent("keypress",l)),document.activeElement.dispatchEvent(new KeyboardEvent("keyup",l))}return{success:!0,message:"\u952E\u76D8\u8F93\u5165\u6210\u529F"}}catch(r){return{success:!1,error:r.message}}}function kt(e,t){return new Promise((n,o)=>{try{let i=N(e),r=N(t);if(!i){n({success:!1,error:`\u672A\u627E\u5230\u6E90\u5143\u7D20: ${e}`});return}if(!r){n({success:!1,error:`\u672A\u627E\u5230\u76EE\u6807\u5143\u7D20: ${t}`});return}let l=i.getBoundingClientRect(),a=r.getBoundingClientRect(),s=l.left+l.width/2,d=l.top+l.height/2,h=a.left+a.width/2,u=a.top+a.height/2,c=(p,g,y)=>{let v=new DragEvent(p,{bubbles:!0,cancelable:!0,clientX:g,clientY:y,screenX:g,screenY:y});Object.defineProperty(v,"dataTransfer",{value:{getData:()=>"",setData:()=>{},effectAllowed:"all",dropEffect:"none"}}),document.elementFromPoint(g,y)?.dispatchEvent(v)};c("dragstart",s,d),c("dragenter",h,u),c("dragover",h,u),c("drop",h,u),c("dragend",s,d),n({success:!0,experimental:!0,message:`\u26A0\uFE0F\u62D6\u62FD\u4E3A\u5B9E\u9A8C\u6027\uFF0C\u53EF\u80FD\u672A\u751F\u6548\uFF08${e} \u2192 ${t}\uFF09\u3002\u53D7\u6D4F\u89C8\u5668 dataTransfer \u9650\u5236\uFF0C\u4F9D\u8D56\u62D6\u62FD\u6570\u636E\u7684\u7F51\u9875\u591A\u6570\u65E0\u6CD5\u89E6\u53D1\uFF0C\u5EFA\u8BAE\u9A8C\u8BC1\u7ED3\u679C\u6216\u6539\u7528\u70B9\u51FB\u5750\u6807\u5B9E\u73B0`})}catch(i){n({success:!1,error:i.message})}})}function St(e,t,n,o="application/octet-stream"){try{let i=N(e);if(!i)return{success:!1,error:`\u672A\u627E\u5230\u6587\u4EF6\u4E0A\u4F20\u63A7\u4EF6: ${e}`};if(i.type!=="file")return{success:!1,error:"\u9009\u62E9\u7684\u5143\u7D20\u4E0D\u662F\u6587\u4EF6\u4E0A\u4F20\u63A7\u4EF6"};let r;try{let s=atob(n),d=new Uint8Array(s.length);for(let h=0;h<s.length;h++)d[h]=s.charCodeAt(h);r=new Blob([d],{type:o})}catch{r=new Blob([n],{type:o})}let l=new File([r],t,{type:o}),a=new DataTransfer;return a.items.add(l),i.files=a.files,i.dispatchEvent(new Event("change",{bubbles:!0})),{success:!0,message:`\u5DF2\u4E0A\u4F20\u6587\u4EF6: ${t}`}}catch(i){return{success:!1,error:i.message}}}function Tt(e,t,n=null,o=5e3){return new Promise(async i=>{try{let r=document.querySelector(e);if(!r){i({success:!1,error:`\u672A\u627E\u5230\u89E6\u53D1\u5668: ${e}`});return}if(r.tagName==="SELECT"){let d=r.options;for(let h=0;h<d.length;h++){let u=d[h],c=(u.textContent||u.label||"").trim();if(c===t||c.includes(t)){r.value=u.value,r.dispatchEvent(new Event("change",{bubbles:!0})),r.dispatchEvent(new Event("input",{bubbles:!0})),i({success:!0,message:`\u5DF2\u9009\u62E9: ${c}`,triggerTag:"SELECT"});return}}i({success:!1,error:`\u5728 <select> \u4E2D\u672A\u627E\u5230\u5339\u914D\u7684\u9009\u9879: "${t}"`,availableOptions:Array.from(d).map(h=>h.textContent?.trim()).filter(Boolean)});return}r.click(),await new Promise(d=>setTimeout(d,300));let l=Date.now(),a=n?document.querySelector(n):document,s=null;for(;Date.now()-l<o;){let d=a.querySelectorAll('li, [role="option"], [role="menuitem"], .option, .dropdown-item, .select-item, [data-value], div');for(let h of d){let u=(h.textContent||"").trim();if(!(u.length<2)&&(u===t||u.includes(t)||u.replace(/\s+/g,"")===t.replace(/\s+/g,""))){s=h;break}}if(s)break;await new Promise(h=>setTimeout(h,100))}if(!s){i({success:!1,error:`\u5728 ${o}ms \u5185\u672A\u627E\u5230\u5339\u914D\u9009\u9879: "${t}"`});return}s.click(),i({success:!0,message:`\u5DF2\u9009\u62E9: ${s.textContent?.trim()}`,triggerTag:r.tagName})}catch(r){i({success:!1,error:r.message})}})}function Ct({action:e,storage:t,key:n,value:o}){try{let i=t==="session"?sessionStorage:localStorage;switch(e){case"get":if(!n){let l={};for(let a=0;a<i.length;a++){let s=i.key(a);l[s]=i.getItem(s)}return{success:!0,content:JSON.stringify(l),data:l}}let r=i.getItem(n);return{success:!0,content:JSON.stringify({key:n,value:r}),value:r};case"set":return!n||o===void 0?{success:!1,error:"set\u64CD\u4F5C\u9700\u8981\u63D0\u4F9Bkey\u548Cvalue"}:(i.setItem(n,o),{success:!0,message:`\u5DF2\u8BBE\u7F6E ${n}`});case"remove":return n?(i.removeItem(n),{success:!0,message:`\u5DF2\u5220\u9664 ${n}`}):{success:!1,error:"remove\u64CD\u4F5C\u9700\u8981\u63D0\u4F9Bkey"};case"clear":return i.clear(),{success:!0,message:"\u5DF2\u6E05\u7A7A\u5B58\u50A8"};default:return{success:!1,error:`\u672A\u77E5\u64CD\u4F5C: ${e}`}}}catch(i){return{success:!1,error:i.message}}}function At(e,t){try{let n=document.createElement("canvas");n.width=t,n.height=t;let o=n.getContext("2d");o.fillStyle="#FFFFFF",o.fillRect(0,0,t,t);let i=[];for(let u=0;u<e.length;u++)i.push(e.charCodeAt(u));let r=Math.max(2,Math.floor(t/41)),l=Math.floor(t/r),a=Math.floor((t-l*r)/2);o.fillStyle="#000000";let s=(u,c)=>{let p=7*r;o.fillRect(u,c,p,p),o.fillStyle="#FFFFFF",o.fillRect(u+r,c+r,p-2*r,p-2*r),o.fillStyle="#000000",o.fillRect(u+2*r,c+2*r,p-4*r,p-4*r),o.fillStyle="#000000"};s(a,a),s(a+(l-7)*r,a),s(a,a+(l-7)*r);let d=0;for(let u=0;u<e.length;u++)d=(d<<5)-d+e.charCodeAt(u),d|=0;let h=u=>{let c=u+1831565813;return c=Math.imul(c^c>>>15,c|1),c^=c+Math.imul(c^c>>>7,c|61),((c^c>>>14)>>>0)/4294967296};for(let u=0;u<l;u++)for(let c=0;c<l;c++){let p=u<8&&c<8,g=u<8&&c>=l-8,y=u>=l-8&&c<8;p||g||y||h(d+u*l+c)>.5&&o.fillRect(a+c*r,a+u*r,r,r)}return n.toDataURL("image/png")}catch{return null}}function Lt(e="",t=200,n="M",o=!0){return new Promise(i=>{try{let r=e||window.location.href,l=document.createElement("div");l.id="ai-helper-qrcode",l.style.cssText=`
        position: fixed;
        top: 50%;
        left: 50%;
  ...
  </div>`,x.innerHTML=t,x._clickHandler=n=>{if(n.target.closest(".aih-dropdown-settings")){n.stopPropagation(),x.style.display="none";try{chrome.runtime.sendMessage({type:"OPEN_OPTIONS_PAGE",hash:"toolbar"}).catch(()=>{})}catch{}return}if(n.target.closest(".aih-dropdown-block")){n.stopPropagation(),n.preventDefault(),x.style.display="none",Gt();return}if(n.target.closest(".aih-dropdown-hide")){n.stopPropagation(),n.preventDefault(),x.style.display="none",Me=!0,S(),z(),b="";return}let o=n.target.closest("[data-action]");o&&(n.stopPropagation(),x.style.display="none",De(o.dataset.action,b))},x.addEventListener("click",x._clickHandler),x.addEventListener("keydown",n=>{if(n.key==="Enter"||n.key===" "){let o=n.target.closest('[role="button"]');o&&(n.preventDefault(),o.click())}})}async function _t(){if(f)return;await Ie();let e=[...R].sort((c,p)=>c.order-p.order),t=e.find(c=>c.id==="ai-search"),n=e.filter(c=>c.id!=="ai-search"&&c.id!=="copy"),o=n.slice(0,Ce-1),i=n.slice(Ce-1);f=document.createElement("div"),f.id="aih-selection-toolbar";let r='<span class="aih-tb-buttons">';r+=`<span class="aih-tb-grip" title="\u62D6\u62FD\u79FB\u52A8">${w.grip}</span>`;let l=ve;t&&(r+=`<div class="aih-tb-btn primary" role="button" tabindex="0" data-action="ai-search" title="AI \u641C\u7D22">
      <span class="aih-tb-icon">${w.search}</span>${l?"":"AI\u641C\u7D22"}
    </div>`),o.forEach(c=>{let p=$e(c.id);r+=`<div class="aih-tb-btn" role="button" tabindex="0" data-action="${c.id}" title="${c.name}">
  ...
  </div>`,$t(i),r+=`<div class="aih-tb-btn" role="button" tabindex="0" data-action="copy" title="\u590D\u5236\u9009\u4E2D\u5185\u5BB9">
    <span class="aih-tb-icon">${w.copy}</span>${l?"":"\u590D\u5236"}
  ...
  `,m.querySelector(".aih-result-close").addEventListener("click",t=>{t.stopPropagation(),z()}),m.querySelector(".aih-result-lock").addEventListener("click",t=>{t.stopPropagation(),qt()}),m.querySelector(".aih-result-footer").addEventListener("click",t=>{t.stopPropagation();let n=t.target.closest("[data-action]")?.dataset?.action;if(n==="regenerate-result"){if(!be||!de)return;we(be,de,xe)}else n==="copy-result"&&Wt()});let e=m.querySelector(".aih-followup-input");m.querySelector(".aih-followup-send").addEventListener("click",t=>{t.stopPropagation();let n=e.value.trim();n&&(fe(n),e.value="")}),e.addEventListener("keydown",t=>{if(t.key==="Enter"){t.preventDefault();let n=e.value.trim();n&&(fe(n),e.value="")}}),m.querySelector(".aih-suggestions-list").addEventListener("click",t=>{let n=t.target.closest(".aih-suggestion-chip");if(!n)return;t.stopPropagation();let o=n.dataset.question;o&&fe(o)}),m.addEventListener("keydown",t=>{if(t.key==="Enter"||t.key===" "){let n=t.target.closest('[role="button"]');n&&(t.preventDefault(),n.click())}}),I(m),Ne(m,".aih-result-header")}function Ae(e,t,n,o=[]){if(!m)return;I(m);let i=window.innerWidth,r=window.innerHeight;m.style.display="flex",m.style.left="-9999px",m.style.top="-9999px";let l=m.querySelector(".aih-result-body");l.innerHTML=n;let a=m.querySelector(".aih-result-suggestions"),s=m.querySelector(".aih-suggestions-list");o.length>0&&a&&s?(s.innerHTML=o.map(d=>`<div class="aih-suggestion-chip" role="button" tabindex="0" data-question="${W(d)}">${W(d)}</div>`).join(""),a.style.display="block"):a&&(a.style.display="none"),requestAnimationFrame(()=>{let d=m.getBoundingClientRect(),h=d.width||420,u=Math.min(d.height||200,520),c=e-h/2;c<8&&(c=8),c+h>i-8&&(c=i-h-8);let p=t-u-8;p<8&&(p=t+8),m.style.left=c+"px",m.style.top=p+"px",m.style.maxHeight=Math.min(520,r-p-16)+"px",_=!0,I(m)})}function Ot(e,t){if(!m)return;H={x:e,y:t},q=!1,he();let n=m.querySelector(".aih-result-suggestions");n&&(n.style.display="none");let o=m.querySelector(".aih-followup-input");o&&(o.value=""),I(m),m.style.display="flex";let i=m.querySelector(".aih-result-body");i.innerHTML='<div class="aih-result-loading"><div class="aih-spinner"></div>AI \u6B63\u5728\u601D\u8003...</div>',qe(m,e,t),_=!0,S()}function Oe(e,t,n){if(!m)return;q=!1,D="",he(),I(m),m.style.display="flex";let o=m.querySelector(".aih-result-body");o.innerHTML=`<div class="aih-result-error">\u8BF7\u6C42\u5931\u8D25: ${W(n)}</div>`,qe(m,e,t),_=!0}function qe(e,t,n){let o=window.innerWidth,i=window.innerHeight;e.style.left="-9999px",e.style.top="-9999px",requestAnimationFrame(()=>{let r=e.getBoundingClientRect(),l=r.width||420,a=Math.min(r.height||200,520),s=t-l/2;s<8&&(s=8),s+l>o-8&&(s=o-l-8);let d=n-a-8;d<8&&(d=n+8),e.style.left=s+"px",e.style.top=d+"px",e.style.maxHeight=Math.min(520,i-d-16)+"px",I(e)})}function z(){m&&(m.style.display="none",_=!1,q=!1,D="",he())}function qt(){q=!q,he()}function he(){if(!m)return;let e=m.querySelector(".aih-result-lock");e&&(q?(e.innerHTML=w.lock,e.classList.add("locked"),e.title="\u89E3\u9664\u9501\u5B9A"):(e.innerHTML=w.unlock,e.classList.remove("locked"),e.title="\u9501\u5B9A\u7A97\u53E3"))}function fe(e){if(!e||!$())return;let t=b||de||"";try{chrome.runtime.sendMessage({type:"DIRECT_SEND",text:e,selectedText:t}).catch(n=>{k.error("[SelectionToolbar] \u53D1\u9001\u8FFD\u95EE\u5230\u4FA7\u8FB9\u680F\u5931\u8D25:",n)})}catch{}}function Dt(e,t){if(!(!e||!$()))try{chrome.runtime.sendMessage({type:"DIRECT_SEND",text:e,selectedText:t||""}).catch(n=>{k.error("[SelectionToolbar] \u53D1\u9001\u5230\u4FA7\u8FB9\u680F\u5931\u8D25:",n)})}catch{}}function W(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}function ee(e,t){if(!f||!b||_)return;I(f);let n=window.innerWidth,o=window.innerHeight;f.style.display="flex",lastToolbarShowTime=Date.now(),requestAnimationFrame(()=>{let i=f.getBoundingClientRect(),r=i.width||300,l=i.height||40,a=e-r/2;a<8&&(a=8),a+r>n-8&&(a=n-r-8);let s=t-l-10;s<8&&(s=t+10),s<8&&(s=8),s+l>o-8&&(s=o-l-8),f.style.left=a+"px",f.style.top=s+"px",M||=(f.classList.add("show"),!0)})}function S(){!f||!M||(A&&(A=!1,ie="",Y=null,f.classList.remove("aih-ask-mode"),f.style.width="",Q&&=(f.style.left=Q,"")),f.classList.remove("show"),f.style.display="none",M=!1)}function Bt(){if(!f)return{x:0,y:0};let e=f.getBoundingClientRect();return{x:e.left+e.width/2,y:e.top}}function Pt(e){let t=e.getBoundingClientRect();return{x:t.left+t.width/2,y:t.top}}function me(){if(!$()||!Z)return;if(!L){let r=j();if(k.debug("[SelectionToolbar] iframe onSelectionChange text:",r.text?.substring(0,30),"currentSelectedText:",!!b,"pendingIframeSelection:",!!C),r.text&&r.text.length>=2){let l=se(r.range);C={text:r.text,x:l.x,y:l.y},k.debug("[SelectionToolbar] iframe pendingIframeSelection \u5DF2\u8BBE\u7F6E")}else if(b){b="",C=null;try{chrome.runtime.sendMessage({type:"IFRAME_SELECTION_CLEAR"}).catch(()=>{})}catch{}}return}if(G.length>0&&G.includes(window.location.hostname)||Me)return;let e=window.getSelection(),t=e?e.toString().trim():"",n=null;if(t&&t.length>=2&&e.rangeCount>0)n=e.getRangeAt(0);else{let r=j();r.text&&r.text.length>=2&&(t=r.text,n=r.range)}if(!t||t.length<2){A||S(),b="",B=null;return}let o=5e3,i=t.length>o?t.substring(0,o)+"...":t;if(n){let r=n.commonAncestorContainer,l=r.nodeType===Node.TEXT_NODE?r.parentElement.closest("[contenteditable], input, textarea"):r.closest&&r.closest("[contenteditable], input, textarea");if(l instanceof HTMLElement&&(l.tagName==="INPUT"||l.tagName==="TEXTAREA")){S(),b="",B=null;return}}b=i,B=!0}function Ft(e){if(!(f&&f.contains(e.target))&&!(m&&m.contains(e.target))){if(ue){ue=!1;return}_&&!q&&z(),M&&!A&&S(),chrome.runtime.sendMessage({type:"IFRAME_CLICK_DISMISS"}).catch(()=>{})}}function Ht(){if(k.debug("[SelectionToolbar] onMouseUp isTopFrame:",L,"pendingSelection:",B,"pendingIframeSelection:",!!C,"currentSelectedText:",!!b,"isToolbarVisible:",M,"toolbarEl:",!!f),!L){if(C){ue=!0,C.text,b=C.text;try{window.parent.postMessage({type:"IFRAME_SELECTION",text:C.text,x:C.x,y:C.y},"*")}catch{}try{chrome.runtime.sendMessage({type:"IFRAME_SELECTION",text:C.text,x:C.x,y:C.y}).catch(()=>{})}catch{}C=null}return}if(!M&&B&&b){ue=!0;let e=window.innerWidth/2,t=window.innerHeight/2,n=window.getSelection();if(n&&n.rangeCount>0){let o=n.getRangeAt(0).getBoundingClientRect();(o.width>0||o.height>0)&&(e=o.left+o.width/2,t=o.top)}if(e===window.innerWidth/2&&t===window.innerHeight/2){let o=j();if(o.text&&o.text.length>=2){let i=se(o.range);e=i.x,t=i.y}}chrome.runtime.sendMessage({type:"IFRAME_CLICK_DISMISS"}).catch(()=>{}),ee(e,t),B=null}}function jt(){if(A)return;if(!L&&b){let n=j();if(n.text){let o=se(n.range);try{window.parent.postMessage({type:"IFRAME_SELECTION",text:n.text,x:o.x,y:o.y},"*")}catch{}try{chrome.runtime.sendMessage({type:"IFRAME_SELECTION",text:n.text,x:o.x,y:o.y}).catch(()=>{})}catch{}}return}if(!M)return;let e=window.getSelection();if(e&&e.rangeCount>0&&b){let n=e.getRangeAt(0).getBoundingClientRect();if(n.width>0||n.height>0){ee(n.left+n.width/2,n.top);return}}let t=j();if(t.text&&t.text.length>=2&&b){let n=se(t.range);ee(n.x,n.y);return}S()}function zt(){A||M&&S()}function De(e,t){if(!t)return;if(de=t,e==="copy"){Ut(t),S();return}if(be=e,xe="",["ai-search","explain","translate","summary"].includes(e)){we(e,t);return}let n=R.find(o=>o.id===e);n&&(xe=n.systemPrompt||"",we(e,t,n.systemPrompt))}function Ut(e){Be(e).then(()=>{Fe()}).catch(t=>{k.error("[SelectionToolbar] \u590D\u5236\u5931\u8D25:",t),Pe()})}function Wt(){let e=D;e&&Be(e).then(()=>{Fe()}).catch(t=>{k.error("[SelectionToolbar] \u590D\u5236\u7ED3\u679C\u5931\u8D25:",t),Pe()})}async function Be(e){if(!navigator.clipboard)return Le(e);try{await navigator.clipboard.writeText(e)}catch(t){if(t.name==="NotAllowedError"||t.name==="SecurityError")return Le(e);throw t}}function Le(e){return new Promise((t,n)=>{let o=document.createElement("textarea");o.value=e,o.style.position="fixed",o.style.left="-9999px",o.style.opacity="0",I(o);try{o.select(),o.setSelectionRange(0,e.length),document.execCommand("copy")?t():n(Error("execCommand copy failed"))}catch(i){n(i)}finally{o.remove()}})}function Pe(){let e=document.getElementById("aih-copy-toast");e&&e.remove();let t=document.createElement("div");t.id="aih-copy-toast",t.textContent="\u590D\u5236\u5931\u8D25\uFF0C\u8BF7\u624B\u52A8\u590D\u5236",t.style.cssText=`
    position: fixed;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%);
  ...
  `,I(t),t.style.zIndex="2147483647",setTimeout(()=>t.remove(),1800)}function Fe(){let e=document.getElementById("aih-copy-toast");e&&e.remove();let t=document.createElement("div");if(t.id="aih-copy-toast",t.textContent="\u5DF2\u590D\u5236",t.style.cssText=`
    position: fixed;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%);
  ...
  `,!document.getElementById("aih-toast-anim")){let n=document.createElement("style");n.id="aih-toast-anim",n.textContent=`
    ...
    `,document.head.appendChild(n)}I(t),t.style.zIndex="2147483647",setTimeout(()=>t.remove(),1300)}function we(e,t,n){if(!$()){k.warn("[SelectionToolbar] \u6269\u5C55\u4E0A\u4E0B\u6587\u5DF2\u5931\u6548\uFF0C\u8BF7\u5237\u65B0\u9875\u9762");return}let o={"ai-search":`\u641C\u7D22\u5E76\u5206\u6790\u4EE5\u4E0B\u5185\u5BB9\uFF1A
...
${t}`:o[e]||t;if(e==="ai-search"){S(),window.getSelection().removeAllRanges();try{chrome.runtime.sendMessage({type:"SELECTION_TOOLBAR_ACTION",action:e,text:t,prompt:i}).catch(s=>{k.error("[SelectionToolbar] \u53D1\u9001\u6D88\u606F\u5931\u8D25:",s)})}catch{}return}_e();let r={"ai-search":"AI\u641C\u7D22",explain:"\u89E3\u91CA",translate:"\u7FFB\u8BD1",summary:"\u603B\u7ED3"}[e];if(!r&&R){let s=R.find(d=>d.id===e);r=s?s.name:"AI \u56DE\u7B54"}let l=m.querySelector(".aih-result-header span");l&&(l.innerHTML=`${w.sparkle} ${r||"AI \u56DE\u7B54"}`);let a=_&&m?Pt(m):Bt();Ot(a.x,a.y),chrome.runtime.sendMessage({type:"SELECTION_TOOLBAR_ACTION",action:e,text:t,prompt:i,systemPrompt:n||""}).catch(s=>{k.error("[SelectionToolbar] \u53D1\u9001\u6D88\u606F\u5931\u8D25:",s),Oe(a.x,a.y,s.message)})}$()&&chrome.runtime.onMessage.addListener((e,t,n)=>{if($()){if(e.type==="IFRAME_SELECTION"){if(!L)return;k.debug("[SelectionToolbar] \u6536\u5230 IFRAME_SELECTION text:",e.text?.substring(0,30),"isToolbarVisible:",M,"isResultVisible:",_),b=e.text;let o=e.x,i=e.y;if(window.top!==window&&window.frameElement)try{let r=window.frameElement.getBoundingClientRect();o=e.x-r.left,i=e.y-r.top}catch{}if(M&&f&&b){requestAnimationFrame(()=>{let r=window.innerWidth,l=f.offsetWidth||300,a=f.offsetHeight||40,s=o-l/2;s<8&&(s=8),s+l>r-8&&(s=r-l-8);let d=i-a-8;d<8&&(d=i+8),f.style.left=s+"px",f.style.top=d+"px"});return}B={x:o,y:i},b&&b.length>=2&&ee(o,i);return}if(e.type==="IFRAME_SELECTION_CLEAR"){if(!L)return;M&&!A&&(S(),b="");return}if(e.type==="IFRAME_CLICK_DISMISS"){M&&f&&Date.now()-lastToolbarShowTime>300&&(S(),b=""),_&&!q&&z();return}if(L){if(e.type==="SELECTION_TOOLBAR_STREAM_START"){F="";return}if(e.type==="SELECTION_TOOLBAR_STREAM_CHUNK"){if(F+=e.delta||"",m&&_){let o=m.querySelector(".aih-result-body");o&&(o.querySelector(".aih-result-content-stream")||(o.innerHTML='<div class="aih-result-content-stream"></div>'),o.innerHTML='<div class="aih-result-content-stream">'+W(F).replace(/\n/g,"<br>")+"</div>")}return}if(e.type==="SELECTION_TOOLBAR_STREAM_DONE"){e.finalContent&&(F=e.finalContent);let o=F||"\u65E0\u54CD\u5E94";D=F;let i=o,r=[],l=o.indexOf("---SUGGESTIONS---");l!==-1&&(i=o.substring(0,l).trim(),D=i,r=o.substring(l+17).split(`
`).map(s=>s.replace(/^[\d]+[\.\、\s]+/,"").trim()).filter(s=>s.length>0).slice(0,3));let a=typeof marked<"u"?marked.parse(i):W(i).replace(/\n/g,"<br>");Ae(H.x,H.y,a,r),F="";return}if(e.type==="SELECTION_TOOLBAR_RESULT")if(e.error)D="",Oe(H.x,H.y,e.error);else{let o=e.content||"\u65E0\u54CD\u5E94",i=o;D=o;let r=[],l=o.indexOf("---SUGGESTIONS---");l!==-1&&(i=o.substring(0,l).trim(),D=i,r=o.substring(l+17).split(`
`).map(s=>s.replace(/^[\d]+[\.\、\s]+/,"").trim()).filter(s=>s.length>0).slice(0,3));let a=typeof marked<"u"?marked.parse(i):W(i).replace(/\n/g,"<br>");Ae(H.x,H.y,a,r)}}}});function Gt(){if(!$())return;let e=window.location.hostname;try{chrome.storage.local.get(["blockedDomains"],t=>{try{let n=t.blockedDomains||[];n.includes(e)||(n.push(e),chrome.storage.local.set({blockedDomains:n},()=>{G=n,S(),z(),b=""}))}catch{}})}catch{}}function Kt(){$()&&chrome.storage.local.get(["enableSelectionToolbar","blockedDomains"],e=>{Z=e.enableSelectionToolbar===void 0?!0:!!e.enableSelectionToolbar,G=e.blockedDomains||[],k.debug("[SelectionToolbar] \u5F00\u5173\u72B6\u6001:",Z?"\u5DF2\u542F\u7528":"\u5DF2\u7981\u7528","\u5C4F\u853D\u57DF\u540D:",G.length)})}$()&&chrome.storage.onChanged.addListener((e,t)=>{$()&&(t==="local"&&e.enableSelectionToolbar&&(Z=!!e.enableSelectionToolbar.newValue,Z||(S(),z(),b="")),t==="local"&&e.blockedDomains&&(G=e.blockedDomains.newValue||[]),t==="local"&&e.toolbarTools&&Nt())});function Xt(){Mt(),_t(),_e(),Kt(),document.addEventListener("selectionchange",me),document.addEventListener("click",Ft,!0),document.addEventListener("mouseup",Ht,!0),window.addEventListener("scroll",jt,!0),window.addEventListener("resize",zt),window.addEventListener("message",e=>{if(e.data?.type==="IFRAME_SELECTION"&&L){b=e.data.text;let t=e.data.x,n=e.data.y;if(window.top!==window&&window.frameElement)try{let o=window.frameElement.getBoundingClientRect();t=e.data.x-o.left,n=e.data.y-o.top}catch{}if(M&&f&&b){requestAnimationFrame(()=>{let o=window.innerWidth,i=f.offsetWidth||300,r=f.offsetHeight||40,l=t-i/2;l<8&&(l=8),l+i>o-8&&(l=o-i-8);let a=n-r-8;a<8&&(a=n+8),f.style.left=l+"px",f.style.top=a+"px"});return}B={x:t,y:n},b&&b.length>=2&&ee(t,n);return}e.data?.type==="IFRAME_CLICK_DISMISS"&&L&&_&&!q&&z()}),L&&(pe=ge(me),new MutationObserver(()=>{Qe(pe),pe=ge(me)}).observe(document.body,{childList:!0,subtree:!0})),k.debug("[SelectionToolbar] \u521D\u59CB\u5316\u5B8C\u6210",L?"(\u9876\u5C42frame)":"(\u5B50frame)")}console.log("[ContentScript] \u5185\u5BB9\u811A\u672C\u5DF2\u52A0\u8F7D URL:",window.location.href,"isTopFrame:",window.top===window,"hasBody:",!!document.body),document.addEventListener("keydown",e=>{(e.ctrlKey||e.metaKey)&&e.shiftKey&&e.key==="A"&&(e.preventDefault(),chrome.action.click()),e.altKey&&!e.shiftKey&&e.code==="KeyS"&&!e.ctrlKey&&!e.metaKey&&(e.preventDefault(),chrome.runtime.sendMessage({type:"CAPTURE_TAB_FROM_PAGE"})),e.altKey&&e.shiftKey&&e.code==="KeyS"&&!e.ctrlKey&&!e.metaKey&&(e.preventDefault(),chrome.runtime.sendMessage({type:"CAPTURE_REGION_FROM_PAGE"}))});var Yt={GET_PAGE_TEXT:e=>ct(e),GET_FULL_HTML:e=>dt(e),QUERY_ELEMENTS:e=>lt(e),GET_SELECTED_CONTENT:e=>ut(e.format),INTERACT_ELEMENT:e=>e.action==="hover"?mt(e.selector):yt(e.selector,e.waitTime,e.timeout),FILL_FORM:e=>xt(e.fields,e.waitTime),SCROLL_TO:e=>wt(e),KEYBOARD_INPUT:e=>Et(e),FILE_UPLOAD:e=>St(e.selector,e.fileName,e.fileContent,e.fileType),EXTRACT_TABLE:e=>ht(e.selector,e.includeHeaders,e.format),EXTRACT_METADATA:()=>et(),EXTRACT_LINKS:e=>tt(e.filterType,e.includeImages),EXTRACT_FORMS:e=>nt(e.formSelector),EXTRACT_IMAGES:e=>rt(e),SEARCH_IN_PAGE:e=>it(e),FIND_SIMILAR:e=>at(e.selector,e.maxResults),IFRAME_CONTENT:e=>ot(e.selector,e.includeNested,e.maxLength),SCROLL_COLLECT:e=>st(e),HIGHLIGHT_TEXT:e=>gt(e.text,e.color),MANAGE_STORAGE:e=>Ct(e),INJECT_CSS:e=>Rt(e.css,e.targetSelector,e.injectMode),COPY_TO_CLIPBOARD:e=>pt(e.text),PASTE_FROM_CLIPBOARD:()=>ft(),WAIT_ELEMENT:e=>vt(e.selector,e.state,e.timeout),DRAG_DROP:e=>kt(e.sourceSelector,e.targetSelector),SELECT_DROPDOWN:e=>Tt(e.triggerSelector,e.optionText,e.optionSelector,e.timeout),QRCODE:e=>Lt(e.content,e.size,e.errorCorrection,e.showImage),CLEAR_DATA:e=>{try{let t=[];return e.site?window.location.href.includes(new URL(e.site).hostname)&&(localStorage.clear(),sessionStorage.clear(),t.push("localStorage","sessionStorage")):(localStorage.clear(),sessionStorage.clear(),t.push("localStorage","sessionStorage")),{success:!0,cleared:t}}catch(t){return{success:!1,error:t.message}}},START_REGION_SELECTION:()=>Jt(),GET_PAGE_METRICS:()=>({width:Math.max(document.documentElement.scrollWidth,document.body.scrollWidth||0,window.innerWidth),height:Math.max(document.documentElement.scrollHeight,document.body.scrollHeight||0,window.innerHeight)})},Vt=new Set(["COPY_TO_CLIPBOARD","PASTE_FROM_CLIPBOARD","WAIT_ELEMENT","DRAG_DROP","SELECT_DROPDOWN","QRCODE","START_REGION_SELECTION"]),Qt=new Set(["GET_PAGE_TEXT","GET_FULL_HTML","EXTRACT_METADATA","EXTRACT_TABLE","IFRAME_CONTENT","QUERY_ELEMENTS"]);$()&&chrome.runtime.onMessage.addListener((e,t,n)=>{if(Qt.has(e.type)&&window.top!==window)return;if(e.action==="getSelectedText"){let r=window.getSelection()?.toString()?.trim()||"";if(r&&document.hasFocus())return n({text:r}),!0;let l=j();return l.text&&l.text.trim()&&document.hasFocus()&&n({text:l.text.trim()}),!0}let o=Yt[e.type];if(!o)return;let i=o(e);if(Vt.has(e.type)||i instanceof Promise)return Promise.resolve(i).then(n),!0;n(i)}),Xt();function Jt(){return new Promise(e=>{let t=document.createElement("div");t.id="__region_select_overlay__",t.style.cssText=`
