...
`)}`}:{success:!0,content:JSON.stringify({data:n,rowCount:n.length,columnCount:n[0]?.length||0}),data:n}}catch(o){return{success:!1,error:o.message}}}async function gt(e){try{return await navigator.clipboard.writeText(e),{success:!0,message:"\u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F"}}catch{try{let t=document.createElement("textarea");return t.value=e,t.style.position="fixed",t.style.left="-9999px",document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),{success:!0,message:"\u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F\uFF08\u964D\u7EA7\u65B9\u6848\uFF09"}}catch(t){return{success:!1,error:t.message}}}}async function yt(){try{return{success:!0,content:await navigator.clipboard.readText()}}catch(e){return{success:!1,error:e.message}}}function bt(e){try{let t=_(e);if(!t)return{success:!1,error:`\u672A\u627E\u5230\u5143\u7D20: ${e}`};let r=new MouseEvent("mouseenter",{bubbles:!0,cancelable:!0,view:window});t.dispatchEvent(r);let o=new MouseEvent("mouseover",{bubbles:!0,cancelable:!0,view:window});return t.dispatchEvent(o),{success:!0,message:`\u5DF2\u5728\u5143\u7D20\u4E0A\u89E6\u53D1\u60AC\u505C\u6548\u679C: ${e}`}}catch(t){return{success:!1,error:t.message}}}function xt(e,t="yellow"){try{if(!e)return{success:!1,error:"\u672A\u63D0\u4F9B\u8981\u9AD8\u4EAE\u7684\u6587\u672C"};ue();let r=document.createElement("style");r.id="ai-helper-highlight-style",r.textContent=`
  ...
  </div>`,w.innerHTML=t,w._clickHandler=r=>{if(r.target.closest(".aih-dropdown-settings")){r.stopPropagation(),w.style.display="none";try{chrome.runtime.sendMessage({type:"OPEN_OPTIONS_PAGE",hash:"toolbar"}).catch(()=>{})}catch{}return}if(r.target.closest(".aih-dropdown-block")){r.stopPropagation(),r.preventDefault(),w.style.display="none",Zt();return}if(r.target.closest(".aih-dropdown-hide")){r.stopPropagation(),r.preventDefault(),w.style.display="none",Re=!0,S(),G(),x="";return}let o=r.target.closest("[data-action]");o&&(r.stopPropagation(),w.style.display="none",qe(o.dataset.action,x))},w.addEventListener("click",w._clickHandler),w.addEventListener("keydown",r=>{if(r.key==="Enter"||r.key===" "){let o=r.target.closest('[role="button"]');o&&(r.preventDefault(),o.click())}})}async function Ft(){if(g)return;await Ne();let e=[...R].sort((c,p)=>c.order-p.order),t=e.find(c=>c.id==="ai-search"),r=e.filter(c=>c.id!=="ai-search"&&c.id!=="copy"),o=r.slice(0,Ce-1),i=r.slice(Ce-1);g=document.createElement("div"),g.id="aih-selection-toolbar";let n='<span class="aih-tb-buttons">';n+=`<span class="aih-tb-grip" title="\u62D6\u62FD\u79FB\u52A8">${v.grip}</span>`;let l=Ee;t&&(n+=`<div class="aih-tb-btn primary" role="button" tabindex="0" data-action="ai-search" title="AI \u641C\u7D22">
  ...
  </div>`,Bt(i),n+=`<div class="aih-tb-btn" role="button" tabindex="0" data-action="copy" title="\u590D\u5236\u9009\u4E2D\u5185\u5BB9">
  ...
  `,I(t),t.style.zIndex="2147483647",setTimeout(()=>t.remove(),1800)}function He(){let e=document.getElementById("aih-copy-toast");e&&e.remove();let t=document.createElement("div");if(t.id="aih-copy-toast",t.textContent="\u5DF2\u590D\u5236",t.style.cssText=`
    position: fixed;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%);
  ...
  `,!document.getElementById("aih-toast-anim")){let r=document.createElement("style");r.id="aih-toast-anim",r.textContent=`
    ...
    `,document.head.appendChild(r)}I(t),t.style.zIndex="2147483647",setTimeout(()=>t.remove(),1300)}function we(e,t,r){if(!O()){k.warn("[SelectionToolbar] \u6269\u5C55\u4E0A\u4E0B\u6587\u5DF2\u5931\u6548\uFF0C\u8BF7\u5237\u65B0\u9875\u9762");return}let o={"ai-search":`\u641C\u7D22\u5E76\u5206\u6790\u4EE5\u4E0B\u5185\u5BB9\uFF1A
...
${t}`:o[e]||t;if(e==="ai-search"){S(),window.getSelection().removeAllRanges();try{chrome.runtime.sendMessage({type:"SELECTION_TOOLBAR_ACTION",action:e,text:t,prompt:i}).catch(a=>{k.error("[SelectionToolbar] \u53D1\u9001\u6D88\u606F\u5931\u8D25:",a)})}catch{}return}Ie();let n={"ai-search":"AI\u641C\u7D22",explain:"\u89E3\u91CA",translate:"\u7FFB\u8BD1",summary:"\u603B\u7ED3"}[e];if(!n&&R){let a=R.find(u=>u.id===e);n=a?a.name:"AI \u56DE\u7B54"}let l=y.querySelector(".aih-result-header span");l&&(l.innerHTML=`${v.sparkle} ${n||"AI \u56DE\u7B54"}`);let s=$&&y?Wt(y):Ut();jt(s.x,s.y),chrome.runtime.sendMessage({type:"SELECTION_TOOLBAR_ACTION",action:e,text:t,prompt:i,systemPrompt:r||""}).catch(a=>{k.error("[SelectionToolbar] \u53D1\u9001\u6D88\u606F\u5931\u8D25:",a),Oe(s.x,s.y,a.message)})}O()&&chrome.runtime.onMessage.addListener((e,t,r)=>{if(O()){if(e.type==="IFRAME_SELECTION"){if(!L)return;k.debug("[SelectionToolbar] \u6536\u5230 IFRAME_SELECTION text:",e.text?.substring(0,30),"isToolbarVisible:",M,"isResultVisible:",$),x=e.text;let o=e.x,i=e.y;if(window.top!==window&&window.frameElement)try{let n=window.frameElement.getBoundingClientRect();o=e.x-n.left,i=e.y-n.top}catch{}if(M&&g&&x){requestAnimationFrame(()=>{let n=window.innerWidth,l=g.offsetWidth||300,s=g.offsetHeight||40,a=o-l/2;a<8&&(a=8),a+l>n-8&&(a=n-l-8);let u=i-s-8;u<8&&(u=i+8),g.style.left=a+"px",g.style.top=u+"px"});return}H={x:o,y:i},x&&x.length>=2&&ee(o,i);return}if(e.type==="IFRAME_SELECTION_CLEAR"){if(!L)return;M&&!A&&(S(),x="");return}if(e.type==="IFRAME_CLICK_DISMISS"){M&&g&&Date.now()-lastToolbarShowTime>300&&(S(),x=""),$&&!D&&G();return}if(L){if(e.type==="SELECTION_TOOLBAR_STREAM_START"){B="";return}if(e.type==="SELECTION_TOOLBAR_STREAM_CHUNK"){if(B+=e.delta||"",y&&$){let o=y.querySelector(".aih-result-body");o&&(o.querySelector(".aih-result-content-stream")||(o.innerHTML='<div class="aih-result-content-stream"></div>'),o.innerHTML='<div class="aih-result-content-stream">'+U(B).replace(/\n/g,"<br>")+"</div>")}return}if(e.type==="SELECTION_TOOLBAR_STREAM_DONE"){e.finalContent&&(B=e.finalContent);let o=B||"\u65E0\u54CD\u5E94";P=B;let i=o,n=[],l=o.indexOf("---SUGGESTIONS---");l!==-1&&(i=o.substring(0,l).trim(),P=i,n=o.substring(l+17).split(`
`).map(a=>a.replace(/^[\d]+[\.\、\s]+/,"").trim()).filter(a=>a.length>0).slice(0,3));let s=typeof marked<"u"?marked.parse(i):U(i).replace(/\n/g,"<br>");Ae(F.x,F.y,s,n),B="";return}if(e.type==="SELECTION_TOOLBAR_RESULT")if(e.error)P="",Oe(F.x,F.y,e.error);else{let o=e.content||"\u65E0\u54CD\u5E94",i=o;P=o;let n=[],l=o.indexOf("---SUGGESTIONS---");l!==-1&&(i=o.substring(0,l).trim(),P=i,n=o.substring(l+17).split(`
`).map(a=>a.replace(/^[\d]+[\.\、\s]+/,"").trim()).filter(a=>a.length>0).slice(0,3));let s=typeof marked<"u"?marked.parse(i):U(i).replace(/\n/g,"<br>");Ae(F.x,F.y,s,n)}}}});function Zt(){if(!O())return;let e=window.location.hostname;try{chrome.storage.local.get(["blockedDomains"],t=>{try{let r=t.blockedDomains||[];r.includes(e)||(r.push(e),chrome.storage.local.set({blockedDomains:r},()=>{W=r,S(),G(),x=""}))}catch{}})}catch{}}function er(){O()&&chrome.storage.local.get(["enableSelectionToolbar","blockedDomains"],e=>{Z=e.enableSelectionToolbar===void 0?!0:!!e.enableSelectionToolbar,W=e.blockedDomains||[],k.debug("[SelectionToolbar] \u5F00\u5173\u72B6\u6001:",Z?"\u5DF2\u542F\u7528":"\u5DF2\u7981\u7528","\u5C4F\u853D\u57DF\u540D:",W.length)})}O()&&chrome.storage.onChanged.addListener((e,t)=>{O()&&(t==="local"&&e.enableSelectionToolbar&&(Z=!!e.enableSelectionToolbar.newValue,Z||(S(),G(),x="")),t==="local"&&e.blockedDomains&&(W=e.blockedDomains.newValue||[]),t==="local"&&e.toolbarTools&&Pt())});function tr(){Dt(),Ft(),Ie(),er(),document.addEventListener("selectionchange",ge),document.addEventListener("click",Kt,!0),document.addEventListener("mouseup",Xt,!0),window.addEventListener("scroll",Yt,!0),window.addEventListener("resize",Vt),window.addEventListener("message",e=>{if(e.data?.type==="IFRAME_SELECTION"&&L){x=e.data.text;let t=e.data.x,r=e.data.y;if(window.top!==window&&window.frameElement)try{let o=window.frameElement.getBoundingClientRect();t=e.data.x-o.left,r=e.data.y-o.top}catch{}if(M&&g&&x){requestAnimationFrame(()=>{let o=window.innerWidth,i=g.offsetWidth||300,n=g.offsetHeight||40,l=t-i/2;l<8&&(l=8),l+i>o-8&&(l=o-i-8);let s=r-n-8;s<8&&(s=r+8),g.style.left=l+"px",g.style.top=s+"px"});return}H={x:t,y:r},x&&x.length>=2&&ee(t,r);return}e.data?.type==="IFRAME_CLICK_DISMISS"&&L&&$&&!D&&G()}),L&&(me=ye(ge),new MutationObserver(()=>{Je(me),me=ye(ge)}).observe(document.body,{childList:!0,subtree:!0})),k.debug("[SelectionToolbar] \u521D\u59CB\u5316\u5B8C\u6210",L?"(\u9876\u5C42frame)":"(\u5B50frame)")}console.log("[ContentScript] \u5185\u5BB9\u811A\u672C\u5DF2\u52A0\u8F7D URL:",window.location.href,"isTopFrame:",window.top===window,"hasBody:",!!document.body),document.addEventListener("keydown",e=>{(e.ctrlKey||e.metaKey)&&e.shiftKey&&e.key==="A"&&(e.preventDefault(),chrome.action.click()),e.altKey&&!e.shiftKey&&e.code==="KeyS"&&!e.ctrlKey&&!e.metaKey&&(e.preventDefault(),chrome.runtime.sendMessage({type:"CAPTURE_TAB_FROM_PAGE"})),e.altKey&&e.shiftKey&&e.code==="KeyS"&&!e.ctrlKey&&!e.metaKey&&(e.preventDefault(),chrome.runtime.sendMessage({type:"CAPTURE_REGION_FROM_PAGE"}))});var rr={GET_PAGE_TEXT:e=>ht(e),GET_FULL_HTML:e=>pt(e),QUERY_INTERACTIVE_ELEMENTS:e=>at(e),GET_SELECTED_CONTENT:e=>mt(e.format),CLICK_ELEMENT:e=>wt(e.selector,e.waitTime,e.timeout),FILL_FORM:e=>vt(e.fields,e.waitTime),SCROLL_TO:e=>kt(e),HOVER_ELEMENT:e=>bt(e.selector),KEYBOARD_INPUT:e=>Tt(e),FILE_UPLOAD:e=>At(e.selector,e.fileName,e.fileContent,e.fileType),EXTRACT_TABLE:e=>ft(e.selector,e.includeHeaders,e.format),EXTRACT_METADATA:()=>et(),EXTRACT_LINKS:e=>tt(e.filterType,e.includeImages),EXTRACT_FORMS:e=>rt(e.formSelector),EXTRACT_IMAGES:e=>nt(e),SEARCH_IN_PAGE:e=>st(e),PAGE_TO_MARKDOWN:e=>ot(e.selector,e.includeImages,e.includeLinks,e.maxLength),PAGE_TO_JSON:e=>it(e.selector,e.maxItems),FIND_SIMILAR_ELEMENTS:e=>ct(e.selector,e.maxResults),GET_IFRAME_CONTENT:e=>lt(e.selector,e.includeNested,e.maxLength),HIGHLIGHT_TEXT:e=>xt(e.text,e.color),REMOVE_HIGHLIGHTS:()=>ue(),SHADOW_DOM_QUERY:e=>$t(e.selector,e.deep,e.maxDepth,e.maxResults),MANAGE_STORAGE:e=>Rt(e),TEXT_TO_SPEECH:e=>Nt(e.text,e.lang,e.rate,e.pitch),INJECT_CSS:e=>qt(e.css,e.targetSelector,e.injectMode),VIDEO_CONTROL:e=>_t(e.action,e.selector,e.value),COPY_TO_CLIPBOARD:e=>gt(e.text),PASTE_FROM_CLIPBOARD:()=>yt(),WAIT_FOR_ELEMENT:e=>St(e.selector,e.state,e.timeout),DRAG_AND_DROP:e=>Ct(e.sourceSelector,e.targetSelector),SELECT_DROPDOWN:e=>Lt(e.triggerSelector,e.optionText,e.optionSelector,e.timeout),COLOR_PICKER:()=>Mt(),GENERATE_QRCODE:e=>Ot(e.content,e.size,e.errorCorrection,e.showImage),GET_ELEMENT_COUNT:e=>ut(e.selector,e.includeHidden),SCROLL_AND_COLLECT:e=>dt(e),CLEAR_PAGE_DATA:e=>{try{let t=[];return e.site?window.location.href.includes(new URL(e.site).hostname)&&(localStorage.clear(),sessionStorage.clear(),t.push("localStorage","sessionStorage")):(localStorage.clear(),sessionStorage.clear(),t.push("localStorage","sessionStorage")),{success:!0,cleared:t}}catch(t){return{success:!1,error:t.message}}},START_REGION_SELECTION:()=>ir(),GET_PAGE_METRICS:()=>({width:Math.max(document.documentElement.scrollWidth,document.body.scrollWidth||0,window.innerWidth),height:Math.max(document.documentElement.scrollHeight,document.body.scrollHeight||0,window.innerHeight),viewportHeight:window.innerHeight}),GET_VIEWPORT_HEIGHT:()=>({height:window.innerHeight}),GET_SCROLL_POSITION:()=>({scrollX:window.scrollX,scrollY:window.scrollY})},nr=new Set(["COPY_TO_CLIPBOARD","PASTE_FROM_CLIPBOARD","WAIT_FOR_ELEMENT","DRAG_AND_DROP","SELECT_DROPDOWN","SCROLL_AND_COLLECT","WATCH_ELEMENT","COLOR_PICKER","GENERATE_QRCODE","SCREENSHOT_ELEMENT","START_REGION_SELECTION"]),or=new Set(["GET_PAGE_TEXT","GET_FULL_HTML","PAGE_TO_MARKDOWN","PAGE_TO_JSON","EXTRACT_METADATA","EXTRACT_TABLE","GET_ELEMENT_COUNT","SCROLL_AND_COLLECT","GET_IFRAME_CONTENT","QUERY_INTERACTIVE_ELEMENTS"]);O()&&chrome.runtime.onMessage.addListener((e,t,r)=>{if(or.has(e.type)&&window.top!==window)return;if(e.action==="getSelectedText"){let n=window.getSelection()?.toString()?.trim()||"";if(n&&document.hasFocus())return r({text:n}),!0;let l=j();return l.text&&l.text.trim()&&document.hasFocus()&&r({text:l.text.trim()}),!0}let o=rr[e.type];if(!o)return;let i=o(e);if(nr.has(e.type)||i instanceof Promise)return Promise.resolve(i).then(r),!0;r(i)}),tr();function ir(){return new Promise(e=>{let t=document.createElement("div");t.id="__region_select_overlay__",t.style.cssText=`
